...
class UserDetail(dd.DetailLayout):
    ...
    box1 = """
    username user_type:20 person company partner
    first_name last_name initials
    email language time_zone dashboard_layout
    id created modified
    """
...
class Me(Users):
    ...
    #     #     raise Exception("20210531 {}".format(cls))
...
if has_socialauth and settings.SITE.has_feature('third_party_authentication'):
