...
class Ksjsb(Project):
    ...
    def buy_things_with_coins(self):
        ...
        if self.uia_ins.click_by_screen_text(text='去完成', txt=self.uia_ins.txt):  # 已完成
            ...
            while True:
                ...
                try:
                    ...
                    print_err(err)
                    err_cnt += 1
                    print(f'buy_things_with_coins 去完成 err_cnt={err_cnt}')
                if err_cnt >= 6:
                    return self.buy_things_with_coins()
        click_cnt = 0
        while self.uia_ins.click_by_screen_text('去逛街', txt=self.uia_ins.txt):  # 已领取
            ...
            if click_cnt >= 10:
                ...
                break
        if self.uia_ins.get_point_by_screen_text('明日再来'):
    ...
    def change_money(self):
        ...
        if not expat_err_flag:
            ...
            self.uia_ins.click_by_screen_text('立即兑换')
        sleep(3)
