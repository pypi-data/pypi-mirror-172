import asyncio
from archetypewsgi.api_resources.error import AuthRequestError
from archetypewsgi.enums import Method
from archetypewsgi import prod_api_base, auth_version
import requests
import json
import logging
...
class AuthRequestor:
    def __init__(self):
        from archetypewsgi import secret_key, app_id
