...
class NewSequence(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, external_ids, status, meta, type, sample_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, external_ids, status, meta, type, sample_id, *args, **kwargs):  # noqa: E501
        """NewSequence - a model defined in OpenAPI
