...
class GHSwitches(object):
    ...
    def __init__(self, pigpio, pi, pb_switch_gpio, toggle_switch_gpio):
        ...
        """
        self.push_button = GHSwitch(pigpio, pi, pb_switch_gpio)
        self.toggle = GHSwitch(pigpio, pi, toggle_switch_gpio)
...
class GHSwitch(object):
    ...
    def __init__(self, pigpio, pi, switch_gpio):
