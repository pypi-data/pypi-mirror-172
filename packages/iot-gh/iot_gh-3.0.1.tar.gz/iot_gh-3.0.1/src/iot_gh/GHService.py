...
class GHService(object):
    ...
    """
    def __init__(self, pigpio, pi, spi, conf):
        ...
        self.buzzer = GHBuzzer(self.pigpio, self._pi, GHgpio.BUZZER)
        self.fan = GHFan(self.pigpio, self._pi, GHgpio.FAN)
        self.lamps = GHLamps(self.pigpio, self._pi, GHgpio.RED_LED, GHgpio.WHITE_LED, GHgpio.RED_LED, GHgpio.DUAL_LED)
        self.servo = GHServo(self.pigpio, self._pi, GHgpio.SERVO_PWM, conf.servo_cw_position, conf.servo_ccw_position)
        self.switches = GHSwitches(self.pigpio, self._pi, GHgpio.SWITCH_PB, GHgpio.SWITCH_TOGGLE)
