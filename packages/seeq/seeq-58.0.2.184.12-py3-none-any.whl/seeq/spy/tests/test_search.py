...
def test_search_quiet_flag_with_url():
    ...
    quiet_error = "The quiet flag cannot be supplied when a status object is provided"
    errors_error = "The errors flag cannot be supplied when a status object is provided"
