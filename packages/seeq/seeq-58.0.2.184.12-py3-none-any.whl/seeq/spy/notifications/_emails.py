...
def _create_email_request_input(to: RecipientType, subject: str, content: str,
                                cc: Optional[RecipientType], bcc: Optional[RecipientType]) -> EmailRequestInput:
...
def _call_send_email_api(session: Session, email_body: EmailRequestInput) -> None:
    api_client_url: str = session.public_url
...
def send_email(to: RecipientType, subject: str, content: str, *,
               cc: Optional[RecipientType] = None, bcc: Optional[RecipientType] = None, errors: Optional[str] = None,
    ...
    email_request_body: EmailRequestInput = _create_email_request_input(to, subject, content, cc, bcc)
