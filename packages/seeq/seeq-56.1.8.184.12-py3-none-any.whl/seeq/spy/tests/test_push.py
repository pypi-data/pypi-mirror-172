...
def test_push_to_workbook():
    ...
    # If the user doesn't have permission to the Folder the Workbook is contained within, the push should still
    # succeed if errors='catalog' is used.
    ...
    items_api.get_access_control(id=workbook_id)
