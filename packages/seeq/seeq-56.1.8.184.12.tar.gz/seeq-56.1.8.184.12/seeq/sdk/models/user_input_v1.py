...
class UserInputV1(object):
    ...
    def __init__(self, data_id=None, datasource_class=None, datasource_id=None, description=None, email=None, first_name=None, is_admin=None, is_enabled=None, last_name=None, max_requests=None, name=None, password=None, session_duration=None, username=None, workbench=None):
        """
