...
"""
    ...
    OpenAPI spec version: 56.1.8-SNAPSHOT
...
class RequestOutputV1(object):
    ...
    def __init__(self, activities=None, activity_graph=None, flame_graph=None, href=None, parallelization_count=None, parameters=None, progress=None, request_method=None, request_path=None, run_duration=None, user_email=None, username=None):
        """
    ...
    def flame_graph(self):
        ...
        A tree of ActivityInfos (root first) that can be used to construct a flame graph for this request if it is a formula request
