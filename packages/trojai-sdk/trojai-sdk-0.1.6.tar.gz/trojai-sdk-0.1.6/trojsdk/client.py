...
class TrojClient:
    ...
    def post_job(
        ...
        data = {"job_config": {"body": config.to_dict()}, "docker_metadata": docker_metadata}

        r = requests_retry.post(
            f"{config.auth_config.api_endpoint}/jobs", headers=self._get_creds_headers(), json=data
        )
