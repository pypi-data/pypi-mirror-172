...
class BlackTestCase(BlackBaseTestCase):
    ...
    def test_piping(self) -> None:
        source, expected = read_data("miscellaneous", "black_init.py")
    ...
    def test_tab_comment_indentation(self) -> None:
        contents_tab = "if 1:\n\tif 2:\n\t\tpass\n\t# comment\n\tpass\n"
        contents_spc = "if 1:\n    if 2:\n        pass\n    # comment\n    pass\n"
        self.assertFormatEqual(contents_tab, fs(contents_spc))
        self.assertFormatEqual(contents_tab, fs(contents_tab))
        ...
        self.assertFormatEqual(contents_tab, fs(contents_spc))
        self.assertFormatEqual(contents_tab, fs(contents_tab))
        self.assertFormatEqual(contents_tab, fs(contents_mix))
