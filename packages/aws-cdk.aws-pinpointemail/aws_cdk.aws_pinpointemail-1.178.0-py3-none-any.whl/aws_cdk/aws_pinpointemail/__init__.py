...
class CfnConfigurationSet(
    ...
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Sequence[typing.Union["CfnConfigurationSet.TagsProperty", typing.Dict[str, typing.Any]]]] = None,
    ...
    def tags(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnConfigurationSet, "tags").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class TagsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnConfigurationSet.TagsProperty.__init__)
...
class CfnConfigurationSetEventDestination(
    ...
    def __init__(
        ...
        *,
        ...
        event_destination: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnConfigurationSetEventDestination.EventDestinationProperty", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
    ...
    def event_destination_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnConfigurationSetEventDestination, "event_destination_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class EventDestinationProperty:
        def __init__(
            ...
            *,
            ...
            pinpoint_destination: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnConfigurationSetEventDestination.PinpointDestinationProperty", typing.Dict[str, typing.Any]]]] = None,
    ...
    class PinpointDestinationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnConfigurationSetEventDestination.PinpointDestinationProperty.__init__)
...
class CfnDedicatedIpPool(
    ...
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Sequence[typing.Union["CfnDedicatedIpPool.TagsProperty", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
    ...
    def tags(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDedicatedIpPool, "tags").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "tags", value)
    ...
    class TagsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDedicatedIpPool.TagsProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {}
            if key is not None:
...
class CfnIdentity(
    ...
    def __init__(
        ...
        *,
        ...
        mail_from_attributes: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnIdentity.MailFromAttributesProperty", typing.Dict[str, typing.Any]]]] = None,
        tags: typing.Optional[typing.Sequence[typing.Union["CfnIdentity.TagsProperty", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnIdentity.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnIdentity.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnIdentity._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnIdentity, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "name", value)
    ...
    def dkim_signing_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnIdentity, "dkim_signing_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def feedback_forwarding_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnIdentity, "feedback_forwarding_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def mail_from_attributes(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnIdentity, "mail_from_attributes").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnIdentity, "tags").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "tags", value)
    ...
    class MailFromAttributesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnIdentity.MailFromAttributesProperty.__init__)
    ...
    class TagsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnIdentity.TagsProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {}
            if key is not None:
...
class CfnIdentityProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnIdentityProps.__init__)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
