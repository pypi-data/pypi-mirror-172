...
class TerraformStateBackend(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TerraformStateBackend.__init__)
    ...
    def policy(self) -> aws_cdk.aws_iam.IPolicy:
        return typing.cast(aws_cdk.aws_iam.IPolicy, jsii.get(self, "policy"))
...
class TerraformStateBackendProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TerraformStateBackendProps.__init__)
