...
const SELECT_ID_POSTFIX = "-select";
...
class MapCompositionBlockDefinition extends window.wagtailStreamField.blocks.FieldBlockDefinition {
    ...
    render(placeholder, prefix, initialState, initialError) {
        ...
        const selectField = document.getElementById(prefix + SELECT_ID_POSTFIX);
    ...
    onSelectionChange(selectedOption) {
        ...
        let input = document.getElementById(selectId.substring(0, selectId.lastIndexOf(SELECT_ID_POSTFIX)));
