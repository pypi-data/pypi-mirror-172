...
#     js_constructor='hslayers.blocks.MapBlock'

#     @cached_property
#     def media(self):
#         structblock_media = super().media
#         return forms.Media(
#             js=structblock_media._js + ['https://cdnjs.cloudflare.com/ajax/libs/slim-select/1.27.1/slimselect.min.js', 'hslayers/js/map-block.js'],
#             css={
#                  'all': ['https://cdnjs.cloudflare.com/ajax/libs/slim-select/1.27.1/slimselect.min.css']
#             }
#         )
