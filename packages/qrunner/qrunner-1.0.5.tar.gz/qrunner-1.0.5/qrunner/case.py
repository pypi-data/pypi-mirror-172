...
class TestCase(HttpRequest):
    ...
    def assertLenEq(path, value):
        ...
        """
        search_value = jmespath.search(path, ResponseResult.response)
        logger.info(f'断言: {search_value} 的长度 {len(search_value)} 等于 {value}')
    ...
    def assertLenGt(path, value):
        ...
        """
        search_value = jmespath.search(path, ResponseResult.response)
        logger.info(f'断言: {search_value} 的长度 {len(search_value)} 大于 {value}')
    ...
    def assertLenGtOrEq(path, value):
        ...
        """
        search_value = jmespath.search(path, ResponseResult.response)
        logger.info(f'断言: {search_value} 的长度 {len(search_value)} 大于等于 {value}')
        assert len(search_value) >= value, f"{search_value} 的长度不大于 {value}"
    ...
    def assertLenLt(path, value):
        ...
        """
        search_value = jmespath.search(path, ResponseResult.response)
        logger.info(f'断言: {search_value} 的长度 {len(search_value)} 小于 {value}')
        assert len(search_value) < value, f"{search_value} 的长度不大于 {value}"
    ...
    def assertLenLtOrEq(path, value):
        ...
        """
        search_value = jmespath.search(path, ResponseResult.response)
        logger.info(f'断言: {search_value} 的长度 {len(search_value)} 小于等于 {value}')
        assert len(search_value) <= value, f"{search_value} 的长度不大于 {value}"
