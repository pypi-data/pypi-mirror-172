...
class MfgBase(object):
    ...
    def default_fp1_pn(n):
        return (n / (n + 1), 1 / (n + 1))

    def solve_with_fp1(self, maxit=10, pn=default_fp1_pn):
        self.diff_M = []
        # init
    ...
    def default_fp2_pn(self, n):
        return (1 - 1 / n, 1 / n)

    def solve_with_fp2(self, maxit=10, pn=default_fp2_pn):
        self.diff_M = []
        # init
