...
class AddGitHubStageOptions(aws_cdk.pipelines.AddStageOpts):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AddGitHubStageOptions.__init__)
...
class AwsCredentialsSecrets:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsCredentialsSecrets.__init__)
...
class DockerHubCredentialSecrets:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DockerHubCredentialSecrets.__init__)
...
class ExternalDockerCredentialSecrets:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ExternalDockerCredentialSecrets.__init__)
...
class GitHubActionRole(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubActionRole.__init__)
    ...
    def existing_git_hub_actions_provider(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubActionRole.existing_git_hub_actions_provider)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class GitHubActionRoleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubActionRoleProps.__init__)
...
class GitHubActionStep(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubActionStep.__init__)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class GitHubActionStepProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubActionStepProps.__init__)
...
class GitHubWorkflow(
    ...
    def add_stage_with_git_hub_options(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubWorkflow.add_stage_with_git_hub_options)
...
class GitHubWorkflowProps(aws_cdk.pipelines.PipelineBaseProps):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GitHubWorkflowProps.__init__)
...
class JobSettings:
    def __init__(self, *, if_: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JobSettings.__init__)
            check_type(argname="argument if_", value=if_, expected_type=type_hints["if_"])
        self._values: typing.Dict[str, typing.Any] = {}
        if if_ is not None:
            self._values["if_"] = if_
...
class Runner(metaclass=jsii.JSIIMeta, jsii_type="cdk-pipelines-github.Runner"):
    ...
    def self_hosted(cls, labels: typing.Sequence[builtins.str]) -> "Runner":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Runner.self_hosted)
...
class WorkflowTriggers:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(WorkflowTriggers.__init__)
...
class YamlFile(metaclass=jsii.JSIIMeta, jsii_type="cdk-pipelines-github.YamlFile"):
    ...
    def patch(self, *patches: JsonPatch) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(YamlFile.patch)
    ...
    def update(self, obj: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(YamlFile.update)
    ...
    def comment_at_top(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(YamlFile, "comment_at_top").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
