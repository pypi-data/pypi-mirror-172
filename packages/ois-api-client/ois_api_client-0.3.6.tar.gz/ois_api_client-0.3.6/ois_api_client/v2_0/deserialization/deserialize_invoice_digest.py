...
def deserialize_invoice_digest(element: ET.Element) -> Optional[InvoiceDigest]:
    ...
    result = InvoiceDigest(
        ...
        supplier_group_tax_number=XR.get_child_text(element, 'supplierGroupTaxNumber', API),
        ...
        customer_group_tax_number=XR.get_child_text(element, 'customerGroupTaxNumber', API),
