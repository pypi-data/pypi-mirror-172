...
class InvoiceDigest:
    ...
    :param supplier_group_member_tax_number: The supplier's group tax number
    :param supplier_name: Name of the seller (supplier)
    :param customer_tax_number: The buyer's tax number
    :param customer_group_member_tax_number: The buyer's group tax number
    ...
    supplier_group_member_tax_number: Optional[str]
    supplier_name: str
    customer_tax_number: Optional[str]
    customer_group_member_tax_number: Optional[str]
    ...
    ins_date: datetime
    completeness_indicator: Optional[bool]
