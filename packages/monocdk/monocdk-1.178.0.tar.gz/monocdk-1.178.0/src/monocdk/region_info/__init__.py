...
class Default(metaclass=jsii.JSIIMeta, jsii_type="monocdk.region_info.Default"):
    ...
    def service_principal(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Default.service_principal)
...
class Fact(metaclass=jsii.JSIIMeta, jsii_type="monocdk.region_info.Fact"):
    ...
    def find(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Fact.find)
            check_type(argname="argument region", value=region, expected_type=type_hints["region"])
    ...
    def register(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Fact.register)
    ...
    def require_fact(cls, region: builtins.str, name: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Fact.require_fact)
            check_type(argname="argument region", value=region, expected_type=type_hints["region"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    def unregister(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Fact.unregister)
            check_type(argname="argument region", value=region, expected_type=type_hints["region"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
...
class FactName(metaclass=jsii.JSIIMeta, jsii_type="monocdk.region_info.FactName"):
    ...
    def cloudwatch_lambda_insights_version(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FactName.cloudwatch_lambda_insights_version)
    ...
    def service_principal(cls, service: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FactName.service_principal)
...
class RegionInfo(metaclass=jsii.JSIIMeta, jsii_type="monocdk.region_info.RegionInfo"):
    ...
    def get(cls, name: builtins.str) -> "RegionInfo":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RegionInfo.get)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    def limited_region_map(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RegionInfo.limited_region_map)
    ...
    def region_map(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RegionInfo.region_map)
            check_type(argname="argument fact_name", value=fact_name, expected_type=type_hints["fact_name"])
    ...
    def cloudwatch_lambda_insights_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RegionInfo.cloudwatch_lambda_insights_arn)
    ...
    def service_principal(self, service: builtins.str) -> typing.Optional[builtins.str]:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RegionInfo.service_principal)
            check_type(argname="argument service", value=service, expected_type=type_hints["service"])
