...
class CfnInferenceScheduler(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInferenceScheduler.__init__)
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInferenceScheduler.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInferenceScheduler._render_properties)
    ...
    def data_input_configuration(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInferenceScheduler, "data_input_configuration").fset)
    ...
    def data_output_configuration(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInferenceScheduler, "data_output_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def data_upload_frequency(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInferenceScheduler, "data_upload_frequency").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def model_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInferenceScheduler, "model_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def role_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInferenceScheduler, "role_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def data_delay_offset_in_minutes(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInferenceScheduler, "data_delay_offset_in_minutes").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def inference_scheduler_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInferenceScheduler, "inference_scheduler_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def server_side_kms_key_id(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInferenceScheduler, "server_side_kms_key_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnInferenceSchedulerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInferenceSchedulerProps.__init__)
