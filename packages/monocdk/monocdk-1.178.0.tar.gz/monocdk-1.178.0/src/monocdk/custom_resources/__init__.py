...
aws_custom1 = cr.AwsCustomResource(self, "API1",
    on_create=lambda.custom_resources.AwsSdkCall(
        service="...",
        action="...",
...
aws_custom = cr.AwsCustomResource(self, "aws-custom",
    ...
    on_update=lambda.custom_resources.AwsSdkCall(
        service="...",
        action="...",
        parameters={
            "text": "...",
...
verify_domain_identity = cr.AwsCustomResource(self, "VerifyDomainIdentity",
    on_create=route53.custom_resources.AwsSdkCall(
        service="SES",
...
get_parameter = cr.AwsCustomResource(self, "GetParameter",
    on_update=lambda.custom_resources.AwsSdkCall( # will also be called for a CREATE event
        service="SSM",
        action="getParameter",
        parameters={
            "Name": "my-parameter",
...
class AwsCustomResource(
    ...
    def __init__(
        ...
        *,
        ...
        on_create: typing.Optional[typing.Union["AwsSdkCall", typing.Dict[str, typing.Any]]] = None,
        on_delete: typing.Optional[typing.Union["AwsSdkCall", typing.Dict[str, typing.Any]]] = None,
        on_update: typing.Optional[typing.Union["AwsSdkCall", typing.Dict[str, typing.Any]]] = None,
        ...
        :param log_retention: (experimental) The number of days log events of the singleton Lambda function implementing this custom resource are kept in CloudWatch Logs. Default: logs.RetentionDays.INFINITE
        ...
        :param role: (experimental) The execution role for the singleton Lambda function implementing this custom resource provider. This role will apply to all ``AwsCustomResource`` instances in the stack. The role must be assumable by the ``lambda.amazonaws.com`` service principal. Default: - a new role is created
        :param timeout: (experimental) The timeout for the singleton Lambda function implementing this custom resource. Default: Duration.minutes(2)

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsCustomResource.__init__)
    ...
    def get_response_field(self, data_path: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsCustomResource.get_response_field)
    ...
    def get_response_field_reference(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsCustomResource.get_response_field_reference)
            check_type(argname="argument data_path", value=data_path, expected_type=type_hints["data_path"])
...
class AwsCustomResourcePolicy(
    ...
    def from_statements(
        cls,
        statements: typing.Sequence[_PolicyStatement_296fe8a3],
    ) -> "AwsCustomResourcePolicy":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsCustomResourcePolicy.from_statements)
...
class AwsCustomResourceProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AwsCustomResourceProps.__init__)
...
class AwsSdkCall:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsSdkCall.__init__)
...
class PhysicalResourceId(
    ...
    def from_response(cls, response_path: builtins.str) -> "PhysicalResourceId":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PhysicalResourceId.from_response)
    ...
    def of(cls, id: builtins.str) -> "PhysicalResourceId":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PhysicalResourceId.of)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class PhysicalResourceIdReference(
    ...
    def resolve(self, _: _IResolveContext_e363e2cb) -> typing.Any:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PhysicalResourceIdReference.resolve)
...
class Provider(
    ...
    def __init__(
        ...
        *,
        ...
        :param provider_function_name: (experimental) Provider Lambda name. The provider lambda function name. Default: - CloudFormation default name from unique physical ID
        ...
        :param role: (experimental) AWS Lambda execution role. The role that will be assumed by the AWS Lambda. Must be assumable by the 'lambda.amazonaws.com' service principal. Default: - A default role will be created.
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Provider.bind)
...
class ProviderProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ProviderProps.__init__)
    ...
    def provider_function_name(self) -> typing.Optional[builtins.str]:
        '''(experimental) Provider Lambda name.
...
class SdkCallsPolicyOptions:
    def __init__(self, *, resources: typing.Sequence[builtins.str]) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SdkCallsPolicyOptions.__init__)
