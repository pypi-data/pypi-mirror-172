...
class CfnAssistant(
    ...
    def __init__(
        ...
        *,
        ...
        server_side_encryption_configuration: typing.Optional[typing.Union[typing.Union["CfnAssistant.ServerSideEncryptionConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
...
class CfnAssistantAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        association: typing.Union[typing.Union["CfnAssistantAssociation.AssociationDataProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
...
class CfnKnowledgeBase(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        description: typing.Optional[builtins.str] = None,
        rendering_configuration: typing.Optional[typing.Union[typing.Union["CfnKnowledgeBase.RenderingConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        server_side_encryption_configuration: typing.Optional[typing.Union[typing.Union["CfnKnowledgeBase.ServerSideEncryptionConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        source_configuration: typing.Optional[typing.Union[typing.Union["CfnKnowledgeBase.SourceConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        tags: typing.Optional[typing.Sequence[typing.Union[_CfnTag_95fbdc29, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
    ...
    class SourceConfigurationProperty:
        def __init__(
            self,
            *,
            app_integrations: typing.Optional[typing.Union[typing.Union["CfnKnowledgeBase.AppIntegrationsConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
