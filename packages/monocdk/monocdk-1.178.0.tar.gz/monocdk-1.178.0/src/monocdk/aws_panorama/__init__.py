...
class CfnApplicationInstance(
    ...
    def __init__(
        ...
        *,
        ...
        manifest_payload: typing.Union[typing.Union["CfnApplicationInstance.ManifestPayloadProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        application_instance_id_to_replace: typing.Optional[builtins.str] = None,
        description: typing.Optional[builtins.str] = None,
        device_id: typing.Optional[builtins.str] = None,
        manifest_overrides_payload: typing.Optional[typing.Union[typing.Union["CfnApplicationInstance.ManifestOverridesPayloadProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
