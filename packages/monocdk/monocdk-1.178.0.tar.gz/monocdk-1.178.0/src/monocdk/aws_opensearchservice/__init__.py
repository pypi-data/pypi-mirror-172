...
class CfnDomain(
    ...
    def __init__(
        ...
        *,
        ...
        cluster_config: typing.Optional[typing.Union[typing.Union["CfnDomain.ClusterConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ...
    def cluster_config(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDomain, "cluster_config").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def engine_version(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDomain, "engine_version").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class ClusterConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDomain.ClusterConfigProperty.__init__)
    ...
    class EBSOptionsProperty:
        def __init__(
            ...
            *,
            ...
            :param throughput: ``CfnDomain.EBSOptionsProperty.Throughput``.
...
class DomainProps:
    def __init__(
        ...
        *,
        ...
        cognito_dashboards_auth: typing.Optional[typing.Union[CognitoOptions, typing.Dict[str, typing.Any]]] = None,
...
class EngineVersion(
    ...
    def elasticsearch(cls, version: builtins.str) -> "EngineVersion":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EngineVersion.elasticsearch)
            check_type(argname="argument version", value=version, expected_type=type_hints["version"])
    ...
    def open_search(cls, version: builtins.str) -> "EngineVersion":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EngineVersion.open_search)
            check_type(argname="argument version", value=version, expected_type=type_hints["version"])
