...
class CfnBillingGroup(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        account_grouping: typing.Union[typing.Union["CfnBillingGroup.AccountGroupingProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        computation_preference: typing.Union[typing.Union["CfnBillingGroup.ComputationPreferenceProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        name: builtins.str,
...
class CfnCustomLineItem(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        billing_period_range: typing.Optional[typing.Union[typing.Union["CfnCustomLineItem.BillingPeriodRangeProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        custom_line_item_charge_details: typing.Optional[typing.Union[typing.Union["CfnCustomLineItem.CustomLineItemChargeDetailsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        description: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.Sequence[typing.Union[_CfnTag_95fbdc29, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
    ...
    class CustomLineItemChargeDetailsProperty:
        def __init__(
            ...
            *,
            type: builtins.str,
            flat: typing.Optional[typing.Union[typing.Union["CfnCustomLineItem.CustomLineItemFlatChargeDetailsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            percentage: typing.Optional[typing.Union[typing.Union["CfnCustomLineItem.CustomLineItemPercentageChargeDetailsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''The charge details of a custom line item.
