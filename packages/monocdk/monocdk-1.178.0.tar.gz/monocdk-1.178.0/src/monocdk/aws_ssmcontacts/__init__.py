...
class CfnContact(
    ...
    def __init__(
        ...
        *,
        ...
        plan: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnContact.StageProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        type: builtins.str,
    ) -> None:
    ...
    class StageProperty:
        def __init__(
            ...
            *,
            ...
            targets: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnContact.TargetsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
    ...
    class TargetsProperty:
        def __init__(
            self,
            *,
            channel_target_info: typing.Optional[typing.Union[typing.Union["CfnContact.ChannelTargetInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            contact_target_info: typing.Optional[typing.Union[typing.Union["CfnContact.ContactTargetInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
