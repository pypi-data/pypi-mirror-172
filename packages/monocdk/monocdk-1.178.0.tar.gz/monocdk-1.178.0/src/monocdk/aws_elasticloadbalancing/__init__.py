...
class CfnLoadBalancer(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        listeners: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnLoadBalancer.ListenersProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        access_logging_policy: typing.Optional[typing.Union[typing.Union["CfnLoadBalancer.AccessLoggingPolicyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        app_cookie_stickiness_policy: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnLoadBalancer.AppCookieStickinessPolicyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        availability_zones: typing.Optional[typing.Sequence[builtins.str]] = None,
        connection_draining_policy: typing.Optional[typing.Union[typing.Union["CfnLoadBalancer.ConnectionDrainingPolicyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        connection_settings: typing.Optional[typing.Union[typing.Union["CfnLoadBalancer.ConnectionSettingsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        cross_zone: typing.Optional[typing.Union[builtins.bool, _IResolvable_a771d0ef]] = None,
        health_check: typing.Optional[typing.Union[typing.Union["CfnLoadBalancer.HealthCheckProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        instances: typing.Optional[typing.Sequence[builtins.str]] = None,
        lb_cookie_stickiness_policy: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnLoadBalancer.LBCookieStickinessPolicyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        load_balancer_name: typing.Optional[builtins.str] = None,
        policies: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnLoadBalancer.PoliciesProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
