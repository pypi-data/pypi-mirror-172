...
class CfnStreamProcessor(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        kinesis_video_stream: typing.Union[typing.Union["CfnStreamProcessor.KinesisVideoStreamProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        role_arn: builtins.str,
        bounding_box_regions_of_interest: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnStreamProcessor.BoundingBoxProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        connected_home_settings: typing.Optional[typing.Union[typing.Union["CfnStreamProcessor.ConnectedHomeSettingsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        data_sharing_preference: typing.Optional[typing.Union[typing.Union["CfnStreamProcessor.DataSharingPreferenceProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        face_search_settings: typing.Optional[typing.Union[typing.Union["CfnStreamProcessor.FaceSearchSettingsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        kinesis_data_stream: typing.Optional[typing.Union[typing.Union["CfnStreamProcessor.KinesisDataStreamProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        kms_key_id: typing.Optional[builtins.str] = None,
        name: typing.Optional[builtins.str] = None,
        notification_channel: typing.Optional[typing.Union[typing.Union["CfnStreamProcessor.NotificationChannelProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        polygon_regions_of_interest: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnStreamProcessor.PolygonProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        s3_destination: typing.Optional[typing.Union[typing.Union["CfnStreamProcessor.S3DestinationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        tags: typing.Optional[typing.Sequence[typing.Union[_CfnTag_95fbdc29, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
    ...
    def polygon_regions_of_interest(
        self,
    ) -> typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnStreamProcessor.PolygonProperty", _IResolvable_a771d0ef]]]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnStreamProcessor.PolygonProperty", _IResolvable_a771d0ef]]]], jsii.get(self, "polygonRegionsOfInterest"))

    @polygon_regions_of_interest.setter
    def polygon_regions_of_interest(
        self,
        value: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnStreamProcessor.PolygonProperty", _IResolvable_a771d0ef]]]],
    ) -> None:
        if __debug__:
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_rekognition.CfnStreamProcessor.PointProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_rekognition.CfnStreamProcessor.PolygonProperty",
        jsii_struct_bases=[],
    ...
    class PolygonProperty:
        def __init__(
            self,
            *,
            polygon: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnStreamProcessor.PointProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        ) -> None:
            '''
        ...
        def polygon(
            self,
        ) -> typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnStreamProcessor.PointProperty", _IResolvable_a771d0ef]]]:
            ...
            return typing.cast(typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnStreamProcessor.PointProperty", _IResolvable_a771d0ef]]], result)
...
class CfnStreamProcessorProps:
    ...
    def polygon_regions_of_interest(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union[CfnStreamProcessor.PolygonProperty, _IResolvable_a771d0ef]]]], result)
