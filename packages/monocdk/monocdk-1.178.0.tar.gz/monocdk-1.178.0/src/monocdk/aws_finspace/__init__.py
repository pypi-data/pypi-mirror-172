...
class CfnEnvironment(
    ...
    jsii_type="monocdk.aws_finspace.CfnEnvironment",
):
    ...
    Example::
        ...
        from monocdk import aws_finspace as finspace
    ...
    def __init__(
        ...
        *,
        ...
        federation_parameters: typing.Optional[typing.Union[typing.Union["CfnEnvironment.FederationParametersProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        kms_key_id: typing.Optional[builtins.str] = None,
        superuser_parameters: typing.Optional[typing.Union[typing.Union["CfnEnvironment.SuperuserParametersProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ) -> None:
    ...
    def data_bundles(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEnvironment, "data_bundles").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def federation_mode(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEnvironment, "federation_mode").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def federation_parameters(
        self,
    ) -> typing.Optional[typing.Union["CfnEnvironment.FederationParametersProperty", _IResolvable_a771d0ef]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnEnvironment.FederationParametersProperty", _IResolvable_a771d0ef]], jsii.get(self, "federationParameters"))

    @federation_parameters.setter
    def federation_parameters(
        self,
        value: typing.Optional[typing.Union["CfnEnvironment.FederationParametersProperty", _IResolvable_a771d0ef]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEnvironment, "federation_parameters").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def kms_key_id(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEnvironment, "kms_key_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def superuser_parameters(
        self,
    ) -> typing.Optional[typing.Union["CfnEnvironment.SuperuserParametersProperty", _IResolvable_a771d0ef]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnEnvironment.SuperuserParametersProperty", _IResolvable_a771d0ef]], jsii.get(self, "superuserParameters"))

    @superuser_parameters.setter
    def superuser_parameters(
        self,
        value: typing.Optional[typing.Union["CfnEnvironment.SuperuserParametersProperty", _IResolvable_a771d0ef]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEnvironment, "superuser_parameters").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "superuserParameters", value)

    @jsii.data_type(
        jsii_type="monocdk.aws_finspace.CfnEnvironment.FederationParametersProperty",
        jsii_struct_bases=[],
        name_mapping={
            "application_call_back_url": "applicationCallBackUrl",
    ...
    class FederationParametersProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnEnvironment.FederationParametersProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_finspace.CfnEnvironment.SuperuserParametersProperty",
        jsii_struct_bases=[],
        name_mapping={
            "email_address": "emailAddress",
            "first_name": "firstName",
    ...
    class SuperuserParametersProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnEnvironment.SuperuserParametersProperty.__init__)
...
@jsii.data_type(
    jsii_type="monocdk.aws_finspace.CfnEnvironmentProps",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
        "data_bundles": "dataBundles",
...
class CfnEnvironmentProps:
    ...
    def federation_parameters(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnEnvironment.FederationParametersProperty, _IResolvable_a771d0ef]], result)
    ...
    def superuser_parameters(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnEnvironment.SuperuserParametersProperty, _IResolvable_a771d0ef]], result)
