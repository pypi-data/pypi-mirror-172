...
class CloudArtifact(metaclass=jsii.JSIIMeta, jsii_type="monocdk.cx_api.CloudArtifact"):
    ...
    def __init__(
        ...
        *,
        ...
        metadata: typing.Optional[typing.Mapping[builtins.str, typing.Sequence[typing.Union[_MetadataEntry_b98ee123, typing.Dict[str, typing.Any]]]]] = None,
        properties: typing.Optional[typing.Union[typing.Union[_AwsCloudFormationStackProperties_6a08f279, typing.Dict[str, typing.Any]], typing.Union[_AssetManifestProperties_5eac543c, typing.Dict[str, typing.Any]], typing.Union[_TreeArtifactProperties_44f77b3d, typing.Dict[str, typing.Any]], typing.Union[_NestedCloudAssemblyProperties_40af483d, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        '''
        :param assembly: -
        :param id: -
...
class CloudAssemblyBuilder(
    ...
    def add_missing(
        ...
        *,
        key: builtins.str,
        props: typing.Union[typing.Union[_AmiContextQuery_a528fa4a, typing.Dict[str, typing.Any]], typing.Union[_AvailabilityZonesContextQuery_a84904c8, typing.Dict[str, typing.Any]], typing.Union[_HostedZoneContextQuery_3a794037, typing.Dict[str, typing.Any]], typing.Union[_SSMParameterContextQuery_6f44d3dd, typing.Dict[str, typing.Any]], typing.Union[_VpcContextQuery_12233b2e, typing.Dict[str, typing.Any]], typing.Union[_EndpointServiceAvailabilityZonesContextQuery_9b9d87e5, typing.Dict[str, typing.Any]], typing.Union[_LoadBalancerContextQuery_631e1faf, typing.Dict[str, typing.Any]], typing.Union[_LoadBalancerListenerContextQuery_d16fd2ba, typing.Dict[str, typing.Any]], typing.Union[_SecurityGroupContextQuery_6ba2a6f0, typing.Dict[str, typing.Any]], typing.Union[_KeyContextQuery_f7af0239, typing.Dict[str, typing.Any]], typing.Union[_PluginContextQuery_a248b6d7, typing.Dict[str, typing.Any]]],
...
class MetadataEntry(_MetadataEntry_b98ee123):
    def __init__(
        ...
        *,
        type: builtins.str,
        data: typing.Optional[typing.Union[builtins.str, typing.Union[_FileAssetMetadataEntry_3cdad4c1, typing.Dict[str, typing.Any]], typing.Union[_ContainerImageAssetMetadataEntry_c1b055f1, typing.Dict[str, typing.Any]], typing.Sequence[typing.Union[_Tag_34494fd5, typing.Dict[str, typing.Any]]]]] = None,
...
class SynthesisMessage:
    def __init__(
        self,
        *,
        entry: typing.Union[_MetadataEntry_b98ee123, typing.Dict[str, typing.Any]],
        id: builtins.str,
