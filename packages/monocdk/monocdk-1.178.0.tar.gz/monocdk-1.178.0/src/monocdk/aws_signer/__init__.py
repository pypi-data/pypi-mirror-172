...
class CfnSigningProfile(
    ...
    def __init__(
        ...
        *,
        ...
        signature_validity_period: typing.Optional[typing.Union[typing.Union["CfnSigningProfile.SignatureValidityPeriodProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
