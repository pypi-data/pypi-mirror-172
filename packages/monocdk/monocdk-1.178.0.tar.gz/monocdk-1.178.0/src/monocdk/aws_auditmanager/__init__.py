...
class CfnAssessment(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        assessment_reports_destination: typing.Optional[typing.Union[typing.Union["CfnAssessment.AssessmentReportsDestinationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        aws_account: typing.Optional[typing.Union[typing.Union["CfnAssessment.AWSAccountProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        description: typing.Optional[builtins.str] = None,
        framework_id: typing.Optional[builtins.str] = None,
        name: typing.Optional[builtins.str] = None,
        roles: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnAssessment.RoleProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        scope: typing.Optional[typing.Union[typing.Union["CfnAssessment.ScopeProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ...
    class ScopeProperty:
        def __init__(
            self,
            *,
            aws_accounts: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnAssessment.AWSAccountProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
            aws_services: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnAssessment.AWSServiceProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
