...
class CfnTable(
    ...
    def __init__(
        ...
        *,
        ...
        partition_key_columns: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnTable.ColumnProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        billing_mode: typing.Optional[typing.Union[typing.Union["CfnTable.BillingModeProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        clustering_key_columns: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnTable.ClusteringKeyColumnProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        default_time_to_live: typing.Optional[jsii.Number] = None,
        encryption_specification: typing.Optional[typing.Union[typing.Union["CfnTable.EncryptionSpecificationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        point_in_time_recovery_enabled: typing.Optional[typing.Union[builtins.bool, _IResolvable_a771d0ef]] = None,
        regular_columns: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnTable.ColumnProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ...
    class ClusteringKeyColumnProperty:
        def __init__(
            self,
            *,
            column: typing.Union[typing.Union["CfnTable.ColumnProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
