...
class CfnPlaybackConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        avail_suppression: typing.Optional[typing.Union[typing.Union["CfnPlaybackConfiguration.AvailSuppressionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        bumper: typing.Optional[typing.Union[typing.Union["CfnPlaybackConfiguration.BumperProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        cdn_configuration: typing.Optional[typing.Union[typing.Union["CfnPlaybackConfiguration.CdnConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        configuration_aliases: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Mapping[builtins.str, typing.Any]]] = None,
        dash_configuration: typing.Optional[typing.Union[typing.Union["CfnPlaybackConfiguration.DashConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        live_pre_roll_configuration: typing.Optional[typing.Union[typing.Union["CfnPlaybackConfiguration.LivePreRollConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        manifest_processing_rules: typing.Optional[typing.Union[typing.Union["CfnPlaybackConfiguration.ManifestProcessingRulesProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ...
    class ManifestProcessingRulesProperty:
        def __init__(
            self,
            *,
            ad_marker_passthrough: typing.Optional[typing.Union[typing.Union["CfnPlaybackConfiguration.AdMarkerPassthroughProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''The configuration for manifest processing rules.
