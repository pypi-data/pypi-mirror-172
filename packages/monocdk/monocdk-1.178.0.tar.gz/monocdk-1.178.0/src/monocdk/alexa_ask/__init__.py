...
class CfnSkill(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        authentication_configuration: typing.Union[typing.Union["CfnSkill.AuthenticationConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        skill_package: typing.Union[typing.Union["CfnSkill.SkillPackageProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSkill.__init__)
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSkill.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSkill._render_properties)
    ...
    def authentication_configuration(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnSkill, "authentication_configuration").fset)
    ...
    def skill_package(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnSkill, "skill_package").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def vendor_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnSkill, "vendor_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class AuthenticationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnSkill.AuthenticationConfigurationProperty.__init__)
    ...
    class OverridesProperty:
        def __init__(self, *, manifest: typing.Any = None) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnSkill.OverridesProperty.__init__)
    ...
    class SkillPackageProperty:
        def __init__(
            ...
            *,
            ...
            s3_key: builtins.str,
            overrides: typing.Optional[typing.Union[typing.Union["CfnSkill.OverridesProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnSkill.SkillPackageProperty.__init__)
...
class CfnSkillProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSkillProps.__init__)
