...
class CfnSafetyRule(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        rule_config: typing.Union[typing.Union["CfnSafetyRule.RuleConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        assertion_rule: typing.Optional[typing.Union[typing.Union["CfnSafetyRule.AssertionRuleProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        gating_rule: typing.Optional[typing.Union[typing.Union["CfnSafetyRule.GatingRuleProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        tags: typing.Optional[typing.Sequence[typing.Union[_CfnTag_95fbdc29, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
