...
class CfnDetector(
    ...
    def __init__(
        ...
        *,
        ...
        data_sources: typing.Optional[typing.Union[typing.Union["CfnDetector.CFNDataSourceConfigurationsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ...
    class CFNDataSourceConfigurationsProperty:
        def __init__(
            self,
            *,
            kubernetes: typing.Optional[typing.Union[typing.Union["CfnDetector.CFNKubernetesConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            malware_protection: typing.Optional[typing.Union[typing.Union["CfnDetector.CFNMalwareProtectionConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            s3_logs: typing.Optional[typing.Union[typing.Union["CfnDetector.CFNS3LogsConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
    ...
    class CFNKubernetesConfigurationProperty:
        def __init__(
            self,
            *,
            audit_logs: typing.Optional[typing.Union[typing.Union["CfnDetector.CFNKubernetesAuditLogsConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
    ...
    class CFNMalwareProtectionConfigurationProperty:
        def __init__(
            self,
            *,
            scan_ec2_instance_with_findings: typing.Optional[typing.Union[typing.Union["CfnDetector.CFNScanEc2InstanceWithFindingsConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''
...
class CfnFilter(
    ...
    def __init__(
        ...
        *,
        ...
        finding_criteria: typing.Union[typing.Union["CfnFilter.FindingCriteriaProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        name: builtins.str,
        rank: jsii.Number,
        tags: typing.Optional[typing.Sequence[typing.Union[_CfnTag_95fbdc29, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
    ...
    class FindingCriteriaProperty:
        def __init__(
            ...
            *,
            ...
            item_type: typing.Optional[typing.Union[typing.Union["CfnFilter.ConditionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
