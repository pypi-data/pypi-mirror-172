...
class CfnStream(
    ...
    def __init__(
        ...
        *,
        ...
        stream_encryption: typing.Optional[typing.Union[typing.Union["CfnStream.StreamEncryptionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        stream_mode_details: typing.Optional[typing.Union[typing.Union["CfnStream.StreamModeDetailsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
