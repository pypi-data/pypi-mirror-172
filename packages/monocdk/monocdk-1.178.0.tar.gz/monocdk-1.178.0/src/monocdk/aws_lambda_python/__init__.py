...
class PythonFunction(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PythonFunction.__init__)
...
class PythonFunctionProps(_FunctionOptions_dc75a392):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(PythonFunctionProps.__init__)
...
class PythonLayerVersion(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PythonLayerVersion.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(bundling, dict):
            bundling = BundlingOptions(**bundling)
        if __debug__:
            type_hints = typing.get_type_hints(PythonLayerVersionProps.__init__)
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
