...
class CfnLicense(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        consumption_configuration: typing.Union[typing.Union["CfnLicense.ConsumptionConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        entitlements: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnLicense.EntitlementProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        home_region: builtins.str,
        issuer: typing.Union[typing.Union["CfnLicense.IssuerDataProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        license_name: builtins.str,
        product_name: builtins.str,
        validity: typing.Union[typing.Union["CfnLicense.ValidityDateFormatProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        beneficiary: typing.Optional[builtins.str] = None,
        license_metadata: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnLicense.MetadataProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ...
    class ConsumptionConfigurationProperty:
        def __init__(
            self,
            *,
            borrow_configuration: typing.Optional[typing.Union[typing.Union["CfnLicense.BorrowConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            provisional_configuration: typing.Optional[typing.Union[typing.Union["CfnLicense.ProvisionalConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
