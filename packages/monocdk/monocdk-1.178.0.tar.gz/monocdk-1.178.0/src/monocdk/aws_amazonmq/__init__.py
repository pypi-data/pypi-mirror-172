...
class CfnBroker(
    ...
    def __init__(
        ...
        *,
        ...
        users: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnBroker.UserProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        authentication_strategy: typing.Optional[builtins.str] = None,
        configuration: typing.Optional[typing.Union[typing.Union["CfnBroker.ConfigurationIdProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        encryption_options: typing.Optional[typing.Union[typing.Union["CfnBroker.EncryptionOptionsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ldap_server_metadata: typing.Optional[typing.Union[typing.Union["CfnBroker.LdapServerMetadataProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        logs: typing.Optional[typing.Union[typing.Union["CfnBroker.LogListProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        maintenance_window_start_time: typing.Optional[typing.Union[typing.Union["CfnBroker.MaintenanceWindowProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
...
class CfnConfigurationAssociation(
    ...
    def __init__(
        ...
        *,
        broker: builtins.str,
        configuration: typing.Union[typing.Union["CfnConfigurationAssociation.ConfigurationIdProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
    ) -> None:
