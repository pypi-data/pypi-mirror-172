...
class CfnLaunchProfile(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        stream_configuration: typing.Union[typing.Union["CfnLaunchProfile.StreamConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
    ...
    class StreamConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            session_storage: typing.Optional[typing.Union[typing.Union["CfnLaunchProfile.StreamConfigurationSessionStorageProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''A configuration for a streaming session.
    ...
    class StreamConfigurationSessionStorageProperty:
        def __init__(
            ...
            *,
            ...
            root: typing.Optional[typing.Union[typing.Union["CfnLaunchProfile.StreamingSessionStorageRootProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
...
class CfnStudio(
    ...
    def __init__(
        ...
        *,
        ...
        studio_encryption_configuration: typing.Optional[typing.Union[typing.Union["CfnStudio.StudioEncryptionConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        tags: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
    ) -> None:
...
class CfnStudioComponent(
    ...
    def __init__(
        ...
        *,
        ...
        studio_id: builtins.str,
        type: builtins.str,
        configuration: typing.Optional[typing.Union[typing.Union["CfnStudioComponent.StudioComponentConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        description: typing.Optional[builtins.str] = None,
        ec2_security_group_ids: typing.Optional[typing.Sequence[builtins.str]] = None,
        initialization_scripts: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnStudioComponent.StudioComponentInitializationScriptProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        script_parameters: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnStudioComponent.ScriptParameterKeyValueProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ...
    class ActiveDirectoryConfigurationProperty:
        def __init__(
            self,
            *,
            computer_attributes: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnStudioComponent.ActiveDirectoryComputerAttributeProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ...
    class StudioComponentConfigurationProperty:
        def __init__(
            self,
            *,
            active_directory_configuration: typing.Optional[typing.Union[typing.Union["CfnStudioComponent.ActiveDirectoryConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            compute_farm_configuration: typing.Optional[typing.Union[typing.Union["CfnStudioComponent.ComputeFarmConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            license_service_configuration: typing.Optional[typing.Union[typing.Union["CfnStudioComponent.LicenseServiceConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            shared_file_system_configuration: typing.Optional[typing.Union[typing.Union["CfnStudioComponent.SharedFileSystemConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''The configuration of the studio component, based on component type.
