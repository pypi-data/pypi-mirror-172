...
class _ICommandHooksProxy:
    ...
    def after_bundling(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ICommandHooks.after_bundling)
    ...
    def before_bundling(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ICommandHooks.before_bundling)
            check_type(argname="argument input_dir", value=input_dir, expected_type=type_hints["input_dir"])
            check_type(argname="argument output_dir", value=output_dir, expected_type=type_hints["output_dir"])
    ...
    def before_install(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ICommandHooks.before_install)
            check_type(argname="argument input_dir", value=input_dir, expected_type=type_hints["input_dir"])
            check_type(argname="argument output_dir", value=output_dir, expected_type=type_hints["output_dir"])
...
class NodejsFunction(
    ...
    def __init__(
        ...
        *,
        ...
        bundling: typing.Optional[typing.Union[BundlingOptions, typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NodejsFunction.__init__)
...
class NodejsFunctionProps(_FunctionOptions_dc75a392):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(NodejsFunctionProps.__init__)
