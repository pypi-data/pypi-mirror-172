...
class CfnHub(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnHub.__init__)
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnHub.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnHub._render_properties)
...
class CfnHubProps:
    def __init__(self, *, tags: typing.Any = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnHubProps.__init__)
