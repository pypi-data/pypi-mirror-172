...
class CfnWorkspace(
    ...
    def __init__(
        ...
        *,
        ...
        workspace_properties: typing.Optional[typing.Union[typing.Union["CfnWorkspace.WorkspacePropertiesProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ) -> None:
