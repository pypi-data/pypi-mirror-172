    ...
    **Related APIs** - `CreateDatasetGroup <https://docs.aws.amazon.com/personalize/latest/dg/API_CreateDatasetGroup.html>`_
    ...
    def __init__(
        ...
        *,
        ...
        dataset_import_job: typing.Optional[typing.Union[typing.Union["CfnDataset.DatasetImportJobProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ) -> None:
...
class CfnSolution(
    ...
    def __init__(
        ...
        *,
        ...
        solution_config: typing.Optional[typing.Union[typing.Union["CfnSolution.SolutionConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ) -> None:
