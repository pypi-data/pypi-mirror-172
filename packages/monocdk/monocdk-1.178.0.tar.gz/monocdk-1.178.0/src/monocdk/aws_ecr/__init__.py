...
class AuthorizationToken(
    ...
    def grant_read(cls, grantee: _IGrantable_4c5a91d1) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AuthorizationToken.grant_read)
...
class CfnPublicRepository(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPublicRepository.__init__)
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPublicRepository.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPublicRepository._render_properties)
    ...
    def repository_catalog_data(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPublicRepository, "repository_catalog_data").fset)
    ...
    def repository_policy_text(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPublicRepository, "repository_policy_text").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def repository_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPublicRepository, "repository_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnPublicRepositoryProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPublicRepositoryProps.__init__)
...
class CfnPullThroughCacheRule(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPullThroughCacheRule.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPullThroughCacheRule.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPullThroughCacheRule._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def ecr_repository_prefix(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPullThroughCacheRule, "ecr_repository_prefix").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def upstream_registry_url(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPullThroughCacheRule, "upstream_registry_url").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnPullThroughCacheRuleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPullThroughCacheRuleProps.__init__)
...
class CfnRegistryPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRegistryPolicy.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRegistryPolicy.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRegistryPolicy._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def policy_text(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRegistryPolicy, "policy_text").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnRegistryPolicyProps:
    def __init__(self, *, policy_text: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRegistryPolicyProps.__init__)
...
class CfnReplicationConfiguration(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        replication_configuration: typing.Union[typing.Union["CfnReplicationConfiguration.ReplicationConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnReplicationConfiguration.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnReplicationConfiguration.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnReplicationConfiguration._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def replication_configuration(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnReplicationConfiguration, "replication_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class ReplicationConfigurationProperty:
        def __init__(
            self,
            *,
            rules: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnReplicationConfiguration.ReplicationRuleProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        ) -> None:
            '''The replication configuration for a registry.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnReplicationConfiguration.ReplicationConfigurationProperty.__init__)
    ...
    class ReplicationDestinationProperty:
        def __init__(self, *, region: builtins.str, registry_id: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnReplicationConfiguration.ReplicationDestinationProperty.__init__)
    ...
    class ReplicationRuleProperty:
        def __init__(
            self,
            *,
            destinations: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnReplicationConfiguration.ReplicationDestinationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
            repository_filters: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnReplicationConfiguration.RepositoryFilterProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            '''An array of objects representing the replication destinations and repository filters for a replication configuration.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnReplicationConfiguration.ReplicationRuleProperty.__init__)
    ...
    class RepositoryFilterProperty:
        def __init__(self, *, filter: builtins.str, filter_type: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnReplicationConfiguration.RepositoryFilterProperty.__init__)
...
class CfnReplicationConfigurationProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnReplicationConfigurationProps.__init__)
...
class CfnRepository(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        encryption_configuration: typing.Optional[typing.Union[typing.Union["CfnRepository.EncryptionConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        image_scanning_configuration: typing.Optional[typing.Union[typing.Union["CfnRepository.ImageScanningConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        image_tag_mutability: typing.Optional[builtins.str] = None,
        lifecycle_policy: typing.Optional[typing.Union[typing.Union["CfnRepository.LifecyclePolicyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        repository_name: typing.Optional[builtins.str] = None,
        repository_policy_text: typing.Any = None,
        tags: typing.Optional[typing.Sequence[typing.Union[_CfnTag_95fbdc29, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRepository.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRepository.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRepository._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def repository_policy_text(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRepository, "repository_policy_text").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "repositoryPolicyText", value)
    ...
    def encryption_configuration(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRepository, "encryption_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def image_scanning_configuration(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRepository, "image_scanning_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def image_tag_mutability(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRepository, "image_tag_mutability").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def lifecycle_policy(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRepository, "lifecycle_policy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def repository_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRepository, "repository_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "repositoryName", value)
    ...
    class EncryptionConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnRepository.EncryptionConfigurationProperty.__init__)
    ...
    class ImageScanningConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnRepository.ImageScanningConfigurationProperty.__init__)
    ...
    class LifecyclePolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnRepository.LifecyclePolicyProperty.__init__)
...
class CfnRepositoryProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRepositoryProps.__init__)
...
class _IRepositoryProxy(
    ...
    def add_to_resource_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.add_to_resource_policy)
    ...
    def grant(
        ...
        *actions: builtins.str,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.grant)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
    ...
    def grant_pull(self, grantee: _IGrantable_4c5a91d1) -> _Grant_bcb5eae7:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.grant_pull)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
    ...
    def grant_pull_push(self, grantee: _IGrantable_4c5a91d1) -> _Grant_bcb5eae7:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.grant_pull_push)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
    ...
    def on_cloud_trail_event(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_cloud_trail_event)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def on_cloud_trail_image_pushed(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_cloud_trail_image_pushed)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def on_event(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_event)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = _OnEventOptions_d5081088(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_image_scan_completed(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_image_scan_completed)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def repository_uri_for_digest(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.repository_uri_for_digest)
    ...
    def repository_uri_for_tag(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.repository_uri_for_tag)
    ...
    def repository_uri_for_tag_or_digest(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.repository_uri_for_tag_or_digest)
...
class OnCloudTrailImagePushedOptions(_OnEventOptions_d5081088):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(OnCloudTrailImagePushedOptions.__init__)
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(event_pattern, dict):
            event_pattern = _EventPattern_a23fbf37(**event_pattern)
        if __debug__:
            type_hints = typing.get_type_hints(OnImageScanCompletedOptions.__init__)
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
            check_type(argname="argument event_pattern", value=event_pattern, expected_type=type_hints["event_pattern"])
            check_type(argname="argument rule_name", value=rule_name, expected_type=type_hints["rule_name"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
...
class PublicGalleryAuthorizationToken(
    ...
    def grant_read(cls, grantee: _IGrantable_4c5a91d1) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PublicGalleryAuthorizationToken.grant_read)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
        return typing.cast(None, jsii.sinvoke(cls, "grantRead", [grantee]))
...
class RepositoryAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryAttributes.__init__)
...
class RepositoryBase(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def grant(
        ...
        *actions: builtins.str,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.grant)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
            check_type(argname="argument actions", value=actions, expected_type=typing.Tuple[type_hints["actions"], ...]) # pyright: ignore [reportGeneralTypeIssues]
        return typing.cast(_Grant_bcb5eae7, jsii.invoke(self, "grant", [grantee, *actions]))
    ...
    def grant_pull(self, grantee: _IGrantable_4c5a91d1) -> _Grant_bcb5eae7:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.grant_pull)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
        return typing.cast(_Grant_bcb5eae7, jsii.invoke(self, "grantPull", [grantee]))
    ...
    def grant_pull_push(self, grantee: _IGrantable_4c5a91d1) -> _Grant_bcb5eae7:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.grant_pull_push)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
        return typing.cast(_Grant_bcb5eae7, jsii.invoke(self, "grantPullPush", [grantee]))
    ...
    def on_cloud_trail_event(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.on_cloud_trail_event)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = _OnEventOptions_d5081088(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_cloud_trail_image_pushed(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.on_cloud_trail_image_pushed)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = OnCloudTrailImagePushedOptions(
            image_tag=image_tag,
            description=description,
    ...
    def on_event(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.on_event)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = _OnEventOptions_d5081088(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_image_scan_completed(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.on_image_scan_completed)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = OnImageScanCompletedOptions(
            image_tags=image_tags,
            description=description,
    ...
    def repository_uri_for_digest(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.repository_uri_for_digest)
            check_type(argname="argument digest", value=digest, expected_type=type_hints["digest"])
        return typing.cast(builtins.str, jsii.invoke(self, "repositoryUriForDigest", [digest]))
    ...
    def repository_uri_for_tag(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.repository_uri_for_tag)
            check_type(argname="argument tag", value=tag, expected_type=type_hints["tag"])
        return typing.cast(builtins.str, jsii.invoke(self, "repositoryUriForTag", [tag]))
    ...
    def repository_uri_for_tag_or_digest(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.repository_uri_for_tag_or_digest)
            check_type(argname="argument tag_or_digest", value=tag_or_digest, expected_type=type_hints["tag_or_digest"])
        return typing.cast(builtins.str, jsii.invoke(self, "repositoryUriForTagOrDigest", [tag_or_digest]))
...
class _RepositoryBaseProxy(
    ...
    def add_to_resource_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryBase.add_to_resource_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(_AddToResourcePolicyResult_0fd9d2a9, jsii.invoke(self, "addToResourcePolicy", [statement]))
...
class RepositoryEncryption(
    ...
    def __init__(self, value: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryEncryption.__init__)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Repository(
    ...
    def arn_for_local_repository(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.arn_for_local_repository)
            check_type(argname="argument repository_name", value=repository_name, expected_type=type_hints["repository_name"])
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def from_repository_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.from_repository_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument repository_arn", value=repository_arn, expected_type=type_hints["repository_arn"])
    ...
    def from_repository_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.from_repository_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_repository_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.from_repository_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument repository_name", value=repository_name, expected_type=type_hints["repository_name"])
    ...
    def add_to_resource_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.add_to_resource_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(_AddToResourcePolicyResult_0fd9d2a9, jsii.invoke(self, "addToResourcePolicy", [statement]))
