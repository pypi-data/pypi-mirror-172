...
deployment_group = codedeploy.ServerDeploymentGroup(self, "CodeDeployDeploymentGroup",
    ...
    auto_rollback=autoscaling.aws_codedeploy.AutoRollbackConfig(
...
class AutoRollbackConfig:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AutoRollbackConfig.__init__)
...
class CfnApplication(
    ...
    Example::
        ...
        from monocdk import aws_codedeploy as codedeploy
    ...
    def compute_platform(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnApplication, "compute_platform").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnDeploymentConfig(
    ...
    def __init__(
        ...
        *,
        ...
        minimum_healthy_hosts: typing.Optional[typing.Union[typing.Union["CfnDeploymentConfig.MinimumHealthyHostsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        traffic_routing_config: typing.Optional[typing.Union[typing.Union["CfnDeploymentConfig.TrafficRoutingConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnDeploymentConfig.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnDeploymentConfig.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnDeploymentConfig._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def compute_platform(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentConfig, "compute_platform").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "computePlatform", value)
    ...
    def deployment_config_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentConfig, "deployment_config_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def minimum_healthy_hosts(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentConfig, "minimum_healthy_hosts").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def traffic_routing_config(
        self,
    ) -> typing.Optional[typing.Union["CfnDeploymentConfig.TrafficRoutingConfigProperty", _IResolvable_a771d0ef]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnDeploymentConfig.TrafficRoutingConfigProperty", _IResolvable_a771d0ef]], jsii.get(self, "trafficRoutingConfig"))

    @traffic_routing_config.setter
    def traffic_routing_config(
        self,
        value: typing.Optional[typing.Union["CfnDeploymentConfig.TrafficRoutingConfigProperty", _IResolvable_a771d0ef]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentConfig, "traffic_routing_config").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class MinimumHealthyHostsProperty:
        def __init__(self, *, type: builtins.str, value: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentConfig.MinimumHealthyHostsProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_codedeploy.CfnDeploymentConfig.TimeBasedCanaryProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class TimeBasedCanaryProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentConfig.TimeBasedCanaryProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_codedeploy.CfnDeploymentConfig.TimeBasedLinearProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class TimeBasedLinearProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentConfig.TimeBasedLinearProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_codedeploy.CfnDeploymentConfig.TrafficRoutingConfigProperty",
        jsii_struct_bases=[],
        name_mapping={
            "type": "type",
    ...
    class TrafficRoutingConfigProperty:
        def __init__(
            ...
            *,
            type: builtins.str,
            time_based_canary: typing.Optional[typing.Union[typing.Union["CfnDeploymentConfig.TimeBasedCanaryProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            time_based_linear: typing.Optional[typing.Union[typing.Union["CfnDeploymentConfig.TimeBasedLinearProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentConfig.TrafficRoutingConfigProperty.__init__)
                check_type(argname="argument type", value=type, expected_type=type_hints["type"])
        ...
        def time_based_canary(
            self,
        ) -> typing.Optional[typing.Union["CfnDeploymentConfig.TimeBasedCanaryProperty", _IResolvable_a771d0ef]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnDeploymentConfig.TimeBasedCanaryProperty", _IResolvable_a771d0ef]], result)

        @builtins.property
        def time_based_linear(
            self,
        ) -> typing.Optional[typing.Union["CfnDeploymentConfig.TimeBasedLinearProperty", _IResolvable_a771d0ef]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnDeploymentConfig.TimeBasedLinearProperty", _IResolvable_a771d0ef]], result)
...
class CfnDeploymentConfigProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnDeploymentConfigProps.__init__)
            check_type(argname="argument compute_platform", value=compute_platform, expected_type=type_hints["compute_platform"])
    ...
    def traffic_routing_config(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnDeploymentConfig.TrafficRoutingConfigProperty, _IResolvable_a771d0ef]], result)
...
class CfnDeploymentGroup(
    ...
    def __init__(
        ...
        *,
        ...
        alarm_configuration: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.AlarmConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        auto_rollback_configuration: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.AutoRollbackConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        auto_scaling_groups: typing.Optional[typing.Sequence[builtins.str]] = None,
        blue_green_deployment_configuration: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.BlueGreenDeploymentConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        deployment: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.DeploymentProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        deployment_config_name: typing.Optional[builtins.str] = None,
        deployment_group_name: typing.Optional[builtins.str] = None,
        deployment_style: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.DeploymentStyleProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ec2_tag_filters: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.EC2TagFilterProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ec2_tag_set: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.EC2TagSetProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ecs_services: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.ECSServiceProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        load_balancer_info: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.LoadBalancerInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        on_premises_instance_tag_filters: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.TagFilterProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        on_premises_tag_set: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.OnPremisesTagSetProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        outdated_instances_strategy: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.Sequence[typing.Union[_CfnTag_95fbdc29, typing.Dict[str, typing.Any]]]] = None,
        trigger_configurations: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.TriggerConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnDeploymentGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnDeploymentGroup.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnDeploymentGroup._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def application_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "application_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "applicationName", value)
    ...
    def service_role_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "service_role_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def alarm_configuration(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "alarm_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def auto_rollback_configuration(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "auto_rollback_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def auto_scaling_groups(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "auto_scaling_groups").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def blue_green_deployment_configuration(
        self,
    ) -> typing.Optional[typing.Union["CfnDeploymentGroup.BlueGreenDeploymentConfigurationProperty", _IResolvable_a771d0ef]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnDeploymentGroup.BlueGreenDeploymentConfigurationProperty", _IResolvable_a771d0ef]], jsii.get(self, "blueGreenDeploymentConfiguration"))

    @blue_green_deployment_configuration.setter
    def blue_green_deployment_configuration(
        self,
        value: typing.Optional[typing.Union["CfnDeploymentGroup.BlueGreenDeploymentConfigurationProperty", _IResolvable_a771d0ef]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "blue_green_deployment_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def deployment(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "deployment").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def deployment_config_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "deployment_config_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "deploymentConfigName", value)
    ...
    def deployment_group_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "deployment_group_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def deployment_style(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "deployment_style").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ec2_tag_filters(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "ec2_tag_filters").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ec2_tag_set(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "ec2_tag_set").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ecs_services(
        self,
    ) -> typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnDeploymentGroup.ECSServiceProperty", _IResolvable_a771d0ef]]]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnDeploymentGroup.ECSServiceProperty", _IResolvable_a771d0ef]]]], jsii.get(self, "ecsServices"))

    @ecs_services.setter
    def ecs_services(
        self,
        value: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnDeploymentGroup.ECSServiceProperty", _IResolvable_a771d0ef]]]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "ecs_services").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def load_balancer_info(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "load_balancer_info").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def on_premises_instance_tag_filters(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "on_premises_instance_tag_filters").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def on_premises_tag_set(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "on_premises_tag_set").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def outdated_instances_strategy(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "outdated_instances_strategy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def trigger_configurations(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDeploymentGroup, "trigger_configurations").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class AlarmConfigurationProperty:
        def __init__(
            self,
            *,
            alarms: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.AlarmProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.AlarmConfigurationProperty.__init__)
    ...
    class AlarmProperty:
        def __init__(self, *, name: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.AlarmProperty.__init__)
    ...
    class AutoRollbackConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.AutoRollbackConfigurationProperty.__init__)
                check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_codedeploy.CfnDeploymentGroup.BlueGreenDeploymentConfigurationProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class BlueGreenDeploymentConfigurationProperty:
        def __init__(
            self,
            *,
            deployment_ready_option: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.DeploymentReadyOptionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            green_fleet_provisioning_option: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.GreenFleetProvisioningOptionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            terminate_blue_instances_on_deployment_success: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.BlueInstanceTerminationOptionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''Information about blue/green deployment options for a deployment group.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.BlueGreenDeploymentConfigurationProperty.__init__)
        ...
        def deployment_ready_option(
            self,
        ) -> typing.Optional[typing.Union["CfnDeploymentGroup.DeploymentReadyOptionProperty", _IResolvable_a771d0ef]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnDeploymentGroup.DeploymentReadyOptionProperty", _IResolvable_a771d0ef]], result)

        @builtins.property
        def green_fleet_provisioning_option(
            self,
        ) -> typing.Optional[typing.Union["CfnDeploymentGroup.GreenFleetProvisioningOptionProperty", _IResolvable_a771d0ef]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnDeploymentGroup.GreenFleetProvisioningOptionProperty", _IResolvable_a771d0ef]], result)

        @builtins.property
        def terminate_blue_instances_on_deployment_success(
            self,
        ) -> typing.Optional[typing.Union["CfnDeploymentGroup.BlueInstanceTerminationOptionProperty", _IResolvable_a771d0ef]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnDeploymentGroup.BlueInstanceTerminationOptionProperty", _IResolvable_a771d0ef]], result)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_codedeploy.CfnDeploymentGroup.BlueInstanceTerminationOptionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "action": "action",
    ...
    class BlueInstanceTerminationOptionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.BlueInstanceTerminationOptionProperty.__init__)
    ...
    class DeploymentProperty:
        def __init__(
            self,
            *,
            revision: typing.Union[typing.Union["CfnDeploymentGroup.RevisionLocationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.DeploymentProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_codedeploy.CfnDeploymentGroup.DeploymentReadyOptionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "action_on_timeout": "actionOnTimeout",
    ...
    class DeploymentReadyOptionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.DeploymentReadyOptionProperty.__init__)
    ...
    class DeploymentStyleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.DeploymentStyleProperty.__init__)
    ...
    class EC2TagFilterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.EC2TagFilterProperty.__init__)
    ...
    class EC2TagSetListObjectProperty:
        def __init__(
            self,
            *,
            ec2_tag_group: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.EC2TagFilterProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.EC2TagSetListObjectProperty.__init__)
    ...
    class EC2TagSetProperty:
        def __init__(
            self,
            *,
            ec2_tag_set_list: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.EC2TagSetListObjectProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            '''The ``EC2TagSet`` property type specifies information about groups of tags applied to Amazon EC2 instances.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.EC2TagSetProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_codedeploy.CfnDeploymentGroup.ECSServiceProperty",
        jsii_struct_bases=[],
    ...
    class ECSServiceProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.ECSServiceProperty.__init__)
    ...
    class ELBInfoProperty:
        def __init__(self, *, name: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.ELBInfoProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            self._values: typing.Dict[str, typing.Any] = {}
            if name is not None:
                self._values["name"] = name
    ...
    class GitHubLocationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.GitHubLocationProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_codedeploy.CfnDeploymentGroup.GreenFleetProvisioningOptionProperty",
        jsii_struct_bases=[],
    ...
    class GreenFleetProvisioningOptionProperty:
        def __init__(self, *, action: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.GreenFleetProvisioningOptionProperty.__init__)
                check_type(argname="argument action", value=action, expected_type=type_hints["action"])
            self._values: typing.Dict[str, typing.Any] = {}
            if action is not None:
                self._values["action"] = action
    ...
    class LoadBalancerInfoProperty:
        def __init__(
            self,
            *,
            elb_info_list: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.ELBInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
            target_group_info_list: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.TargetGroupInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
            target_group_pair_info_list: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.TargetGroupPairInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.LoadBalancerInfoProperty.__init__)
        ...
        def target_group_pair_info_list(
            self,
        ) -> typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnDeploymentGroup.TargetGroupPairInfoProperty", _IResolvable_a771d0ef]]]]:
            ...
            return typing.cast(typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnDeploymentGroup.TargetGroupPairInfoProperty", _IResolvable_a771d0ef]]]], result)
    ...
    class OnPremisesTagSetListObjectProperty:
        def __init__(
            self,
            *,
            on_premises_tag_group: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.TagFilterProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.OnPremisesTagSetListObjectProperty.__init__)
    ...
    class OnPremisesTagSetProperty:
        def __init__(
            self,
            *,
            on_premises_tag_set_list: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.OnPremisesTagSetListObjectProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.OnPremisesTagSetProperty.__init__)
    ...
    class RevisionLocationProperty:
        def __init__(
            self,
            *,
            git_hub_location: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.GitHubLocationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            revision_type: typing.Optional[builtins.str] = None,
            s3_location: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.S3LocationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.RevisionLocationProperty.__init__)
    ...
    class S3LocationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.S3LocationProperty.__init__)
    ...
    class TagFilterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.TagFilterProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument type", value=type, expected_type=type_hints["type"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {}
    ...
    class TargetGroupInfoProperty:
        def __init__(self, *, name: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.TargetGroupInfoProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            self._values: typing.Dict[str, typing.Any] = {}
            if name is not None:
                self._values["name"] = name
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_codedeploy.CfnDeploymentGroup.TargetGroupPairInfoProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class TargetGroupPairInfoProperty:
        def __init__(
            self,
            *,
            prod_traffic_route: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.TrafficRouteProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            target_groups: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnDeploymentGroup.TargetGroupInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
            test_traffic_route: typing.Optional[typing.Union[typing.Union["CfnDeploymentGroup.TrafficRouteProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.TargetGroupPairInfoProperty.__init__)
        ...
        def prod_traffic_route(
            self,
        ) -> typing.Optional[typing.Union["CfnDeploymentGroup.TrafficRouteProperty", _IResolvable_a771d0ef]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnDeploymentGroup.TrafficRouteProperty", _IResolvable_a771d0ef]], result)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_codedeploy.CfnDeploymentGroup.TrafficRouteProperty",
        jsii_struct_bases=[],
    ...
    class TrafficRouteProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.TrafficRouteProperty.__init__)
    ...
    class TriggerConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnDeploymentGroup.TriggerConfigProperty.__init__)
...
class CfnDeploymentGroupProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnDeploymentGroupProps.__init__)
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
    ...
    def blue_green_deployment_configuration(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnDeploymentGroup.BlueGreenDeploymentConfigurationProperty, _IResolvable_a771d0ef]], result)
    ...
    def ecs_services(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union[CfnDeploymentGroup.ECSServiceProperty, _IResolvable_a771d0ef]]]], result)
...
class CustomLambdaDeploymentConfigProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CustomLambdaDeploymentConfigProps.__init__)
...
class EcsApplicationProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsApplicationProps.__init__)
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
        self._values: typing.Dict[str, typing.Any] = {}
        if application_name is not None:
            self._values["application_name"] = application_name
...
class EcsDeploymentConfig(
    ...
    def from_ecs_deployment_config_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsDeploymentConfig.from_ecs_deployment_config_name)
...
class EcsDeploymentGroup(
    ...
    def from_ecs_deployment_group_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsDeploymentGroup.from_ecs_deployment_group_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class EcsDeploymentGroupAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsDeploymentGroupAttributes.__init__)
...
class InstanceTagSet(
    ...
    def __init__(
        ...
        *instance_tag_groups: typing.Mapping[builtins.str, typing.List[builtins.str]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(InstanceTagSet.__init__)
...
class LambdaApplication(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaApplication.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_lambda_application_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaApplication.from_lambda_application_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class LambdaApplicationProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaApplicationProps.__init__)
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
        self._values: typing.Dict[str, typing.Any] = {}
        if application_name is not None:
            self._values["application_name"] = application_name
...
class LambdaDeploymentConfig(
    ...
    def import_(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDeploymentConfig.import_)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument _id", value=_id, expected_type=type_hints["_id"])
...
class LambdaDeploymentConfigImportProps:
    def __init__(self, *, deployment_config_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDeploymentConfigImportProps.__init__)
            check_type(argname="argument deployment_config_name", value=deployment_config_name, expected_type=type_hints["deployment_config_name"])
        self._values: typing.Dict[str, typing.Any] = {
            "deployment_config_name": deployment_config_name,
        }
...
class LambdaDeploymentGroup(
    ...
    def __init__(
        ...
        *,
        ...
        alarms: typing.Optional[typing.Sequence[_IAlarm_bf66c8d0]] = None,
        application: typing.Optional[ILambdaApplication] = None,
        auto_rollback: typing.Optional[typing.Union[AutoRollbackConfig, typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDeploymentGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_lambda_deployment_group_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDeploymentGroup.from_lambda_deployment_group_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_alarm(self, alarm: _IAlarm_bf66c8d0) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDeploymentGroup.add_alarm)
    ...
    def add_post_hook(self, post_hook: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDeploymentGroup.add_post_hook)
    ...
    def add_pre_hook(self, pre_hook: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDeploymentGroup.add_pre_hook)
    ...
    def grant_put_lifecycle_event_hook_execution_status(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDeploymentGroup.grant_put_lifecycle_event_hook_execution_status)
...
class LambdaDeploymentGroupAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDeploymentGroupAttributes.__init__)
            check_type(argname="argument application", value=application, expected_type=type_hints["application"])
            check_type(argname="argument deployment_group_name", value=deployment_group_name, expected_type=type_hints["deployment_group_name"])
            check_type(argname="argument deployment_config", value=deployment_config, expected_type=type_hints["deployment_config"])
        self._values: typing.Dict[str, typing.Any] = {
...
class LambdaDeploymentGroupProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDeploymentGroupProps.__init__)
...
class LoadBalancer(
    ...
    def application(
        cls,
        alb_target_group: _IApplicationTargetGroup_5a474b2b,
    ) -> "LoadBalancer":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LoadBalancer.application)
    ...
    def classic(cls, load_balancer: _LoadBalancer_a7de240f) -> "LoadBalancer":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LoadBalancer.classic)
            check_type(argname="argument load_balancer", value=load_balancer, expected_type=type_hints["load_balancer"])
        return typing.cast("LoadBalancer", jsii.sinvoke(cls, "classic", [load_balancer]))

    @jsii.member(jsii_name="network")
    @builtins.classmethod
    def network(cls, nlb_target_group: _INetworkTargetGroup_6938b578) -> "LoadBalancer":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LoadBalancer.network)
...
class MinimumHealthyHosts(
    ...
    def count(cls, value: jsii.Number) -> "MinimumHealthyHosts":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MinimumHealthyHosts.count)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def percentage(cls, value: jsii.Number) -> "MinimumHealthyHosts":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MinimumHealthyHosts.percentage)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ServerApplication(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerApplication.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_server_application_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerApplication.from_server_application_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class ServerApplicationProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerApplicationProps.__init__)
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
        self._values: typing.Dict[str, typing.Any] = {}
        if application_name is not None:
            self._values["application_name"] = application_name
...
class ServerDeploymentConfig(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerDeploymentConfig.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_server_deployment_config_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerDeploymentConfig.from_server_deployment_config_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class ServerDeploymentConfigProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerDeploymentConfigProps.__init__)
            check_type(argname="argument minimum_healthy_hosts", value=minimum_healthy_hosts, expected_type=type_hints["minimum_healthy_hosts"])
            check_type(argname="argument deployment_config_name", value=deployment_config_name, expected_type=type_hints["deployment_config_name"])
        self._values: typing.Dict[str, typing.Any] = {
            "minimum_healthy_hosts": minimum_healthy_hosts,
...
class ServerDeploymentGroup(
    ...
    def __init__(
        ...
        *,
        ...
        auto_rollback: typing.Optional[typing.Union[AutoRollbackConfig, typing.Dict[str, typing.Any]]] = None,
        auto_scaling_groups: typing.Optional[typing.Sequence[_IAutoScalingGroup_352723c6]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerDeploymentGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_server_deployment_group_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerDeploymentGroup.from_server_deployment_group_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_alarm(self, alarm: _IAlarm_bf66c8d0) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerDeploymentGroup.add_alarm)
            check_type(argname="argument alarm", value=alarm, expected_type=type_hints["alarm"])
        return typing.cast(None, jsii.invoke(self, "addAlarm", [alarm]))
    ...
    def add_auto_scaling_group(self, asg: _AutoScalingGroup_604a934f) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerDeploymentGroup.add_auto_scaling_group)
...
class ServerDeploymentGroupAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerDeploymentGroupAttributes.__init__)
            check_type(argname="argument application", value=application, expected_type=type_hints["application"])
            check_type(argname="argument deployment_group_name", value=deployment_group_name, expected_type=type_hints["deployment_group_name"])
            check_type(argname="argument deployment_config", value=deployment_config, expected_type=type_hints["deployment_config"])
        self._values: typing.Dict[str, typing.Any] = {
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(auto_rollback, dict):
            auto_rollback = AutoRollbackConfig(**auto_rollback)
        if __debug__:
            type_hints = typing.get_type_hints(ServerDeploymentGroupProps.__init__)
            check_type(argname="argument alarms", value=alarms, expected_type=type_hints["alarms"])
            check_type(argname="argument application", value=application, expected_type=type_hints["application"])
            check_type(argname="argument auto_rollback", value=auto_rollback, expected_type=type_hints["auto_rollback"])
            check_type(argname="argument auto_scaling_groups", value=auto_scaling_groups, expected_type=type_hints["auto_scaling_groups"])
...
class CustomLambdaDeploymentConfig(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CustomLambdaDeploymentConfig.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class EcsApplication(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsApplication.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_ecs_application_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsApplication.from_ecs_application_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
