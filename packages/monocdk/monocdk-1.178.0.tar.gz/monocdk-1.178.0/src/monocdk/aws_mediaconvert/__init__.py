...
class CfnJobTemplate(
    ...
    def __init__(
        ...
        *,
        ...
        acceleration_settings: typing.Optional[typing.Union[typing.Union["CfnJobTemplate.AccelerationSettingsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        category: typing.Optional[builtins.str] = None,
        description: typing.Optional[builtins.str] = None,
        hop_destinations: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnJobTemplate.HopDestinationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
