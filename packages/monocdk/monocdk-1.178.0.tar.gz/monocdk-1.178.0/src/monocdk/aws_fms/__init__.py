...
class CfnPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        security_service_policy_data: typing.Union[typing.Union["CfnPolicy.SecurityServicePolicyDataProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        delete_all_policy_resources: typing.Optional[typing.Union[builtins.bool, _IResolvable_a771d0ef]] = None,
        exclude_map: typing.Optional[typing.Union[typing.Union["CfnPolicy.IEMapProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        include_map: typing.Optional[typing.Union[typing.Union["CfnPolicy.IEMapProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        resources_clean_up: typing.Optional[typing.Union[builtins.bool, _IResolvable_a771d0ef]] = None,
        resource_tags: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnPolicy.ResourceTagProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ...
    class PolicyOptionProperty:
        def __init__(
            self,
            *,
            network_firewall_policy: typing.Optional[typing.Union[typing.Union["CfnPolicy.NetworkFirewallPolicyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            third_party_firewall_policy: typing.Optional[typing.Union[typing.Union["CfnPolicy.ThirdPartyFirewallPolicyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''
    ...
    class SecurityServicePolicyDataProperty:
        def __init__(
            ...
            *,
            ...
            policy_option: typing.Optional[typing.Union[typing.Union["CfnPolicy.PolicyOptionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''
