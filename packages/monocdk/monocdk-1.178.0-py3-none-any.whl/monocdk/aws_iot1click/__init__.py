...
class CfnProject(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        placement_template: typing.Union[typing.Union["CfnProject.PlacementTemplateProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
    ...
    class PlacementTemplateProperty:
        def __init__(
            ...
            *,
            ...
            device_templates: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Mapping[builtins.str, typing.Union[typing.Union["CfnProject.DeviceTemplateProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
