...
class CfnAlert(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        action: typing.Union[typing.Union["CfnAlert.ActionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
    ...
    class ActionProperty:
        def __init__(
            self,
            *,
            lambda_configuration: typing.Optional[typing.Union[typing.Union["CfnAlert.LambdaConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            sns_configuration: typing.Optional[typing.Union[typing.Union["CfnAlert.SNSConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
...
class CfnAnomalyDetector(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        anomaly_detector_config: typing.Union[typing.Union["CfnAnomalyDetector.AnomalyDetectorConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        metric_set_list: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnAnomalyDetector.MetricSetProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
    ...
    class FileFormatDescriptorProperty:
        def __init__(
            self,
            *,
            csv_format_descriptor: typing.Optional[typing.Union[typing.Union["CfnAnomalyDetector.CsvFormatDescriptorProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            json_format_descriptor: typing.Optional[typing.Union[typing.Union["CfnAnomalyDetector.JsonFormatDescriptorProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
    ...
    class MetricSetProperty:
        def __init__(
            self,
            *,
            metric_list: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnAnomalyDetector.MetricProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
            metric_set_name: builtins.str,
            metric_source: typing.Union[typing.Union["CfnAnomalyDetector.MetricSourceProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
            ...
            timestamp_column: typing.Optional[typing.Union[typing.Union["CfnAnomalyDetector.TimestampColumnProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ...
    class MetricSourceProperty:
        def __init__(
            self,
            *,
            app_flow_config: typing.Optional[typing.Union[typing.Union["CfnAnomalyDetector.AppFlowConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            cloudwatch_config: typing.Optional[typing.Union[typing.Union["CfnAnomalyDetector.CloudwatchConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            rds_source_config: typing.Optional[typing.Union[typing.Union["CfnAnomalyDetector.RDSSourceConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            redshift_source_config: typing.Optional[typing.Union[typing.Union["CfnAnomalyDetector.RedshiftSourceConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            s3_source_config: typing.Optional[typing.Union[typing.Union["CfnAnomalyDetector.S3SourceConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''Contains information about how the source data should be interpreted.
    ...
    class RDSSourceConfigProperty:
        def __init__(
            ...
            *,
            ...
            vpc_configuration: typing.Union[typing.Union["CfnAnomalyDetector.VpcConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        ) -> None:
    ...
    class S3SourceConfigProperty:
        def __init__(
            self,
            *,
            file_format_descriptor: typing.Union[typing.Union["CfnAnomalyDetector.FileFormatDescriptorProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
            role_arn: builtins.str,
