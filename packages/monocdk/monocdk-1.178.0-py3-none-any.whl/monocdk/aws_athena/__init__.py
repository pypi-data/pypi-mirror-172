...
class CfnWorkGroup(
    ...
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Sequence[typing.Union[_CfnTag_95fbdc29, typing.Dict[str, typing.Any]]]] = None,
        work_group_configuration: typing.Optional[typing.Union[typing.Union["CfnWorkGroup.WorkGroupConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ) -> None:
    ...
    class ResultConfigurationProperty:
        def __init__(
            self,
            *,
            encryption_configuration: typing.Optional[typing.Union[typing.Union["CfnWorkGroup.EncryptionConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ...
    class WorkGroupConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            engine_version: typing.Optional[typing.Union[typing.Union["CfnWorkGroup.EngineVersionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            ...
            result_configuration: typing.Optional[typing.Union[typing.Union["CfnWorkGroup.ResultConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''The configuration of the workgroup, which includes the location in Amazon S3 where query results are stored, the encryption option, if any, used for query results, whether Amazon CloudWatch Metrics are enabled for the workgroup, and the limit for the amount of bytes scanned (cutoff) per query, if it is specified.
