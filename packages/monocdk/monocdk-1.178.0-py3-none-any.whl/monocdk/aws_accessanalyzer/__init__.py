...
class CfnAnalyzer(
    ...
    def __init__(
        ...
        *,
        ...
        archive_rules: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnAnalyzer.ArchiveRuleProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ...
    class ArchiveRuleProperty:
        def __init__(
            self,
            *,
            filter: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnAnalyzer.FilterProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
