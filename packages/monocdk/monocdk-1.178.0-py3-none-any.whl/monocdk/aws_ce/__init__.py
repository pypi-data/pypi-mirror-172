...
class CfnAnomalyMonitor(
    ...
    def __init__(
        ...
        *,
        ...
        resource_tags: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnAnomalyMonitor.ResourceTagProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ) -> None:
...
class CfnAnomalySubscription(
    ...
    def __init__(
        ...
        *,
        ...
        subscribers: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnAnomalySubscription.SubscriberProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        subscription_name: builtins.str,
        threshold: jsii.Number,
        resource_tags: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnAnomalySubscription.ResourceTagProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ) -> None:
