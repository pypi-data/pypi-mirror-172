...
class CfnNotificationChannel(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        config: typing.Union[typing.Union["CfnNotificationChannel.NotificationChannelConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
    ) -> None:
    ...
    class NotificationChannelConfigProperty:
        def __init__(
            self,
            *,
            sns: typing.Optional[typing.Union[typing.Union["CfnNotificationChannel.SnsChannelConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
...
class CfnResourceCollection(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        resource_collection_filter: typing.Union[typing.Union["CfnResourceCollection.ResourceCollectionFilterProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
    ) -> None:
    ...
    class ResourceCollectionFilterProperty:
        def __init__(
            self,
            *,
            cloud_formation: typing.Optional[typing.Union[typing.Union["CfnResourceCollection.CloudFormationCollectionFilterProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
