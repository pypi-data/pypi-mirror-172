...
class CfnVirtualCluster(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        container_provider: typing.Union[typing.Union["CfnVirtualCluster.ContainerProviderProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        name: builtins.str,
    ...
    class ContainerInfoProperty:
        def __init__(
            self,
            *,
            eks_info: typing.Union[typing.Union["CfnVirtualCluster.EksInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        ) -> None:
    ...
    class ContainerProviderProperty:
        def __init__(
            ...
            *,
            id: builtins.str,
            info: typing.Union[typing.Union["CfnVirtualCluster.ContainerInfoProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
            type: builtins.str,
        ) -> None:
