...
class Alarms:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Alarms.__init__)
...
class ArbitraryIntervals:
    def __init__(
        ...
        *,
        ...
        intervals: typing.Sequence[typing.Union["ScalingInterval", typing.Dict[str, typing.Any]]],
    ) -> None:
        '''
        :param absolute: 
        :param intervals: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ArbitraryIntervals.__init__)
...
class CompleteScalingInterval:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CompleteScalingInterval.__init__)
...
class _IRandomGeneratorProxy:
    ...
    def next_int(self, min: jsii.Number, max: jsii.Number) -> jsii.Number:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRandomGenerator.next_int)
