...
class ApiGatewayDomain(
    ...
    def __init__(self, domain_name: _IDomainName_2f71106c) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiGatewayDomain.__init__)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiGatewayDomain.bind)
...
class ApiGatewayv2DomainProperties(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiGatewayv2DomainProperties.__init__)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiGatewayv2DomainProperties.bind)
            check_type(argname="argument _record", value=_record, expected_type=type_hints["_record"])
            check_type(argname="argument _zone", value=_zone, expected_type=type_hints["_zone"])
        return typing.cast(_AliasRecordTargetConfig_5788d785, jsii.invoke(self, "bind", [_record, _zone]))
...
class BucketWebsiteTarget(
    ...
    def __init__(self, bucket: _IBucket_73486e29) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BucketWebsiteTarget.__init__)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BucketWebsiteTarget.bind)
            check_type(argname="argument _record", value=_record, expected_type=type_hints["_record"])
            check_type(argname="argument _zone", value=_zone, expected_type=type_hints["_zone"])
        return typing.cast(_AliasRecordTargetConfig_5788d785, jsii.invoke(self, "bind", [_record, _zone]))
...
class ClassicLoadBalancerTarget(
    ...
    def __init__(self, load_balancer: _LoadBalancer_a7de240f) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ClassicLoadBalancerTarget.__init__)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ClassicLoadBalancerTarget.bind)
            check_type(argname="argument _record", value=_record, expected_type=type_hints["_record"])
            check_type(argname="argument _zone", value=_zone, expected_type=type_hints["_zone"])
        return typing.cast(_AliasRecordTargetConfig_5788d785, jsii.invoke(self, "bind", [_record, _zone]))
...
class CloudFrontTarget(
    ...
    def __init__(self, distribution: _IDistribution_685deca5) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFrontTarget.__init__)
    ...
    def get_hosted_zone_id(cls, scope: _IConstruct_5a0f9c5e) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFrontTarget.get_hosted_zone_id)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFrontTarget.bind)
            check_type(argname="argument _record", value=_record, expected_type=type_hints["_record"])
            check_type(argname="argument _zone", value=_zone, expected_type=type_hints["_zone"])
        return typing.cast(_AliasRecordTargetConfig_5788d785, jsii.invoke(self, "bind", [_record, _zone]))
...
class ElasticBeanstalkEnvironmentEndpointTarget(
    ...
    def __init__(self, environment_endpoint: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ElasticBeanstalkEnvironmentEndpointTarget.__init__)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ElasticBeanstalkEnvironmentEndpointTarget.bind)
            check_type(argname="argument _record", value=_record, expected_type=type_hints["_record"])
            check_type(argname="argument _zone", value=_zone, expected_type=type_hints["_zone"])
        return typing.cast(_AliasRecordTargetConfig_5788d785, jsii.invoke(self, "bind", [_record, _zone]))
...
class GlobalAcceleratorDomainTarget(
    ...
    def __init__(self, accelerator_domain_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GlobalAcceleratorDomainTarget.__init__)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GlobalAcceleratorDomainTarget.bind)
            check_type(argname="argument _record", value=_record, expected_type=type_hints["_record"])
            check_type(argname="argument _zone", value=_zone, expected_type=type_hints["_zone"])
        return typing.cast(_AliasRecordTargetConfig_5788d785, jsii.invoke(self, "bind", [_record, _zone]))
...
class GlobalAcceleratorTarget(
    ...
    def __init__(self, accelerator: _IAccelerator_8b90cb82) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GlobalAcceleratorTarget.__init__)
...
class InterfaceVpcEndpointTarget(
    ...
    def __init__(self, vpc_endpoint: _IInterfaceVpcEndpoint_6081623d) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(InterfaceVpcEndpointTarget.__init__)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(InterfaceVpcEndpointTarget.bind)
            check_type(argname="argument _record", value=_record, expected_type=type_hints["_record"])
            check_type(argname="argument _zone", value=_zone, expected_type=type_hints["_zone"])
        return typing.cast(_AliasRecordTargetConfig_5788d785, jsii.invoke(self, "bind", [_record, _zone]))
...
class LoadBalancerTarget(
    ...
    def __init__(self, load_balancer: _ILoadBalancerV2_f1c75d72) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LoadBalancerTarget.__init__)
            check_type(argname="argument load_balancer", value=load_balancer, expected_type=type_hints["load_balancer"])
        jsii.create(self.__class__, self, [load_balancer])
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LoadBalancerTarget.bind)
            check_type(argname="argument _record", value=_record, expected_type=type_hints["_record"])
            check_type(argname="argument _zone", value=_zone, expected_type=type_hints["_zone"])
        return typing.cast(_AliasRecordTargetConfig_5788d785, jsii.invoke(self, "bind", [_record, _zone]))
...
class Route53RecordTarget(
    ...
    def __init__(self, record: _IRecordSet_133a645a) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Route53RecordTarget.__init__)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Route53RecordTarget.bind)
            check_type(argname="argument _record", value=_record, expected_type=type_hints["_record"])
...
class UserPoolDomainTarget(
    ...
    def __init__(self, domain: _UserPoolDomain_18478017) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UserPoolDomainTarget.__init__)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UserPoolDomainTarget.bind)
            check_type(argname="argument _record", value=_record, expected_type=type_hints["_record"])
            check_type(argname="argument _zone", value=_zone, expected_type=type_hints["_zone"])
        return typing.cast(_AliasRecordTargetConfig_5788d785, jsii.invoke(self, "bind", [_record, _zone]))
