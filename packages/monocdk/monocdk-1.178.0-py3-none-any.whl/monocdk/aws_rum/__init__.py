...
class CfnAppMonitor(
    ...
    jsii_type="monocdk.aws_rum.CfnAppMonitor",
):
    ...
    Example::
        ...
        from monocdk import aws_rum as rum
    ...
    def __init__(
        ...
        *,
        domain: builtins.str,
        name: builtins.str,
        app_monitor_configuration: typing.Optional[typing.Union[typing.Union["CfnAppMonitor.AppMonitorConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        cw_log_enabled: typing.Optional[typing.Union[builtins.bool, _IResolvable_a771d0ef]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAppMonitor.__init__)
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAppMonitor.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAppMonitor._render_properties)
    ...
    def domain(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAppMonitor, "domain").fset)
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAppMonitor, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def app_monitor_configuration(
        self,
    ) -> typing.Optional[typing.Union["CfnAppMonitor.AppMonitorConfigurationProperty", _IResolvable_a771d0ef]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnAppMonitor.AppMonitorConfigurationProperty", _IResolvable_a771d0ef]], jsii.get(self, "appMonitorConfiguration"))

    @app_monitor_configuration.setter
    def app_monitor_configuration(
        self,
        value: typing.Optional[typing.Union["CfnAppMonitor.AppMonitorConfigurationProperty", _IResolvable_a771d0ef]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAppMonitor, "app_monitor_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def cw_log_enabled(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _IResolvable_a771d0ef]], jsii.get(self, "cwLogEnabled"))
    ...
    def cw_log_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAppMonitor, "cw_log_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "cwLogEnabled", value)

    @jsii.data_type(
        jsii_type="monocdk.aws_rum.CfnAppMonitor.AppMonitorConfigurationProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class AppMonitorConfigurationProperty:
        def __init__(
            self,
            *,
            allow_cookies: typing.Optional[typing.Union[builtins.bool, _IResolvable_a771d0ef]] = None,
            enable_x_ray: typing.Optional[typing.Union[builtins.bool, _IResolvable_a771d0ef]] = None,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnAppMonitor.AppMonitorConfigurationProperty.__init__)
...
@jsii.data_type(
    jsii_type="monocdk.aws_rum.CfnAppMonitorProps",
    jsii_struct_bases=[],
    name_mapping={
        "domain": "domain",
        "name": "name",
...
class CfnAppMonitorProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAppMonitorProps.__init__)
    ...
    def app_monitor_configuration(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnAppMonitor.AppMonitorConfigurationProperty, _IResolvable_a771d0ef]], result)
