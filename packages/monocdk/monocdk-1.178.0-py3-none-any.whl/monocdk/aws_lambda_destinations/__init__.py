...
class EventBridgeDestination(
    ...
    def __init__(self, event_bus: typing.Optional[_IEventBus_2ca38c95] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EventBridgeDestination.__init__)
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EventBridgeDestination.bind)
...
class LambdaDestination(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDestination.__init__)
            check_type(argname="argument fn", value=fn, expected_type=type_hints["fn"])
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDestination.bind)
...
class LambdaDestinationOptions:
    def __init__(self, *, response_only: typing.Optional[builtins.bool] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaDestinationOptions.__init__)
...
class SnsDestination(
    ...
    def __init__(self, topic: _ITopic_465e36b9) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SnsDestination.__init__)
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SnsDestination.bind)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument fn", value=fn, expected_type=type_hints["fn"])
        _options = _DestinationOptions_31232a3a(type=type)
...
class SqsDestination(
    ...
    def __init__(self, queue: _IQueue_45a01ab4) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SqsDestination.__init__)
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SqsDestination.bind)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument fn", value=fn, expected_type=type_hints["fn"])
        _options = _DestinationOptions_31232a3a(type=type)
