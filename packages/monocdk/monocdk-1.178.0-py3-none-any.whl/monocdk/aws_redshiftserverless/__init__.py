...
class CfnWorkgroup(
    ...
    def __init__(
        ...
        *,
        ...
        config_parameters: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnWorkgroup.ConfigParameterProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
