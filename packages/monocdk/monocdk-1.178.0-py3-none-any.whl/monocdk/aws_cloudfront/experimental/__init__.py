...
from ...aws_lambda import (
    ...
    FunctionUrl as _FunctionUrl_0f64d446,
    FunctionUrlAuthType as _FunctionUrlAuthType_4cfe7120,
    FunctionUrlCorsOptions as _FunctionUrlCorsOptions_3bbf24b0,
    FunctionUrlOptions as _FunctionUrlOptions_dae61a5b,
...
class EdgeFunction(
    ...
    def __init__(
        ...
        *,
        ...
        current_version_options: typing.Optional[typing.Union[_VersionOptions_085bb455, typing.Dict[str, typing.Any]]] = None,
        ...
        log_retention_retry_options: typing.Optional[typing.Union[_LogRetentionRetryOptions_7acc40ab, typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EdgeFunction.__init__)
    ...
    def add_alias(
        ...
        *,
        additional_versions: typing.Optional[typing.Sequence[typing.Union[_VersionWeight_7bcc86af, typing.Dict[str, typing.Any]]]] = None,
        description: typing.Optional[builtins.str] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EdgeFunction.add_alias)
    ...
    def add_event_source(self, source: _IEventSource_7914870e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EdgeFunction.add_event_source)
    ...
    def add_event_source_mapping(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EdgeFunction.add_event_source_mapping)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_function_url(
        self,
        *,
        auth_type: typing.Optional[_FunctionUrlAuthType_4cfe7120] = None,
        cors: typing.Optional[typing.Union[_FunctionUrlCorsOptions_3bbf24b0, typing.Dict[str, typing.Any]]] = None,
    ) -> _FunctionUrl_0f64d446:
        ...
        :stability: experimental
        '''
        options = _FunctionUrlOptions_dae61a5b(auth_type=auth_type, cors=cors)

        return typing.cast(_FunctionUrl_0f64d446, jsii.invoke(self, "addFunctionUrl", [options]))
    ...
    def add_permission(
        ...
        *,
        ...
        function_url_auth_type: typing.Optional[_FunctionUrlAuthType_4cfe7120] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EdgeFunction.add_permission)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_to_role_policy(self, statement: _PolicyStatement_296fe8a3) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EdgeFunction.add_to_role_policy)
    ...
    def grant_invoke(self, identity: _IGrantable_4c5a91d1) -> _Grant_bcb5eae7:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EdgeFunction.grant_invoke)
    ...
    def grant_invoke_url(self, identity: _IGrantable_4c5a91d1) -> _Grant_bcb5eae7:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EdgeFunction.grant_invoke_url)
            check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
    ...
    def metric(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EdgeFunction.metric)
    ...
    def architecture(self) -> _Architecture_24056b62:
        '''(experimental) The system architectures compatible with this lambda function.

        :stability: experimental
        '''
        return typing.cast(_Architecture_24056b62, jsii.get(self, "architecture"))
...
class EdgeFunctionProps(_FunctionProps_5561697c):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(EdgeFunctionProps.__init__)
