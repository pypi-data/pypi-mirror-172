...
class CfnNotificationRule(
    ...
    def __init__(
        ...
        *,
        ...
        targets: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnNotificationRule.TargetProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
