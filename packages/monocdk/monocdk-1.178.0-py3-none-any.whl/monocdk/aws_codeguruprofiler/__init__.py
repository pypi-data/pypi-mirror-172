...
class CfnProfilingGroup(
    ...
    def __init__(
        ...
        *,
        ...
        anomaly_detection_notification_configuration: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnProfilingGroup.ChannelProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
