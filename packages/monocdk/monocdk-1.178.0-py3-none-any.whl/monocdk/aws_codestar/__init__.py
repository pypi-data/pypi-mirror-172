...
class CfnGitHubRepository(
    ...
    def __init__(
        ...
        *,
        ...
        code: typing.Optional[typing.Union[typing.Union["CfnGitHubRepository.CodeProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnGitHubRepository.__init__)
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnGitHubRepository.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnGitHubRepository._render_properties)
    ...
    def repository_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGitHubRepository, "repository_name").fset)
    ...
    def repository_owner(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGitHubRepository, "repository_owner").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def code(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGitHubRepository, "code").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def connection_arn(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGitHubRepository, "connection_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def enable_issues(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGitHubRepository, "enable_issues").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def is_private(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGitHubRepository, "is_private").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def repository_access_token(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGitHubRepository, "repository_access_token").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def repository_description(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGitHubRepository, "repository_description").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class CodeProperty:
        def __init__(
            self,
            *,
            s3: typing.Union[typing.Union["CfnGitHubRepository.S3Property", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnGitHubRepository.CodeProperty.__init__)
    ...
    class S3Property:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnGitHubRepository.S3Property.__init__)
...
class CfnGitHubRepositoryProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnGitHubRepositoryProps.__init__)
...
class GitHubRepository(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubRepository.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
