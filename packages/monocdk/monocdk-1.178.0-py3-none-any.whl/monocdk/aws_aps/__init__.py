...
class CfnWorkspace(
    ...
    def __init__(
        ...
        *,
        ...
        logging_configuration: typing.Optional[typing.Union[typing.Union["CfnWorkspace.LoggingConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        tags: typing.Optional[typing.Sequence[typing.Union[_CfnTag_95fbdc29, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
