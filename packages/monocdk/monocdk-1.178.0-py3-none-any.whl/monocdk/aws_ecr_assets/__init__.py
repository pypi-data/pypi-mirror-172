...
```python
from monocdk.aws_ecr_assets import DockerImageAsset, Platform
...
class DockerImageAsset(
    ...
    def __init__(
        ...
        *,
        ...
        invalidation: typing.Optional[typing.Union["DockerImageAssetInvalidationOptions", typing.Dict[str, typing.Any]]] = None,
    ...
    def add_resource_metadata(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DockerImageAsset.add_resource_metadata)
    ...
    def image_uri(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DockerImageAsset, "image_uri").fset)
    ...
    def repository(self, value: _IRepository_8b4d2894) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DockerImageAsset, "repository").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DockerImageAssetInvalidationOptions:
    def __init__(
        ...
        *,
        ...
        :param platform: (experimental) Use ``platform`` while calculating the asset hash. Default: true
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DockerImageAssetInvalidationOptions.__init__)
...
class DockerImageAssetOptions(
    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DockerImageAssetOptions.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(invalidation, dict):
            invalidation = DockerImageAssetInvalidationOptions(**invalidation)
        if __debug__:
            type_hints = typing.get_type_hints(DockerImageAssetProps.__init__)
            check_type(argname="argument exclude", value=exclude, expected_type=type_hints["exclude"])
            check_type(argname="argument follow", value=follow, expected_type=type_hints["follow"])
            check_type(argname="argument ignore_mode", value=ignore_mode, expected_type=type_hints["ignore_mode"])
            check_type(argname="argument extra_hash", value=extra_hash, expected_type=type_hints["extra_hash"])
...
class NetworkMode(
    ...
    def custom(cls, mode: builtins.str) -> "NetworkMode":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkMode.custom)
    ...
    def from_container(cls, container_id: builtins.str) -> "NetworkMode":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NetworkMode.from_container)
...
class Platform(metaclass=jsii.JSIIMeta, jsii_type="monocdk.aws_ecr_assets.Platform"):
    ...
    def custom(cls, platform: builtins.str) -> "Platform":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Platform.custom)
            check_type(argname="argument platform", value=platform, expected_type=type_hints["platform"])
...
class TarballImageAsset(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TarballImageAsset.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def image_uri(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(TarballImageAsset, "image_uri").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "imageUri", value)
    ...
    def repository(self, value: _IRepository_8b4d2894) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(TarballImageAsset, "repository").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "repository", value)
...
class TarballImageAssetProps:
    def __init__(self, *, tarball_file: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TarballImageAssetProps.__init__)
