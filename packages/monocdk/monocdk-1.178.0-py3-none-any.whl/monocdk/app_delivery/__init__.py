...
class PipelineDeployStackAction(
    ...
    def add_to_deployment_role_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PipelineDeployStackAction.add_to_deployment_role_policy)
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PipelineDeployStackAction.bind)
    ...
    def on_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PipelineDeployStackAction.on_state_change)
...
class PipelineDeployStackActionProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PipelineDeployStackActionProps.__init__)
