...
class CfnGroup(
    ...
    def __init__(
        ...
        *,
        ...
        insights_configuration: typing.Optional[typing.Union[typing.Union["CfnGroup.InsightsConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
...
class CfnSamplingRule(
    ...
    def __init__(
        ...
        *,
        ...
        sampling_rule: typing.Optional[typing.Union[typing.Union["CfnSamplingRule.SamplingRuleProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        sampling_rule_record: typing.Optional[typing.Union[typing.Union["CfnSamplingRule.SamplingRuleRecordProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        sampling_rule_update: typing.Optional[typing.Union[typing.Union["CfnSamplingRule.SamplingRuleUpdateProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        tags: typing.Optional[typing.Sequence[typing.Any]] = None,
    ) -> None:
