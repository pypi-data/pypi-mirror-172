...
class CfnDataIntegration(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        schedule_config: typing.Union[typing.Union["CfnDataIntegration.ScheduleConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
...
class CfnEventIntegration(
    ...
    def __init__(
        ...
        *,
        ...
        event_filter: typing.Union[typing.Union["CfnEventIntegration.EventFilterProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        name: builtins.str,
        description: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.Sequence[typing.Union[_CfnTag_95fbdc29, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
    ...
    class EventIntegrationAssociationProperty:
        def __init__(
            self,
            *,
            client_association_metadata: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnEventIntegration.MetadataProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
