...
import monocdk as codepipeline_actions
```
...
codepipeline_actions.CodeBuildAction(
    ...
    environment_variables={
        "COMMIT_ID": codebuild.aws_codebuild.BuildEnvironmentVariable(
...
codepipeline_actions.CodeBuildAction(
    ...
    input=source_output,
    environment_variables={
        "COMMIT_URL": codebuild.aws_codebuild.BuildEnvironmentVariable(
...
codepipeline_actions.CodeBuildAction(
    ...
    input=source_output,
    environment_variables={
        "VERSION_ID": codebuild.aws_codebuild.BuildEnvironmentVariable(
...
codepipeline_actions.CodeBuildAction(
    ...
    input=source_output,
    environment_variables={
        "IMAGE_URI": ecr.aws_codebuild.BuildEnvironmentVariable(
...
```python
from monocdk import PhysicalName
...
class Action(
    ...
    def __init__(
        ...
        *,
        ...
        artifact_bounds: typing.Union[_ActionArtifactBounds_77337cd6, typing.Dict[str, typing.Any]],
...
class _ActionProxy(
    Action,
    jsii.proxy_for(_Action_0220d19f), # type: ignore[misc]
):
    pass
...
class AlexaSkillDeployAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlexaSkillDeployAction._bound)
...
class AlexaSkillDeployActionProps(_CommonActionProps_4f0e79c2):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlexaSkillDeployActionProps.__init__)
...
class BitBucketSourceAction(
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BitBucketSourceAction.bind)
    ...
    def on_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BitBucketSourceAction.on_state_change)
...
class CacheControl(
    ...
    def from_string(cls, s: builtins.str) -> "CacheControl":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CacheControl.from_string)
    ...
    def max_age(cls, t: _Duration_070aa057) -> "CacheControl":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CacheControl.max_age)
    ...
    def s_max_age(cls, t: _Duration_070aa057) -> "CacheControl":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CacheControl.s_max_age)
            check_type(argname="argument t", value=t, expected_type=type_hints["t"])
    ...
    def value(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CacheControl, "value").fset)
...
class CloudFormationCreateReplaceChangeSetAction(
    ...
    def add_to_deployment_role_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationCreateReplaceChangeSetAction.add_to_deployment_role_policy)
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationCreateReplaceChangeSetAction._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class CloudFormationCreateReplaceChangeSetActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationCreateReplaceChangeSetActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
...
class CloudFormationCreateUpdateStackAction(
    ...
    def add_to_deployment_role_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationCreateUpdateStackAction.add_to_deployment_role_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(builtins.bool, jsii.invoke(self, "addToDeploymentRolePolicy", [statement]))
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationCreateUpdateStackAction._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class CloudFormationCreateUpdateStackActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationCreateUpdateStackActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class CloudFormationDeleteStackAction(
    ...
    Example::
        ...
        cloud_formation_delete_stack_action = codepipeline_actions.CloudFormationDeleteStackAction(
            ...
            cfn_capabilities=[monocdk.CfnCapabilities.NONE],
    ...
    def add_to_deployment_role_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationDeleteStackAction.add_to_deployment_role_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(builtins.bool, jsii.invoke(self, "addToDeploymentRolePolicy", [statement]))
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationDeleteStackAction._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class CloudFormationDeleteStackActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationDeleteStackActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class CloudFormationDeployStackInstancesAction(
    Action,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk.aws_codepipeline_actions.CloudFormationDeployStackInstancesAction",
):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param stack_instances: (experimental) Specify where to create or update Stack Instances. You can specify either AWS Accounts Ids or AWS Organizations Organizational Units.
        :param stack_set_name: (experimental) The name of the StackSet we are adding instances to.
        :param parameter_overrides: (experimental) Parameter values that only apply to the current Stack Instances. These parameters are shared between all instances added by this action. Default: - no parameters will be overridden
        :param role: (experimental) The Role in which context's this Action will be executing in. The Pipeline's Role will assume this Role (the required permissions for that will be granted automatically) right before executing this Action. This Action will be passed into your {@link IAction.bind} method in the {@link ActionBindOptions.role} property. Default: a new Role will be generated
        :param failure_tolerance_percentage: (experimental) The percentage of accounts per Region for which this stack operation can fail before AWS CloudFormation stops the operation in that Region. If the operation is stopped in a Region, AWS CloudFormation doesn't attempt the operation in subsequent Regions. When calculating the number of accounts based on the specified percentage, AWS CloudFormation rounds down to the next whole number. Default: 0%
        :param max_account_concurrency_percentage: (experimental) The maximum percentage of accounts in which to perform this operation at one time. When calculating the number of accounts based on the specified percentage, AWS CloudFormation rounds down to the next whole number. If rounding down would result in zero, AWS CloudFormation sets the number as one instead. Although you use this setting to specify the maximum, for large deployments the actual number of accounts acted upon concurrently may be lower due to service throttling. Default: 1%
        :param stack_set_region: (experimental) The AWS Region the StackSet is in. Note that a cross-region Pipeline requires replication buckets to function correctly. You can provide their names with the ``PipelineProps.crossRegionReplicationBuckets`` property. If you don't, the CodePipeline Construct will create new Stacks in your CDK app containing those buckets, that you will need to ``cdk deploy`` before deploying the main, Pipeline-containing Stack. Default: - same region as the Pipeline
        :param action_name: (experimental) The physical, human-readable name of the Action. Note that Action names must be unique within a single Stage.
        :param run_order: (experimental) The runOrder property for this Action. RunOrder determines the relative order in which multiple Actions in the same Stage execute. Default: 1
        :param variables_namespace: (experimental) The name of the namespace to use for variables emitted by this action. Default: - a name will be generated, based on the stage and action names, if any of the action's variables were referenced - otherwise, no namespace will be set
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationDeployStackInstancesAction._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class CloudFormationDeployStackSetAction(
    Action,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk.aws_codepipeline_actions.CloudFormationDeployStackSetAction",
):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param stack_set_name: (experimental) The name to associate with the stack set. This name must be unique in the Region where it is created. The name may only contain alphanumeric and hyphen characters. It must begin with an alphabetic character and be 128 characters or fewer.
        :param template: (experimental) The location of the template that defines the resources in the stack set. This must point to a template with a maximum size of 460,800 bytes. Enter the path to the source artifact name and template file.
        :param cfn_capabilities: (experimental) Indicates that the template can create and update resources, depending on the types of resources in the template. You must use this property if you have IAM resources in your stack template or you create a stack directly from a template containing macros. Default: - the StackSet will have no IAM capabilities
        :param deployment_model: (experimental) Determines how IAM roles are created and managed. The choices are: - Self Managed: you create IAM roles with the required permissions in the administration account and all target accounts. - Service Managed: only available if the account and target accounts are part of an AWS Organization. The necessary roles will be created for you. If you want to deploy to all accounts that are a member of AWS Organizations Organizational Units (OUs), you must select Service Managed permissions. Note: This parameter can only be changed when no stack instances exist in the stack set. Default: StackSetDeploymentModel.selfManaged()
        :param description: (experimental) A description of the stack set. You can use this to describe the stack set’s purpose or other relevant information. Default: - no description
        :param parameters: (experimental) The template parameters for your stack set. These parameters are shared between all instances of the stack set. Default: - no parameters will be used
        :param stack_instances: (experimental) Specify where to create or update Stack Instances. You can specify either AWS Accounts Ids or AWS Organizations Organizational Units. Default: - don't create or update any Stack Instances
        :param role: (experimental) The Role in which context's this Action will be executing in. The Pipeline's Role will assume this Role (the required permissions for that will be granted automatically) right before executing this Action. This Action will be passed into your {@link IAction.bind} method in the {@link ActionBindOptions.role} property. Default: a new Role will be generated
        :param failure_tolerance_percentage: (experimental) The percentage of accounts per Region for which this stack operation can fail before AWS CloudFormation stops the operation in that Region. If the operation is stopped in a Region, AWS CloudFormation doesn't attempt the operation in subsequent Regions. When calculating the number of accounts based on the specified percentage, AWS CloudFormation rounds down to the next whole number. Default: 0%
        :param max_account_concurrency_percentage: (experimental) The maximum percentage of accounts in which to perform this operation at one time. When calculating the number of accounts based on the specified percentage, AWS CloudFormation rounds down to the next whole number. If rounding down would result in zero, AWS CloudFormation sets the number as one instead. Although you use this setting to specify the maximum, for large deployments the actual number of accounts acted upon concurrently may be lower due to service throttling. Default: 1%
        :param stack_set_region: (experimental) The AWS Region the StackSet is in. Note that a cross-region Pipeline requires replication buckets to function correctly. You can provide their names with the ``PipelineProps.crossRegionReplicationBuckets`` property. If you don't, the CodePipeline Construct will create new Stacks in your CDK app containing those buckets, that you will need to ``cdk deploy`` before deploying the main, Pipeline-containing Stack. Default: - same region as the Pipeline
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationDeployStackSetAction._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class CloudFormationExecuteChangeSetAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationExecuteChangeSetAction._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class CloudFormationExecuteChangeSetActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationExecuteChangeSetActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class CodeBuildAction(
    ...
    def __init__(
        ...
        *,
        ...
        environment_variables: typing.Optional[typing.Mapping[builtins.str, typing.Union[_BuildEnvironmentVariable_00095c97, typing.Dict[str, typing.Any]]]] = None,
        ...
        :param combine_batch_build_artifacts: (experimental) Combine the build artifacts for a batch builds. Enabling this will combine the build artifacts into the same location for batch builds. If ``executeBatchBuild`` is not set to ``true``, this property is ignored. Default: false
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeBuildAction._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
    ...
    def variable(self, variable_name: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeBuildAction.variable)
...
class CodeBuildActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeBuildActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
    ...
    def combine_batch_build_artifacts(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Combine the build artifacts for a batch builds.
...
class CodeCommitSourceAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeCommitSourceAction._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class CodeCommitSourceActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeCommitSourceActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class CodeCommitSourceVariables:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeCommitSourceVariables.__init__)
...
class CodeDeployEcsContainerImageInput:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeDeployEcsContainerImageInput.__init__)
            check_type(argname="argument input", value=input, expected_type=type_hints["input"])
...
class CodeDeployEcsDeployAction(
    ...
    def __init__(
        ...
        *,
        ...
        container_image_inputs: typing.Optional[typing.Sequence[typing.Union[CodeDeployEcsContainerImageInput, typing.Dict[str, typing.Any]]]] = None,
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeDeployEcsDeployAction._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class CodeDeployEcsDeployActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeDeployEcsDeployActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class CodeDeployServerDeployAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeDeployServerDeployAction._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class CodeDeployServerDeployActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeDeployServerDeployActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class CodeStarConnectionsSourceAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeStarConnectionsSourceAction._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class CodeStarConnectionsSourceActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeStarConnectionsSourceActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
@jsii.data_type(
    jsii_type="monocdk.aws_codepipeline_actions.CodeStarSourceVariables",
    jsii_struct_bases=[],
    name_mapping={
        "author_date": "authorDate",
        "branch_name": "branchName",
...
class CodeStarSourceVariables:
    def __init__(
        ...
        *,
        ...
        '''(experimental) The CodePipeline variables emitted by CodeStar source Action.

        :param author_date: (experimental) The date the currently last commit on the tracked branch was authored, in ISO-8601 format.
        :param branch_name: (experimental) The name of the branch this action tracks.
        :param commit_id: (experimental) The SHA1 hash of the currently last commit on the tracked branch.
        :param commit_message: (experimental) The message of the currently last commit on the tracked branch.
        :param connection_arn: (experimental) The connection ARN this source uses.
        :param full_repository_name: (experimental) The name of the repository this action points to.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CodeStarSourceVariables.__init__)
            check_type(argname="argument author_date", value=author_date, expected_type=type_hints["author_date"])
            check_type(argname="argument branch_name", value=branch_name, expected_type=type_hints["branch_name"])
            check_type(argname="argument commit_id", value=commit_id, expected_type=type_hints["commit_id"])
            check_type(argname="argument commit_message", value=commit_message, expected_type=type_hints["commit_message"])
...
@jsii.data_type(
    jsii_type="monocdk.aws_codepipeline_actions.CommonCloudFormationStackSetOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class CommonCloudFormationStackSetOptions:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Options in common between both StackSet actions.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CommonCloudFormationStackSetOptions.__init__)
...
class EcrSourceAction(
    ...
    def __init__(
        ...
        *,
        ...
        :param image_tag: (experimental) The image tag that will be checked for changes. Provide an empty string to trigger on changes to any tag. Default: 'latest'
        :param role: (experimental) The Role in which context's this Action will be executing in. The Pipeline's Role will assume this Role (the required permissions for that will be granted automatically) right before executing this Action. This Action will be passed into your {@link IAction.bind} method in the {@link ActionBindOptions.role} property. Default: a new Role will be generated
        :param action_name: (experimental) The physical, human-readable name of the Action. Note that Action names must be unique within a single Stage.
        :param run_order: (experimental) The runOrder property for this Action. RunOrder determines the relative order in which multiple Actions in the same Stage execute. Default: 1
        :param variables_namespace: (experimental) The name of the namespace to use for variables emitted by this action. Default: - a name will be generated, based on the stage and action names, if any of the action's variables were referenced - otherwise, no namespace will be set
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcrSourceAction._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class EcrSourceActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcrSourceActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class EcrSourceVariables:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcrSourceVariables.__init__)
...
class EcsDeployAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsDeployAction._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class EcsDeployActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EcsDeployActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class GitHubSourceAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubSourceAction._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        _options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class GitHubSourceActionProps(_CommonActionProps_4f0e79c2):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubSourceActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
...
class GitHubSourceVariables:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitHubSourceVariables.__init__)
            check_type(argname="argument author_date", value=author_date, expected_type=type_hints["author_date"])
            check_type(argname="argument branch_name", value=branch_name, expected_type=type_hints["branch_name"])
            check_type(argname="argument commit_id", value=commit_id, expected_type=type_hints["commit_id"])
            check_type(argname="argument commit_message", value=commit_message, expected_type=type_hints["commit_message"])
...
class JenkinsAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JenkinsAction._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        _options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class JenkinsActionProps(_CommonActionProps_4f0e79c2):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JenkinsActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
...
class JenkinsProviderAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JenkinsProviderAttributes.__init__)
...
class JenkinsProviderProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JenkinsProviderProps.__init__)
            check_type(argname="argument provider_name", value=provider_name, expected_type=type_hints["provider_name"])
            check_type(argname="argument server_url", value=server_url, expected_type=type_hints["server_url"])
...
class LambdaInvokeAction(
    ...
    def __init__(
        ...
        *,
        ...
        :param user_parameters: (experimental) A set of key-value pairs that will be accessible to the invoked Lambda inside the event that the Pipeline will call it with. Only one of ``userParameters`` or ``userParametersString`` can be specified. Default: - no user parameters will be passed
        :param user_parameters_string: (experimental) The string representation of the user parameters that will be accessible to the invoked Lambda inside the event that the Pipeline will call it with. Only one of ``userParametersString`` or ``userParameters`` can be specified. Default: - no user parameters will be passed
        :param role: (experimental) The Role in which context's this Action will be executing in. The Pipeline's Role will assume this Role (the required permissions for that will be granted automatically) right before executing this Action. This Action will be passed into your {@link IAction.bind} method in the {@link ActionBindOptions.role} property. Default: a new Role will be generated
        :param action_name: (experimental) The physical, human-readable name of the Action. Note that Action names must be unique within a single Stage.
        :param run_order: (experimental) The runOrder property for this Action. RunOrder determines the relative order in which multiple Actions in the same Stage execute. Default: 1
        :param variables_namespace: (experimental) The name of the namespace to use for variables emitted by this action. Default: - a name will be generated, based on the stage and action names, if any of the action's variables were referenced - otherwise, no namespace will be set
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaInvokeAction._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
    ...
    def variable(self, variable_name: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaInvokeAction.variable)
            check_type(argname="argument variable_name", value=variable_name, expected_type=type_hints["variable_name"])
        return typing.cast(builtins.str, jsii.invoke(self, "variable", [variable_name]))
...
class LambdaInvokeActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaInvokeActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
    ...
    def user_parameters_string(self) -> typing.Optional[builtins.str]:
        '''(experimental) The string representation of the user parameters that will be accessible to the invoked Lambda inside the event that the Pipeline will call it with.
...
class ManualApprovalAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManualApprovalAction._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
    ...
    def grant_manual_approval(self, grantable: _IGrantable_4c5a91d1) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManualApprovalAction.grant_manual_approval)
...
class ManualApprovalActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManualApprovalActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
@jsii.data_type(
    jsii_type="monocdk.aws_codepipeline_actions.OrganizationsDeploymentProps",
    jsii_struct_bases=[],
...
class OrganizationsDeploymentProps:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Properties for configuring service-managed (Organizations) permissions.

        :param auto_deployment: (experimental) Automatically deploy to new accounts added to Organizational Units. Whether AWS CloudFormation StackSets automatically deploys to AWS Organizations accounts that are added to a target organization or organizational unit (OU). Default: Disabled
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OrganizationsDeploymentProps.__init__)
    ...
    def auto_deployment(self) -> typing.Optional["StackSetOrganizationsAutoDeployment"]:
        '''(experimental) Automatically deploy to new accounts added to Organizational Units.
...
class S3DeployAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3DeployAction._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class S3DeployActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3DeployActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class S3SourceAction(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param bucket: (experimental) The Amazon S3 bucket that stores the source code. If you import an encrypted bucket in your stack, please specify the encryption key at import time by using ``Bucket.fromBucketAttributes()`` method.
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3SourceAction._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class S3SourceActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3SourceActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class S3SourceVariables:
    def __init__(self, *, e_tag: builtins.str, version_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3SourceVariables.__init__)
...
@jsii.data_type(
    jsii_type="monocdk.aws_codepipeline_actions.SelfManagedDeploymentProps",
    jsii_struct_bases=[],
    name_mapping={
...
class SelfManagedDeploymentProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SelfManagedDeploymentProps.__init__)
    ...
    @builtins.property
    def administration_role(self) -> typing.Optional[_IRole_59af6f50]:
        '''(experimental) The IAM role in the administrator account used to assume execution roles in the target accounts.
    ...
    def execution_role_name(self) -> typing.Optional[builtins.str]:
        '''(experimental) The name of the IAM role in the target accounts used to perform stack set operations.
    ...
    **Note**: this class is still experimental, and may have breaking changes in the future!
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServiceCatalogDeployActionBeta1._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class ServiceCatalogDeployActionBeta1Props(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServiceCatalogDeployActionBeta1Props.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class StackInstances(
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="monocdk.aws_codepipeline_actions.StackInstances",
):
    '''(experimental) Where Stack Instances will be created from the StackSet.
    ...
    def from_artifact_path(
        cls,
        artifact_path: _ArtifactPath_a5b79113,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StackInstances.from_artifact_path)
    ...
    def in_accounts(
        ...
        '''(experimental) Create stack instances in a set of accounts and regions passed as literal lists.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StackInstances.in_accounts)
    ...
    def in_organizational_units(
        ...
        '''(experimental) Create stack instances in all accounts in a set of Organizational Units (OUs) and regions passed as literal lists.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StackInstances.in_organizational_units)
...
class StackSetDeploymentModel(
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="monocdk.aws_codepipeline_actions.StackSetDeploymentModel",
):
    ...
    def organizations(
        ...
        *,
        ...
        '''(experimental) Deploy to AWS Organizations accounts.
    ...
    def self_managed(
        ...
        *,
        ...
        '''(experimental) Deploy to AWS Accounts not managed by AWS Organizations.
...
@jsii.enum(
    jsii_type="monocdk.aws_codepipeline_actions.StackSetOrganizationsAutoDeployment"
)
class StackSetOrganizationsAutoDeployment(enum.Enum):
    '''(experimental) Describes whether AWS CloudFormation StackSets automatically deploys to AWS Organizations accounts that are added to a target organization or organizational unit (OU).

    :stability: experimental
    '''

    ENABLED = "ENABLED"
    '''(experimental) StackSets automatically deploys additional stack instances to AWS Organizations accounts that are added to a target organization or organizational unit (OU) in the specified Regions.
    ...
    '''
    DISABLED = "DISABLED"
    '''(experimental) StackSets does not automatically deploy additional stack instances to AWS Organizations accounts that are added to a target organization or organizational unit (OU) in the specified Regions.

    :stability: experimental
    '''
    ENABLED_WITH_STACK_RETENTION = "ENABLED_WITH_STACK_RETENTION"
    '''(experimental) Stack resources are retained when an account is removed from a target organization or OU.
...
class StackSetParameters(
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="monocdk.aws_codepipeline_actions.StackSetParameters",
):
    '''(experimental) Base parameters for the StackSet.
    ...
    def from_artifact_path(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StackSetParameters.from_artifact_path)
            check_type(argname="argument artifact_path", value=artifact_path, expected_type=type_hints["artifact_path"])
    ...
    def from_literal(
        ...
        '''(experimental) A list of template parameters for your stack set.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StackSetParameters.from_literal)
...
class StackSetTemplate(
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="monocdk.aws_codepipeline_actions.StackSetTemplate",
):
    '''(experimental) The source of a StackSet template.
    ...
    def from_artifact_path(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StackSetTemplate.from_artifact_path)
            check_type(argname="argument artifact_path", value=artifact_path, expected_type=type_hints["artifact_path"])
...
class StateMachineInput(
    ...
    def file_path(cls, input_file: _ArtifactPath_a5b79113) -> "StateMachineInput":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StateMachineInput.file_path)
    ...
    def literal(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StateMachineInput.literal)
...
class StepFunctionInvokeAction(
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StepFunctionInvokeAction._bound)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
            check_type(argname="argument _stage", value=_stage, expected_type=type_hints["_stage"])
        options = _ActionBindOptions_20e0a317(bucket=bucket, role=role)
...
class StepFunctionsInvokeActionProps(_CommonAwsActionProps_1494edc0):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StepFunctionsInvokeActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class BaseJenkinsProvider(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseJenkinsProvider.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class BitBucketSourceActionProps(CodeStarConnectionsSourceActionProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BitBucketSourceActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
@jsii.data_type(
    jsii_type="monocdk.aws_codepipeline_actions.CloudFormationDeployStackInstancesActionProps",
    jsii_struct_bases=[
        _CommonAwsActionProps_1494edc0, CommonCloudFormationStackSetOptions
    ],
    name_mapping={
        "action_name": "actionName",
        "run_order": "runOrder",
...
class CloudFormationDeployStackInstancesActionProps(
    _CommonAwsActionProps_1494edc0,
    ...
    def __init__(
        ...
        *,
        ...
        '''(experimental) Properties for the CloudFormationDeployStackInstancesAction.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationDeployStackInstancesActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
    ...
    def stack_set_name(self) -> builtins.str:
        '''(experimental) The name of the StackSet we are adding instances to.
    ...
    def parameter_overrides(self) -> typing.Optional[StackSetParameters]:
        '''(experimental) Parameter values that only apply to the current Stack Instances.
...
@jsii.data_type(
    jsii_type="monocdk.aws_codepipeline_actions.CloudFormationDeployStackSetActionProps",
    jsii_struct_bases=[
        _CommonAwsActionProps_1494edc0, CommonCloudFormationStackSetOptions
    ],
    name_mapping={
...
class CloudFormationDeployStackSetActionProps(
    ...
    def __init__(
        ...
        *,
        ...
        '''(experimental) Properties for the CloudFormationDeployStackSetAction.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudFormationDeployStackSetActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class JenkinsProvider(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JenkinsProvider.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_jenkins_provider_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JenkinsProvider.from_jenkins_provider_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
