...
class CfnTopic(
    ...
    def __init__(
        ...
        *,
        ...
        subscription: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnTopic.SubscriptionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
