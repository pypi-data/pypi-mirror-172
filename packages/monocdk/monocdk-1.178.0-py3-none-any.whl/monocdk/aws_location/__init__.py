...
class CfnMap(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        configuration: typing.Union[typing.Union["CfnMap.MapConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
...
class CfnPlaceIndex(
    ...
    def __init__(
        ...
        *,
        ...
        data_source_configuration: typing.Optional[typing.Union[typing.Union["CfnPlaceIndex.DataSourceConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        description: typing.Optional[builtins.str] = None,
        pricing_plan: typing.Optional[builtins.str] = None,
    ) -> None:
