...
cloudfront.Distribution(self, "myDist",
    default_behavior=apigateway.aws_cloudfront.BehaviorOptions(origin=origins.S3Origin(my_bucket))
)
```
...
```python
cloudfront.Distribution(self, "myDist",
    default_behavior=apigateway.aws_cloudfront.BehaviorOptions(origin=origins.HttpOrigin("www.example.com"))
)
```
...
my_bucket = s3.Bucket(self, "myBucket")
cloudfront.Distribution(self, "myDist",
    default_behavior=apigateway.aws_cloudfront.BehaviorOptions(
...
cloudfront.Distribution(self, "Distribution",
    default_behavior=apigateway.aws_cloudfront.BehaviorOptions(origin=origins.RestApiOrigin(api))
)
```
...
from ..aws_cloudfront import (
    ...
    OriginOptions as _OriginOptions_5ac8a405,
...
class HttpOrigin(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HttpOrigin.__init__)
...
class HttpOriginProps(_OriginProps_d402b2f3):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HttpOriginProps.__init__)
...
class LoadBalancerV2Origin(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LoadBalancerV2Origin.__init__)
...
class LoadBalancerV2OriginProps(HttpOriginProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LoadBalancerV2OriginProps.__init__)
            check_type(argname="argument connection_attempts", value=connection_attempts, expected_type=type_hints["connection_attempts"])
            check_type(argname="argument connection_timeout", value=connection_timeout, expected_type=type_hints["connection_timeout"])
            check_type(argname="argument custom_headers", value=custom_headers, expected_type=type_hints["custom_headers"])
            check_type(argname="argument origin_shield_region", value=origin_shield_region, expected_type=type_hints["origin_shield_region"])
...
class OriginGroup(
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OriginGroup.bind)
...
class OriginGroupProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OriginGroupProps.__init__)
...
class RestApiOrigin(
    _OriginBase_41a5d89d,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk.aws_cloudfront_origins.RestApiOrigin",
):
    '''(experimental) An Origin for an API Gateway REST API.
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RestApiOrigin.__init__)
...
@jsii.data_type(
    jsii_type="monocdk.aws_cloudfront_origins.RestApiOriginProps",
    jsii_struct_bases=[_OriginOptions_5ac8a405],
    name_mapping={
        "connection_attempts": "connectionAttempts",
        "connection_timeout": "connectionTimeout",
        "custom_headers": "customHeaders",
...
class RestApiOriginProps(_OriginOptions_5ac8a405):
    def __init__(
        self,
        *,
        connection_attempts: typing.Optional[jsii.Number] = None,
        ...
        '''(experimental) Properties for an Origin for an API Gateway REST API.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RestApiOriginProps.__init__)
            check_type(argname="argument connection_attempts", value=connection_attempts, expected_type=type_hints["connection_attempts"])
            check_type(argname="argument connection_timeout", value=connection_timeout, expected_type=type_hints["connection_timeout"])
            check_type(argname="argument custom_headers", value=custom_headers, expected_type=type_hints["custom_headers"])
            check_type(argname="argument origin_shield_region", value=origin_shield_region, expected_type=type_hints["origin_shield_region"])
...
class S3Origin(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3Origin.__init__)
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3Origin.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        options = _OriginBindOptions_15a2501d(origin_id=origin_id)
...
class S3OriginProps(_OriginProps_d402b2f3):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3OriginProps.__init__)
            check_type(argname="argument connection_attempts", value=connection_attempts, expected_type=type_hints["connection_attempts"])
            check_type(argname="argument connection_timeout", value=connection_timeout, expected_type=type_hints["connection_timeout"])
            check_type(argname="argument custom_headers", value=custom_headers, expected_type=type_hints["custom_headers"])
            check_type(argname="argument origin_shield_region", value=origin_shield_region, expected_type=type_hints["origin_shield_region"])
