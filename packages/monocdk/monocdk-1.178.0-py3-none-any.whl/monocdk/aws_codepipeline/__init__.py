...
pipeline = codepipeline.Pipeline(self, "MyFirstPipeline",
    stages=[codepipeline.aws_codepipeline.StageProps(
        stage_name="Source",
        actions=[]
    )
    ]
...
some_stage = pipeline.add_stage(
    ...
    placement=codepipeline.aws_codepipeline.StagePlacement(
...
codepipeline.CustomActionRegistration(self, "GenericGitSourceProviderResource",
    ...
    artifact_bounds=codepipeline.aws_codepipeline.ActionArtifactBounds(min_inputs=0, max_inputs=0, min_outputs=1, max_outputs=1),
    ...
    action_properties=[codepipeline.aws_codepipeline.CustomActionProperty(
        name="Branch",
        required=True,
        key=False,
        secret=False,
        ...
        type="String"
    ), codepipeline.aws_codepipeline.CustomActionProperty(
        name="GitUrl",
        required=True,
        key=False,
        secret=False,
...
class ActionArtifactBounds:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ActionArtifactBounds.__init__)
...
class ActionProperties:
    def __init__(
        ...
        *,
        ...
        artifact_bounds: typing.Union[ActionArtifactBounds, typing.Dict[str, typing.Any]],
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ActionProperties.__init__)
...
class Artifact(metaclass=jsii.JSIIMeta, jsii_type="monocdk.aws_codepipeline.Artifact"):
    ...
    def __init__(self, artifact_name: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Artifact.__init__)
    ...
    def artifact(cls, name: builtins.str) -> "Artifact":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Artifact.artifact)
    ...
    def at_path(self, file_name: builtins.str) -> "ArtifactPath":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Artifact.at_path)
    ...
    def get_metadata(self, key: builtins.str) -> typing.Any:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Artifact.get_metadata)
    ...
    def get_param(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Artifact.get_param)
    ...
    def set_metadata(self, key: builtins.str, value: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Artifact.set_metadata)
            check_type(argname="argument key", value=key, expected_type=type_hints["key"])
...
class ArtifactPath(
    ...
    def __init__(self, artifact: Artifact, file_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ArtifactPath.__init__)
    ...
    def artifact_path(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ArtifactPath.artifact_path)
            check_type(argname="argument artifact_name", value=artifact_name, expected_type=type_hints["artifact_name"])
            check_type(argname="argument file_name", value=file_name, expected_type=type_hints["file_name"])
...
class CfnCustomActionType(
    ...
    def __init__(
        ...
        *,
        ...
        input_artifact_details: typing.Union[typing.Union["CfnCustomActionType.ArtifactDetailsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        output_artifact_details: typing.Union[typing.Union["CfnCustomActionType.ArtifactDetailsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        provider: builtins.str,
        version: builtins.str,
        configuration_properties: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnCustomActionType.ConfigurationPropertiesProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        settings: typing.Optional[typing.Union[typing.Union["CfnCustomActionType.SettingsProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnCustomActionType.__init__)
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnCustomActionType.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnCustomActionType._render_properties)
    ...
    def category(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnCustomActionType, "category").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def input_artifact_details(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnCustomActionType, "input_artifact_details").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def output_artifact_details(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnCustomActionType, "output_artifact_details").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def provider(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnCustomActionType, "provider").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def version(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnCustomActionType, "version").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def configuration_properties(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnCustomActionType, "configuration_properties").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def settings(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnCustomActionType, "settings").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class ArtifactDetailsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnCustomActionType.ArtifactDetailsProperty.__init__)
    ...
    class ConfigurationPropertiesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnCustomActionType.ConfigurationPropertiesProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    class SettingsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnCustomActionType.SettingsProperty.__init__)
...
class CfnCustomActionTypeProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnCustomActionTypeProps.__init__)
            check_type(argname="argument category", value=category, expected_type=type_hints["category"])
...
class CfnPipeline(
    ...
    def __init__(
        ...
        *,
        ...
        stages: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnPipeline.StageDeclarationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        artifact_store: typing.Optional[typing.Union[typing.Union["CfnPipeline.ArtifactStoreProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        artifact_stores: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnPipeline.ArtifactStoreMapProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        disable_inbound_stage_transitions: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnPipeline.StageTransitionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ...
    def role_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPipeline, "role_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def stages(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPipeline, "stages").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def artifact_store(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPipeline, "artifact_store").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def artifact_stores(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPipeline, "artifact_stores").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def disable_inbound_stage_transitions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPipeline, "disable_inbound_stage_transitions").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPipeline, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def restart_execution_on_update(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPipeline, "restart_execution_on_update").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class ActionDeclarationProperty:
        def __init__(
            self,
            *,
            action_type_id: typing.Union[typing.Union["CfnPipeline.ActionTypeIdProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
            name: builtins.str,
            configuration: typing.Any = None,
            input_artifacts: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnPipeline.InputArtifactProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
            namespace: typing.Optional[builtins.str] = None,
            output_artifacts: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnPipeline.OutputArtifactProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
            region: typing.Optional[builtins.str] = None,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnPipeline.ActionDeclarationProperty.__init__)
    ...
    class ActionTypeIdProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnPipeline.ActionTypeIdProperty.__init__)
                check_type(argname="argument category", value=category, expected_type=type_hints["category"])
                check_type(argname="argument owner", value=owner, expected_type=type_hints["owner"])
                check_type(argname="argument provider", value=provider, expected_type=type_hints["provider"])
                check_type(argname="argument version", value=version, expected_type=type_hints["version"])
    ...
    class ArtifactStoreMapProperty:
        def __init__(
            self,
            *,
            artifact_store: typing.Union[typing.Union["CfnPipeline.ArtifactStoreProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
            region: builtins.str,
        ) -> None:
            '''A mapping of ``artifactStore`` objects and their corresponding AWS Regions.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnPipeline.ArtifactStoreMapProperty.__init__)
    ...
    class ArtifactStoreProperty:
        def __init__(
            ...
            *,
            ...
            type: builtins.str,
            encryption_key: typing.Optional[typing.Union[typing.Union["CfnPipeline.EncryptionKeyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''The S3 bucket where artifacts for the pipeline are stored.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnPipeline.ArtifactStoreProperty.__init__)
    ...
    class BlockerDeclarationProperty:
        def __init__(self, *, name: builtins.str, type: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnPipeline.BlockerDeclarationProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
                check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            self._values: typing.Dict[str, typing.Any] = {
                "name": name,
    ...
    class EncryptionKeyProperty:
        def __init__(self, *, id: builtins.str, type: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnPipeline.EncryptionKeyProperty.__init__)
                check_type(argname="argument id", value=id, expected_type=type_hints["id"])
                check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            self._values: typing.Dict[str, typing.Any] = {
                "id": id,
    ...
    class InputArtifactProperty:
        def __init__(self, *, name: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnPipeline.InputArtifactProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            self._values: typing.Dict[str, typing.Any] = {
                "name": name,
            }
    ...
    class OutputArtifactProperty:
        def __init__(self, *, name: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnPipeline.OutputArtifactProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            self._values: typing.Dict[str, typing.Any] = {
                "name": name,
            }
    ...
    class StageDeclarationProperty:
        def __init__(
            self,
            *,
            actions: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnPipeline.ActionDeclarationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
            name: builtins.str,
            blockers: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnPipeline.BlockerDeclarationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            '''Represents information about a stage and its definition.
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnPipeline.StageDeclarationProperty.__init__)
    ...
    class StageTransitionProperty:
        def __init__(self, *, reason: builtins.str, stage_name: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnPipeline.StageTransitionProperty.__init__)
...
class CfnWebhook(
    ...
    def __init__(
        ...
        *,
        ...
        authentication_configuration: typing.Union[typing.Union["CfnWebhook.WebhookAuthConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        filters: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnWebhook.WebhookFilterRuleProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnWebhook.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnWebhook.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnWebhook._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def authentication(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWebhook, "authentication").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def authentication_configuration(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWebhook, "authentication_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def filters(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWebhook, "filters").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def target_action(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWebhook, "target_action").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def target_pipeline(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWebhook, "target_pipeline").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def target_pipeline_version(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWebhook, "target_pipeline_version").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWebhook, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "name", value)
    ...
    def register_with_third_party(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWebhook, "register_with_third_party").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class WebhookAuthConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnWebhook.WebhookAuthConfigurationProperty.__init__)
    ...
    class WebhookFilterRuleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnWebhook.WebhookFilterRuleProperty.__init__)
...
class CfnWebhookProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnWebhookProps.__init__)
...
class CommonActionProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CommonActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
        self._values: typing.Dict[str, typing.Any] = {
...
class CommonAwsActionProps(CommonActionProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CommonAwsActionProps.__init__)
            check_type(argname="argument action_name", value=action_name, expected_type=type_hints["action_name"])
            check_type(argname="argument run_order", value=run_order, expected_type=type_hints["run_order"])
            check_type(argname="argument variables_namespace", value=variables_namespace, expected_type=type_hints["variables_namespace"])
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
...
class CrossRegionSupport:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrossRegionSupport.__init__)
...
@jsii.data_type(
    jsii_type="monocdk.aws_codepipeline.CustomActionProperty",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
        "required": "required",
...
class CustomActionProperty:
    def __init__(
        ...
        *,
        ...
        '''(experimental) The creation attributes used for defining a configuration property of a custom Action.

        :param name: (experimental) The name of the property. You use this name in the ``configuration`` attribute when defining your custom Action class.
        :param required: (experimental) Whether this property is required.
        :param description: (experimental) The description of the property. Default: the description will be empty
        :param key: (experimental) Whether this property is a key. Default: false
        :param queryable: (experimental) Whether this property is queryable. Note that only a single property of a custom Action can be queryable. Default: false
        :param secret: (experimental) Whether this property is secret, like a password, or access key. Default: false
        :param type: (experimental) The type of the property, like 'String', 'Number', or 'Boolean'. Default: 'String'
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CustomActionProperty.__init__)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument required", value=required, expected_type=type_hints["required"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
            check_type(argname="argument key", value=key, expected_type=type_hints["key"])
...
class CustomActionRegistration(
    _Construct_e78e779f,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk.aws_codepipeline.CustomActionRegistration",
):
    ...
    def __init__(
        ...
        *,
        ...
        category: ActionCategory,
        provider: builtins.str,
        action_properties: typing.Optional[typing.Sequence[typing.Union[CustomActionProperty, typing.Dict[str, typing.Any]]]] = None,
        ...
        :param scope: -
        :param id: -
        :param artifact_bounds: (experimental) The artifact bounds of the Action.
        :param category: (experimental) The category of the Action.
        :param provider: (experimental) The provider of the Action. For example, ``'MyCustomActionProvider'``
        :param action_properties: (experimental) The properties used for customizing the instance of your Action. Default: []
        :param entity_url: (experimental) The URL shown for the entire Action in the Pipeline UI. Default: none
        :param execution_url: (experimental) The URL shown for a particular execution of an Action in the Pipeline UI. Default: none
        :param version: (experimental) The version of your Action. Default: '1'

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CustomActionRegistration.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
@jsii.data_type(
    jsii_type="monocdk.aws_codepipeline.CustomActionRegistrationProps",
    jsii_struct_bases=[],
    name_mapping={
        "artifact_bounds": "artifactBounds",
        "category": "category",
...
class CustomActionRegistrationProps:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Properties of registering a custom Action.
        ...
        if isinstance(artifact_bounds, dict):
            artifact_bounds = ActionArtifactBounds(**artifact_bounds)
        if __debug__:
            type_hints = typing.get_type_hints(CustomActionRegistrationProps.__init__)
            check_type(argname="argument artifact_bounds", value=artifact_bounds, expected_type=type_hints["artifact_bounds"])
            check_type(argname="argument category", value=category, expected_type=type_hints["category"])
            check_type(argname="argument provider", value=provider, expected_type=type_hints["provider"])
    ...
    @builtins.property
    def artifact_bounds(self) -> ActionArtifactBounds:
        '''(experimental) The artifact bounds of the Action.
    ...
    @builtins.property
    def provider(self) -> builtins.str:
        '''(experimental) The provider of the Action.
    ...
    def action_properties(self) -> typing.Optional[typing.List[CustomActionProperty]]:
        '''(experimental) The properties used for customizing the instance of your Action.
    ...
    def entity_url(self) -> typing.Optional[builtins.str]:
        '''(experimental) The URL shown for the entire Action in the Pipeline UI.
    ...
    def execution_url(self) -> typing.Optional[builtins.str]:
        '''(experimental) The URL shown for a particular execution of an Action in the Pipeline UI.
    ...
    @builtins.property
    def version(self) -> typing.Optional[builtins.str]:
        '''(experimental) The version of your Action.
...
class _IActionProxy:
    ...
    def on_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IAction.on_state_change)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
...
class IPipeline(
    ...
    def notify_on(
        ...
        *,
        ...
        :param events: (experimental) A list of event types associated with this notification rule for CodePipeline Pipeline. For a complete list of event types and IDs, see Notification concepts in the Developer Tools Console User Guide.
...
class _IPipelineProxy(
    ...
    def notify_on(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IPipeline.notify_on)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
    ...
    def notify_on_any_action_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IPipeline.notify_on_any_action_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        ...
        return typing.cast(_INotificationRule_e22254bb, jsii.invoke(self, "notifyOnAnyActionStateChange", [id, target, options]))
    ...
    def notify_on_any_manual_approval_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IPipeline.notify_on_any_manual_approval_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = _NotificationRuleOptions_8645c987(
            detail_type=detail_type,
        ...
        return typing.cast(_INotificationRule_e22254bb, jsii.invoke(self, "notifyOnAnyManualApprovalStateChange", [id, target, options]))
    ...
    def notify_on_any_stage_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IPipeline.notify_on_any_stage_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = _NotificationRuleOptions_8645c987(
            detail_type=detail_type,
        ...
        return typing.cast(_INotificationRule_e22254bb, jsii.invoke(self, "notifyOnAnyStageStateChange", [id, target, options]))
    ...
    def notify_on_execution_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IPipeline.notify_on_execution_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = _NotificationRuleOptions_8645c987(
            detail_type=detail_type,
        ...
        return typing.cast(_INotificationRule_e22254bb, jsii.invoke(self, "notifyOnExecutionStateChange", [id, target, options]))
    ...
    def on_event(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IPipeline.on_event)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def on_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IPipeline.on_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = _OnEventOptions_d5081088(
            description=description,
            event_pattern=event_pattern,
...
class _IStageProxy:
    ...
    def add_action(self, action: IAction) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IStage.add_action)
    ...
    def on_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IStage.on_state_change)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = _RuleProps_32051f01(
            description=description,
...
class Pipeline(
    ...
    def __init__(
        ...
        *,
        ...
        role: typing.Optional[_IRole_59af6f50] = None,
        stages: typing.Optional[typing.Sequence[typing.Union["StageProps", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
        ...
        :param enable_key_rotation: (experimental) Enable KMS key rotation for the generated KMS keys. By default KMS key rotation is disabled, but will add an additional $1/month for each year the key exists when enabled. Default: - false (key rotation is disabled)
    ...
    def from_pipeline_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.from_pipeline_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_stage(
        self,
        *,
        placement: typing.Optional[typing.Union["StagePlacement", typing.Dict[str, typing.Any]]] = None,
        ...
        :param transition_disabled_reason: (experimental) The reason for disabling transition to this stage. Only applicable if ``transitionToEnabled`` is set to ``false``. Default: 'Transition disabled'
        :param transition_to_enabled: (experimental) Whether to enable transition to this stage. Default: true
    ...
    def add_to_role_policy(self, statement: _PolicyStatement_296fe8a3) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.add_to_role_policy)
    ...
    def bind_as_notification_rule_source(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.bind_as_notification_rule_source)
    ...
    def notify_on(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.notify_on)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = PipelineNotifyOnOptions(
            events=events,
    ...
    def notify_on_any_action_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.notify_on_any_action_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = _NotificationRuleOptions_8645c987(
            detail_type=detail_type,
    ...
    def notify_on_any_manual_approval_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.notify_on_any_manual_approval_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = _NotificationRuleOptions_8645c987(
            detail_type=detail_type,
    ...
    def notify_on_any_stage_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.notify_on_any_stage_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = _NotificationRuleOptions_8645c987(
            detail_type=detail_type,
    ...
    def notify_on_execution_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.notify_on_execution_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = _NotificationRuleOptions_8645c987(
            detail_type=detail_type,
    ...
    def on_event(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.on_event)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = _OnEventOptions_d5081088(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.on_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = _OnEventOptions_d5081088(
            description=description,
            event_pattern=event_pattern,
    ...
    def stage(self, stage_name: builtins.str) -> IStage:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Pipeline.stage)
            check_type(argname="argument stage_name", value=stage_name, expected_type=type_hints["stage_name"])
...
@jsii.enum(jsii_type="monocdk.aws_codepipeline.PipelineNotificationEvents")
class PipelineNotificationEvents(enum.Enum):
    '''(experimental) The list of event types for AWS Codepipeline Pipeline.
    ...
    '''(experimental) Trigger notification when pipeline execution failed.

    :stability: experimental
    '''
    PIPELINE_EXECUTION_CANCELED = "PIPELINE_EXECUTION_CANCELED"
    '''(experimental) Trigger notification when pipeline execution canceled.

    :stability: experimental
    '''
    PIPELINE_EXECUTION_STARTED = "PIPELINE_EXECUTION_STARTED"
    '''(experimental) Trigger notification when pipeline execution started.

    :stability: experimental
    '''
    PIPELINE_EXECUTION_RESUMED = "PIPELINE_EXECUTION_RESUMED"
    '''(experimental) Trigger notification when pipeline execution resumed.

    :stability: experimental
    '''
    PIPELINE_EXECUTION_SUCCEEDED = "PIPELINE_EXECUTION_SUCCEEDED"
    '''(experimental) Trigger notification when pipeline execution succeeded.

    :stability: experimental
    '''
    PIPELINE_EXECUTION_SUPERSEDED = "PIPELINE_EXECUTION_SUPERSEDED"
    '''(experimental) Trigger notification when pipeline execution superseded.

    :stability: experimental
    '''
    STAGE_EXECUTION_STARTED = "STAGE_EXECUTION_STARTED"
    '''(experimental) Trigger notification when pipeline stage execution started.

    :stability: experimental
    '''
    STAGE_EXECUTION_SUCCEEDED = "STAGE_EXECUTION_SUCCEEDED"
    '''(experimental) Trigger notification when pipeline stage execution succeeded.

    :stability: experimental
    '''
    STAGE_EXECUTION_RESUMED = "STAGE_EXECUTION_RESUMED"
    '''(experimental) Trigger notification when pipeline stage execution resumed.

    :stability: experimental
    '''
    STAGE_EXECUTION_CANCELED = "STAGE_EXECUTION_CANCELED"
    '''(experimental) Trigger notification when pipeline stage execution canceled.

    :stability: experimental
    '''
    STAGE_EXECUTION_FAILED = "STAGE_EXECUTION_FAILED"
    '''(experimental) Trigger notification when pipeline stage execution failed.

    :stability: experimental
    '''
    ACTION_EXECUTION_SUCCEEDED = "ACTION_EXECUTION_SUCCEEDED"
    '''(experimental) Trigger notification when pipeline action execution succeeded.

    :stability: experimental
    '''
    ACTION_EXECUTION_FAILED = "ACTION_EXECUTION_FAILED"
    '''(experimental) Trigger notification when pipeline action execution failed.

    :stability: experimental
    '''
    ACTION_EXECUTION_CANCELED = "ACTION_EXECUTION_CANCELED"
    '''(experimental) Trigger notification when pipeline action execution canceled.

    :stability: experimental
    '''
    ACTION_EXECUTION_STARTED = "ACTION_EXECUTION_STARTED"
    '''(experimental) Trigger notification when pipeline action execution started.

    :stability: experimental
    '''
    MANUAL_APPROVAL_FAILED = "MANUAL_APPROVAL_FAILED"
    '''(experimental) Trigger notification when pipeline manual approval failed.

    :stability: experimental
    '''
    MANUAL_APPROVAL_NEEDED = "MANUAL_APPROVAL_NEEDED"
    '''(experimental) Trigger notification when pipeline manual approval needed.

    :stability: experimental
    '''
    MANUAL_APPROVAL_SUCCEEDED = "MANUAL_APPROVAL_SUCCEEDED"
    '''(experimental) Trigger notification when pipeline manual approval succeeded.
...
@jsii.data_type(
    jsii_type="monocdk.aws_codepipeline.PipelineNotifyOnOptions",
...
class PipelineNotifyOnOptions(_NotificationRuleOptions_8645c987):
    def __init__(
        self,
        *,
        detail_type: typing.Optional[_DetailType_50204ab4] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PipelineNotifyOnOptions.__init__)
    ...
    def events(self) -> typing.List[PipelineNotificationEvents]:
        '''(experimental) A list of event types associated with this notification rule for CodePipeline Pipeline.
...
class PipelineProps:
    ...
    def enable_key_rotation(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Enable KMS key rotation for the generated KMS keys.
...
class StagePlacement:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StagePlacement.__init__)
...
class StageProps:
    ...
    def transition_disabled_reason(self) -> typing.Optional[builtins.str]:
        '''(experimental) The reason for disabling transition to this stage.
    ...
    def transition_to_enabled(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Whether to enable transition to this stage.
...
class Action(
    ...
    jsii_type="monocdk.aws_codepipeline.Action",
):
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Action.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        options = ActionBindOptions(bucket=bucket, role=role)
    ...
    def on_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Action.on_state_change)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = _RuleProps_32051f01(
            description=description,
    ...
    def _variable_expression(self, variable_name: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Action._variable_expression)
...
class _ActionProxy(Action):
    ...
    def _bound(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Action._bound)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        options = ActionBindOptions(bucket=bucket, role=role)
