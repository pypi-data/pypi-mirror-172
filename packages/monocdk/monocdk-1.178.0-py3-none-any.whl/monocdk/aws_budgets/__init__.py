...
class CfnBudget(
    ...
    Example::
        ...
        from monocdk import aws_budgets as budgets
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        budget: typing.Union[typing.Union["CfnBudget.BudgetDataProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        notifications_with_subscribers: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnBudget.NotificationWithSubscribersProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnBudget.__init__)
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnBudget.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnBudget._render_properties)
    ...
    def budget(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBudget, "budget").fset)
    ...
    def notifications_with_subscribers(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBudget, "notifications_with_subscribers").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class BudgetDataProperty:
        def __init__(
            ...
            *,
            ...
            budget_limit: typing.Optional[typing.Union[typing.Union["CfnBudget.SpendProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            budget_name: typing.Optional[builtins.str] = None,
            cost_filters: typing.Any = None,
            cost_types: typing.Optional[typing.Union[typing.Union["CfnBudget.CostTypesProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            planned_budget_limits: typing.Any = None,
            time_period: typing.Optional[typing.Union[typing.Union["CfnBudget.TimePeriodProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudget.BudgetDataProperty.__init__)
    ...
    class CostTypesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudget.CostTypesProperty.__init__)
    ...
    class NotificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudget.NotificationProperty.__init__)
    ...
    class NotificationWithSubscribersProperty:
        def __init__(
            self,
            *,
            notification: typing.Union[typing.Union["CfnBudget.NotificationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
            subscribers: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnBudget.SubscriberProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudget.NotificationWithSubscribersProperty.__init__)
    ...
    class SpendProperty:
        def __init__(self, *, amount: jsii.Number, unit: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudget.SpendProperty.__init__)
    ...
    class SubscriberProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudget.SubscriberProperty.__init__)
    ...
    class TimePeriodProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudget.TimePeriodProperty.__init__)
...
class CfnBudgetProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnBudgetProps.__init__)
...
class CfnBudgetsAction(
    _CfnResource_e0a482dc,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk.aws_budgets.CfnBudgetsAction",
):
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        action_threshold: typing.Union[typing.Union["CfnBudgetsAction.ActionThresholdProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        action_type: builtins.str,
        budget_name: builtins.str,
        definition: typing.Union[typing.Union["CfnBudgetsAction.DefinitionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        execution_role_arn: builtins.str,
        notification_type: builtins.str,
        subscribers: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnBudgetsAction.SubscriberProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnBudgetsAction.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: _TreeInspector_1cd1894e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnBudgetsAction.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnBudgetsAction._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def action_threshold(
        self,
    ) -> typing.Union["CfnBudgetsAction.ActionThresholdProperty", _IResolvable_a771d0ef]:
        ...
        '''
        return typing.cast(typing.Union["CfnBudgetsAction.ActionThresholdProperty", _IResolvable_a771d0ef], jsii.get(self, "actionThreshold"))

    @action_threshold.setter
    def action_threshold(
        self,
        value: typing.Union["CfnBudgetsAction.ActionThresholdProperty", _IResolvable_a771d0ef],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBudgetsAction, "action_threshold").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def action_type(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBudgetsAction, "action_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def budget_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBudgetsAction, "budget_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def definition(
        self,
    ) -> typing.Union["CfnBudgetsAction.DefinitionProperty", _IResolvable_a771d0ef]:
        ...
        '''
        return typing.cast(typing.Union["CfnBudgetsAction.DefinitionProperty", _IResolvable_a771d0ef], jsii.get(self, "definition"))

    @definition.setter
    def definition(
        self,
        value: typing.Union["CfnBudgetsAction.DefinitionProperty", _IResolvable_a771d0ef],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBudgetsAction, "definition").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def execution_role_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBudgetsAction, "execution_role_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def notification_type(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBudgetsAction, "notification_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def subscribers(
        self,
    ) -> typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnBudgetsAction.SubscriberProperty", _IResolvable_a771d0ef]]]:
        ...
        '''
        return typing.cast(typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnBudgetsAction.SubscriberProperty", _IResolvable_a771d0ef]]], jsii.get(self, "subscribers"))

    @subscribers.setter
    def subscribers(
        self,
        value: typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnBudgetsAction.SubscriberProperty", _IResolvable_a771d0ef]]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBudgetsAction, "subscribers").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def approval_model(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBudgetsAction, "approval_model").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "approvalModel", value)

    @jsii.data_type(
        jsii_type="monocdk.aws_budgets.CfnBudgetsAction.ActionThresholdProperty",
        jsii_struct_bases=[],
    ...
    class ActionThresholdProperty:
        def __init__(self, *, type: builtins.str, value: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudgetsAction.ActionThresholdProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_budgets.CfnBudgetsAction.DefinitionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class DefinitionProperty:
        def __init__(
            self,
            *,
            iam_action_definition: typing.Optional[typing.Union[typing.Union["CfnBudgetsAction.IamActionDefinitionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            scp_action_definition: typing.Optional[typing.Union[typing.Union["CfnBudgetsAction.ScpActionDefinitionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
            ssm_action_definition: typing.Optional[typing.Union[typing.Union["CfnBudgetsAction.SsmActionDefinitionProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudgetsAction.DefinitionProperty.__init__)
        ...
        def iam_action_definition(
            self,
        ) -> typing.Optional[typing.Union["CfnBudgetsAction.IamActionDefinitionProperty", _IResolvable_a771d0ef]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnBudgetsAction.IamActionDefinitionProperty", _IResolvable_a771d0ef]], result)

        @builtins.property
        def scp_action_definition(
            self,
        ) -> typing.Optional[typing.Union["CfnBudgetsAction.ScpActionDefinitionProperty", _IResolvable_a771d0ef]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnBudgetsAction.ScpActionDefinitionProperty", _IResolvable_a771d0ef]], result)

        @builtins.property
        def ssm_action_definition(
            self,
        ) -> typing.Optional[typing.Union["CfnBudgetsAction.SsmActionDefinitionProperty", _IResolvable_a771d0ef]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnBudgetsAction.SsmActionDefinitionProperty", _IResolvable_a771d0ef]], result)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_budgets.CfnBudgetsAction.IamActionDefinitionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "policy_arn": "policyArn",
            "groups": "groups",
    ...
    class IamActionDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudgetsAction.IamActionDefinitionProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_budgets.CfnBudgetsAction.ScpActionDefinitionProperty",
        jsii_struct_bases=[],
    ...
    class ScpActionDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudgetsAction.ScpActionDefinitionProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_budgets.CfnBudgetsAction.SsmActionDefinitionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "instance_ids": "instanceIds",
            "region": "region",
    ...
    class SsmActionDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudgetsAction.SsmActionDefinitionProperty.__init__)
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_budgets.CfnBudgetsAction.SubscriberProperty",
        jsii_struct_bases=[],
    ...
    class SubscriberProperty:
        def __init__(self, *, address: builtins.str, type: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnBudgetsAction.SubscriberProperty.__init__)
                check_type(argname="argument address", value=address, expected_type=type_hints["address"])
                check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            self._values: typing.Dict[str, typing.Any] = {
                "address": address,
...
@jsii.data_type(
    jsii_type="monocdk.aws_budgets.CfnBudgetsActionProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnBudgetsActionProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnBudgetsActionProps.__init__)
    ...
    def action_threshold(
        ...
        return typing.cast(typing.Union[CfnBudgetsAction.ActionThresholdProperty, _IResolvable_a771d0ef], result)
    ...
    def definition(
        ...
        return typing.cast(typing.Union[CfnBudgetsAction.DefinitionProperty, _IResolvable_a771d0ef], result)
    ...
    def subscribers(
        ...
        result = self._values.get("subscribers")
        assert result is not None, "Required property 'subscribers' is missing"
        return typing.cast(typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union[CfnBudgetsAction.SubscriberProperty, _IResolvable_a771d0ef]]], result)
