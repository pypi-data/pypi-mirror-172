...
class ApiEventSource(
    ...
    def __init__(
        ...
        *,
        ...
        method_responses: typing.Optional[typing.Sequence[typing.Union[_MethodResponse_bb921d07, typing.Dict[str, typing.Any]]]] = None,
        ...
        request_validator_options: typing.Optional[typing.Union[_RequestValidatorOptions_b89e3f10, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
        :param method: -
        :param path: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiEventSource.__init__)
    ...
    def bind(self, target: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiEventSource.bind)
...
class BaseStreamEventSourceProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BaseStreamEventSourceProps.__init__)
...
class KafkaEventSourceProps(BaseStreamEventSourceProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(KafkaEventSourceProps.__init__)
            check_type(argname="argument starting_position", value=starting_position, expected_type=type_hints["starting_position"])
            check_type(argname="argument batch_size", value=batch_size, expected_type=type_hints["batch_size"])
            check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
            check_type(argname="argument max_batching_window", value=max_batching_window, expected_type=type_hints["max_batching_window"])
...
class ManagedKafkaEventSourceProps(KafkaEventSourceProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManagedKafkaEventSourceProps.__init__)
            check_type(argname="argument starting_position", value=starting_position, expected_type=type_hints["starting_position"])
            check_type(argname="argument batch_size", value=batch_size, expected_type=type_hints["batch_size"])
            check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
            check_type(argname="argument max_batching_window", value=max_batching_window, expected_type=type_hints["max_batching_window"])
...
class S3EventSource(
    ...
    def __init__(
        ...
        *,
        ...
        filters: typing.Optional[typing.Sequence[typing.Union[_NotificationKeyFilter_7f4bf31a, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        '''
        :param bucket: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3EventSource.__init__)
    ...
    def bind(self, target: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3EventSource.bind)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        return typing.cast(None, jsii.invoke(self, "bind", [target]))
...
class S3EventSourceProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3EventSourceProps.__init__)
...
class SelfManagedKafkaEventSourceProps(KafkaEventSourceProps):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SelfManagedKafkaEventSourceProps.__init__)
            check_type(argname="argument starting_position", value=starting_position, expected_type=type_hints["starting_position"])
            check_type(argname="argument batch_size", value=batch_size, expected_type=type_hints["batch_size"])
            check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
            check_type(argname="argument max_batching_window", value=max_batching_window, expected_type=type_hints["max_batching_window"])
...
class SnsDlq(
    ...
    def __init__(self, topic: _ITopic_465e36b9) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SnsDlq.__init__)
            check_type(argname="argument topic", value=topic, expected_type=type_hints["topic"])
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SnsDlq.bind)
...
class SnsEventSource(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SnsEventSource.__init__)
            check_type(argname="argument topic", value=topic, expected_type=type_hints["topic"])
    ...
    def bind(self, target: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SnsEventSource.bind)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        return typing.cast(None, jsii.invoke(self, "bind", [target]))
...
class SnsEventSourceProps(_LambdaSubscriptionProps_d5f9085e):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SnsEventSourceProps.__init__)
...
class SqsDlq(
    ...
    def __init__(self, queue: _IQueue_45a01ab4) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SqsDlq.__init__)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SqsDlq.bind)
            check_type(argname="argument _target", value=_target, expected_type=type_hints["_target"])
            check_type(argname="argument target_handler", value=target_handler, expected_type=type_hints["target_handler"])
        return typing.cast(_DlqDestinationConfig_563cae69, jsii.invoke(self, "bind", [_target, target_handler]))
...
class SqsEventSource(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SqsEventSource.__init__)
            check_type(argname="argument queue", value=queue, expected_type=type_hints["queue"])
    ...
    def bind(self, target: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SqsEventSource.bind)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        return typing.cast(None, jsii.invoke(self, "bind", [target]))
...
class SqsEventSourceProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SqsEventSourceProps.__init__)
            check_type(argname="argument batch_size", value=batch_size, expected_type=type_hints["batch_size"])
            check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
            check_type(argname="argument max_batching_window", value=max_batching_window, expected_type=type_hints["max_batching_window"])
...
class StreamEventSource(
    ...
    def _enrich_mapping_options(
        ...
        *,
        ...
        report_batch_item_failures: typing.Optional[builtins.bool] = None,
        retry_attempts: typing.Optional[jsii.Number] = None,
        source_access_configurations: typing.Optional[typing.Sequence[typing.Union[_SourceAccessConfiguration_afc347bf, typing.Dict[str, typing.Any]]]] = None,
...
class _StreamEventSourceProxy(StreamEventSource):
    ...
    def bind(self, _target: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StreamEventSource.bind)
            check_type(argname="argument _target", value=_target, expected_type=type_hints["_target"])
...
class StreamEventSourceProps(BaseStreamEventSourceProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StreamEventSourceProps.__init__)
            check_type(argname="argument starting_position", value=starting_position, expected_type=type_hints["starting_position"])
            check_type(argname="argument batch_size", value=batch_size, expected_type=type_hints["batch_size"])
            check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
            check_type(argname="argument max_batching_window", value=max_batching_window, expected_type=type_hints["max_batching_window"])
...
class DynamoEventSource(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DynamoEventSource.__init__)
    ...
    def bind(self, target: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DynamoEventSource.bind)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        return typing.cast(None, jsii.invoke(self, "bind", [target]))
...
class DynamoEventSourceProps(StreamEventSourceProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DynamoEventSourceProps.__init__)
            check_type(argname="argument starting_position", value=starting_position, expected_type=type_hints["starting_position"])
            check_type(argname="argument batch_size", value=batch_size, expected_type=type_hints["batch_size"])
            check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
            check_type(argname="argument max_batching_window", value=max_batching_window, expected_type=type_hints["max_batching_window"])
...
class KinesisEventSource(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(KinesisEventSource.__init__)
    ...
    def bind(self, target: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(KinesisEventSource.bind)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        return typing.cast(None, jsii.invoke(self, "bind", [target]))
...
class KinesisEventSourceProps(StreamEventSourceProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(KinesisEventSourceProps.__init__)
            check_type(argname="argument starting_position", value=starting_position, expected_type=type_hints["starting_position"])
            check_type(argname="argument batch_size", value=batch_size, expected_type=type_hints["batch_size"])
            check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
            check_type(argname="argument max_batching_window", value=max_batching_window, expected_type=type_hints["max_batching_window"])
...
class ManagedKafkaEventSource(
    ...
    def bind(self, target: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManagedKafkaEventSource.bind)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        return typing.cast(None, jsii.invoke(self, "bind", [target]))
...
class SelfManagedKafkaEventSource(
    ...
    def bind(self, target: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SelfManagedKafkaEventSource.bind)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        return typing.cast(None, jsii.invoke(self, "bind", [target]))
