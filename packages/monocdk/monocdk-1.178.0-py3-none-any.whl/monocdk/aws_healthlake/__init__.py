...
class CfnFHIRDatastore(
    ...
    def __init__(
        ...
        *,
        ...
        preload_data_config: typing.Optional[typing.Union[typing.Union["CfnFHIRDatastore.PreloadDataConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        sse_configuration: typing.Optional[typing.Union[typing.Union["CfnFHIRDatastore.SseConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ...
    class SseConfigurationProperty:
        def __init__(
            self,
            *,
            kms_encryption_config: typing.Union[typing.Union["CfnFHIRDatastore.KmsEncryptionConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
        ) -> None:
