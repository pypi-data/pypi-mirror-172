...
parent_template = cfn_inc.CfnInclude(self, "ParentStack",
    ...
    load_nested_stacks={
        "ChildStack": core.cloudformation_include.CfnIncludeProps(
...
class CfnInclude(
    ...
    def __init__(
        ...
        *,
        ...
        load_nested_stacks: typing.Optional[typing.Mapping[builtins.str, typing.Union["CfnIncludeProps", typing.Dict[str, typing.Any]]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInclude.__init__)
    ...
    def get_condition(self, condition_name: builtins.str) -> _CfnCondition_79795035:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInclude.get_condition)
    ...
    def get_hook(self, hook_logical_id: builtins.str) -> _CfnHook_02bf9fbf:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInclude.get_hook)
    ...
    def get_mapping(self, mapping_name: builtins.str) -> _CfnMapping_40a28af7:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInclude.get_mapping)
    ...
    def get_nested_stack(self, logical_id: builtins.str) -> "IncludedNestedStack":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInclude.get_nested_stack)
    ...
    def get_output(self, logical_id: builtins.str) -> _CfnOutput_a4d857a8:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInclude.get_output)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
    ...
    def get_parameter(self, parameter_name: builtins.str) -> _CfnParameter_3e6f99ac:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInclude.get_parameter)
    ...
    def get_resource(self, logical_id: builtins.str) -> _CfnResource_e0a482dc:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInclude.get_resource)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
    ...
    def get_rule(self, rule_name: builtins.str) -> _CfnRule_c48d2c85:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInclude.get_rule)
    ...
    def load_nested_stack(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInclude.load_nested_stack)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
...
class CfnIncludeProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnIncludeProps.__init__)
...
class IncludedNestedStack:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IncludedNestedStack.__init__)
