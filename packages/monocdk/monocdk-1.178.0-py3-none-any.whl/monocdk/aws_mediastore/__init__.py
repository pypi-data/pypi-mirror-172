...
class CfnContainer(
    ...
    Example::
        ...
        from monocdk import aws_mediastore as mediastore
    ...
    def __init__(
        ...
        *,
        ...
        cors_policy: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnContainer.CorsRuleProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        lifecycle_policy: typing.Optional[builtins.str] = None,
        metric_policy: typing.Optional[typing.Union[typing.Union["CfnContainer.MetricPolicyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ...
    def container_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContainer, "container_name").fset)
    ...
    def access_logging_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContainer, "access_logging_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def cors_policy(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContainer, "cors_policy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def lifecycle_policy(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContainer, "lifecycle_policy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def metric_policy(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContainer, "metric_policy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def policy(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContainer, "policy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class CorsRuleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnContainer.CorsRuleProperty.__init__)
    ...
    class MetricPolicyProperty:
        def __init__(
            ...
            *,
            ...
            metric_policy_rules: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnContainer.MetricPolicyRuleProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnContainer.MetricPolicyProperty.__init__)
    ...
    class MetricPolicyRuleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnContainer.MetricPolicyRuleProperty.__init__)
