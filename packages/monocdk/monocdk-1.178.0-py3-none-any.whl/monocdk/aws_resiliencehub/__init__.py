...
class CfnApp(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        resource_mappings: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnApp.ResourceMappingProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
    ...
    class ResourceMappingProperty:
        def __init__(
            ...
            *,
            ...
            physical_resource_id: typing.Union[typing.Union["CfnApp.PhysicalResourceIdProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef],
...
class CfnResiliencyPolicy(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        policy: typing.Union[_IResolvable_a771d0ef, typing.Mapping[builtins.str, typing.Union[typing.Union["CfnResiliencyPolicy.FailurePolicyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]],
