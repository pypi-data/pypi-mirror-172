...
class CfnServer(
    ...
    def __init__(
        ...
        *,
        ...
        engine_attributes: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnServer.EngineAttributeProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
