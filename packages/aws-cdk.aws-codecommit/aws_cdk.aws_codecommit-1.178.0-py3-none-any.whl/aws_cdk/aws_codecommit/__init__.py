...
class CfnRepository(
    ...
    def __init__(
        ...
        *,
        ...
        code: typing.Optional[typing.Union[typing.Union["CfnRepository.CodeProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable]] = None,
        ...
        triggers: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnRepository.RepositoryTriggerProperty", typing.Dict[str, typing.Any]]]]]] = None,
    ) -> None:
    ...
    def code(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRepository, "code").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def repository_description(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRepository, "repository_description").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def triggers(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRepository, "triggers").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class CodeProperty:
        def __init__(
            self,
            *,
            s3: typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnRepository.S3Property", typing.Dict[str, typing.Any]]],
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnRepository.CodeProperty.__init__)
    ...
    class RepositoryTriggerProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnRepository.RepositoryTriggerProperty.__init__)
    ...
    class S3Property:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnRepository.S3Property.__init__)
...
class Code(metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-codecommit.Code"):
    ...
    def from_directory(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Code.from_directory)
    ...
    def from_zip_file(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Code.from_zip_file)
...
class CodeConfig:
    def __init__(
        self,
        *,
        code: typing.Union[CfnRepository.CodeProperty, typing.Dict[str, typing.Any]],
    ) -> None:
...
class _IRepositoryProxy(
    ...
    def grant_read(self, grantee: aws_cdk.aws_iam.IGrantable) -> aws_cdk.aws_iam.Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.grant_read)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
    ...
    def notifiy_on_pull_request_merged(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.notifiy_on_pull_request_merged)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        ...
        return typing.cast(aws_cdk.aws_codestarnotifications.INotificationRule, jsii.invoke(self, "notifiyOnPullRequestMerged", [id, target, options]))
    ...
    def notify_on(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.notify_on)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
    ...
    def notify_on_approval_rule_overridden(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.notify_on_approval_rule_overridden)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
        ...
        return typing.cast(aws_cdk.aws_codestarnotifications.INotificationRule, jsii.invoke(self, "notifyOnApprovalRuleOverridden", [id, target, options]))
    ...
    def notify_on_approval_status_changed(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.notify_on_approval_status_changed)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
        ...
        return typing.cast(aws_cdk.aws_codestarnotifications.INotificationRule, jsii.invoke(self, "notifyOnApprovalStatusChanged", [id, target, options]))
    ...
    def notify_on_branch_or_tag_created(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.notify_on_branch_or_tag_created)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
        ...
        return typing.cast(aws_cdk.aws_codestarnotifications.INotificationRule, jsii.invoke(self, "notifyOnBranchOrTagCreated", [id, target, options]))
    ...
    def notify_on_branch_or_tag_deleted(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.notify_on_branch_or_tag_deleted)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
        ...
        return typing.cast(aws_cdk.aws_codestarnotifications.INotificationRule, jsii.invoke(self, "notifyOnBranchOrTagDeleted", [id, target, options]))
    ...
    def notify_on_pull_request_comment(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.notify_on_pull_request_comment)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
        ...
        return typing.cast(aws_cdk.aws_codestarnotifications.INotificationRule, jsii.invoke(self, "notifyOnPullRequestComment", [id, target, options]))
    ...
    def notify_on_pull_request_created(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.notify_on_pull_request_created)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
        ...
        return typing.cast(aws_cdk.aws_codestarnotifications.INotificationRule, jsii.invoke(self, "notifyOnPullRequestCreated", [id, target, options]))
    ...
    def notify_on_pull_request_merged(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.notify_on_pull_request_merged)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
        ...
        return typing.cast(aws_cdk.aws_codestarnotifications.INotificationRule, jsii.invoke(self, "notifyOnPullRequestMerged", [id, target, options]))
    ...
    def on_comment_on_commit(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_comment_on_commit)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def on_comment_on_pull_request(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_comment_on_pull_request)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_commit(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_commit)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def on_pull_request_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_pull_request_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_reference_created(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_reference_created)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_reference_deleted(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_reference_deleted)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_reference_updated(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_reference_updated)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRepository.on_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
...
class OnCommitOptions(aws_cdk.aws_events.OnEventOptions):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(OnCommitOptions.__init__)
...
class Repository(
    ...
    def bind_as_notification_rule_source(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.bind_as_notification_rule_source)
    ...
    def grant(
        ...
        *actions: builtins.str,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.grant)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
            check_type(argname="argument actions", value=actions, expected_type=typing.Tuple[type_hints["actions"], ...]) # pyright: ignore [reportGeneralTypeIssues]
        return typing.cast(aws_cdk.aws_iam.Grant, jsii.invoke(self, "grant", [grantee, *actions]))
    ...
    def grant_pull(self, grantee: aws_cdk.aws_iam.IGrantable) -> aws_cdk.aws_iam.Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.grant_pull)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
        return typing.cast(aws_cdk.aws_iam.Grant, jsii.invoke(self, "grantPull", [grantee]))
    ...
    def grant_pull_push(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.grant_pull_push)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
        return typing.cast(aws_cdk.aws_iam.Grant, jsii.invoke(self, "grantPullPush", [grantee]))
    ...
    def grant_read(self, grantee: aws_cdk.aws_iam.IGrantable) -> aws_cdk.aws_iam.Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.grant_read)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
        return typing.cast(aws_cdk.aws_iam.Grant, jsii.invoke(self, "grantRead", [grantee]))
    ...
    def notifiy_on_pull_request_merged(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.notifiy_on_pull_request_merged)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
    ...
    def notify(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.notify)
    ...
    def notify_on(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.notify_on)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = RepositoryNotifyOnOptions(
            events=events,
    ...
    def notify_on_approval_rule_overridden(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.notify_on_approval_rule_overridden)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
    ...
    def notify_on_approval_status_changed(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.notify_on_approval_status_changed)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
    ...
    def notify_on_branch_or_tag_created(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.notify_on_branch_or_tag_created)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
    ...
    def notify_on_branch_or_tag_deleted(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.notify_on_branch_or_tag_deleted)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
    ...
    def notify_on_pull_request_comment(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.notify_on_pull_request_comment)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
    ...
    def notify_on_pull_request_created(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.notify_on_pull_request_created)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
    ...
    def notify_on_pull_request_merged(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.notify_on_pull_request_merged)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        options = aws_cdk.aws_codestarnotifications.NotificationRuleOptions(
            detail_type=detail_type,
    ...
    def on_comment_on_commit(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.on_comment_on_commit)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_comment_on_pull_request(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.on_comment_on_pull_request)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_commit(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.on_commit)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = OnCommitOptions(
            branches=branches,
            description=description,
    ...
    def on_event(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.on_event)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_pull_request_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.on_pull_request_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_reference_created(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.on_reference_created)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_reference_deleted(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.on_reference_deleted)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_reference_updated(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.on_reference_updated)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
    ...
    def on_state_change(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Repository.on_state_change)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = aws_cdk.aws_events.OnEventOptions(
            description=description,
            event_pattern=event_pattern,
...
class RepositoryNotifyOnOptions(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryNotifyOnOptions.__init__)
...
class RepositoryTriggerOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RepositoryTriggerOptions.__init__)
            check_type(argname="argument branches", value=branches, expected_type=type_hints["branches"])
            check_type(argname="argument custom_data", value=custom_data, expected_type=type_hints["custom_data"])
            check_type(argname="argument events", value=events, expected_type=type_hints["events"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
