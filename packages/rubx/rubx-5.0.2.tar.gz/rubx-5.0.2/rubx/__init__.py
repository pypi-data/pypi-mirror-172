...
class Robot :
    def __init__(self, auth=None, app='rubx', phone_number=None, device=defaultDevice, proxy={'http':'http://127.0.0.1:9050'}, your_name='rubx', city='tehran', banner=True) -> None :
    ...
    def sendMessage(self, chat_id, text, metadata=[], parse_mode=None, button_id=None, message_id=None) -> dict:
        inData = {
            "method":"sendMessage",
            "input":{
                "object_guid":chat_id,
    ...
    def setGroupAdmin(self, chat_id: str, user_id: str, access_list: list) -> dict:
    ...
    def setActionChat(self, object_guid: str, action: str) -> dict:
...
transport-cc\r\na=fmtp:111 minptime=10;useinbandfec=1\r\na=rtpmap:63 red/48000/2\r\na=fmtp:63 111/111\r\na=rtpmap:103 ISAC/16000\r\na=rtpmap:104 ISAC/32000\r\na=rtpmap:9 G722/8000\r\na=rtpmap:0 PCMU/8000\r\na=rtpmap:8 PCMA/8000\r\na=rtpmap:106 CN/32000\r\na=rtpmap:105 CN/16000\r\na=rtpmap:13 CN/8000\r\na=rtpmap:110 telephone-event/48000\r\na=rtpmap:112 telephone-event/32000\r\na=rtpmap:113 telephone-event/16000\r\na=rtpmap:126 telephone-event/8000\r\na=ssrc:1614457217 cname:lYBnCNdQcW/DEUj9\r\na=ssrc:1614457217 msid:LjIerKYwibTOvR0Ewwk1PBsYYxTInaoXObBE 00f6113c-f01a-447a-a72e-c989684b627a\r\n""",
    ...
    def setMuteChat(self, guid: str) -> dict:
        '''action:  Mute'''
        for i in range(4):
            try:
                return loads(self.enc.decrypt(post(json={"api_version":"5","auth": self.auth,"data_enc":self.enc.encrypt(dumps({
    ...
    def setUnmuteChat(self, guid: str) -> dict:
        '''action:  Unmute'''
        for i in range(4):
            try:
                return loads(self.enc.decrypt(post(json={"api_version":"5","auth": self.auth,"data_enc":self.enc.encrypt(dumps({
    ...
    def sendChatActivity(self, target_guid: str, activity='rubxLib!') -> dict:
        for i in range(4):
            try:
                return loads(self.enc.decrypt(post(json={"api_version":"5","auth": self.auth,"data_enc":self.enc.encrypt(dumps({
                    "method":"sendChatActivity",
    ...
    def searchGloblMessages(self, text: str, type='Text') -> dict:
    ...
    def sendMention(self, object_guid: str, text: str, user_guid: str, mode='User', message_id=None) -> dict :
    ...
    def sendMetas(self, object_guid: str, text: str, message_id=None) -> dict :
    ...
    def setPinChats(self, object_guid: str) -> dict :
        for i in range(4) :
    ...
    def setUnPinChats(self, object_guid: str) -> dict :
        for i in range(4) :
    ...
    def chat_history_for_new_members_visible(self, group_guid: str) -> dict :
        for i in range(4) :
            try :
                return loads(self.enc.decrypt(post(json={"api_version":"5","auth": self.auth,"data_enc":self.enc.encrypt(dumps({
                  "method":"editGroupInfo",
    ...
    def chat_history_for_new_members_hidden(self, group_guid: str) -> dict :
        for i in range(4) :
            try :
                return loads(self.enc.decrypt(post(json={"api_version":"5","auth": self.auth,"data_enc":self.enc.encrypt(dumps({
                  "method":"editGroupInfo",
    ...
    def deleteGroup(self, group_guid: str) -> dict :
        for i in range(4) :
            try :
                return loads(self.enc.decrypt(post(json={"api_version":"5","auth": self.auth,"data_enc":self.enc.encrypt(dumps({
    ...
    def getBotInfo(self, bot_guid: str) -> dict :
        for i in range(4) :
            try :
                return loads(self.enc.decrypt(post(json={"api_version":"5","auth": self.auth,"data_enc":self.enc.encrypt(dumps({
                  "method":"getBotInfo",
