...
from ... import models
from ...kalmonak_extension import Radicale
...
# This file was generated by Kalabash on %s
# DO NOT EDIT MANUALLY!
        """ % datetime.datetime.today())

        allow_calendars_administration = param_tools.get_global_parameter(
            "allow_calendars_administration", app="kalabash_radicale")
    ...
    def handle(self, *args, **options):
        ...
        path = param_tools.get_global_parameter(
            "rights_file_path", app="kalabash_radicale")
