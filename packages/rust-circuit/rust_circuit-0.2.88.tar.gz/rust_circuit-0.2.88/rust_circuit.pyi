...
class ArrayConstant(Circuit):
    ...
    @staticmethod
    def from_hash_prefix(name: Optional[str], hash_base16: str) -> "ArrayConstant": ...
...
class DiscreteVar(Circuit):
    ...
    @staticmethod
    def new_uniform(self, values: Circuit, name: Optional[str] = None) -> DiscreteVar: ...
...
def rust_expression_notation_circuit(circuit: Circuit, tensors_as_randn: bool = True) -> str: ...
