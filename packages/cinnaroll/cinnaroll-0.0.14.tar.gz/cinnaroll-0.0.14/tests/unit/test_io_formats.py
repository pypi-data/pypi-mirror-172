...
from cinnaroll_internal.io_formats import (
    ALLOWED_INFER_FUNC_INPUT_FORMATS, ALLOWED_INFER_FUNC_OUTPUT_FORMATS, IMG,
    JSON, DisallowedInferFuncInputFormatError,
    DisallowedInferFuncOutputFormatError, InferFuncInputFormatMismatchError,
    InferFuncOutputFormatMismatchError, find_disallowed_io_format_errors,
...
class Inputs:
    def __init__(self) -> None:
        self.valid_json = str(
            [{"zaba": 5, "pies": 3, "kot": -1}, {"orzel": 15, "nosorozec": 10}]
        ).replace("'", '"')
