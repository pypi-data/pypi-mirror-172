...
class Volume:
    ...
    def from_parser_section(cls, section: SectionProxy):
        ...
        snap_mount_base = section.get("snap_mount_base") or None  # None if empty string
        if snap_mount_base is not None:
            snap_mount_base = "NOMOUNT" if snap_mount_base.upper() == "NOMOUNT" else Path(snap_mount_base)
        ...
        return cls(
            ...
            snap_mount_base=snap_mount_base,
