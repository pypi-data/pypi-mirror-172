...
class rtkConjugateGradientConeBeamReconstructionFilterCIF3(itk.rtkIterativeConeBeamReconstructionFilterPython.rtkIterativeConeBeamReconstructionFilterCIF3CIF3):
    ...
    SetIterationCosts = _swig_new_instance_method(_rtkConjugateGradientConeBeamReconstructionFilterPython.rtkConjugateGradientConeBeamReconstructionFilterCIF3_SetIterationCosts)
    GetIterationCosts = _swig_new_instance_method(_rtkConjugateGradientConeBeamReconstructionFilterPython.rtkConjugateGradientConeBeamReconstructionFilterCIF3_GetIterationCosts)
    ...
    GetResidualCosts = _swig_new_instance_method(_rtkConjugateGradientConeBeamReconstructionFilterPython.rtkConjugateGradientConeBeamReconstructionFilterCIF3_GetResidualCosts)
...
def conjugate_gradient_cone_beam_reconstruction_filter(*args: itkt.ImageLike,  input_volume=..., input_projection_stack=..., input_weights=..., support_mask=..., geometry=..., number_of_iterations: int=..., iteration_costs: bool=..., disable_displaced_detector_filter: bool=..., tikhonov: float=..., gamma: float=..., cuda_conjugate_gradient: bool=..., forward_projection_filter=..., back_projection_filter=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for ConjugateGradientConeBeamReconstructionFilter"""
    import itk

    kwarg_typehints = { 'input_volume':input_volume,'input_projection_stack':input_projection_stack,'input_weights':input_weights,'support_mask':support_mask,'geometry':geometry,'number_of_iterations':number_of_iterations,'iteration_costs':iteration_costs,'disable_displaced_detector_filter':disable_displaced_detector_filter,'tikhonov':tikhonov,'gamma':gamma,'cuda_conjugate_gradient':cuda_conjugate_gradient,'forward_projection_filter':forward_projection_filter,'back_projection_filter':back_projection_filter }
