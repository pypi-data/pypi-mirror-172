...
def rtkSARTConeBeamReconstructionFilterCIF4CIF3_New():
    return rtkSARTConeBeamReconstructionFilterCIF4CIF3.New()

class rtkSARTConeBeamReconstructionFilterCIF4CIF3(itk.rtkIterativeConeBeamReconstructionFilterPython.rtkIterativeConeBeamReconstructionFilterCIF3CIF3):
    r"""Proxy of C++ rtkSARTConeBeamReconstructionFilterCIF4CIF3 class."""
    ...
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3___New_orig__)
    Clone = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_Clone)
    GetModifiableGeometry = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_GetModifiableGeometry)
    GetGeometry = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_GetGeometry)
    SetGeometry = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_SetGeometry)
    GetNumberOfIterations = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_GetNumberOfIterations)
    SetNumberOfIterations = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_SetNumberOfIterations)
    GetNumberOfProjectionsPerSubset = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_GetNumberOfProjectionsPerSubset)
    SetNumberOfProjectionsPerSubset = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_SetNumberOfProjectionsPerSubset)
    GetLambda = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_GetLambda)
    SetLambda = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_SetLambda)
    GetEnforcePositivity = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_GetEnforcePositivity)
    SetEnforcePositivity = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_SetEnforcePositivity)
    SetGatingWeights = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_SetGatingWeights)
    SetDisableDisplacedDetectorFilter = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_SetDisableDisplacedDetectorFilter)
    GetDisableDisplacedDetectorFilter = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_GetDisableDisplacedDetectorFilter)
    SetDivisionThreshold = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_SetDivisionThreshold)
    GetDivisionThreshold = _swig_new_instance_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_GetDivisionThreshold)
    __swig_destroy__ = _rtkSARTConeBeamReconstructionFilterPython.delete_rtkSARTConeBeamReconstructionFilterCIF4CIF3
    cast = _swig_new_static_method(_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_cast)

    def New(*args, **kargs):
        """New() -> rtkSARTConeBeamReconstructionFilterCIF4CIF3

        Create a new object of the class rtkSARTConeBeamReconstructionFilterCIF4CIF3 and set the input and the parameters if some
        ...
        Ex:
          ...
          rtkSARTConeBeamReconstructionFilterCIF4CIF3.New(reader, threshold=10)

        is (most of the time) equivalent to:

          obj = rtkSARTConeBeamReconstructionFilterCIF4CIF3.New()
          obj.SetInput(0, reader.GetOutput())
          obj.SetThreshold(10)
        """
        obj = rtkSARTConeBeamReconstructionFilterCIF4CIF3.__New_orig__()
...
# Register rtkSARTConeBeamReconstructionFilterCIF4CIF3 in _rtkSARTConeBeamReconstructionFilterPython:
_rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_swigregister(rtkSARTConeBeamReconstructionFilterCIF4CIF3)
rtkSARTConeBeamReconstructionFilterCIF4CIF3___New_orig__ = _rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3___New_orig__
rtkSARTConeBeamReconstructionFilterCIF4CIF3_cast = _rtkSARTConeBeamReconstructionFilterPython.rtkSARTConeBeamReconstructionFilterCIF4CIF3_cast
...
def sart_cone_beam_reconstruction_filter(*args: itkt.ImageLike,  geometry=..., number_of_iterations: int=..., number_of_projections_per_subset: int=..., enforce_positivity: bool=..., gating_weights: Sequence[float]=..., disable_displaced_detector_filter: bool=..., division_threshold: float=..., forward_projection_filter=..., back_projection_filter=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for SARTConeBeamReconstructionFilter"""
    import itk

    kwarg_typehints = { 'geometry':geometry,'number_of_iterations':number_of_iterations,'number_of_projections_per_subset':number_of_projections_per_subset,'enforce_positivity':enforce_positivity,'gating_weights':gating_weights,'disable_displaced_detector_filter':disable_displaced_detector_filter,'division_threshold':division_threshold,'forward_projection_filter':forward_projection_filter,'back_projection_filter':back_projection_filter }
