...
def projection_stack_to_four_d_image_filter(*args: itkt.ImageLike,  input_volume_series=..., input_projection_stack=..., back_projection_filter=..., geometry=..., use_cuda_splat: bool=..., use_cuda_sources: bool=..., weights=..., signal: Sequence[float]=...,**kwargs)-> itkt.ImageSourceReturn:
