...
class rtkOSEMConeBeamReconstructionFilterCIF4CIF3(itk.rtkIterativeConeBeamReconstructionFilterPython.rtkIterativeConeBeamReconstructionFilterCIF3CIF3):
    ...
    GetSigmaZero = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterCIF4CIF3_GetSigmaZero)
    SetSigmaZero = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterCIF4CIF3_SetSigmaZero)
    GetAlpha = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterCIF4CIF3_GetAlpha)
    SetAlpha = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterCIF4CIF3_SetAlpha)
...
class rtkOSEMConeBeamReconstructionFilterID3ID3(itk.rtkIterativeConeBeamReconstructionFilterPython.rtkIterativeConeBeamReconstructionFilterID3):
    ...
    GetSigmaZero = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterID3ID3_GetSigmaZero)
    SetSigmaZero = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterID3ID3_SetSigmaZero)
    GetAlpha = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterID3ID3_GetAlpha)
    SetAlpha = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterID3ID3_SetAlpha)
...
class rtkOSEMConeBeamReconstructionFilterIF3IF3(itk.rtkIterativeConeBeamReconstructionFilterPython.rtkIterativeConeBeamReconstructionFilterIF3):
    ...
    GetSigmaZero = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterIF3IF3_GetSigmaZero)
    SetSigmaZero = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterIF3IF3_SetSigmaZero)
    GetAlpha = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterIF3IF3_GetAlpha)
    SetAlpha = _swig_new_instance_method(_rtkOSEMConeBeamReconstructionFilterPython.rtkOSEMConeBeamReconstructionFilterIF3IF3_SetAlpha)
...
def osem_cone_beam_reconstruction_filter(*args: itkt.ImageLike,  geometry=..., number_of_iterations: int=..., number_of_projections_per_subset: int=..., sigma_zero: float=..., alpha: float=..., beta_regularization: float=..., store_normalization_images: bool=..., forward_projection_filter=..., back_projection_filter=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for OSEMConeBeamReconstructionFilter"""
    import itk

    kwarg_typehints = { 'geometry':geometry,'number_of_iterations':number_of_iterations,'number_of_projections_per_subset':number_of_projections_per_subset,'sigma_zero':sigma_zero,'alpha':alpha,'beta_regularization':beta_regularization,'store_normalization_images':store_normalization_images,'forward_projection_filter':forward_projection_filter,'back_projection_filter':back_projection_filter }
