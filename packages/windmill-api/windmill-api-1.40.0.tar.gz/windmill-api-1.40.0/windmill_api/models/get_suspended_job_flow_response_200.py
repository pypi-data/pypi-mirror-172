...
from ..models.get_suspended_job_flow_response_200_type import GetSuspendedJobFlowResponse200Type
...
class GetSuspendedJobFlowResponse200:
    ...
    type: Union[Unset, GetSuspendedJobFlowResponse200Type] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = GetSuspendedJobFlowResponse200Type(_type)
