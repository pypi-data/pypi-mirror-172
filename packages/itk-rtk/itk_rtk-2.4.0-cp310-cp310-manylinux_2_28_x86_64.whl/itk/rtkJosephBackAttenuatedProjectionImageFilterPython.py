...
class rtkFunctorSplatWeightMultiplicationDDD(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _rtkJosephBackAttenuatedProjectionImageFilterPython.delete_rtkFunctorSplatWeightMultiplicationDDD
    __ne__ = _swig_new_instance_method(_rtkJosephBackAttenuatedProjectionImageFilterPython.rtkFunctorSplatWeightMultiplicationDDD___ne__)
    __eq__ = _swig_new_instance_method(_rtkJosephBackAttenuatedProjectionImageFilterPython.rtkFunctorSplatWeightMultiplicationDDD___eq__)
    __call__ = _swig_new_instance_method(_rtkJosephBackAttenuatedProjectionImageFilterPython.rtkFunctorSplatWeightMultiplicationDDD___call__)
    ...
    def __init__(self, *args):
        ...
        """
        _rtkJosephBackAttenuatedProjectionImageFilterPython.rtkFunctorSplatWeightMultiplicationDDD_swiginit(self, _rtkJosephBackAttenuatedProjectionImageFilterPython.new_rtkFunctorSplatWeightMultiplicationDDD(*args))

# Register rtkFunctorSplatWeightMultiplicationDDD in _rtkJosephBackAttenuatedProjectionImageFilterPython:
_rtkJosephBackAttenuatedProjectionImageFilterPython.rtkFunctorSplatWeightMultiplicationDDD_swigregister(rtkFunctorSplatWeightMultiplicationDDD)
...
class rtkFunctorSplatWeightMultiplicationFDF(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _rtkJosephBackAttenuatedProjectionImageFilterPython.delete_rtkFunctorSplatWeightMultiplicationFDF
    __ne__ = _swig_new_instance_method(_rtkJosephBackAttenuatedProjectionImageFilterPython.rtkFunctorSplatWeightMultiplicationFDF___ne__)
    __eq__ = _swig_new_instance_method(_rtkJosephBackAttenuatedProjectionImageFilterPython.rtkFunctorSplatWeightMultiplicationFDF___eq__)
    __call__ = _swig_new_instance_method(_rtkJosephBackAttenuatedProjectionImageFilterPython.rtkFunctorSplatWeightMultiplicationFDF___call__)
    ...
    def __init__(self, *args):
        ...
        """
        _rtkJosephBackAttenuatedProjectionImageFilterPython.rtkFunctorSplatWeightMultiplicationFDF_swiginit(self, _rtkJosephBackAttenuatedProjectionImageFilterPython.new_rtkFunctorSplatWeightMultiplicationFDF(*args))

# Register rtkFunctorSplatWeightMultiplicationFDF in _rtkJosephBackAttenuatedProjectionImageFilterPython:
_rtkJosephBackAttenuatedProjectionImageFilterPython.rtkFunctorSplatWeightMultiplicationFDF_swigregister(rtkFunctorSplatWeightMultiplicationFDF)
