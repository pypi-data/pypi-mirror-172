...
class itkImageFileReaderIVF54(itk.itkImageSourceRTKPython.itkImageSourceIVF54):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54___New_orig__)
    Clone = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_Clone)
    SetFileNameInput = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_SetFileNameInput)
    SetFileName = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_SetFileName)
    GetFileNameInput = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_GetFileNameInput)
    GetFileName = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_GetFileName)
    SetImageIO = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_SetImageIO)
    GetModifiableImageIO = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_GetModifiableImageIO)
    GetImageIO = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_GetImageIO)
    SetUseStreaming = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_SetUseStreaming)
    GetUseStreaming = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_GetUseStreaming)
    UseStreamingOn = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_UseStreamingOn)
    UseStreamingOff = _swig_new_instance_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_UseStreamingOff)
    __swig_destroy__ = _itkImageFileReaderRTKPython.delete_itkImageFileReaderIVF54
    cast = _swig_new_static_method(_itkImageFileReaderRTKPython.itkImageFileReaderIVF54_cast)
...
itkImageFileReaderIVF54___New_orig__ = _itkImageFileReaderRTKPython.itkImageFileReaderIVF54___New_orig__
itkImageFileReaderIVF54_cast = _itkImageFileReaderRTKPython.itkImageFileReaderIVF54_cast
