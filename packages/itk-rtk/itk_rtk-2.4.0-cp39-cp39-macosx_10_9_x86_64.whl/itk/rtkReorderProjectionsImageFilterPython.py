...
class rtkReorderProjectionsImageFilterICD3ICD3(itk.itkImageToImageFilterBPython.itkImageToImageFilterICD3ICD3):
    ...
    __New_orig__ = _swig_new_static_method(_rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3___New_orig__)
    Clone = _swig_new_instance_method(_rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3_Clone)
    GetModifiableOutputGeometry = _swig_new_instance_method(_rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3_GetModifiableOutputGeometry)
    GetOutputGeometry = _swig_new_instance_method(_rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3_GetOutputGeometry)
    SetInputGeometry = _swig_new_instance_method(_rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3_SetInputGeometry)
    GetPermutation = _swig_new_instance_method(_rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3_GetPermutation)
    SetPermutation = _swig_new_instance_method(_rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3_SetPermutation)
    SetInputSignal = _swig_new_instance_method(_rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3_SetInputSignal)
    GetOutputSignal = _swig_new_instance_method(_rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3_GetOutputSignal)
    __swig_destroy__ = _rtkReorderProjectionsImageFilterPython.delete_rtkReorderProjectionsImageFilterICD3ICD3
    cast = _swig_new_static_method(_rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3_cast)
...
rtkReorderProjectionsImageFilterICD3ICD3___New_orig__ = _rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3___New_orig__
rtkReorderProjectionsImageFilterICD3ICD3_cast = _rtkReorderProjectionsImageFilterPython.rtkReorderProjectionsImageFilterICD3ICD3_cast
