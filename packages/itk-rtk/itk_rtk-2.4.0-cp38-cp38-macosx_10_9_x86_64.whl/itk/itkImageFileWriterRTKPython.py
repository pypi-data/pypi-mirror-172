...
class itkImageFileWriterIVF54(itk.ITKCommonBasePython.itkProcessObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54___New_orig__)
    Clone = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_Clone)
    SetInput = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_SetInput)
    GetInput = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_GetInput)
    SetFileName = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_SetFileName)
    GetFileName = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_GetFileName)
    SetImageIO = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_SetImageIO)
    GetModifiableImageIO = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_GetModifiableImageIO)
    GetImageIO = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_GetImageIO)
    Write = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_Write)
    SetIORegion = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_SetIORegion)
    GetIORegion = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_GetIORegion)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_GetNumberOfStreamDivisions)
    SetUseCompression = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_SetUseCompression)
    GetUseCompression = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_GetUseCompression)
    UseCompressionOn = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_UseCompressionOn)
    UseCompressionOff = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_UseCompressionOff)
    SetCompressionLevel = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_SetCompressionLevel)
    GetCompressionLevel = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_GetCompressionLevel)
    SetUseInputMetaDataDictionary = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_SetUseInputMetaDataDictionary)
    GetUseInputMetaDataDictionary = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_GetUseInputMetaDataDictionary)
    UseInputMetaDataDictionaryOn = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_UseInputMetaDataDictionaryOn)
    UseInputMetaDataDictionaryOff = _swig_new_instance_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_UseInputMetaDataDictionaryOff)
    __swig_destroy__ = _itkImageFileWriterRTKPython.delete_itkImageFileWriterIVF54
    cast = _swig_new_static_method(_itkImageFileWriterRTKPython.itkImageFileWriterIVF54_cast)
...
itkImageFileWriterIVF54___New_orig__ = _itkImageFileWriterRTKPython.itkImageFileWriterIVF54___New_orig__
itkImageFileWriterIVF54_cast = _itkImageFileWriterRTKPython.itkImageFileWriterIVF54_cast
