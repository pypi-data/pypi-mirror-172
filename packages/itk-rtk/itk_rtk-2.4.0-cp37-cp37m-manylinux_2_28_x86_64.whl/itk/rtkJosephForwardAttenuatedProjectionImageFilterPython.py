...
class rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _rtkJosephForwardAttenuatedProjectionImageFilterPython.delete_rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD
    __ne__ = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD___ne__)
    __eq__ = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD___eq__)
    __call__ = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD___call__)
    SetAttenuationMinusEmissionMapsPtrDiff = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD_SetAttenuationMinusEmissionMapsPtrDiff)
    GetAttenuationRay = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD_GetAttenuationRay)
    GetAttenuationPixel = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD_GetAttenuationPixel)
    GetEx1 = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD_GetEx1)
    ...
    def __init__(self, *args):
        ...
        """
        _rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD_swiginit(self, _rtkJosephForwardAttenuatedProjectionImageFilterPython.new_rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD(*args))

# Register rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD in _rtkJosephForwardAttenuatedProjectionImageFilterPython:
_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD_swigregister(rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionDDD)
...
class rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _rtkJosephForwardAttenuatedProjectionImageFilterPython.delete_rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF
    __ne__ = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF___ne__)
    __eq__ = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF___eq__)
    __call__ = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF___call__)
    SetAttenuationMinusEmissionMapsPtrDiff = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF_SetAttenuationMinusEmissionMapsPtrDiff)
    GetAttenuationRay = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF_GetAttenuationRay)
    GetAttenuationPixel = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF_GetAttenuationPixel)
    GetEx1 = _swig_new_instance_method(_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF_GetEx1)
    ...
    def __init__(self, *args):
        ...
        """
        _rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF_swiginit(self, _rtkJosephForwardAttenuatedProjectionImageFilterPython.new_rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF(*args))

# Register rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF in _rtkJosephForwardAttenuatedProjectionImageFilterPython:
_rtkJosephForwardAttenuatedProjectionImageFilterPython.rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF_swigregister(rtkFunctorInterpolationWeightMultiplicationAttenuatedBackProjectionFFF)
...
def joseph_forward_attenuated_projection_image_filter(*args: itkt.ImageLike,  interpolation_weight_multiplication=..., projected_value_accumulation=..., sum_along_ray=..., inferior_clip: float=..., superior_clip: float=..., geometry=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for JosephForwardAttenuatedProjectionImageFilter"""
    import itk

    kwarg_typehints = { 'interpolation_weight_multiplication':interpolation_weight_multiplication,'projected_value_accumulation':projected_value_accumulation,'sum_along_ray':sum_along_ray,'inferior_clip':inferior_clip,'superior_clip':superior_clip,'geometry':geometry }
...
@helpers.accept_array_like_xarray_torch
def joseph_forward_projection_image_filter(*args: itkt.ImageLike,  interpolation_weight_multiplication=..., projected_value_accumulation=..., sum_along_ray=..., inferior_clip: float=..., superior_clip: float=..., geometry=...,**kwargs)-> itkt.ImageSourceReturn:
