...
class SopsSecret(
    ...
    def __init__(
        ...
        *,
        ...
        generate_secret_string: typing.Optional[typing.Union[aws_cdk.aws_secretsmanager.SecretStringGenerator, typing.Dict[str, typing.Any]]] = None,
        removal_policy: typing.Optional[aws_cdk.RemovalPolicy] = None,
        replica_regions: typing.Optional[typing.Sequence[typing.Union[aws_cdk.aws_secretsmanager.ReplicaRegion, typing.Dict[str, typing.Any]]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSecret.__init__)
    ...
    def add_rotation_schedule(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSecret.add_rotation_schedule)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_to_resource_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSecret.add_to_resource_policy)
    ...
    def apply_removal_policy(self, policy: aws_cdk.RemovalPolicy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSecret.apply_removal_policy)
    ...
    def attach(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSecret.attach)
    ...
    def grant_read(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSecret.grant_read)
    ...
    def grant_write(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSecret.grant_write)
    ...
    def secret_value_from_json(self, json_field: builtins.str) -> aws_cdk.SecretValue:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSecret.secret_value_from_json)
...
class SopsSync(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSync.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = SopsSyncProps(
            secret=secret,
...
class SopsSyncOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSyncOptions.__init__)
...
class SopsSyncProps(SopsSyncOptions):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSyncProps.__init__)
            check_type(argname="argument sops_file_path", value=sops_file_path, expected_type=type_hints["sops_file_path"])
            check_type(argname="argument convert_to_json", value=convert_to_json, expected_type=type_hints["convert_to_json"])
            check_type(argname="argument flatten", value=flatten, expected_type=type_hints["flatten"])
            check_type(argname="argument sops_age_key", value=sops_age_key, expected_type=type_hints["sops_age_key"])
...
class SopsSyncProvider(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSyncProvider.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_age_key(self, key: aws_cdk.SecretValue) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SopsSyncProvider.add_age_key)
...
class SopsSecretProps(aws_cdk.aws_secretsmanager.SecretProps, SopsSyncOptions):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SopsSecretProps.__init__)
