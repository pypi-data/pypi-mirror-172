...
class workflowitems(models.Model):
    ...
    current_from_party = models.ForeignKey(PartyType , models.DO_NOTHING , blank = True , null = True  , related_name = 'wf_from_party')
    current_to_party = models.ForeignKey(PartyType , models.DO_NOTHING , blank = True , null = True )
