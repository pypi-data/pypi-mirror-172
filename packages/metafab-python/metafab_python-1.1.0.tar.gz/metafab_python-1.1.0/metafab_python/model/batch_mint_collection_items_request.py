...
class BatchMintCollectionItemsRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, item_ids, quantities, *args, **kwargs):  # noqa: E501
        """BatchMintCollectionItemsRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            address (str): A valid EVM based address to create (mint) the items for. For example, `0x39cb70F972E0EE920088AeF97Dbe5c6251a9c25D`.. [optional]  # noqa: E501
            wallet_id (str): Any wallet id within the MetaFab ecosystem to create (mint) the items for.. [optional]  # noqa: E501
        """
