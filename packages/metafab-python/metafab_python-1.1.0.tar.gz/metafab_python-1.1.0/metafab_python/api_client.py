...
from metafab_python import rest
from metafab_python.configuration import Configuration
from metafab_python.exceptions import ApiTypeError, ApiValueError, ApiException
from metafab_python.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ContractsApi()
        api_instance.create_contract  # this is an instance of the class Endpoint
        api_instance.create_contract()  # this invokes api_instance.create_contract.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_contract.callable or self.callable in this class
