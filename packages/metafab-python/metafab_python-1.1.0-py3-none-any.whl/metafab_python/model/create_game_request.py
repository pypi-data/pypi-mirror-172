...
class CreateGameRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, email, password, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, email, password, *args, **kwargs):  # noqa: E501
        """CreateGameRequest - a model defined in OpenAPI
