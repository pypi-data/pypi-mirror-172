...
class CreateContractRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, abi, chain, *args, **kwargs):  # noqa: E501
        """CreateContractRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, abi, chain, *args, **kwargs):  # noqa: E501
        """CreateContractRequest - a model defined in OpenAPI
