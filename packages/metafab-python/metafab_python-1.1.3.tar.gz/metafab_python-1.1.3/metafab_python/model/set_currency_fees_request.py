...
class SetCurrencyFeesRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, recipient_address, basis_points, fixed_amount, cap_amount, *args, **kwargs):  # noqa: E501
        """SetCurrencyFeesRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, recipient_address, basis_points, fixed_amount, cap_amount, *args, **kwargs):  # noqa: E501
        """SetCurrencyFeesRequest - a model defined in OpenAPI
