...
class TransactionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_transaction_endpoint = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/v1/transactions/{transactionId}',
    ...
    def get_transaction(
        ...
        **kwargs
        ...
        Returns an executed transaction object for the provided transactionId. Transactions are created by MetaFab when interacting with contracts, currencies, items and other MetaFab resources.  # noqa: E501
