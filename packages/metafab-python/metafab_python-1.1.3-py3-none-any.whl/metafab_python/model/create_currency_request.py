...
class CreateCurrencyRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, symbol, supply_cap, chain, *args, **kwargs):  # noqa: E501
        """CreateCurrencyRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, symbol, supply_cap, chain, *args, **kwargs):  # noqa: E501
        """CreateCurrencyRequest - a model defined in OpenAPI
