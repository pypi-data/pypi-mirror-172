...
from MergePythonSDK.shared import rest
from MergePythonSDK.shared.configuration import Configuration
from MergePythonSDK.shared.exceptions import ApiTypeError, ApiValueError, ApiException
from MergePythonSDK.shared.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AccountDetailsApi()
        api_instance.account_details_retrieve  # this is an instance of the class Endpoint
        api_instance.account_details_retrieve()  # this invokes api_instance.account_details_retrieve.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.account_details_retrieve.callable or self.callable in this class
