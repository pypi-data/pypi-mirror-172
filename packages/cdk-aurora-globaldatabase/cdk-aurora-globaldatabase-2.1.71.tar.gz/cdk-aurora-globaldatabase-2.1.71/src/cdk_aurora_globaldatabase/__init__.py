...
class GlobalAuroraRDSMaster(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GlobalAuroraRDSMaster.__init__)
    ...
    def add_regional_cluster(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GlobalAuroraRDSMaster.add_regional_cluster)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class GlobalAuroraRDSMasterProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GlobalAuroraRDSMasterProps.__init__)
...
class GlobalAuroraRDSSlaveInfra(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GlobalAuroraRDSSlaveInfra.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class GlobalAuroraRDSSlaveInfraProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GlobalAuroraRDSSlaveInfraProps.__init__)
            check_type(argname="argument deletion_protection", value=deletion_protection, expected_type=type_hints["deletion_protection"])
...
class RegionalOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RegionalOptions.__init__)
