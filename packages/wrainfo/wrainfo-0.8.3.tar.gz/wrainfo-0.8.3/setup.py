...
setup(
    ...
    description="Is a software to process FURUNO weather radar data.",
    entry_points={
        'console_scripts': [
            'wrainfo=bin.wrainfo_cli:main',
        ],
    },
    extras_require={
        "doc": req_doc,
    ...
    name='wrainfo',
    packages=find_packages(include=['wrainfo', 'wrainfo.*']),
    project_urls={
    ...
    url='https://git.gfz-potsdam.de/fernlab/products/furuno/wrainfo',
