...
class Annotations(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/assertions.Annotations"):
    ...
    def from_stack(cls, stack: aws_cdk.core.Stack) -> "Annotations":
        '''Base your assertions on the messages returned by a synthesized CDK ``Stack``.

        :param stack: the CDK Stack to run assertions on.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Annotations.from_stack)
    ...
    def find_error(
        ...
        message: typing.Any,
    ) -> typing.List[aws_cdk.cx_api.SynthesisMessage]:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Annotations.find_error)
            check_type(argname="argument construct_path", value=construct_path, expected_type=type_hints["construct_path"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
        return typing.cast(typing.List[aws_cdk.cx_api.SynthesisMessage], jsii.invoke(self, "findError", [construct_path, message]))
    ...
    def find_info(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Annotations.find_info)
            check_type(argname="argument construct_path", value=construct_path, expected_type=type_hints["construct_path"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
        return typing.cast(typing.List[aws_cdk.cx_api.SynthesisMessage], jsii.invoke(self, "findInfo", [construct_path, message]))
    ...
    def find_warning(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Annotations.find_warning)
            check_type(argname="argument construct_path", value=construct_path, expected_type=type_hints["construct_path"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
        return typing.cast(typing.List[aws_cdk.cx_api.SynthesisMessage], jsii.invoke(self, "findWarning", [construct_path, message]))
    ...
    def has_error(self, construct_path: builtins.str, message: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Annotations.has_error)
            check_type(argname="argument construct_path", value=construct_path, expected_type=type_hints["construct_path"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
    ...
    def has_info(self, construct_path: builtins.str, message: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Annotations.has_info)
            check_type(argname="argument construct_path", value=construct_path, expected_type=type_hints["construct_path"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
    ...
    def has_no_error(self, construct_path: builtins.str, message: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Annotations.has_no_error)
            check_type(argname="argument construct_path", value=construct_path, expected_type=type_hints["construct_path"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
    ...
    def has_no_info(self, construct_path: builtins.str, message: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Annotations.has_no_info)
            check_type(argname="argument construct_path", value=construct_path, expected_type=type_hints["construct_path"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
    ...
    def has_no_warning(self, construct_path: builtins.str, message: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Annotations.has_no_warning)
            check_type(argname="argument construct_path", value=construct_path, expected_type=type_hints["construct_path"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
    ...
    def has_warning(self, construct_path: builtins.str, message: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Annotations.has_warning)
            check_type(argname="argument construct_path", value=construct_path, expected_type=type_hints["construct_path"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
...
class Match(metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/assertions.Match"):
    ...
    def array_equals(cls, pattern: typing.Sequence[typing.Any]) -> "Matcher":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Match.array_equals)
    ...
    def exact(cls, pattern: typing.Any) -> "Matcher":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Match.exact)
            check_type(argname="argument pattern", value=pattern, expected_type=type_hints["pattern"])
    ...
    def not_(cls, pattern: typing.Any) -> "Matcher":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Match.not_)
            check_type(argname="argument pattern", value=pattern, expected_type=type_hints["pattern"])
    ...
    def object_equals(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Match.object_equals)
            check_type(argname="argument pattern", value=pattern, expected_type=type_hints["pattern"])
    ...
    def serialized_json(cls, pattern: typing.Any) -> "Matcher":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Match.serialized_json)
            check_type(argname="argument pattern", value=pattern, expected_type=type_hints["pattern"])
...
class MatchCapture:
    def __init__(self, *, capture: "Capture", value: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MatchCapture.__init__)
...
class MatchFailure:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MatchFailure.__init__)
...
class MatchResult(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/assertions.MatchResult"):
    ...
    def __init__(self, target: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MatchResult.__init__)
    ...
    def compose(self, id: builtins.str, inner: "MatchResult") -> "MatchResult":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MatchResult.compose)
    ...
    def push(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MatchResult.push)
            check_type(argname="argument matcher", value=matcher, expected_type=type_hints["matcher"])
            check_type(argname="argument path", value=path, expected_type=type_hints["path"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
...
class Matcher(
    ...
    def is_matcher(cls, x: typing.Any) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Matcher.is_matcher)
...
class _MatcherProxy(Matcher):
    ...
    def test(self, actual: typing.Any) -> MatchResult:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Matcher.test)
...
class Template(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/assertions.Template"):
    ...
    def from_json(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.from_json)
            check_type(argname="argument template", value=template, expected_type=type_hints["template"])
        return typing.cast("Template", jsii.sinvoke(cls, "fromJSON", [template]))

    @jsii.member(jsii_name="fromStack")
    @builtins.classmethod
    def from_stack(cls, stack: aws_cdk.core.Stack) -> "Template":
        '''Base your assertions on the CloudFormation template synthesized by a CDK ``Stack``.

        :param stack: the CDK Stack to run assertions on.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.from_stack)
            check_type(argname="argument stack", value=stack, expected_type=type_hints["stack"])
    ...
    def from_string(cls, template: builtins.str) -> "Template":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.from_string)
            check_type(argname="argument template", value=template, expected_type=type_hints["template"])
    ...
    def find_conditions(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.find_conditions)
    ...
    def find_mappings(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.find_mappings)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def find_outputs(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.find_outputs)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def find_parameters(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.find_parameters)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def find_resources(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.find_resources)
    ...
    def has_condition(self, logical_id: builtins.str, props: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.has_condition)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def has_mapping(self, logical_id: builtins.str, props: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.has_mapping)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def has_output(self, logical_id: builtins.str, props: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.has_output)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def has_parameter(self, logical_id: builtins.str, props: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.has_parameter)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def has_resource(self, type: builtins.str, props: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.has_resource)
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def has_resource_properties(self, type: builtins.str, props: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.has_resource_properties)
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def resource_count_is(self, type: builtins.str, count: jsii.Number) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.resource_count_is)
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
    ...
    def template_matches(self, expected: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Template.template_matches)
...
class Capture(
    ...
    def __init__(self, pattern: typing.Any = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Capture.__init__)
            check_type(argname="argument pattern", value=pattern, expected_type=type_hints["pattern"])
    ...
    def test(self, actual: typing.Any) -> MatchResult:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Capture.test)
            check_type(argname="argument actual", value=actual, expected_type=type_hints["actual"])
        return typing.cast(MatchResult, jsii.invoke(self, "test", [actual]))
