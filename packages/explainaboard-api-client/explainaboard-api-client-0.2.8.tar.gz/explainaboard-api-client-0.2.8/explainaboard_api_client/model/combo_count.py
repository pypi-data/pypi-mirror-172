...
class ComboCount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, bucket, count, samples, *args, **kwargs):  # noqa: E501
        """ComboCount - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, bucket, count, samples, *args, **kwargs):  # noqa: E501
        """ComboCount - a model defined in OpenAPI
