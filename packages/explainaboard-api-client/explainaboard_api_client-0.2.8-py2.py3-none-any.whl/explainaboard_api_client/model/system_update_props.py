...
class SystemUpdateProps(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'metadata': (SystemMetadataUpdatable,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, metadata, *args, **kwargs):  # noqa: E501
        """SystemUpdateProps - a model defined in OpenAPI

        Args:
            metadata (SystemMetadataUpdatable):
