...
class BenchmarkDatasetConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dataset_name, *args, **kwargs):  # noqa: E501
        """BenchmarkDatasetConfig - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, dataset_name, *args, **kwargs):  # noqa: E501
        """BenchmarkDatasetConfig - a model defined in OpenAPI
