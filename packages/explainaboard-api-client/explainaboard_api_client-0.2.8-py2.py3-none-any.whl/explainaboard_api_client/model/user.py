...
class User(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, email, api_key, preferred_username, *args, **kwargs):  # noqa: E501
        """User - a model defined in OpenAPI

        Args:
            id (str): a unique identifier for the authenticated user.
            email (str):
            api_key (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, email, api_key, preferred_username, *args, **kwargs):  # noqa: E501
        """User - a model defined in OpenAPI
