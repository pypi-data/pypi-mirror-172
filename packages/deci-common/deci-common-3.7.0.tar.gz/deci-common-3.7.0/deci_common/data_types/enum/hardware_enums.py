...
class HardwareTypeLabel(str, Enum):
    ...
    K80 = HardwareType.K80.value
    V100 = HardwareType.V100.value
    T4 = HardwareType.T4.value
    A10G = HardwareType.A10G.value
    A100_80G = HardwareType.A100_80G.value
    A100_40G = HardwareType.A100_40G.value
    CPU = HardwareType.CPU.value
    EPYC = HardwareType.EPYC.value
    EPYC_7002 = HardwareType.EPYC_7002.value
    EPYC_7003 = HardwareType.EPYC_7003.value
    CASCADE_LAKE = HardwareType.CASCADE_LAKE.value
    SKYLAKE = HardwareType.SKYLAKE.value
    Broadwell = HardwareType.Broadwell.value
    Icelake = HardwareType.Icelake.value
...
class MapHardwareTypeToEnvironment(str, Enum):
    ...
    CPU = HardwareEnvironment.AWS.value
...
class MapHardwareTypeToDefaultBatchSizeList(list, Enum):
    ...
    A10G = get_enum_values(BatchSize)
    A100_80G = get_enum_values(BatchSize)
    A100_40G = get_enum_values(BatchSize)
    CPU = get_enum_values(BatchSize)
    EPYC = get_enum_values(BatchSize)
    EPYC_7002 = get_enum_values(BatchSize)
    EPYC_7003 = get_enum_values(BatchSize)
    ...
    Icelake = get_enum_values(BatchSize)
