    ...
    def parse(self) -> List[BaseAnnotation]:
        ...
        for dataset_count, input_data in enumerate(self.mot_input_data):
            ...
            for annotation_line in annotation_lines:
                ...
                annotation_line_dict[frame_id].append(annotation_line)
