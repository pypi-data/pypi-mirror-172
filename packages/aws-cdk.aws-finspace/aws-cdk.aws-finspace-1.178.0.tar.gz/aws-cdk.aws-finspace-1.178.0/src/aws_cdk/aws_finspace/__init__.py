...
class CfnEnvironment(
    ...
    def __init__(
        ...
        *,
        ...
        federation_parameters: typing.Optional[typing.Union[typing.Union["CfnEnvironment.FederationParametersProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable]] = None,
        kms_key_id: typing.Optional[builtins.str] = None,
        superuser_parameters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnEnvironment.SuperuserParametersProperty", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
