...
# -*- coding: utf-8 -*-
#########################################################
## Thai Language Toolkit : version  1.5.9
...
class TextProp:
    ...
    tfidf = 0. ## Sum of TNC-tfidf of a word 
    tncdisp = 0. ## Sum of TNC-dispersion of a word
    ttcdisp = 0. ## Sum of TTC-dispersion of a word 
    arf = 0. ## Sum of averaged reduced frequency of a word
...
#            print(w,vars(wrd))
    ...
    for w in WRD:
        if 'tnc-tfidf' in WRD[w]: txt.tfidf += WRD[w]['tnc-tfidf']        
        if 'tnc-disp' in WRD[w]: txt.tncdisp += WRD[w]['tnc-disp']        
        if 'ttc-disp' in WRD[w]: txt.ttcdisp += WRD[w]['ttc-disp']        

    for w in txt.wrd:
#        print("wrd_lst",words_lst)
#        print("word",w)
        txt.wrd_arf[w] = ARF(words_lst,w)
        txt.arf += txt.wrd_arf[w]
    ...
    txt.avgtfidf = txt.tfidf/txt.totaltype
    txt.avgtncdisp = txt.tncdisp/txt.totaltype
    txt.avgttcdisp = txt.ttcdisp/txt.totaltype
    txt.avgarf = txt.arf/txt.totaltype
