Thai Language Toolkit Project  version 1.5.9
============================================
...
Updates:
--------
Version 1.5.8 : add average reduced frequency
...
* avgarf ## average of arf of each word in the text
* pos ## saved as  { POS=freq } (e.g. NOUN, VERB, ADV, ...)
* wrd ##  wrd[word]=freq
* wrd_arf ##  wrd_arf[word]=arf
