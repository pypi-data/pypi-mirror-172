    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(bootstrap_options, dict):
            bootstrap_options = BootstrapOptions(**bootstrap_options)
        if __debug__:
            type_hints = typing.get_type_hints(CapacityOptions.__init__)
...
class KubernetesResource(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(KubernetesResource.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class KubernetesResourceProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(KubernetesResourceProps.__init__)
            check_type(argname="argument cluster", value=cluster, expected_type=type_hints["cluster"])
...
class Mapping:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Mapping.__init__)
...
class Cluster(
    ...
    def add_auto_scaling_group(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Cluster.add_auto_scaling_group)
    ...
    def add_capacity(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Cluster.add_capacity)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_chart(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Cluster.add_chart)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_resource(
        ...
        *manifest: typing.Any,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Cluster.add_resource)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
