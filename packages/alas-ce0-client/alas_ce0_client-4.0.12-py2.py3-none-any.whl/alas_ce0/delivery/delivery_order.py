...
def get_status_info_wom(delivery_order):
    events_info, status, last_event_timestamp = None, None, None, None
    ...
    if delivery_order['status'] == DeliveryOrderStatusType.PhysicallyReceived.value:
        ...
        status = "Intento {} No Entregada".format("1")
        ...
        status = 'En Devolución por cliente'
        ...
        status = 'En Devolución por transportista'
