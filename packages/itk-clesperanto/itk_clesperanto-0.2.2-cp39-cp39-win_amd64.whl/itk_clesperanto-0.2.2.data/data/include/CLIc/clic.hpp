...
#define CLIC_MINOR_VERSION (5)
#define CLIC_PATCH_VERSION (4)
#define CLIC_VERSION "0.5.4"
...
static const std::string GetOpenCLErrorName(cl_int error)
{
    switch(error)
    {
        ...
        case -1010: return "CL_INVALID_D3D9_DEVICE_NV";
        case -1011: return "CL_INVALID_D3D9_RESOURCE_NV";
        case -1012: return "CL_D3D9_RESOURCE_ALREADY_ACQUIRED_NV";
        case -1013: return "CL_D3D9_RESOURCE_NOT_ACQUIRED_NV";
        ...
        // others
        case -9999: return "NVIDIA_ILLEGAL_ACCESS_TO_MEMORY";
        default: return "UNKNOWN_ERROR_CODE";
        }
}

// from http://www.techdarting.com/2014/01/opencl-errors.html
static const std::string GetOpenCLErrorDescription(cl_int error) 
{
	std::string result = "";
	switch (error) 
    {
...
static const std::string GetOpenCLErrorInfo(cl_int error) 
{
