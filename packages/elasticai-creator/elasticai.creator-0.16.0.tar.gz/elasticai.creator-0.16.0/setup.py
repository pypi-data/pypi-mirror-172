...
['elasticai',
 ...
 'elasticai.creator.tests.vhdl.components',
 'elasticai.creator.tests.vhdl.custom_layers',
 'elasticai.creator.tests.vhdl.evaluators',
 'elasticai.creator.tests.vhdl.translator',
 'elasticai.creator.tests.vhdl.translator.abstract',
 'elasticai.creator.tests.vhdl.translator.abstract.layers',
 'elasticai.creator.tests.vhdl.translator.pytorch',
 'elasticai.creator.tests.vhdl.translator.pytorch.build_functions',
 'elasticai.creator.vhdl',
 'elasticai.creator.vhdl.components',
 'elasticai.creator.vhdl.custom_layers',
 'elasticai.creator.vhdl.evaluators',
...
extras_require = \
{':extra == "onnx"': ['numpy>=1.23.0,<2.0.0'],
 'examples': ['torchvision>=0.12.0,<0.13.0'],
 'onnx': ['protobuf>=3.16,<3.17', 'onnx>=1.12,<2.0'],
