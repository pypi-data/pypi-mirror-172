...
class ViewsTestCase(RunCommandsMixin, KalmonakTestCase):
    """Views test cases."""
    ...
    def test_graphs(self):
        """Test graphs views."""
        self.run_logparser()
        url = reverse("kalabash_stats:graph_list")
    ...
    def test_graphs_as_domainadmin(self):
        ...
        self.run_logparser()
        self.client.force_login(self.da)
        url = "{}?gset=mailtraffic".format(reverse("kalabash_stats:graph_list"))
    ...
    def test_get_domain_list(self):
        ...
        url = reverse("kalabash_stats:domain_list")
        response = self.ajax_get(url)
...
@override_settings(RRDTOOL_TEST_MODE=True)
class ManagementCommandsTestCase(RunCommandsMixin, KalmonakTestCase):
