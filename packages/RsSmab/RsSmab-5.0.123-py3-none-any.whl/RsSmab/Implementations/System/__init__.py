...
class SystemCls:
	"""System commands group definition. 185 total commands, 35 Subgroups, 29 group commands"""
	...
	def get_iresponse(self) -> str:
		...
		specific command set is disabled, i.e. the SCPI command method RsSmab.System.iresponse is discarded. \n
	...
	def get_oresponse(self) -> str:
		...
		command set is disabled, i.e. the SCPI command method RsSmab.System.oresponse is discarded. \n
	...
	def recall(self, path_name: str) -> None:
		...
		Loads a file with previously saved R&S SMA100B settings. Loads the selected file with previously saved R&S SMA100B
	...
	def save(self, path_name: str) -> None:
		...
		Saves the current R&S SMA100B settings into a file with defined filename and into a specified directory.
