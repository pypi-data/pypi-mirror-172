...
class SettingCls:
	...
	def get_catalog(self) -> List[str]:
		...
		Snippet: value: List[str] = driver.source.vor.setting.get_catalog() \n
		...
		default and in a specific directory. \n
			:return: avionic_vor_cat_names: filename1,filename2,... Returns a string of filenames separated by commas.
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:VOR:SETTing:CATalog?')
