...
class CommonCls:
	...
	def get_hostname(self) -> str:
		...
		Sets an individual hostname for the Signal Generator. Note: We recommend that you do not change the hostname to avoid
		problems with the network connection. If you change the hostname, be sure to use a unique name.
		This is a password-protected function. Unlock the protection level 1 to access it. See method RsSmab.System.Protect.State.
		set. \n
