...
class MeasureCls:
	...
	def get(self, force: str = None) -> bool:
		...
		Starts all internal adjustments that do not need external measuring equipment. NOTICE! High power at the RF output
		applied during internal adjustment can destroy a connected DUT (device under test) . How to: See 'Running internal
		adjustments'. \n
			:param force: string
