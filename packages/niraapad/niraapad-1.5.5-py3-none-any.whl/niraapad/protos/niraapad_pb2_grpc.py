...
class NiraapadStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ConfigSetter = channel.unary_unary(
                '/Niraapad/ConfigSetter',
                request_serializer=niraapad_dot_protos_dot_niraapad__pb2.ConfigSetterReq.SerializeToString,
                response_deserializer=niraapad_dot_protos_dot_niraapad__pb2.ConfigSetterResp.FromString,
                )
        self.ConfigGetter = channel.unary_unary(
                '/Niraapad/ConfigGetter',
                request_serializer=niraapad_dot_protos_dot_niraapad__pb2.ConfigGetterReq.SerializeToString,
                response_deserializer=niraapad_dot_protos_dot_niraapad__pb2.ConfigGetterResp.FromString,
                )
...
class NiraapadServicer(object):
    ...
    def ConfigSetter(self, request, context):
        """Used for rule base config file
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def ConfigGetter(self, request, context):
        """Used for getting variables from config file
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_NiraapadServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ConfigSetter': grpc.unary_unary_rpc_method_handler(
                    servicer.ConfigSetter,
                    request_deserializer=niraapad_dot_protos_dot_niraapad__pb2.ConfigSetterReq.FromString,
                    response_serializer=niraapad_dot_protos_dot_niraapad__pb2.ConfigSetterResp.SerializeToString,
            ),
            'ConfigGetter': grpc.unary_unary_rpc_method_handler(
                    servicer.ConfigGetter,
                    request_deserializer=niraapad_dot_protos_dot_niraapad__pb2.ConfigGetterReq.FromString,
                    response_serializer=niraapad_dot_protos_dot_niraapad__pb2.ConfigGetterResp.SerializeToString,
            ),
    }
...
class Niraapad(object):
    ...
    def ConfigSetter(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Niraapad/ConfigSetter',
            niraapad_dot_protos_dot_niraapad__pb2.ConfigSetterReq.SerializeToString,
            niraapad_dot_protos_dot_niraapad__pb2.ConfigSetterResp.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def ConfigGetter(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Niraapad/ConfigGetter',
            niraapad_dot_protos_dot_niraapad__pb2.ConfigGetterReq.SerializeToString,
            niraapad_dot_protos_dot_niraapad__pb2.ConfigGetterResp.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
