...
sys.path.append(file_path + '\detective')
...
class VirtualConfigVariables(NiraapadClient, metaclass=AttributeMeta):
    """
    This class is just a facade. It's objective is to provide the
    interface for setting, updating and fetching the configuration 
    variables from configuration file for detection.
    """
    
    niraapad_backend_type = utils.BACKENDS.CONFIG_VARIABLES

    def __init__(self, *args, **kwargs):
        return self.config_variables(*args, **kwargs)
    
    def new_config(self, *args, **kwargs):
        return self.config_variables(*args, **kwargs)

    def get_from_file(self, *args, **kwargs):
        return self.config_getter(*args, **kwargs)

    def add_predicate(self, *args, **kwargs):
        return self.config_variables(*args, **kwargs)
    
    def remove_predicates(self, *args, **kwargs):
        return self.config_variables(*args, **kwargs)

    def update_init_state(self, *args, **kwargs):
        return self.config_variables(*args, **kwargs)
    
    def update_transit_table(self, *args, **kwargs):
        return self.config_variables(*args, **kwargs)
    
    def update_rule_table(self, *args, **kwargs):
        return self.config_variables(*args, **kwargs)
...
DirectConfigVariables = user_interface.ConfigVariables
user_interface.ConfigVariables = VirtualConfigVariables
# ===================================================
