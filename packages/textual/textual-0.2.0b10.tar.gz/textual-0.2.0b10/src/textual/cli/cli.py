...
def console(verbose: bool, exclude: list[str]) -> None:
    ...
    try:
        ...
        console.print("[b red]Unable to import devtools")
        console.print("You may need to install the [i]dev[/i] dependencies.")
        console.print("See https://textual.textualize.io/getting_started/")
        return
