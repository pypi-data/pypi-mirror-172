...
from .TD_hist import HistoricalREST , cache_symbol_id
...
class TD:
    ...
    def full_feed_bidask_callback(self , func: Callable ):
        self.logger.info(f"Defining full feed bidask_callback...")
        self.live_websocket.full_feed_bidask_callback = func
    ...
    def clear_full_feed_bidask_callback(self):
        self.logger.info(f"Clearing full feed bidask_callback...")
        self.live_websocket.full_feed_bidask_callback = None
