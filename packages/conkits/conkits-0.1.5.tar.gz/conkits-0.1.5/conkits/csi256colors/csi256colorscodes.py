...
RESET_ALL = '\033[0m'
ERROR_CSI_STR = '\033[38;5;9m'


class Csi256ColorsCode:
    def __init__(self, color_code, color_type):
        if color_code < 0 or color_code > 255:
            raise ValueError(ERROR_CSI_STR + f'数值{color_code}超出范围0 - 255' + RESET_ALL)
        self.color_type = color_type
        if color_type == 'Fore':
            self.csi_header = CSI + '38;5;'
        elif color_type == 'Back':
            self.csi_header = CSI + '48;5;'
        else:
            raise TypeError(ERROR_CSI_STR + f'未知256色类型{color_type}' + RESET_ALL)
        self.color_code = color_code
        self.csi_str = self.csi_header + str(color_code) + 'm'
    ...
    def __sub__(self, other):
        ...
        if isinstance(other, int):
            ...
            if self.color_type == 'Fore':
                ...
                raise TypeError(ERROR_CSI_STR + f'BackCode类型与ForeCode类型不能相减' + RESET_ALL)
        elif isinstance(other, BackCode):
            if self.color_type == 'Back':
                color_code = (self.color_code - other.color_code) % 256
                return codes_set.get_code_obj(color_code, 'Back')
            else:
                raise TypeError(ERROR_CSI_STR + f'ForeCode类型与BackCode类型不能相减' + RESET_ALL)
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, int):
            ...
            if self.color_type == 'Fore':
                ...
                raise TypeError(ERROR_CSI_STR + f'BackCode类型与ForeCode类型不能相乘' + RESET_ALL)
        elif isinstance(other, BackCode):
            if self.color_type == 'Back':
                color_code = (self.color_code * other.color_code) % 256
                return codes_set.get_code_obj(color_code, 'Back')
            else:
                raise TypeError(ERROR_CSI_STR + f'ForeCode类型与类BackCode型不能相乘' + RESET_ALL)
    ...
    def __floordiv__(self, other):
        ...
        if isinstance(other, int):
            ...
            if self.color_type == 'Fore':
                ...
                raise TypeError(ERROR_CSI_STR + f'BackCode类型与ForeCode类型不能做整除' + RESET_ALL)
        elif isinstance(other, BackCode):
            if self.color_type == 'Back':
                color_code = (self.color_code // other.color_code) % 256
                return codes_set.get_code_obj(color_code, 'Back')
            else:
                raise TypeError(ERROR_CSI_STR + f'ForeCode类型与类BackCode型不能做整除' + RESET_ALL)
    ...
    def __mod__(self, other):
        ...
        if isinstance(other, int):
            ...
            if self.color_type == 'Fore':
                ...
                raise TypeError(ERROR_CSI_STR + f'BackCode类型与ForeCode类型不能做求模运算' + RESET_ALL)
        elif isinstance(other, BackCode):
            if self.color_type == 'Back':
                color_code = (self.color_code % other.color_code) % 256
                return codes_set.get_code_obj(color_code, 'Back')
            else:
                raise TypeError(ERROR_CSI_STR + f'ForeCode类型与类BackCode型不能做求模运算' + RESET_ALL)
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, int):
            ...
            if self.color_type == 'Fore':
                ...
                raise TypeError(ERROR_CSI_STR + f'BackCode类型与ForeCode类型不能比较' + RESET_ALL)
        elif isinstance(other, BackCode):
            if self.color_type == 'Back':
                return self.color_code == other.color_code
            else:
                raise TypeError(ERROR_CSI_STR + f'ForeCode类型与类BackCode型不能比较' + RESET_ALL)
...
class ForeCode(Csi256ColorsCode):
    def __init__(self, color_code):
        super(ForeCode, self).__init__(color_code, 'Fore')


class BackCode(Csi256ColorsCode):
    def __init__(self, color_code):
