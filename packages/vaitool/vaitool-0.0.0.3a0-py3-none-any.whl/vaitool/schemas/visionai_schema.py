...
class ObjectDataTextElement(BaseModel):
...
class ObjectDataMatrixElement(BaseModel):
    name: str = Field(
        ...,
        description="This is a string encoding the name of this object data."
    )
...
class FrameObjectData(BaseModel):
    ...
    text: Optional[list[ObjectDataTextElement]] = Field(
        None, description='List of "path" that describe this object semantic path location.'
    )
    mat: Optional[list[ObjectDataMatrixElement]] = Field(
        None, description='List of "matrix" that describe this object matrix information such as `confidence_score`.'
    )
...
class VisionAI(BaseModel):
    ...
    contexts: Optional[dict[str,Context]]
