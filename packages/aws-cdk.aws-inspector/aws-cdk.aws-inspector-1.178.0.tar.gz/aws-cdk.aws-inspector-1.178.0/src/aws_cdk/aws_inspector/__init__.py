...
class CfnAssessmentTarget(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAssessmentTarget.__init__)
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAssessmentTarget.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAssessmentTarget._render_properties)
    ...
    def assessment_target_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAssessmentTarget, "assessment_target_name").fset)
    ...
    def resource_group_arn(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAssessmentTarget, "resource_group_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnAssessmentTargetProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAssessmentTargetProps.__init__)
...
class CfnAssessmentTemplate(
    ...
    def __init__(
        ...
        *,
        ...
        user_attributes_for_findings: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[typing.Union[aws_cdk.core.CfnTag, typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable]]]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAssessmentTemplate.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAssessmentTemplate.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAssessmentTemplate._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def assessment_target_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAssessmentTemplate, "assessment_target_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def duration_in_seconds(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAssessmentTemplate, "duration_in_seconds").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def rules_package_arns(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAssessmentTemplate, "rules_package_arns").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def assessment_template_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAssessmentTemplate, "assessment_template_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def user_attributes_for_findings(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAssessmentTemplate, "user_attributes_for_findings").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnAssessmentTemplateProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAssessmentTemplateProps.__init__)
...
class CfnResourceGroup(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        resource_group_tags: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[typing.Union[aws_cdk.core.CfnTag, typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable]]],
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnResourceGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnResourceGroup.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnResourceGroup._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def resource_group_tags(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnResourceGroup, "resource_group_tags").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnResourceGroupProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnResourceGroupProps.__init__)
