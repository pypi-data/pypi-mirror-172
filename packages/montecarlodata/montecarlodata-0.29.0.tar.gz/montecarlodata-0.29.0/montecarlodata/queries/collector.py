...
mutation createCollectorRecord($templateProvider:String, $templateVariant:String) {
  createCollectorRecord(templateProvider:$templateProvider, templateVariant:$templateVariant) {
    dc {
      uuid
    }
  }
