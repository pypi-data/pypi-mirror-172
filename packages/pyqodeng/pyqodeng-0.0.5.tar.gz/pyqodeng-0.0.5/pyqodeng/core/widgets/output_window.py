...
from pyqodeng.core.api import CodeEdit, SyntaxHighlighter, TextHelper
from pyqodeng.core.api.client import PROCESS_ERROR_STRING
...
class OutputWindow(CodeEdit):
    ...
    def _init_code_edit(self, backend):
        ...
        self.remove_action(self.action_indent, sub_menu="Advanced")
        self.remove_action(self.action_un_indent, sub_menu="Advanced")
        self.remove_action(self.action_goto_line, sub_menu="Advanced")
