...
setup_args = dict(
    ...
    long_description="",
    author="pranjal tank (quanturf_test)",
    author_email="pranjalt7869@gmail.com",
    url="https://github.com/pranjal-tank/quanturf_pypi_package_test.git",
    license="GPLv3",
    ...
    entry_points={
        "console_scripts": [
            "myscript = quanturf_test.__main__:main",
        ]
    }
)
