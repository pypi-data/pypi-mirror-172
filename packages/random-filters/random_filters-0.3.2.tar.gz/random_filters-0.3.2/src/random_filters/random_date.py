...
def random_date(start: str, end: str, n=None) -> list[str] | str:
    """
...
def random_last_date(n=None) -> str:
    """
...
def random_year(start=None) -> str:
    """
...
def random_month_year(start=None) -> str:
    """
