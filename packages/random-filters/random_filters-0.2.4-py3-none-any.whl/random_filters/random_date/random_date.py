...
class RandomDate(object):
    ...
    def random_date(self, start: str, end: str, n=None) -> list[str] | str:
        """
        ...
        if n is not None:
            ...
            for i in range(n):
                ...
                date_list.sort()
            return 'de ' + date_list[0] + ' ate ' + date_list[-1]
        else:
    ...
    def random_last_date(self, n=None) -> str:
        """
    ...
    def random_year(self, start=None) -> str:
        """
    ...
    def random_month_year(self, start=None) -> str:
        """
