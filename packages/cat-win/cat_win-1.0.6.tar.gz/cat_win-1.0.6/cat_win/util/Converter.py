...
class Converter():
    def is_decimal(self, v: str) -> bool:
        """
    ...
    def _fromDEC(self, value: int, leading: bool = False) -> str:
        ...
        """
        return str(value) + " {Hexadecimal: " + self.__dec_to_hex__(value, leading) + "; Binary: " + self.__dec_to_bin__(value, leading) + "}"
    ...
    def _fromHEX(self, value: str, leading: bool = False) -> str:
        ...
        """
        return value + " {Decimal: " + self.__hex_to_dec__(value) + "; Binary: " + self.__hex_to_bin__(value, leading) + "}"
    ...
    def _fromBIN(self, value: str, leading: bool = False) -> str:
        ...
        """
        return str(value) + " {Decimal: " + self.__bin_to_dec__(value) + "; Hexadecimal: " + self.__bin_to_hex__(value, leading) + "}"