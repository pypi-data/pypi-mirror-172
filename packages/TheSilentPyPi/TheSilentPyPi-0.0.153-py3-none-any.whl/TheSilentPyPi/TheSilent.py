        ...
        for i in range (minimum, maximum):
            ...
            for ii in itertools.product(dictionary, repeat = i):
                ...
                if result.hexdigest() == my_hash:
                    crack_boolean = True
                    print(red + "seconds: " + end - start)
                    print(red + "password: " + compute)
                    break
    ...
    if hash_type == "sha256":
        ...
        for i in range (minimum, maximum):
            ...
            for ii in itertools.product(dictionary, repeat = i):
                ...
                result = hashlib.sha256(compute.encode("utf8"))
...
def dictionary_hash(my_file, my_hash, hash_type = "sha1"):
    ...
    if hash_type == "blake2b":
        print(red + "cracking blake2b hash")
        ...
        for i in range (1, 5):
            ...
            for ii in itertools.product(word_list, repeat = i):
                ...
                result = hashlib.blake2b(compute.encode("utf8")).hexdigest()

                if result == my_hash:
                    crack_boolean = True
                    print(red + "password: " + str(ii))
                    break

    if hash_type == "md5":
        print(red + "cracking md5 hash")
        ...
        for i in range (1, 5):
            ...
            for ii in itertools.product(word_list, repeat = i):
                ...
                result = hashlib.md5(compute.encode("utf8")).hexdigest()
    ...
    if hash_type == "sha1":
        ...
        for i in range (1, 5):
            ...
            for ii in itertools.product(word_list, repeat = i):
                ...
                result = hashlib.sha1(compute.encode("utf8")).hexdigest()
    ...
    if hash_type == "sha256":
        print(red + "cracking sha256 hash")
        ...
        for i in range (1, 5):
            ...
            for ii in itertools.product(word_list, repeat = i):
                ...
                result = hashlib.sha256(compute.encode("utf8")).hexdigest()
    ...
    if hash_type == "sha384":
        print(red + "cracking sha384 hash")
        ...
        for i in range (1, 5):
            ...
            for ii in itertools.product(word_list, repeat = i):
                ...
                result = hashlib.sha384(compute.encode("utf8")).hexdigest()
    ...
    if hash_type == "sha512":
        print(red + "cracking sha512 hash")
        ...
        for i in range (1, 5):
            ...
            for ii in itertools.product(word_list, repeat = i):
                ...
                result = hashlib.sha512(compute.encode("utf8")).hexdigest()
    ...
    if hash_type == "sha512_224":
        print(red + "cracking sha512_224 hash")
        ...
        for i in range (1, 5):
            ...
            for ii in itertools.product(word_list, repeat = i):
                ...
                result = hashlib.sha512_224(compute.encode("utf8")).hexdigest()
    ...
    if hash_type == "sha3_384":
        print(red + "cracking sha3_384 hash")
        ...
        for i in range (1, 5):
            ...
            for ii in itertools.product(word_list, repeat = i):
                ...
                result = hashlib.sha3_384(compute.encode("utf8")).hexdigest()
        ...
        try:
            ...
            if protocol == proto:
                ...
                if parse == "all":
                    ...
                    if len(email) > 0 or len(website) > 0:
                        print(red + "emails: " + str(email))
                        print(red + "websites: " + str(website))
...
print(sql_injection_scanner("testphp.vulnweb.com", secure = False))
