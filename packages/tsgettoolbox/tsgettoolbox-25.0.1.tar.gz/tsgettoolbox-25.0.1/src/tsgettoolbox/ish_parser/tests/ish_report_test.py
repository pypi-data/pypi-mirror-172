...
class ish_report_test(unittest.TestCase):
    ...
    def test_single_reading(self):
        ...
        weather.loads(noaa_string)
        self.assertEqual(
            weather.datetime, datetime.datetime(2014, 1, 1, 1, 8, tzinfo=pytz.UTC)
        )
    ...
    def test_present_weather(self):
        ...
        weather = ish_report()
        weather.loads(noaa_string)
        self.assertEqual(weather.present_weather, ["Light Snow"])
    ...
    def test_report_with_big_quality_section(self):
        ...
        weather.loads(noaa)
        self.assertEqual(
            weather.datetime, datetime.datetime(1970, 5, 2, 0, 0, tzinfo=pytz.UTC)
        )
    ...
    def test_fm15(self):
        ...
        weather.loads(noaa_string)
        self.assertEqual(
            weather.datetime, datetime.datetime(2014, 1, 1, 0, 51, tzinfo=pytz.UTC)
        )
        self.assertEqual(weather.wban, "94846")
        self.assertEqual(weather.weather_station, "725300")
        self.assertEqual(weather.report_type, "FM-15")
    ...
    def test_snowfall(self):
        ...
        self.assertEqual(
            weather.datetime, datetime.datetime(2014, 1, 1, 5, 51, tzinfo=pytz.UTC)
        )
        self.assertEqual(
            weather.snow_depth, [{"depth": 8, "quality": "5", "condition": "9"}]
        )
    ...
    def test_random_sod_file(self):
        ...
        weather.loads(noaa_string)
        self.assertEqual(
            weather.datetime, datetime.datetime(2008, 2, 2, 5, 59, tzinfo=pytz.UTC)
        )
        precip = weather.precipitation[0]
    ...
    def test_another_random_string(self):
        ...
        weather.loads(noaa_string)
        self.assertEqual(
            weather.datetime, datetime.datetime(1980, 2, 8, 12, 0, tzinfo=pytz.UTC)
        )
    ...
    def test_crazy_remarks(self):
        ...
        weather.loads(noaa_string)
        self.assertEqual(
            weather.datetime, datetime.datetime(2006, 3, 1, 5, 59, tzinfo=pytz.UTC)
        )
    ...
    def test_with_crazy_metar_in_remarks(self):
        ...
        self.assertEqual(
            weather.datetime, datetime.datetime(1973, 1, 31, 22, 0, tzinfo=pytz.UTC)
        )
    ...
    def test_bad_length(self):
        ...
        self.assertRaises(ish_reportException, ish_report().loads, noaa_string)
    ...
    def test_old_ord(self):
        ...
        ish.loads(noaa)
        self.assertEqual(
            ish.datetime, datetime.datetime(1946, 10, 1, 9, tzinfo=pytz.UTC)
        )
    ...
    def test_string_that_caused_infinite_recursion(self):
        ...
        ish.loads(noaa)
        self.assertEqual(
            ish.datetime, datetime.datetime(1943, 7, 2, 0, 0, tzinfo=pytz.UTC)
        )
        self.assertEqual(ish.air_temperature.get_fahrenheit(), "MISSING")
