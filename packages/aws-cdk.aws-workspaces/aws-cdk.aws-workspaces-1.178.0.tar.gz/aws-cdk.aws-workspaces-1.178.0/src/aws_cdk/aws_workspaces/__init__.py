...
class CfnConnectionAlias(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnConnectionAlias.__init__)
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnConnectionAlias.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnConnectionAlias._render_properties)
    ...
    def connection_string(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnConnectionAlias, "connection_string").fset)
    ...
    class ConnectionAliasAssociationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnConnectionAlias.ConnectionAliasAssociationProperty.__init__)
...
class CfnConnectionAliasProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnConnectionAliasProps.__init__)
...
class CfnWorkspace(
    ...
    def __init__(
        ...
        *,
        ...
        workspace_properties: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnWorkspace.WorkspacePropertiesProperty", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
    ...
    def bundle_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWorkspace, "bundle_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def directory_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWorkspace, "directory_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def user_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWorkspace, "user_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def root_volume_encryption_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWorkspace, "root_volume_encryption_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def user_volume_encryption_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWorkspace, "user_volume_encryption_enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def volume_encryption_key(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWorkspace, "volume_encryption_key").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def workspace_properties(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWorkspace, "workspace_properties").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class WorkspacePropertiesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnWorkspace.WorkspacePropertiesProperty.__init__)
