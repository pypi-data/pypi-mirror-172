/*! For license information please see 644ceefb.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[70175],{54040:(e,t,i)=>{var r=i(87480),n=i(33310),o=i(58417),a=i(39274);let s=class extends o.A{};s.styles=[a.W],s=(0,r.__decorate)([(0,n.Mo)("mwc-checkbox")],s)},56887:(e,t,i)=>{i.d(t,{F:()=>l});var r=i(87480),n=(i(54040),i(37500)),o=i(33310),a=i(8636),s=i(61092);class l extends s.K{constructor(){super(...arguments),this.left=!1,this.graphic="control"}render(){const e={"mdc-deprecated-list-item__graphic":this.left,"mdc-deprecated-list-item__meta":!this.left},t=this.renderText(),i=this.graphic&&"control"!==this.graphic&&!this.left?this.renderGraphic():n.dy``,r=this.hasMeta&&this.left?this.renderMeta():n.dy``,o=this.renderRipple();return n.dy`
      ${o}
      ${i}
      ${this.left?"":t}
      <span class=${(0,a.$)(e)}>
    ...
    `}},{kind:"method",key:"firstUpdated",value:function(e){v(y(i.prototype),"firstUpdated",this).call(this,e),(0,s.O)()}},{kind:"method",key:"_computeDeviceName",value:function(e,t){const i=e.find((e=>e.id===t));return i?(0,o.jL)(i,this.hass):`<${this.hass.localize("ui.panel.config.integrations.config_entry.unknown_via_device")}>`}},{kind:"get",static:!0,key:"styles",value:function(){return[a.Qx,r.iv`
      ...
      `;const u=(0,m.jL)(f,this.hass),v=this._integrations(f,this.entries),y=this._entities(this.deviceId,this.entities),g=this._entitiesByCategory(y),b=this._batteryEntity(y),k=this._batteryChargingEntity(y),w=b?this.hass.states[b.entity_id]:void 0,_=w&&"binary_sensor"===(0,l.N)(w),x=k?this.hass.states[k.entity_id]:void 0,$=this._computeArea(this.areas,f),C=[],P=[...this._deviceActions||[]];Array.isArray(this._diagnosticDownloadLinks)&&P.push(...this._diagnosticDownloadLinks),this._deleteButtons&&P.push(...this._deleteButtons),P.sort(((e,t)=>"warning"===e.classes&&"warning"!==t.classes?1:"warning"!==e.classes&&"warning"===t.classes?-1:0));const D=P.shift();f.disabled_by&&C.push(t.dy`
          ...
          ${"user"===f.disabled_by?t.dy`
              ...
              `:""}
        `),this._renderIntegrationInfo(f,v,C);const A=(0,a.p)(this.hass,"automation")?t.dy`
          <ha-card outlined>
...
//# sourceMappingURL=644ceefb.js.map