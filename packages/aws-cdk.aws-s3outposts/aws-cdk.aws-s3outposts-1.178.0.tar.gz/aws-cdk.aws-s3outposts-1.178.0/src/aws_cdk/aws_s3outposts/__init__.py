...
class CfnAccessPoint(
    ...
    def __init__(
        ...
        *,
        bucket: builtins.str,
        name: builtins.str,
        vpc_configuration: typing.Union[typing.Union["CfnAccessPoint.VpcConfigurationProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable],
    ...
    def vpc_configuration(
        self,
    ) -> typing.Union["CfnAccessPoint.VpcConfigurationProperty", aws_cdk.core.IResolvable]:
        ...
        '''
        return typing.cast(typing.Union["CfnAccessPoint.VpcConfigurationProperty", aws_cdk.core.IResolvable], jsii.get(self, "vpcConfiguration"))

    @vpc_configuration.setter
    def vpc_configuration(
        self,
        value: typing.Union["CfnAccessPoint.VpcConfigurationProperty", aws_cdk.core.IResolvable],
    ) -> None:
        if __debug__:
...
class CfnAccessPointProps:
    ...
    def vpc_configuration(
        ...
        return typing.cast(typing.Union[CfnAccessPoint.VpcConfigurationProperty, aws_cdk.core.IResolvable], result)
...
class CfnBucket(
    ...
    def outpost_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnBucket, "outpost_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnEndpoint(
    ...
    def outpost_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEndpoint, "outpost_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "outpostId", value)
    ...
    def security_group_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEndpoint, "security_group_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def subnet_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEndpoint, "subnet_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def access_type(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEndpoint, "access_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def customer_owned_ipv4_pool(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnEndpoint, "customer_owned_ipv4_pool").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class NetworkInterfaceProperty:
        def __init__(self, *, network_interface_id: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnEndpoint.NetworkInterfaceProperty.__init__)
