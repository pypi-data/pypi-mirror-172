...
def test_gen4_query_aggregated_metadata():
    ...
    with patch("datalad_deprecated.metadata.metadata.Dump") as dump_mock:
        ...
        import datalad_deprecated.metadata.metadata
        datalad_deprecated.metadata.metadata.next_generation_metadata_available = True
...
def test_metadata_source_handling(temp_dir=None):
    ...
    with patch("datalad_deprecated.metadata.metadata.gen4_query_aggregated_metadata") as gen4_mock, \
         patch("datalad_deprecated.metadata.metadata.legacy_query_aggregated_metadata") as legacy_mock:
