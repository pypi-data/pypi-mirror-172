...
class SmnPhaser(Phaser):
    ...
    def output_variants_in_haplotypes(
        ...
        for hap_name in haplotype_variants:
            if "del" not in hap_name:
                ...
                gene = hap_name[:4]
                haplogroup, candidates1, candidates2 = self.assign_hap(query_hap, gene)
                haplotype_variants[hap_name].append(haplogroup)
            else:
                haplotype_variants[hap_name].append("smn2_del_exon78")
    ...
    def get_best_match(
        ...
        """
        Get match match to a haplogroup
        """
    ...
    def assign_hap(self, query_hap, gene):
        """
