...
from hestia_earth.models.utils.cycle import (
    get_excreta_N_total, get_max_rooting_depth, get_crop_residue_on_field_N_total,
...
def _should_run(cycle: dict, term=TERM_ID, tier=TIER):
    ...
    content_list_of_items = [rooting_depth, clay, sand, rainfall, primary_product]
