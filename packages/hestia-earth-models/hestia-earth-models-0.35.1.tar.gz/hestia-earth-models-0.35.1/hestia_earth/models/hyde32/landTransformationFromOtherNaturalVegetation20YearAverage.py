            ...
            "or": [
                {
                    ...
                    "site": {
                        "@type": "Site",
                        "measurements": [{"@type": "Measurement", "value": "", "term.@id": "fallowCorrection"}]
                    }
                },
                {
...
TERM_ID_CYCLE = 'landTransformationFromOtherNaturalVegetation20YearAverageDuringCycle'
TERM_ID_INPUTS = 'landTransformationFromOtherNaturalVegetation20YearAverageInputsProduction'
TERM_ID = 'landTransformationFromOtherNaturalVegetation20YearAverageDuringCycle,landTransformationFromOtherNaturalVegetation20YearAverageInputsProduction'  # noqa: E501
...
def _should_run(impact_assessment: dict):
    ...
    land_transformation_factor = get_emission_factor(impact_assessment, 20, SiteSiteType.OTHER_NATURAL_VEGETATION)
