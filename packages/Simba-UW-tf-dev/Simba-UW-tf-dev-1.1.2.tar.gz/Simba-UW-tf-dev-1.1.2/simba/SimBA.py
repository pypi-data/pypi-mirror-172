...
class loadprojectini:
    def __init__(self,configini):
        ...
        analyze_roi_time_bins_btn = Button(self.roi_draw, text='Analyze ROI data',command=lambda: SettingsMenu(config_path=self.projectconfigini, title='TIME BINS: ANALYZE ROI'))
