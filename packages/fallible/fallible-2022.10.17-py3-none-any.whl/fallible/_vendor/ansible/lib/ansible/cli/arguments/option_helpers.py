...
def fallible_version(func):
    def inner(*args, **kwargs):
        ...
        post_lines = [
            "",
            "",
            "Fallible experimental build 2022.10.17",
            "(core devel cb2e434dd2359a9fe1c00e75431f4abeff7381e8)",
            "This build contains the following experimental features:",
                        "  - [POC] Add projection feature for registering vars - Option 2: https://github.com/ansible/ansible/pull/72553",
            "  - [POC] Support unpacking loop vars: https://github.com/ansible/ansible/pull/74259",
            "  - [POC] ASCII Splash: https://github.com/ansible/ansible/pull/77489",
            "  - [PoC] Add loop_control.lookup: https://github.com/ansible/ansible/pull/77614",
        ]
        return ret + "\n".join(post_lines)
    return inner
