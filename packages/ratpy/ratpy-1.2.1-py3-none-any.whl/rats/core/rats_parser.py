...
class RatsParser:
    ...
    def _assign_samples_to_edbs(self):
        ...
        def __operate(df):
            ...
            if ((df['PAYLOAD_SIZE'].values[0]-8)*2)/(len(df['ACTIVE_EDBS'].values[0]))%1 >0 :
                print("============================================================================================")
                print(f'The number of samples in LLC {df.name} is not divisible by the number of active rats inputs')
                print("============================================================================================")
