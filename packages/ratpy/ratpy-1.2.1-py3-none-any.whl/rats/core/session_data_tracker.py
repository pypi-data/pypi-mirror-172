    ...
    def parse_data_files(self):
        ...
        # dumb... basically this now does nothing...
            ...
            for name in self.data_files.File.values:
                ...
                if not parser_class.metadata['parse_completed_without_error']:
                    self.data_files.loc[
                        self.data_files['File'] == name, 'Intra_file_analysis'] = 'Parsing incomplete - check log in Data Management App'
