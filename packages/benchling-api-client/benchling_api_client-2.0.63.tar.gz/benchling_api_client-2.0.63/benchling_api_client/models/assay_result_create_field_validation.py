...
class AssayResultCreateFieldValidation:
    ...
    def __repr__(self):
        ...
        return "AssayResultCreateFieldValidation({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = UserValidation.from_dict(prop_dict)

            additional_properties[prop_name] = additional_property

        assay_result_create_field_validation.additional_properties = additional_properties
