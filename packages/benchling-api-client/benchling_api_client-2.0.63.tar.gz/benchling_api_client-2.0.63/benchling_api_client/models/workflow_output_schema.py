...
T = TypeVar("T", bound="WorkflowOutputSchema")
...
class WorkflowOutputSchema:
    ...
    def __repr__(self):
        ...
        return "WorkflowOutputSchema({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workflow_output_schema.additional_properties = d
