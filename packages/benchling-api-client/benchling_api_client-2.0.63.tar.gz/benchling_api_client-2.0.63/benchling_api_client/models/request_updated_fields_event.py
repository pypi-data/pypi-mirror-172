...
class RequestUpdatedFieldsEvent:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_event_type() -> Union[Unset, RequestUpdatedFieldsEventEventType]:
            event_type = UNSET
        ...
        event_type = (
            get_event_type()
            if "eventType" in d
            else cast(Union[Unset, RequestUpdatedFieldsEventEventType], UNSET)
        )
        ...
        request = get_request() if "request" in d else cast(Union[Unset, Request], UNSET)
