...
class AssayRunUpdatedFieldsEvent:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        assay_run = get_assay_run() if "assayRun" in d else cast(Union[Unset, AssayRun], UNSET)

        def get_event_type() -> Union[Unset, AssayRunUpdatedFieldsEventEventType]:
            event_type = UNSET
        ...
        event_type = (
            get_event_type()
            if "eventType" in d
            else cast(Union[Unset, AssayRunUpdatedFieldsEventEventType], UNSET)
        )
