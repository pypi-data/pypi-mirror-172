...
from ..models.bulk_create_features_async_task_response import BulkCreateFeaturesAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkCreateFeaturesAsyncTask")
...
class BulkCreateFeaturesAsyncTask:
    ...
    _response: Union[Unset, BulkCreateFeaturesAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkCreateFeaturesAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_response() -> Union[Unset, BulkCreateFeaturesAsyncTaskResponse]:
            response: Union[Unset, BulkCreateFeaturesAsyncTaskResponse] = UNSET
            _response = d.pop("response")
            if not isinstance(_response, Unset):
                response = BulkCreateFeaturesAsyncTaskResponse.from_dict(_response)
        ...
        response = (
            get_response()
            if "response" in d
            else cast(Union[Unset, BulkCreateFeaturesAsyncTaskResponse], UNSET)
        )
        ...
        bulk_create_features_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_create_features_async_task.additional_properties = d
        return bulk_create_features_async_task
    ...
    @property
    def response(self) -> BulkCreateFeaturesAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkCreateFeaturesAsyncTaskResponse) -> None:
