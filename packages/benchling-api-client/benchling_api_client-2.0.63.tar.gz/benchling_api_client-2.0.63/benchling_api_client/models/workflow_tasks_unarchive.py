...
T = TypeVar("T", bound="WorkflowTasksUnarchive")
...
class WorkflowTasksUnarchive:
    ...
    def __repr__(self):
        ...
        return "WorkflowTasksUnarchive({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workflow_task_ids = get_workflow_task_ids() if "workflowTaskIds" in d else cast(List[str], UNSET)

        workflow_tasks_unarchive = cls(
            workflow_task_ids=workflow_task_ids,
        )

        workflow_tasks_unarchive.additional_properties = d
        return workflow_tasks_unarchive
