...
from ..models.bulk_update_rna_sequences_async_task_response import BulkUpdateRnaSequencesAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkUpdateRnaSequencesAsyncTask")
...
class BulkUpdateRnaSequencesAsyncTask:
    ...
    _response: Union[Unset, BulkUpdateRnaSequencesAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkUpdateRnaSequencesAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status = get_status() if "status" in d else cast(AsyncTaskStatus, UNSET)

        def get_response() -> Union[Unset, BulkUpdateRnaSequencesAsyncTaskResponse]:
            response: Union[Unset, BulkUpdateRnaSequencesAsyncTaskResponse] = UNSET
            _response = d.pop("response")
            if not isinstance(_response, Unset):
                response = BulkUpdateRnaSequencesAsyncTaskResponse.from_dict(_response)
        ...
        response = (
            get_response()
            if "response" in d
            else cast(Union[Unset, BulkUpdateRnaSequencesAsyncTaskResponse], UNSET)
        )
        ...
        errors = get_errors() if "errors" in d else cast(Union[Unset, AsyncTaskErrors], UNSET)

        def get_message() -> Union[Unset, str]:
            message = d.pop("message")
            return message

        message = get_message() if "message" in d else cast(Union[Unset, str], UNSET)

        bulk_update_rna_sequences_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_update_rna_sequences_async_task.additional_properties = d
        return bulk_update_rna_sequences_async_task
    ...
    @property
    def response(self) -> BulkUpdateRnaSequencesAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkUpdateRnaSequencesAsyncTaskResponse) -> None:
