...
T = TypeVar("T", bound="WorkflowTaskUpdate")
...
class WorkflowTaskUpdate:
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status_id = get_status_id() if "statusId" in d else cast(Union[Unset, str], UNSET)
        ...
        workflow_task_update.additional_properties = d
