...
T = TypeVar("T", bound="CustomEntityBaseRequestForCreate")
...
class CustomEntityBaseRequestForCreate:
    ...
    def __repr__(self):
        ...
        return "CustomEntityBaseRequestForCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_entity_base_request_for_create = cls(
            aliases=aliases,
        ...
        custom_entity_base_request_for_create.additional_properties = d
        return custom_entity_base_request_for_create
