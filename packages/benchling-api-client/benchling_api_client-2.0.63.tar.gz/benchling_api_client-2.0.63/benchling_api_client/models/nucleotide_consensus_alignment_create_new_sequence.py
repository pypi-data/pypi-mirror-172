...
T = TypeVar("T", bound="NucleotideConsensusAlignmentCreateNewSequence")
...
class NucleotideConsensusAlignmentCreateNewSequence:
    ...
    def __repr__(self):
        ...
        return "NucleotideConsensusAlignmentCreateNewSequence({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nucleotide_consensus_alignment_create_new_sequence = cls(
            folder_id=folder_id,
        )

        nucleotide_consensus_alignment_create_new_sequence.additional_properties = d
        return nucleotide_consensus_alignment_create_new_sequence
