...
T = TypeVar("T", bound="GenericEntityCreator")
...
class GenericEntityCreator:
    ...
    def __repr__(self):
        ...
        return "GenericEntityCreator({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        generic_entity_creator = cls(
            handle=handle,
            id=id,
            name=name,
        )

        generic_entity_creator.additional_properties = d
        return generic_entity_creator
