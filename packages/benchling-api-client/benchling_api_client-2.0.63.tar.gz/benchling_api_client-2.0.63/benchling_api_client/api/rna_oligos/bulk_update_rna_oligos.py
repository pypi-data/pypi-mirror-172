...
from ...models.rna_oligos_bulk_update_request import RnaOligosBulkUpdateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: RnaOligosBulkUpdateRequest,
) -> Dict[str, Any]:
    url = "{}/rna-oligos:bulk-update".format(client.base_url)
