...
from ...models.nucleotide_consensus_alignment_create import NucleotideConsensusAlignmentCreate
...
def _get_kwargs(
    *,
    client: Client,
    json_body: NucleotideConsensusAlignmentCreate,
) -> Dict[str, Any]:
    url = "{}/nucleotide-alignments:create-consensus-alignment".format(client.base_url)
