...
from ...models.rna_sequences_bulk_create_request import RnaSequencesBulkCreateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: RnaSequencesBulkCreateRequest,
) -> Dict[str, Any]:
    url = "{}/rna-sequences:bulk-create".format(client.base_url)
