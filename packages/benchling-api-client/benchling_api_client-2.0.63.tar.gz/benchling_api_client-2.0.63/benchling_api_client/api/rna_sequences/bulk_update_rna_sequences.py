...
from ...models.rna_sequences_bulk_update_request import RnaSequencesBulkUpdateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: RnaSequencesBulkUpdateRequest,
) -> Dict[str, Any]:
    url = "{}/rna-sequences:bulk-update".format(client.base_url)
