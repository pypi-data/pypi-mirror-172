...
from ...models.auto_annotate_rna_sequences import AutoAnnotateRnaSequences
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AutoAnnotateRnaSequences,
) -> Dict[str, Any]:
    url = "{}/rna-sequences:auto-annotate".format(client.base_url)
