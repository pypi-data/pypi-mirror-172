...
from ...models.workflow_tasks_bulk_create_request import WorkflowTasksBulkCreateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: WorkflowTasksBulkCreateRequest,
) -> Dict[str, Any]:
    url = "{}/workflow-tasks:bulk-create".format(client.base_url)
