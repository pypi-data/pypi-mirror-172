...
from ...models.auto_annotate_aa_sequences import AutoAnnotateAaSequences
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AutoAnnotateAaSequences,
) -> Dict[str, Any]:
    url = "{}/aa-sequences:auto-annotate".format(client.base_url)
