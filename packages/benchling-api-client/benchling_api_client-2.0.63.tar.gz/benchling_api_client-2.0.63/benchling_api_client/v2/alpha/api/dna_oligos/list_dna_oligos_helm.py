...
def _parse_response(*, response: httpx.Response) -> Optional[Union[DnaOligosPaginatedListHelm, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[DnaOligosPaginatedListHelm, BadRequestError]]:
    return Response(
