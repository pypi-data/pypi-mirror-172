...
from ..models.entity_schema_app_config_item_type import EntitySchemaAppConfigItemType
...
T = TypeVar("T", bound="EntitySchemaAppConfigItem")
...
class EntitySchemaAppConfigItem:
    ...
    _type: Union[Unset, EntitySchemaAppConfigItemType] = UNSET
    ...
    def __repr__(self):
        ...
        return "EntitySchemaAppConfigItem({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, EntitySchemaAppConfigItemType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = EntitySchemaAppConfigItemType(_type)
                except ValueError:
                    type = EntitySchemaAppConfigItemType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, EntitySchemaAppConfigItemType], UNSET)
        ...
        entity_schema_app_config_item = cls(
            subtype=subtype,
            type=type,
            value=value,
        ...
        entity_schema_app_config_item.additional_properties = d
        return entity_schema_app_config_item
    ...
    @property
    def type(self) -> EntitySchemaAppConfigItemType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EntitySchemaAppConfigItemType) -> None:
        self._type = value
