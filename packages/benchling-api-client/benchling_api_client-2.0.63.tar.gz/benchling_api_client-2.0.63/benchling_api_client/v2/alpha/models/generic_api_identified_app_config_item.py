...
from ..models.generic_api_identified_app_config_item_type import GenericApiIdentifiedAppConfigItemType
...
T = TypeVar("T", bound="GenericApiIdentifiedAppConfigItem")
...
class GenericApiIdentifiedAppConfigItem:
    ...
    _type: Union[Unset, GenericApiIdentifiedAppConfigItemType] = UNSET
    _value: Union[Unset, None, str] = UNSET
    _linked_resource: Union[Unset, None, LinkedAppConfigResourceSummary, InaccessibleResource, UnknownType] = UNSET
    ...
    def __repr__(self):
        ...
        return "GenericApiIdentifiedAppConfigItem({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, GenericApiIdentifiedAppConfigItemType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = GenericApiIdentifiedAppConfigItemType(_type)
                except ValueError:
                    type = GenericApiIdentifiedAppConfigItemType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, GenericApiIdentifiedAppConfigItemType], UNSET)
        ...
        def get_linked_resource() -> Union[
            ...
            def _parse_linked_resource(
                ...
                linked_resource: Union[Unset, None, LinkedAppConfigResourceSummary, InaccessibleResource, UnknownType]
                if data is None:
                    return data
        ...
        generic_api_identified_app_config_item = cls(
            type=type,
            value=value,
        ...
        generic_api_identified_app_config_item.additional_properties = d
        return generic_api_identified_app_config_item
    ...
    @property
    def type(self) -> GenericApiIdentifiedAppConfigItemType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: GenericApiIdentifiedAppConfigItemType) -> None:
        self._type = value
    ...
    @property
    def linked_resource(self) -> Optional[Union[LinkedAppConfigResourceSummary, InaccessibleResource, UnknownType]]:
        if isinstance(self._linked_resource, Unset):
