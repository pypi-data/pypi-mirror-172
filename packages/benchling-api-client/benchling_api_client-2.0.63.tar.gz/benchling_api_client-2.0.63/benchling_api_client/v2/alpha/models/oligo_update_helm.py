...
T = TypeVar("T", bound="OligoUpdateHelm")


@attr.s(auto_attribs=True, repr=False)
class OligoUpdateHelm:
    """  """
    ...
    def __repr__(self):
        ...
        return "OligoUpdateHelm({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        oligo_update_helm.additional_properties = d
        return oligo_update_helm
