...
from ..models.boolean_app_config_item_type import BooleanAppConfigItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="BooleanAppConfigItem")
...
class BooleanAppConfigItem:
    ...
    _type: Union[Unset, BooleanAppConfigItemType] = UNSET
    _value: Union[Unset, None, bool] = UNSET
    ...
    def __repr__(self):
        ...
        return "BooleanAppConfigItem({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, BooleanAppConfigItemType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = BooleanAppConfigItemType(_type)
                except ValueError:
                    type = BooleanAppConfigItemType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, BooleanAppConfigItemType], UNSET)

        def get_value() -> Union[Unset, None, bool]:
            value = d.pop("value")
            return value
        ...
        try:
            ...
            if strict:
                raise
            value = cast(Union[Unset, None, bool], UNSET)
        ...
        boolean_app_config_item.additional_properties = d
        return boolean_app_config_item
    ...
    @property
    def type(self) -> BooleanAppConfigItemType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: BooleanAppConfigItemType) -> None:
        self._type = value
