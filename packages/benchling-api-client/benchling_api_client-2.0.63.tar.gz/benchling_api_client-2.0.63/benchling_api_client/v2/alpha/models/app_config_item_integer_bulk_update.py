...
class AppConfigItemIntegerBulkUpdate:
    ...
    def __repr__(self):
        ...
        return "AppConfigItemIntegerBulkUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        app_config_item_integer_bulk_update = cls(
            id=id,
            type=type,
            value=value,
        )

        app_config_item_integer_bulk_update.additional_properties = d
        return app_config_item_integer_bulk_update
