...
def _parse_response(*, response: httpx.Response) -> Optional[Union[RnaSequencesPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[RnaSequencesPaginatedList, BadRequestError]]:
    return Response(
