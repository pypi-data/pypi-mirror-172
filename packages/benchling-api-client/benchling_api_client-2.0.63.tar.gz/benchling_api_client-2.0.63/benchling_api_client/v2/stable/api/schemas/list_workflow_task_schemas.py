...
def _parse_response(*, response: httpx.Response) -> Optional[Union[WorkflowTaskSchemasPaginatedList, NotFoundError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[WorkflowTaskSchemasPaginatedList, NotFoundError]]:
    return Response(
