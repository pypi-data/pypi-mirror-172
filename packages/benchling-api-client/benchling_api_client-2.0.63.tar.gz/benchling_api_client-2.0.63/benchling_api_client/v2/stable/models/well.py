...
class Well:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_parent_storage_schema() -> Union[Unset, SchemaSummary]:
            parent_storage_schema: Union[Unset, Union[Unset, SchemaSummary]] = UNSET
        ...
        try:
            ...
            if strict:
                raise
            parent_storage_schema = cast(Union[Unset, SchemaSummary], UNSET)
