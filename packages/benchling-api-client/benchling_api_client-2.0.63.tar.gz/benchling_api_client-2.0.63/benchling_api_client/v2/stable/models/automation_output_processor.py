...
class AutomationOutputProcessor:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_archive_record() -> Union[Unset, ArchiveRecord]:
            archive_record: Union[Unset, Union[Unset, ArchiveRecord]] = UNSET
        ...
        try:
            ...
            if strict:
                raise
            archive_record = cast(Union[Unset, ArchiveRecord], UNSET)
        ...
        def get_transforms() -> Union[Unset, List[LabAutomationTransform]]:
            ...
            for transforms_item_data in _transforms or []:
                transforms_item = LabAutomationTransform.from_dict(transforms_item_data, strict=False)
        ...
        try:
            ...
            if strict:
                raise
            transforms = cast(Union[Unset, List[LabAutomationTransform]], UNSET)
