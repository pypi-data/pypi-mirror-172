...
class BulkUpdateCustomEntitiesAsyncTask:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_response() -> Union[Unset, BulkUpdateCustomEntitiesAsyncTaskResponse]:
            response: Union[Unset, Union[Unset, BulkUpdateCustomEntitiesAsyncTaskResponse]] = UNSET
        ...
        try:
            ...
            if strict:
                raise
            response = cast(Union[Unset, BulkUpdateCustomEntitiesAsyncTaskResponse], UNSET)
