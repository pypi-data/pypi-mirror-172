...
def _parse_response(*, response: httpx.Response) -> Optional[Union[CustomEntity, CustomEntity, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[CustomEntity, CustomEntity, BadRequestError]]:
    return Response(
