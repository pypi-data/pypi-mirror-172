...
T = TypeVar("T", bound="WorklistCreator")


@attr.s(auto_attribs=True, repr=False)
class WorklistCreator:
    """  """
    ...
    def __repr__(self):
        ...
        return "WorklistCreator({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        worklist_creator = cls(
            handle=handle,
            id=id,
            name=name,
        )

        worklist_creator.additional_properties = d
        return worklist_creator
