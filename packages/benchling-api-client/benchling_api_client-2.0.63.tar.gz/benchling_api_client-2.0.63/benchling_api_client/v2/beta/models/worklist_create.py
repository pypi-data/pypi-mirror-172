...
class WorklistCreate:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_collaborations() -> Union[Unset, List[Union[PrincipalCollaborator, MemberCollaborator, UnknownType]]]:
            collaborations = []
    ...
    def collaborations(self, value: List[Union[PrincipalCollaborator, MemberCollaborator, UnknownType]]) -> None:
