...
from ...models.workflow_outputs_bulk_create_request import WorkflowOutputsBulkCreateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: WorkflowOutputsBulkCreateRequest,
) -> Dict[str, Any]:
    url = "{}/workflow-outputs:bulk-create".format(client.base_url)
