...
from ...models.workflow_tasks_bulk_copy_request import WorkflowTasksBulkCopyRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: WorkflowTasksBulkCopyRequest,
) -> Dict[str, Any]:
    url = "{}/workflow-tasks:bulk-copy".format(client.base_url)
