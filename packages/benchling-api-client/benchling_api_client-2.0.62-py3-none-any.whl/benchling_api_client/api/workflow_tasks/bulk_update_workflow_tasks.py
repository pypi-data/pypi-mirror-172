...
from ...models.workflow_tasks_bulk_update_request import WorkflowTasksBulkUpdateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: WorkflowTasksBulkUpdateRequest,
) -> Dict[str, Any]:
    url = "{}/workflow-tasks:bulk-update".format(client.base_url)
