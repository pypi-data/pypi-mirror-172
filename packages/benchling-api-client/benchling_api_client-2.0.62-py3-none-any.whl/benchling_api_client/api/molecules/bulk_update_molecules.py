...
from ...models.molecules_bulk_update_request import MoleculesBulkUpdateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: MoleculesBulkUpdateRequest,
) -> Dict[str, Any]:
    url = "{}/molecules:bulk-update".format(client.base_url)
