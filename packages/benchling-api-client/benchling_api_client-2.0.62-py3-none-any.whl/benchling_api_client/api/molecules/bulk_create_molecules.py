...
from ...models.molecules_bulk_create_request import MoleculesBulkCreateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: MoleculesBulkCreateRequest,
) -> Dict[str, Any]:
    url = "{}/molecules:bulk-create".format(client.base_url)
