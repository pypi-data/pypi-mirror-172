...
from ...models.autofill_rna_sequences import AutofillRnaSequences
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AutofillRnaSequences,
) -> Dict[str, Any]:
    url = "{}/rna-sequences:autofill-translations".format(client.base_url)
