    ...
    if response.status_code == 200:
        ...
        def _parse_response_200(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200 = CreateNucleotideTemplateAlignmentAsyncTask.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200 = CreateNucleotideConsensusAlignmentAsyncTask.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200 = BulkCreateRnaSequencesAsyncTask.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200 = BulkUpdateRnaSequencesAsyncTask.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200 = BulkCreateFeaturesAsyncTask.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200 = FindMatchingRegionsAsyncTask.from_dict(data)
