...
from ...models.dropdown_options_archive import DropdownOptionsArchive
...
def _get_kwargs(
    *,
    client: Client,
    dropdown_id: str,
    json_body: DropdownOptionsArchive,
) -> Dict[str, Any]:
    url = "{}/dropdowns/{dropdown_id}/options:archive".format(client.base_url, dropdown_id=dropdown_id)
...
def _parse_response(
    *, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DropdownOptionsArchivalChange.from_dict(response.json())
