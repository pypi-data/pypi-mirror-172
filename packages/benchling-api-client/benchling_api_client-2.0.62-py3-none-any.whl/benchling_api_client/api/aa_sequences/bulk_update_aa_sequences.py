...
from ...models.aa_sequences_bulk_update_request import AaSequencesBulkUpdateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AaSequencesBulkUpdateRequest,
) -> Dict[str, Any]:
    url = "{}/aa-sequences:bulk-update".format(client.base_url)
