...
class Oligo:
    ...
    def __repr__(self):
        ...
        return "Oligo({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nucleotide_type = (
            get_nucleotide_type() if "nucleotideType" in d else cast(Union[Unset, OligoNucleotideType], UNSET)
        )
