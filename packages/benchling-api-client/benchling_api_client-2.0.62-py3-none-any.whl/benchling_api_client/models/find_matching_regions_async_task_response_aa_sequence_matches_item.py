...
class FindMatchingRegionsAsyncTaskResponseAaSequenceMatchesItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        matching_aa_sequence_ids = (
            get_matching_aa_sequence_ids()
            if "matchingAASequenceIds" in d
            else cast(Union[Unset, List[str]], UNSET)
        )
        ...
        target_aa_sequence_id = (
            get_target_aa_sequence_id() if "targetAASequenceId" in d else cast(Union[Unset, str], UNSET)
        )
