...
from ..models.nucleotide_alignment import NucleotideAlignment
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateNucleotideConsensusAlignmentAsyncTask")
...
class CreateNucleotideConsensusAlignmentAsyncTask:
    ...
    _response: Union[Unset, NucleotideAlignment] = UNSET
    ...
    def __repr__(self):
        ...
        return "CreateNucleotideConsensusAlignmentAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_response() -> Union[Unset, NucleotideAlignment]:
            response: Union[Unset, NucleotideAlignment] = UNSET
            _response = d.pop("response")
            if not isinstance(_response, Unset):
                response = NucleotideAlignment.from_dict(_response)

            return response

        response = get_response() if "response" in d else cast(Union[Unset, NucleotideAlignment], UNSET)
        ...
        create_nucleotide_consensus_alignment_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        create_nucleotide_consensus_alignment_async_task.additional_properties = d
        return create_nucleotide_consensus_alignment_async_task
    ...
    @property
    def response(self) -> NucleotideAlignment:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: NucleotideAlignment) -> None:
