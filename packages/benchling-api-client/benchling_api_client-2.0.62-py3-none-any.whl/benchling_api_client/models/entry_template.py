    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_days() -> Union[Unset, List[EntryTemplateDay]]:
            ...
            for days_item_data in _days or []:
                days_item = EntryTemplateDay.from_dict(days_item_data)

                days.append(days_item)

            return days

        days = get_days() if "days" in d else cast(Union[Unset, List[EntryTemplateDay]], UNSET)
        ...
        template_collection_id = (
            get_template_collection_id() if "templateCollectionId" in d else cast(Union[Unset, str], UNSET)
        )
