...
class DropdownFieldDefinition:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        dropdown_id = get_dropdown_id() if "dropdownId" in d else cast(Union[Unset, None, str], UNSET)
        ...
        type = get_type() if "type" in d else cast(Union[Unset, DropdownFieldDefinitionType], UNSET)
