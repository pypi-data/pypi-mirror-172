...
class PlateCreationTableNotePart:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        plate_schema_id = get_plate_schema_id() if "plateSchemaId" in d else cast(Union[Unset, str], UNSET)
        ...
        type = get_type() if "type" in d else cast(Union[Unset, PlateCreationTableNotePartType], UNSET)
