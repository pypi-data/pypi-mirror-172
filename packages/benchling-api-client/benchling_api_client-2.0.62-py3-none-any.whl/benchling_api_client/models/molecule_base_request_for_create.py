...
T = TypeVar("T", bound="MoleculeBaseRequestForCreate")
...
class MoleculeBaseRequestForCreate:
    ...
    def __repr__(self):
        ...
        return "MoleculeBaseRequestForCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_chemical_structure() -> Union[Unset, MoleculeStructure]:
            chemical_structure: Union[Unset, MoleculeStructure] = UNSET
        ...
        chemical_structure = (
            ...
            if "chemicalStructure" in d
            else cast(Union[Unset, MoleculeStructure], UNSET)
        )
        ...
        molecule_base_request_for_create = cls(
            aliases=aliases,
        ...
        molecule_base_request_for_create.additional_properties = d
        return molecule_base_request_for_create
