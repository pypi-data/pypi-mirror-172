...
class MixtureWithEntityType:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        entity_type = (
            get_entity_type()
            if "entityType" in d
            else cast(Union[Unset, MixtureWithEntityTypeEntityType], UNSET)
        )
        ...
        allow_measured_ingredients = (
            get_allow_measured_ingredients()
            if "allowMeasuredIngredients" in d
        ...
        amount = get_amount() if "amount" in d else cast(Union[Unset, str], UNSET)
        ...
        creator = get_creator() if "creator" in d else cast(Union[Unset, MixtureCreator], UNSET)
        ...
        ingredients = get_ingredients() if "ingredients" in d else cast(Union[Unset, List[Ingredient]], UNSET)
        ...
        units = get_units() if "units" in d else cast(Union[Unset, MixtureMeasurementUnits], UNSET)
