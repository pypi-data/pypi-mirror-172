...
T = TypeVar("T", bound="AutofillRnaSequences")
...
class AutofillRnaSequences:
    ...
    def __repr__(self):
        ...
        return "AutofillRnaSequences({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rna_sequence_ids = get_rna_sequence_ids() if "rnaSequenceIds" in d else cast(List[str], UNSET)

        autofill_rna_sequences = cls(
            rna_sequence_ids=rna_sequence_ids,
        )

        return autofill_rna_sequences
