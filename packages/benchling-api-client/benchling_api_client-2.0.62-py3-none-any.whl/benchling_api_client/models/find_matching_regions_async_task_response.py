...
class FindMatchingRegionsAsyncTaskResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        aa_sequence_matches = (
            get_aa_sequence_matches()
            if "aaSequenceMatches" in d
            else cast(Union[Unset, List[FindMatchingRegionsAsyncTaskResponseAaSequenceMatchesItem]], UNSET)
        )
