...
class WorkflowTaskUpdatedScheduledOnEvent:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        event_type = (
            get_event_type()
            if "eventType" in d
            else cast(Union[Unset, WorkflowTaskUpdatedScheduledOnEventEventType], UNSET)
        )
        ...
        workflow_task = (
            get_workflow_task() if "workflowTask" in d else cast(Union[Unset, WorkflowTask], UNSET)
        )
