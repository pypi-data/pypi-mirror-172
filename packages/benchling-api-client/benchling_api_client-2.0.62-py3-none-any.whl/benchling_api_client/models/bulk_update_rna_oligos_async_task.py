...
from ..models.bulk_update_rna_oligos_async_task_response import BulkUpdateRnaOligosAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkUpdateRnaOligosAsyncTask")
...
class BulkUpdateRnaOligosAsyncTask:
    ...
    _response: Union[Unset, BulkUpdateRnaOligosAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkUpdateRnaOligosAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_response() -> Union[Unset, BulkUpdateRnaOligosAsyncTaskResponse]:
            response: Union[Unset, BulkUpdateRnaOligosAsyncTaskResponse] = UNSET
            _response = d.pop("response")
            if not isinstance(_response, Unset):
                response = BulkUpdateRnaOligosAsyncTaskResponse.from_dict(_response)
        ...
        response = (
            get_response()
            if "response" in d
            else cast(Union[Unset, BulkUpdateRnaOligosAsyncTaskResponse], UNSET)
        )
        ...
        bulk_update_rna_oligos_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_update_rna_oligos_async_task.additional_properties = d
        return bulk_update_rna_oligos_async_task
    ...
    @property
    def response(self) -> BulkUpdateRnaOligosAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkUpdateRnaOligosAsyncTaskResponse) -> None:
