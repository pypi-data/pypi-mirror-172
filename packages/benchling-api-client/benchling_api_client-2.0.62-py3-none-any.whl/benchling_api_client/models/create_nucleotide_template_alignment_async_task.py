...
T = TypeVar("T", bound="CreateNucleotideTemplateAlignmentAsyncTask")
...
class CreateNucleotideTemplateAlignmentAsyncTask:
    ...
    def __repr__(self):
        ...
        return "CreateNucleotideTemplateAlignmentAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_nucleotide_template_alignment_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        create_nucleotide_template_alignment_async_task.additional_properties = d
        return create_nucleotide_template_alignment_async_task
