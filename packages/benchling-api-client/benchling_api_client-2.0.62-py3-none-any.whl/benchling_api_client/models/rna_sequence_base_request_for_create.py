...
T = TypeVar("T", bound="RnaSequenceBaseRequestForCreate")
...
class RnaSequenceBaseRequestForCreate:
    ...
    def __repr__(self):
        ...
        return "RnaSequenceBaseRequestForCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rna_sequence_base_request_for_create = cls(
            aliases=aliases,
        ...
        return rna_sequence_base_request_for_create
