...
T = TypeVar("T", bound="RnaOligoUpdate")
...
class RnaOligoUpdate:
    ...
    def __repr__(self):
        ...
        return "RnaOligoUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rna_oligo_update.additional_properties = d
        return rna_oligo_update
