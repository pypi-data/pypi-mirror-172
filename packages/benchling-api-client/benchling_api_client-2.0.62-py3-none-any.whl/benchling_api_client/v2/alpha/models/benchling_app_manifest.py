...
from ..models.benchling_app_manifest_settings import BenchlingAppManifestSettings
...
class BenchlingAppManifest:
    ...
    _settings: Union[Unset, BenchlingAppManifestSettings] = UNSET
    ...
    def __repr__(self):
        ...
        fields.append("settings={}".format(repr(self._settings)))
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self._settings, Unset):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_settings() -> Union[Unset, BenchlingAppManifestSettings]:
            settings: Union[Unset, Union[Unset, BenchlingAppManifestSettings]] = UNSET
            _settings = d.pop("settings")

            if not isinstance(_settings, Unset):
                settings = BenchlingAppManifestSettings.from_dict(_settings)
        ...
        try:
            ...
            if strict:
                raise
            settings = cast(Union[Unset, BenchlingAppManifestSettings], UNSET)
    ...
    @property
    def settings(self) -> BenchlingAppManifestSettings:
        if isinstance(self._settings, Unset):
            raise NotPresentError(self, "settings")
        return self._settings

    @settings.setter
    def settings(self, value: BenchlingAppManifestSettings) -> None:
        self._settings = value

    @settings.deleter
    def settings(self) -> None:
        self._settings = UNSET
