...
from ..models.json_app_config_item_type import JsonAppConfigItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="JsonAppConfigItem")
...
class JsonAppConfigItem:
    ...
    _type: Union[Unset, JsonAppConfigItemType] = UNSET
    ...
    def __repr__(self):
        ...
        return "JsonAppConfigItem({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, JsonAppConfigItemType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = JsonAppConfigItemType(_type)
                except ValueError:
                    type = JsonAppConfigItemType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, JsonAppConfigItemType], UNSET)
        ...
        json_app_config_item.additional_properties = d
        return json_app_config_item
    ...
    @property
    def type(self) -> JsonAppConfigItemType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: JsonAppConfigItemType) -> None:
        self._type = value
