...
class AppConfigItemsBulkUpdateRequest:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        for app_configuration_items_item_data in self._app_configuration_items:
            ...
            elif isinstance(app_configuration_items_item_data, AppConfigItemGenericBulkUpdate):
                app_configuration_items_item = app_configuration_items_item_data.to_dict()

            elif isinstance(app_configuration_items_item_data, AppConfigItemBooleanBulkUpdate):
                app_configuration_items_item = app_configuration_items_item_data.to_dict()

            elif isinstance(app_configuration_items_item_data, AppConfigItemIntegerBulkUpdate):
                app_configuration_items_item = app_configuration_items_item_data.to_dict()

            elif isinstance(app_configuration_items_item_data, AppConfigItemFloatBulkUpdate):
                app_configuration_items_item = app_configuration_items_item_data.to_dict()

            elif isinstance(app_configuration_items_item_data, AppConfigItemDateBulkUpdate):
                app_configuration_items_item = app_configuration_items_item_data.to_dict()

            elif isinstance(app_configuration_items_item_data, AppConfigItemDatetimeBulkUpdate):
                app_configuration_items_item = app_configuration_items_item_data.to_dict()
            ...
            for app_configuration_items_item_data in _app_configuration_items:
                ...
                def _parse_app_configuration_items_item(
                    ...
                    if discriminator_value is not None:
                        app_config_item_bulk_update: Union[
                            AppConfigItemGenericBulkUpdate,
                            AppConfigItemBooleanBulkUpdate,
                            AppConfigItemIntegerBulkUpdate,
                            AppConfigItemFloatBulkUpdate,
                        ...
                        if discriminator_value == "aa_sequence":
                            app_config_item_bulk_update = AppConfigItemGenericBulkUpdate.from_dict(data, strict=False)

                            return app_config_item_bulk_update
                        if discriminator_value == "boolean":
                            app_config_item_bulk_update = AppConfigItemBooleanBulkUpdate.from_dict(data, strict=False)
                        ...
                        if discriminator_value == "date":
                            app_config_item_bulk_update = AppConfigItemDateBulkUpdate.from_dict(data, strict=False)

                            return app_config_item_bulk_update
                        if discriminator_value == "datetime":
                            app_config_item_bulk_update = AppConfigItemDatetimeBulkUpdate.from_dict(data, strict=False)
                        ...
                        if discriminator_value == "float":
                            app_config_item_bulk_update = AppConfigItemFloatBulkUpdate.from_dict(data, strict=False)
                        ...
                        if discriminator_value == "integer":
                            app_config_item_bulk_update = AppConfigItemIntegerBulkUpdate.from_dict(data, strict=False)

                            return app_config_item_bulk_update
                        if discriminator_value == "json":
                            app_config_item_bulk_update = AppConfigItemJsonBulkUpdate.from_dict(data, strict=False)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        app_config_item_bulk_update = AppConfigItemGenericBulkUpdate.from_dict(data, strict=True)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        app_config_item_bulk_update = AppConfigItemBooleanBulkUpdate.from_dict(data, strict=True)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        app_config_item_bulk_update = AppConfigItemIntegerBulkUpdate.from_dict(data, strict=True)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        app_config_item_bulk_update = AppConfigItemFloatBulkUpdate.from_dict(data, strict=True)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        app_config_item_bulk_update = AppConfigItemDateBulkUpdate.from_dict(data, strict=True)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        app_config_item_bulk_update = AppConfigItemDatetimeBulkUpdate.from_dict(data, strict=True)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        app_config_item_bulk_update = AppConfigItemJsonBulkUpdate.from_dict(data, strict=True)
                ...
                app_configuration_items_item = _parse_app_configuration_items_item(app_configuration_items_item_data)
