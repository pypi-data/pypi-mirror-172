...
T = TypeVar("T", bound="BackTranslateHairpinParameters")


@attr.s(auto_attribs=True, repr=False)
class BackTranslateHairpinParameters:
    ...
    def __repr__(self):
        ...
        return "BackTranslateHairpinParameters({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        back_translate_hairpin_parameters = cls(
            stem=stem,
            window=window,
        )

        return back_translate_hairpin_parameters
