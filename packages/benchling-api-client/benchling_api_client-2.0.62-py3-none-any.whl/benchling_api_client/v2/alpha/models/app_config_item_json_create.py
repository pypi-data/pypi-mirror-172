...
from ..models.app_config_item_json_create_type import AppConfigItemJsonCreateType
from ..types import UNSET, Unset

T = TypeVar("T", bound="AppConfigItemJsonCreate")
...
class AppConfigItemJsonCreate:
    ...
    _type: AppConfigItemJsonCreateType
    _value: str
    _app_id: str
    _path: List[str]
    ...
    def __repr__(self):
        ...
        return "AppConfigItemJsonCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> AppConfigItemJsonCreateType:
            _type = d.pop("type")
            try:
                type = AppConfigItemJsonCreateType(_type)
            except ValueError:
                type = AppConfigItemJsonCreateType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(AppConfigItemJsonCreateType, UNSET)
        ...
        app_config_item_json_create = cls(
            type=type,
            value=value,
            app_id=app_id,
            path=path,
        ...
        app_config_item_json_create.additional_properties = d
        return app_config_item_json_create
    ...
    @property
    def type(self) -> AppConfigItemJsonCreateType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: AppConfigItemJsonCreateType) -> None:
        self._type = value
