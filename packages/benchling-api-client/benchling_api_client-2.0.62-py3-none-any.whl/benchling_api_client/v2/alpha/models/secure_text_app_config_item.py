...
from ..models.secure_text_app_config_item_type import SecureTextAppConfigItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="SecureTextAppConfigItem")
...
class SecureTextAppConfigItem:
    ...
    _type: Union[Unset, SecureTextAppConfigItemType] = UNSET
    ...
    def __repr__(self):
        ...
        return "SecureTextAppConfigItem({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, SecureTextAppConfigItemType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = SecureTextAppConfigItemType(_type)
                except ValueError:
                    type = SecureTextAppConfigItemType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, SecureTextAppConfigItemType], UNSET)
        ...
        secure_text_app_config_item = cls(
            type=type,
            value=value,
        ...
        secure_text_app_config_item.additional_properties = d
        return secure_text_app_config_item
    ...
    @property
    def type(self) -> SecureTextAppConfigItemType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: SecureTextAppConfigItemType) -> None:
        self._type = value
