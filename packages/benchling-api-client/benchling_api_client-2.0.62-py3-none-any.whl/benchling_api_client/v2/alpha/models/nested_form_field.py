...
class NestedFormField:
            ...
            for instance_providers_item_data in _instance_providers or []:
                ...
                def _parse_instance_providers_item(
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        instance_providers_item = EntitySearchFormInstanceProvider.from_dict(data, strict=True)
    ...
    def instance_providers(
        ...
        Union[
            BarcodeScanFormInstanceProvider, EntitySearchFormInstanceProvider, NewBlankFormInstanceProvider, UnknownType
        ]
    ]:
