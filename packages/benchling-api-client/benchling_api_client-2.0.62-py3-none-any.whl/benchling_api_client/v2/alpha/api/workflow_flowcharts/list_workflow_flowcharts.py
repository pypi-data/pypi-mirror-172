...
def _parse_response(*, response: httpx.Response) -> Optional[Union[WorkflowFlowchartPaginatedList, NotFoundError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[WorkflowFlowchartPaginatedList, NotFoundError]]:
    return Response(
