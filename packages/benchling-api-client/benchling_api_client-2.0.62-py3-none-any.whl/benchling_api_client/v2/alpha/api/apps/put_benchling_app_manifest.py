...
def _parse_response(
    *, response: httpx.Response
) -> Optional[Union[BenchlingAppManifest, BenchlingAppManifest, BadRequestError, ForbiddenError, ConflictError]]:
    ...
    if response.status_code == 409:
        response_409 = ConflictError.from_dict(response.json(), strict=False)
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[BenchlingAppManifest, BenchlingAppManifest, BadRequestError, ForbiddenError, ConflictError]]:
    return Response(
