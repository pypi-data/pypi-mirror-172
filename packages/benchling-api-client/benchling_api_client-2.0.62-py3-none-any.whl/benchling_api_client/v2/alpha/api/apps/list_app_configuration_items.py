...
def _parse_response(*, response: httpx.Response) -> Optional[Union[AppConfigurationPaginatedList, NotFoundError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[AppConfigurationPaginatedList, NotFoundError]]:
    return Response(
