...
def _parse_response(*, response: httpx.Response) -> Optional[Union[WorkflowFlowchartConfigVersion, NotFoundError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[WorkflowFlowchartConfigVersion, NotFoundError]]:
    return Response(
