...
def _get_kwargs(
    *,
    ...
    responsible_party_ids: Union[Unset, str] = UNSET,
    flowchart_workflow_task_group_ids: Union[Unset, str] = UNSET,
    flowchart_task_schema_id: Union[Unset, str] = UNSET,
    flowchart_creator_ids: Union[Unset, str] = UNSET,
    flowchart_watcher_ids: Union[Unset, str] = UNSET,
    ...
    execution_flowchart_id: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    ...
    if not isinstance(responsible_party_ids, Unset) and responsible_party_ids is not None:
        params["responsiblePartyIds"] = responsible_party_ids
    if not isinstance(flowchart_workflow_task_group_ids, Unset) and flowchart_workflow_task_group_ids is not None:
        params["flowchartWorkflowTaskGroupIds"] = flowchart_workflow_task_group_ids
    if not isinstance(flowchart_task_schema_id, Unset) and flowchart_task_schema_id is not None:
        params["flowchartTaskSchemaId"] = flowchart_task_schema_id
    if not isinstance(flowchart_creator_ids, Unset) and flowchart_creator_ids is not None:
        params["flowchartCreatorIds"] = flowchart_creator_ids
    if not isinstance(flowchart_watcher_ids, Unset) and flowchart_watcher_ids is not None:
        params["flowchartWatcherIds"] = flowchart_watcher_ids
    ...
    if not isinstance(execution_flowchart_id, Unset) and execution_flowchart_id is not None:
        params["executionFlowchartId"] = execution_flowchart_id
...
def sync_detailed(
    *,
    ...
    kwargs = _get_kwargs(
        ...
        responsible_party_ids=responsible_party_ids,
        flowchart_workflow_task_group_ids=flowchart_workflow_task_group_ids,
        flowchart_task_schema_id=flowchart_task_schema_id,
        flowchart_creator_ids=flowchart_creator_ids,
        flowchart_watcher_ids=flowchart_watcher_ids,
