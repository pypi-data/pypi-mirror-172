...
def _parse_response(*, response: httpx.Response) -> Optional[Union[SchemaClassesPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[SchemaClassesPaginatedList, BadRequestError]]:
    return Response(
