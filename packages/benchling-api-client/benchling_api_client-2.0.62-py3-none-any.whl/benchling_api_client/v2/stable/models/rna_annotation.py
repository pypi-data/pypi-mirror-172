...
T = TypeVar("T", bound="RnaAnnotation")
...
class RnaAnnotation:
    ...
    def __repr__(self):
        ...
        return "RnaAnnotation({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_custom_fields() -> Union[Unset, List[SequenceFeatureCustomField]]:
            ...
            for custom_fields_item_data in _custom_fields or []:
                custom_fields_item = SequenceFeatureCustomField.from_dict(custom_fields_item_data, strict=False)
        ...
        rna_annotation.additional_properties = d
