...
from ..models.stage_entry_updated_review_record_event_event_type import StageEntryUpdatedReviewRecordEventEventType
...
class StageEntryUpdatedReviewRecordEvent:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_entry() -> Union[Unset, StageEntry]:
            entry: Union[Unset, Union[Unset, StageEntry]] = UNSET
            _entry = d.pop("entry")
        ...
        try:
            ...
            if strict:
                raise
            entry = cast(Union[Unset, StageEntry], UNSET)

        def get_event_type() -> Union[Unset, StageEntryUpdatedReviewRecordEventEventType]:
            event_type = UNSET
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, StageEntryUpdatedReviewRecordEventEventType], UNSET)
