...
class RequestWriteBase:
    ...
    _assignees: Union[Unset, List[Union[RequestWriteUserAssignee, RequestWriteTeamAssignee, UnknownType]]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        try:
            ...
            if strict:
                raise
            assignees = cast(
                Union[Unset, List[Union[RequestWriteUserAssignee, RequestWriteTeamAssignee, UnknownType]]], UNSET
            )
    ...
    @assignees.setter
    def assignees(self, value: List[Union[RequestWriteUserAssignee, RequestWriteTeamAssignee, UnknownType]]) -> None:
