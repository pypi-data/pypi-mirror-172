...
class ContainerWithCoordinates:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self._parent_storage_schema, Unset):
            parent_storage_schema = self._parent_storage_schema.to_dict() if self._parent_storage_schema else None
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        try:
            ...
            if strict:
                raise
            grid_number = cast(Union[Unset, float], UNSET)
        ...
        try:
            ...
            if strict:
                raise
            grid_position = cast(Union[Unset, str], UNSET)
