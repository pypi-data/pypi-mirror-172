...
class RequestResponseSamplesItemBatch:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_entity() -> Union[Unset, DnaSequenceSummary, AaSequenceSummary, CustomEntitySummary, UnknownType]:
        ...
        try:
            ...
            if strict:
                raise
            entity = cast(Union[Unset, DnaSequenceSummary, AaSequenceSummary, CustomEntitySummary, UnknownType], UNSET)
    ...
    @entity.setter
    def entity(self, value: Union[DnaSequenceSummary, AaSequenceSummary, CustomEntitySummary, UnknownType]) -> None:
        self._entity = value
