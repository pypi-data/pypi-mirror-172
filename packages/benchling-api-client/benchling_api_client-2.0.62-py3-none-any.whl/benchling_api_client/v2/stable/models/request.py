...
class Request:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_assignees() -> Union[Unset, List[Union[RequestUserAssignee, RequestTeamAssignee, UnknownType]]]:
            assignees = []
        ...
        try:
            ...
            if strict:
                raise
            assignees = cast(Union[Unset, List[Union[RequestUserAssignee, RequestTeamAssignee, UnknownType]]], UNSET)
