...
class FindMatchingRegionsAsyncTaskResponse:
    ...
    _aa_sequence_matches: Union[Unset, List[FindMatchingRegionsAsyncTaskResponseAaSequenceMatchesItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_aa_sequence_matches() -> Union[Unset, List[FindMatchingRegionsAsyncTaskResponseAaSequenceMatchesItem]]:
            aa_sequence_matches = []
            _aa_sequence_matches = d.pop("aaSequenceMatches")
            for aa_sequence_matches_item_data in _aa_sequence_matches or []:
                aa_sequence_matches_item = FindMatchingRegionsAsyncTaskResponseAaSequenceMatchesItem.from_dict(
    ...
    def aa_sequence_matches(self, value: List[FindMatchingRegionsAsyncTaskResponseAaSequenceMatchesItem]) -> None:
