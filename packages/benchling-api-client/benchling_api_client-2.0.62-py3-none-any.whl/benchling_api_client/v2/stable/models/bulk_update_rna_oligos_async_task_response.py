...
T = TypeVar("T", bound="BulkUpdateRnaOligosAsyncTaskResponse")
...
class BulkUpdateRnaOligosAsyncTaskResponse:
    ...
    def __repr__(self):
        ...
        return "BulkUpdateRnaOligosAsyncTaskResponse({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        bulk_update_rna_oligos_async_task_response = cls(
            rna_oligos=rna_oligos,
        )

        bulk_update_rna_oligos_async_task_response.additional_properties = d
        return bulk_update_rna_oligos_async_task_response
