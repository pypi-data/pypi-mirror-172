...
class PlateSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        try:
            ...
            if strict:
                raise
            container_schema = cast(Union[Unset, None, PlateSchemaContainerSchema], UNSET)
        ...
        try:
            ...
            if strict:
                raise
            plate_type = cast(Union[Unset, str], UNSET)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, PlateSchemaType], UNSET)
