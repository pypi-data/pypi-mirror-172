...
class BulkCreateCustomEntitiesAsyncTask:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_response() -> Union[Unset, BulkCreateCustomEntitiesAsyncTaskResponse]:
            response: Union[Unset, Union[Unset, BulkCreateCustomEntitiesAsyncTaskResponse]] = UNSET
        ...
        try:
            ...
            if strict:
                raise
            response = cast(Union[Unset, BulkCreateCustomEntitiesAsyncTaskResponse], UNSET)
