...
class DnaSequencesBulkUpdateRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_dna_sequences() -> Union[Unset, List[DnaSequenceBulkUpdate]]:
            dna_sequences = []
            _dna_sequences = d.pop("dnaSequences")
            for dna_sequences_item_data in _dna_sequences or []:
                dna_sequences_item = DnaSequenceBulkUpdate.from_dict(dna_sequences_item_data, strict=False)
        ...
        try:
            ...
            if strict:
                raise
            dna_sequences = cast(Union[Unset, List[DnaSequenceBulkUpdate]], UNSET)
