...
def _parse_response(*, response: httpx.Response) -> Optional[Union[OrganizationsPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[OrganizationsPaginatedList, BadRequestError]]:
    return Response(
