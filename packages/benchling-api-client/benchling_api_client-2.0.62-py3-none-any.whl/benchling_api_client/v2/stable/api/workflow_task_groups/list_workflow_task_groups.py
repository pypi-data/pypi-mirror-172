...
def _parse_response(*, response: httpx.Response) -> Optional[Union[WorkflowTaskGroupsPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[WorkflowTaskGroupsPaginatedList, BadRequestError]]:
    return Response(
