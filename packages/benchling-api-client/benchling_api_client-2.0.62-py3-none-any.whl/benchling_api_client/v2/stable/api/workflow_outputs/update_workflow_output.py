...
def _parse_response(*, response: httpx.Response) -> Optional[Union[WorkflowOutput, BadRequestError, NotFoundError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[WorkflowOutput, BadRequestError, NotFoundError]]:
    return Response(
