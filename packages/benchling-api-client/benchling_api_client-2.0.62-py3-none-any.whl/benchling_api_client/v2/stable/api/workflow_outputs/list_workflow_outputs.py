...
def _parse_response(*, response: httpx.Response) -> Optional[Union[WorkflowOutputsPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[WorkflowOutputsPaginatedList, BadRequestError]]:
    return Response(
