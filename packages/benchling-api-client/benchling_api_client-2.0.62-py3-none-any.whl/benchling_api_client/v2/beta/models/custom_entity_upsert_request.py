...
T = TypeVar("T", bound="CustomEntityUpsertRequest")
...
class CustomEntityUpsertRequest:
    ...
    def __repr__(self):
        ...
        return "CustomEntityUpsertRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        custom_entity_upsert_request = cls(
            name=name,
            schema_id=schema_id,
        ...
        custom_entity_upsert_request.additional_properties = d
        return custom_entity_upsert_request
