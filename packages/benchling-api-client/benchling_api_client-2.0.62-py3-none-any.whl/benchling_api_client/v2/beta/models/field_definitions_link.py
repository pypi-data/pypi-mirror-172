...
T = TypeVar("T", bound="FieldDefinitionsLink")


@attr.s(auto_attribs=True, repr=False)
class FieldDefinitionsLink:
    """  """
    ...
    def __repr__(self):
        ...
        return "FieldDefinitionsLink({})".format(", ".join(fields))
