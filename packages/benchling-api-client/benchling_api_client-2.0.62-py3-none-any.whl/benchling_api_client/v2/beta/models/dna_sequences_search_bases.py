...
from ..models.dna_sequences_search_bases_archive_reason import DnaSequencesSearchBasesArchiveReason
from ..models.dna_sequences_search_bases_sort import DnaSequencesSearchBasesSort
from ..types import UNSET, Unset

T = TypeVar("T", bound="DnaSequencesSearchBases")


@attr.s(auto_attribs=True, repr=False)
class DnaSequencesSearchBases:
    """  """

    _bases: str
    _archive_reason: Union[
        Unset, DnaSequencesSearchBasesArchiveReason
    ] = DnaSequencesSearchBasesArchiveReason.NOT_ARCHIVED
    _next_token: Union[Unset, str] = UNSET
    _page_size: Union[Unset, int] = 50
    _registry_id: Union[Unset, None, str] = UNSET
    _schema_id: Union[Unset, str] = UNSET
    _sort: Union[Unset, DnaSequencesSearchBasesSort] = DnaSequencesSearchBasesSort.MODIFIEDATDESC
    ...
    def __repr__(self):
        ...
        return "DnaSequencesSearchBases({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_archive_reason() -> Union[Unset, DnaSequencesSearchBasesArchiveReason]:
            archive_reason = UNSET
            _archive_reason = d.pop("archiveReason")
            if _archive_reason is not None and _archive_reason is not UNSET:
                try:
                    archive_reason = DnaSequencesSearchBasesArchiveReason(_archive_reason)
                except ValueError:
                    archive_reason = DnaSequencesSearchBasesArchiveReason.of_unknown(_archive_reason)
        ...
        try:
            ...
            if strict:
                raise
            archive_reason = cast(Union[Unset, DnaSequencesSearchBasesArchiveReason], UNSET)
        ...
        def get_sort() -> Union[Unset, DnaSequencesSearchBasesSort]:
            sort = UNSET
            _sort = d.pop("sort")
            if _sort is not None and _sort is not UNSET:
                try:
                    sort = DnaSequencesSearchBasesSort(_sort)
                except ValueError:
                    sort = DnaSequencesSearchBasesSort.of_unknown(_sort)
        ...
        try:
            ...
            if strict:
                raise
            sort = cast(Union[Unset, DnaSequencesSearchBasesSort], UNSET)

        dna_sequences_search_bases = cls(
            bases=bases,
        ...
        return dna_sequences_search_bases
    ...
    @property
    def archive_reason(self) -> DnaSequencesSearchBasesArchiveReason:
    ...
    def archive_reason(self, value: DnaSequencesSearchBasesArchiveReason) -> None:
    ...
    @property
    def sort(self) -> DnaSequencesSearchBasesSort:
        if isinstance(self._sort, Unset):
            raise NotPresentError(self, "sort")
        return self._sort

    @sort.setter
    def sort(self, value: DnaSequencesSearchBasesSort) -> None:
        self._sort = value
