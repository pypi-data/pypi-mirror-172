...
from ...models.rna_oligos_bulk_upsert_request import RnaOligosBulkUpsertRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: RnaOligosBulkUpsertRequest,
    returning: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/rna-oligos:bulk-upsert".format(client.base_url)
