...
from ...models.aa_sequences_bulk_upsert_request import AaSequencesBulkUpsertRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AaSequencesBulkUpsertRequest,
    returning: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/aa-sequences:bulk-upsert".format(client.base_url)
