...
from ...models.dna_sequences_match_bases import DnaSequencesMatchBases
...
def _get_kwargs(
    *,
    client: Client,
    json_body: DnaSequencesMatchBases,
) -> Dict[str, Any]:
    url = "{}/dna-sequences:match-bases".format(client.base_url)
