...
from ..models.generic_app_config_item_type import GenericAppConfigItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="GenericAppConfigItem")


@attr.s(auto_attribs=True, repr=False)
class GenericAppConfigItem:
    """  """

    _type: Union[Unset, GenericAppConfigItemType] = UNSET
    ...
    def __repr__(self):
        ...
        return "GenericAppConfigItem({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, GenericAppConfigItemType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = GenericAppConfigItemType(_type)
                except ValueError:
                    type = GenericAppConfigItemType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, GenericAppConfigItemType], UNSET)
        ...
        generic_app_config_item.additional_properties = d
        return generic_app_config_item
    ...
    @property
    def type(self) -> GenericAppConfigItemType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: GenericAppConfigItemType) -> None:
        self._type = value
