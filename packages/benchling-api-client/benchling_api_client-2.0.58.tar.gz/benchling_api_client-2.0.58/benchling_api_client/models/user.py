...
class User:
    ...
    _password_last_changed_at: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_password_last_changed_at() -> Union[Unset, str]:
        ...
        try:
            ...
            if strict:
                raise
            password_last_changed_at = cast(Union[Unset, str], UNSET)
    ...
    @property
    def password_last_changed_at(self) -> str:
    ...
    def password_last_changed_at(self, value: str) -> None:
