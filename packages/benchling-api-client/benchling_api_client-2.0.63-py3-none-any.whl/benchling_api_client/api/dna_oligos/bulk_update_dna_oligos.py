...
from ...models.dna_oligos_bulk_update_request import DnaOligosBulkUpdateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: DnaOligosBulkUpdateRequest,
) -> Dict[str, Any]:
    url = "{}/dna-oligos:bulk-update".format(client.base_url)
