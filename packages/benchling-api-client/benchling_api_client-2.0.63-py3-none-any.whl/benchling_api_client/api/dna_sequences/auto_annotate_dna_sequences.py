...
from ...models.auto_annotate_dna_sequences import AutoAnnotateDnaSequences
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AutoAnnotateDnaSequences,
) -> Dict[str, Any]:
    url = "{}/dna-sequences:auto-annotate".format(client.base_url)
