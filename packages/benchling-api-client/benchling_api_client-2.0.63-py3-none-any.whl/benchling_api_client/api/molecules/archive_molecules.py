...
from ...models.molecules_archive import MoleculesArchive
...
def _get_kwargs(
    *,
    client: Client,
    json_body: MoleculesArchive,
) -> Dict[str, Any]:
    url = "{}/molecules:archive".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[MoleculesArchivalChange, BadRequestError]]:
    if response.status_code == 200:
        response_200 = MoleculesArchivalChange.from_dict(response.json())
