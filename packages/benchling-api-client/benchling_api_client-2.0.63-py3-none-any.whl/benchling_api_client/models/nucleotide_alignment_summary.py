...
T = TypeVar("T", bound="NucleotideAlignmentSummary")
...
class NucleotideAlignmentSummary:
    ...
    def __repr__(self):
        ...
        return "NucleotideAlignmentSummary({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nucleotide_alignment_summary = cls(
            api_url=api_url,
        ...
        nucleotide_alignment_summary.additional_properties = d
        return nucleotide_alignment_summary
