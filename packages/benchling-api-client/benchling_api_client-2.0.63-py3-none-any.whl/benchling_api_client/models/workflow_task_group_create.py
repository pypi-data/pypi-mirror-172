...
class WorkflowTaskGroupCreate:
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskGroupCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        watcher_ids = get_watcher_ids() if "watcherIds" in d else cast(Union[Unset, List[str]], UNSET)

        workflow_task_group_create = cls(
            schema_id=schema_id,
            folder_id=folder_id,
            name=name,
        ...
        workflow_task_group_create.additional_properties = d
        return workflow_task_group_create
