...
from ..models.bulk_create_rna_sequences_async_task_response import BulkCreateRnaSequencesAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkCreateRnaSequencesAsyncTask")
...
class BulkCreateRnaSequencesAsyncTask:
    ...
    _response: Union[Unset, BulkCreateRnaSequencesAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkCreateRnaSequencesAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_response() -> Union[Unset, BulkCreateRnaSequencesAsyncTaskResponse]:
            response: Union[Unset, BulkCreateRnaSequencesAsyncTaskResponse] = UNSET
            _response = d.pop("response")
            if not isinstance(_response, Unset):
                response = BulkCreateRnaSequencesAsyncTaskResponse.from_dict(_response)
        ...
        response = (
            get_response()
            if "response" in d
            else cast(Union[Unset, BulkCreateRnaSequencesAsyncTaskResponse], UNSET)
        )
        ...
        bulk_create_rna_sequences_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_create_rna_sequences_async_task.additional_properties = d
        return bulk_create_rna_sequences_async_task
    ...
    @property
    def response(self) -> BulkCreateRnaSequencesAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkCreateRnaSequencesAsyncTaskResponse) -> None:
