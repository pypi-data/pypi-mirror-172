...
T = TypeVar("T", bound="FeatureLibraryBase")
...
class FeatureLibraryBase:
    ...
    def __repr__(self):
        ...
        return "FeatureLibraryBase({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        feature_library_base = cls(
            description=description,
            name=name,
        )

        feature_library_base.additional_properties = d
        return feature_library_base
