...
from ..models.find_matching_regions_async_task_response import FindMatchingRegionsAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="FindMatchingRegionsAsyncTask")
...
class FindMatchingRegionsAsyncTask:
    ...
    _response: Union[Unset, FindMatchingRegionsAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "FindMatchingRegionsAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_response() -> Union[Unset, FindMatchingRegionsAsyncTaskResponse]:
            response: Union[Unset, FindMatchingRegionsAsyncTaskResponse] = UNSET
            _response = d.pop("response")
            if not isinstance(_response, Unset):
                response = FindMatchingRegionsAsyncTaskResponse.from_dict(_response)
        ...
        response = (
            get_response()
            if "response" in d
            else cast(Union[Unset, FindMatchingRegionsAsyncTaskResponse], UNSET)
        )
        ...
        find_matching_regions_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        find_matching_regions_async_task.additional_properties = d
        return find_matching_regions_async_task
    ...
    @property
    def response(self) -> FindMatchingRegionsAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: FindMatchingRegionsAsyncTaskResponse) -> None:
