...
class NucleotideConsensusAlignmentCreate:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        algorithm = get_algorithm() if "algorithm" in d else cast(NucleotideAlignmentBaseAlgorithm, UNSET)
                ...
                def _parse_files_item(
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        files_item = NucleotideAlignmentBaseFilesItem.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        files_item = NucleotideAlignmentFile.from_dict(data)
        ...
        def get_new_sequence() -> Union[Unset, NucleotideConsensusAlignmentCreateNewSequence]:
            new_sequence: Union[Unset, NucleotideConsensusAlignmentCreateNewSequence] = UNSET
        ...
        new_sequence = (
            get_new_sequence()
            if "newSequence" in d
            else cast(Union[Unset, NucleotideConsensusAlignmentCreateNewSequence], UNSET)
        )
        ...
        sequence_id = get_sequence_id() if "sequenceId" in d else cast(Union[Unset, str], UNSET)
