...
T = TypeVar("T", bound="BulkCreateRnaSequencesAsyncTaskResponse")
...
class BulkCreateRnaSequencesAsyncTaskResponse:
    ...
    def __repr__(self):
        ...
        return "BulkCreateRnaSequencesAsyncTaskResponse({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bulk_create_rna_sequences_async_task_response = cls(
            rna_sequences=rna_sequences,
        )

        bulk_create_rna_sequences_async_task_response.additional_properties = d
        return bulk_create_rna_sequences_async_task_response
