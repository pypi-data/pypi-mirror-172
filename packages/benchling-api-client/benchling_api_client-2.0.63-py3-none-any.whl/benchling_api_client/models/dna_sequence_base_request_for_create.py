...
T = TypeVar("T", bound="DnaSequenceBaseRequestForCreate")
...
class DnaSequenceBaseRequestForCreate:
    ...
    def __repr__(self):
        ...
        return "DnaSequenceBaseRequestForCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        dna_sequence_base_request_for_create = cls(
            aliases=aliases,
        ...
        return dna_sequence_base_request_for_create
