...
T = TypeVar("T", bound="WorkflowTaskGroupsUnarchive")
...
class WorkflowTaskGroupsUnarchive:
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskGroupsUnarchive({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workflow_task_group_ids = (
            get_workflow_task_group_ids() if "workflowTaskGroupIds" in d else cast(List[str], UNSET)
        )

        workflow_task_groups_unarchive = cls(
            workflow_task_group_ids=workflow_task_group_ids,
        )

        workflow_task_groups_unarchive.additional_properties = d
        return workflow_task_groups_unarchive
