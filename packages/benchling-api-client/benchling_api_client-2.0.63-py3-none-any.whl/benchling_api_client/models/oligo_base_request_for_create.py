...
T = TypeVar("T", bound="OligoBaseRequestForCreate")
...
class OligoBaseRequestForCreate:
    ...
    def __repr__(self):
        ...
        return "OligoBaseRequestForCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        oligo_base_request_for_create = cls(
            aliases=aliases,
        ...
        oligo_base_request_for_create.additional_properties = d
        return oligo_base_request_for_create
