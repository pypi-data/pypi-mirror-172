...
class PlateWells:
    ...
    additional_properties: Dict[str, Union[Well, InaccessibleResource, UnknownType]] = attr.ib(init=False, factory=dict)
            ...
            def _parse_additional_property(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    additional_property = Well.from_dict(data, strict=True)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    additional_property = InaccessibleResource.from_dict(data, strict=True)
