...
class RequestSampleGroupSamples:
    ...
    additional_properties: Dict[str, Union[RequestSampleWithEntity, RequestSampleWithBatch, UnknownType]] = attr.ib(
    ...
    def __setitem__(self, key: str, value: Union[RequestSampleWithEntity, RequestSampleWithBatch, UnknownType]) -> None:
    ...
    def get(self, key, default=None) -> Optional[Union[RequestSampleWithEntity, RequestSampleWithBatch, UnknownType]]:
