...
from ..models.workflow_task_updated_scheduled_on_event_event_type import WorkflowTaskUpdatedScheduledOnEventEventType
...
class WorkflowTaskUpdatedScheduledOnEvent:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, WorkflowTaskUpdatedScheduledOnEventEventType]:
            event_type = UNSET
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, WorkflowTaskUpdatedScheduledOnEventEventType], UNSET)
