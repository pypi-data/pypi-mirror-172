...
class Ingredient:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self._component_lot_container, Unset):
            component_lot_container = self._component_lot_container.to_dict() if self._component_lot_container else None

        component_lot_entity: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self._component_lot_entity, Unset):
            component_lot_entity = self._component_lot_entity.to_dict() if self._component_lot_entity else None
