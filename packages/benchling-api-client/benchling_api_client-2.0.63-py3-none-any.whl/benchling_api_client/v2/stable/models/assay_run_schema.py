...
class AssayRunSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_automation_input_file_configs() -> Union[Unset, List[AssayRunSchemaAutomationInputFileConfigsItem]]:
            automation_input_file_configs = []
        ...
        def get_automation_output_file_configs() -> Union[Unset, List[AssayRunSchemaAutomationOutputFileConfigsItem]]:
            automation_output_file_configs = []
    ...
    def automation_input_file_configs(self, value: List[AssayRunSchemaAutomationInputFileConfigsItem]) -> None:
    ...
    def automation_output_file_configs(self, value: List[AssayRunSchemaAutomationOutputFileConfigsItem]) -> None:
