...
class WorkflowStageRunList:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_workflow_stage_runs() -> Union[Unset, List[WorkflowStageRun]]:
            workflow_stage_runs = []
            _workflow_stage_runs = d.pop("workflowStageRuns")
            for workflow_stage_runs_item_data in _workflow_stage_runs or []:
                workflow_stage_runs_item = WorkflowStageRun.from_dict(workflow_stage_runs_item_data, strict=False)
        ...
        try:
            ...
            if strict:
                raise
            workflow_stage_runs = cast(Union[Unset, List[WorkflowStageRun]], UNSET)
