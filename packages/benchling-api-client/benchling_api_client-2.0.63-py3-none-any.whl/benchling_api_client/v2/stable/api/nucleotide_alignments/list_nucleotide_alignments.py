...
def _parse_response(*, response: httpx.Response) -> Optional[Union[NucleotideAlignmentsPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[NucleotideAlignmentsPaginatedList, BadRequestError]]:
    return Response(
