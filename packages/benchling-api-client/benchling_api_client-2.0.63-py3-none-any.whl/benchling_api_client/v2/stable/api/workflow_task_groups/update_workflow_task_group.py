...
def _parse_response(*, response: httpx.Response) -> Optional[Union[WorkflowTaskGroup, BadRequestError, NotFoundError]]:
    if response.status_code == 200:
        response_200 = WorkflowTaskGroup.from_dict(response.json(), strict=False)
...
def _build_response(*, response: httpx.Response) -> Response[Union[WorkflowTaskGroup, BadRequestError, NotFoundError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    workflow_task_group_id: str,
    json_body: WorkflowTaskGroupUpdate,
) -> Response[Union[WorkflowTaskGroup, BadRequestError, NotFoundError]]:
    kwargs = _get_kwargs(
        client=client,
...
def sync(
    *,
    ...
    workflow_task_group_id: str,
    json_body: WorkflowTaskGroupUpdate,
) -> Optional[Union[WorkflowTaskGroup, BadRequestError, NotFoundError]]:
