...
def _parse_response(*, response: httpx.Response) -> Optional[Union[WorkflowTasksPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[WorkflowTasksPaginatedList, BadRequestError]]:
    return Response(
