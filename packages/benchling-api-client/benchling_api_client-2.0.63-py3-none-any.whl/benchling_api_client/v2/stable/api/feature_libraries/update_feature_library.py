...
def _get_kwargs(
    *,
    ...
    url = "{}/feature-libraries/{feature_library_id}".format(client.base_url, feature_library_id=feature_library_id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[FeatureLibrary, BadRequestError, NotFoundError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[FeatureLibrary, BadRequestError, NotFoundError]]:
    return Response(
