...
def _parse_response(*, response: httpx.Response) -> Optional[Union[FeatureLibrariesPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[FeatureLibrariesPaginatedList, BadRequestError]]:
    return Response(
