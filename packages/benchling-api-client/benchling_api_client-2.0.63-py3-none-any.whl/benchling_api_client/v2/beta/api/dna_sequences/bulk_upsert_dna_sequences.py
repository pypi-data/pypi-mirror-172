...
from ...models.dna_sequences_bulk_upsert_request import DnaSequencesBulkUpsertRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: DnaSequencesBulkUpsertRequest,
    returning: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/dna-sequences:bulk-upsert".format(client.base_url)
