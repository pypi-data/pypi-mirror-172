...
from ...models.dna_oligos_bulk_upsert_request import DnaOligosBulkUpsertRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: DnaOligosBulkUpsertRequest,
    returning: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/dna-oligos:bulk-upsert".format(client.base_url)
