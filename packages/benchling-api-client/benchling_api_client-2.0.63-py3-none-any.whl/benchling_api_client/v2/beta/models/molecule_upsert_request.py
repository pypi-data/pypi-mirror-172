...
T = TypeVar("T", bound="MoleculeUpsertRequest")
...
class MoleculeUpsertRequest:
    ...
    def __repr__(self):
        ...
        return "MoleculeUpsertRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        molecule_upsert_request.additional_properties = d
        return molecule_upsert_request
