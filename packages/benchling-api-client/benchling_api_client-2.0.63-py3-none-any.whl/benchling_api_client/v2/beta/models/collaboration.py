...
class Collaboration:
    ...
    _collaborator: Union[
        Unset, OrgMembershipCollaborator, TeamMembershipCollaborator, UserCollaborator, AppCollaborator, UnknownType
    ] = UNSET
    ...
    def collaborator(
        self,
    ) -> Union[OrgMembershipCollaborator, TeamMembershipCollaborator, UserCollaborator, AppCollaborator, UnknownType]:
        if isinstance(self._collaborator, Unset):
