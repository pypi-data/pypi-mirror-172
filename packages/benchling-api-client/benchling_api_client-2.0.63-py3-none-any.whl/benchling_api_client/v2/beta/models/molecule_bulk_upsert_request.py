...
T = TypeVar("T", bound="MoleculeBulkUpsertRequest")


@attr.s(auto_attribs=True, repr=False)
class MoleculeBulkUpsertRequest:
    """  """
    ...
    def __repr__(self):
        ...
        return "MoleculeBulkUpsertRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        molecule_bulk_upsert_request = cls(
            name=name,
            schema_id=schema_id,
        ...
        molecule_bulk_upsert_request.additional_properties = d
        return molecule_bulk_upsert_request
