...
from ...models.list_rna_oligos_helm_sort import ListRNAOligosHelmSort
from ...models.rna_oligos_paginated_list_helm import RnaOligosPaginatedListHelm
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, ListRNAOligosHelmSort] = ListRNAOligosHelmSort.MODIFIEDATDESC,
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[RnaOligosPaginatedListHelm, BadRequestError]]:
    if response.status_code == 200:
        response_200 = RnaOligosPaginatedListHelm.from_dict(response.json(), strict=False)
...
def _build_response(*, response: httpx.Response) -> Response[Union[RnaOligosPaginatedListHelm, BadRequestError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    namesany_of: Union[Unset, str] = UNSET,
    namesany_ofcase_sensitive: Union[Unset, str] = UNSET,
) -> Response[Union[RnaOligosPaginatedListHelm, BadRequestError]]:
    kwargs = _get_kwargs(
        client=client,
        page_size=page_size,
...
def sync(
    *,
    ...
    namesany_of: Union[Unset, str] = UNSET,
    namesany_ofcase_sensitive: Union[Unset, str] = UNSET,
) -> Optional[Union[RnaOligosPaginatedListHelm, BadRequestError]]:
    """ List RNA Oligos with HELM """
