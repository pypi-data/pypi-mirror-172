...
T = TypeVar("T", bound="AppConfigItemFloatBulkUpdate")
...
class AppConfigItemFloatBulkUpdate:
    ...
    def __repr__(self):
        ...
        return "AppConfigItemFloatBulkUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        try:
            ...
            if strict:
                raise
            type = cast(AppConfigItemFloatUpdateType, UNSET)
        ...
        app_config_item_float_bulk_update = cls(
            id=id,
            type=type,
            value=value,
        )

        app_config_item_float_bulk_update.additional_properties = d
        return app_config_item_float_bulk_update
