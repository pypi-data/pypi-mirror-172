...
T = TypeVar("T", bound="AppConfigItemBooleanBulkUpdate")
...
class AppConfigItemBooleanBulkUpdate:
    ...
    def __repr__(self):
        ...
        return "AppConfigItemBooleanBulkUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        try:
            ...
            if strict:
                raise
            value = cast(bool, UNSET)

        app_config_item_boolean_bulk_update = cls(
            id=id,
            type=type,
            value=value,
        )

        app_config_item_boolean_bulk_update.additional_properties = d
        return app_config_item_boolean_bulk_update
