...
from ..models.barcode_scan_form_instance_provider_identifier_type import BarcodeScanFormInstanceProviderIdentifierType
...
class BarcodeScanFormInstanceProvider:
    ...
    _query_value_from: Union[
        Unset, List[Union[FormBarcodeValueReference, FormRawStringQueryValuePart, FormFieldValueReference, UnknownType]]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_identifier_type() -> Union[Unset, BarcodeScanFormInstanceProviderIdentifierType]:
            ...
            if _identifier_type is not None and _identifier_type is not UNSET:
                try:
                    ...
                    identifier_type = BarcodeScanFormInstanceProviderIdentifierType.of_unknown(_identifier_type)
        ...
        def get_query_value_from() -> Union[
            Unset,
            List[Union[FormBarcodeValueReference, FormRawStringQueryValuePart, FormFieldValueReference, UnknownType]],
        ]:
            query_value_from = []
