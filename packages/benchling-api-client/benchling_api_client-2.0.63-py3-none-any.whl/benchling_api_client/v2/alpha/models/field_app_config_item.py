...
from ..models.field_app_config_item_type import FieldAppConfigItemType
...
T = TypeVar("T", bound="FieldAppConfigItem")
...
class FieldAppConfigItem:
    ...
    _type: Union[Unset, FieldAppConfigItemType] = UNSET
    ...
    def __repr__(self):
        ...
        return "FieldAppConfigItem({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, FieldAppConfigItemType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = FieldAppConfigItemType(_type)
                except ValueError:
                    type = FieldAppConfigItemType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, FieldAppConfigItemType], UNSET)
        ...
        field_app_config_item.additional_properties = d
        return field_app_config_item
    ...
    @property
    def type(self) -> FieldAppConfigItemType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: FieldAppConfigItemType) -> None:
        self._type = value
