...
from ..models.datetime_app_config_item_type import DatetimeAppConfigItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="DatetimeAppConfigItem")
...
class DatetimeAppConfigItem:
    ...
    _type: Union[Unset, DatetimeAppConfigItemType] = UNSET
    ...
    def __repr__(self):
        ...
        return "DatetimeAppConfigItem({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, DatetimeAppConfigItemType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = DatetimeAppConfigItemType(_type)
                except ValueError:
                    type = DatetimeAppConfigItemType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, DatetimeAppConfigItemType], UNSET)
        ...
        datetime_app_config_item.additional_properties = d
        return datetime_app_config_item
    ...
    @property
    def type(self) -> DatetimeAppConfigItemType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: DatetimeAppConfigItemType) -> None:
        self._type = value
