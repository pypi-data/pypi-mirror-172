...
from ..models.text_app_config_item_type import TextAppConfigItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="TextAppConfigItem")
...
class TextAppConfigItem:
    ...
    _type: Union[Unset, TextAppConfigItemType] = UNSET
    ...
    def __repr__(self):
        ...
        return "TextAppConfigItem({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, TextAppConfigItemType]:
            type = UNSET
            _type = d.pop("type")
            if _type is not None and _type is not UNSET:
                try:
                    type = TextAppConfigItemType(_type)
                except ValueError:
                    type = TextAppConfigItemType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, TextAppConfigItemType], UNSET)
        ...
        text_app_config_item.additional_properties = d
        return text_app_config_item
    ...
    @property
    def type(self) -> TextAppConfigItemType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: TextAppConfigItemType) -> None:
        self._type = value
