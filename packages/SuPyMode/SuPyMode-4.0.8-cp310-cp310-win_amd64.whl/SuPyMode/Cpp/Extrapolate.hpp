...
double
ExtrapolateNext1_(std::vector<ScalarType>& y, std::vector<double>& x, size_t NextIter){
  return y[NextIter-1];
}


double
ExtrapolateNext2_(std::vector<ScalarType>& y, std::vector<double>& x, size_t NextIter){
...
double
ExtrapolateNext3_(std::vector<ScalarType>& y, std::vector<double>& x, size_t& NextIter){
...
double
ExtrapolateNext4_(std::vector<ScalarType>& y, std::vector<double>& x, size_t& NextIter){
...
double
ExtrapolateNext(size_t order, std::vector<ScalarType>& y, std::vector<double>& x, size_t& NextIter)
{
  switch(order){
