...
from FiberFusing                import Fused7, Circle
...
class Fiber_DCF1300S_20():
    ...
    def GetGeometries(self, Position):
        self.Fiber = [
                       Circle( Center=Position, Radius=self.rClad, Index=self.nClad ),
                       Circle( Center=Position, Radius=self.rCore, Index=self.nCore ),
                       ]
        return self.Fiber
...
class Fiber_SMF28():
    ...
    def GetGeometries(self, Position):
        self.Fiber = [ Circle( Center=Position, Radius=self.rCore, Index=self.nCore ) ]
        return self.Fiber
