...
class sEKVModel:
    ...
    @staticmethod
    def check_lambdac(lambdac: Union[int, float]):
        if not isinstance(lambdac, Union[int, float]):
    ...
    @staticmethod
    def check_lambdad(lambdad: Union[int, float]):
        if not isinstance(lambdad, Union[float, int]):
