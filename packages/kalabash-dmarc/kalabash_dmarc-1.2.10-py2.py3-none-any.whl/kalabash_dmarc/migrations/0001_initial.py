    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disposition', models.CharField(max_length=10, choices=[(b'none', 'None'), (b'quarantine', 'Quarantine'), (b'reject', 'Reject')])),
                ('dkim_result', models.CharField(max_length=9, choices=[(b'none', 'None'), (b'neutral', 'Neutral'), (b'pass', 'Pass'), (b'fail', 'Fail'), (b'temperror', 'Temporary error'), (b'permerror', 'Permanent error'), (b'policy', 'Policy')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ForeignKey(to='kalabash_dmarc.Record', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='report',
            name='reporter',
            field=models.ForeignKey(to='kalabash_dmarc.Reporter', on_delete=models.CASCADE),
        ...
        migrations.AddField(
            model_name='record',
            name='report',
            field=models.ForeignKey(to='kalabash_dmarc.Report', on_delete=models.CASCADE),
            preserve_default=True,
        ),
    ]
