...
class CfnContact(
    ...
    def __init__(
        ...
        *,
        ...
        plan: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[typing.Union["CfnContact.StageProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable]]],
        type: builtins.str,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnContact.__init__)
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnContact.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnContact._render_properties)
    ...
    def alias(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContact, "alias").fset)
    ...
    def display_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContact, "display_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def plan(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContact, "plan").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def type(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContact, "type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class ChannelTargetInfoProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnContact.ChannelTargetInfoProperty.__init__)
    ...
    class ContactTargetInfoProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnContact.ContactTargetInfoProperty.__init__)
    ...
    class StageProperty:
        def __init__(
            ...
            *,
            ...
            targets: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnContact.TargetsProperty", typing.Dict[str, typing.Any]]]]]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnContact.StageProperty.__init__)
    ...
    class TargetsProperty:
        def __init__(
            self,
            *,
            channel_target_info: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnContact.ChannelTargetInfoProperty", typing.Dict[str, typing.Any]]]] = None,
            contact_target_info: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnContact.ContactTargetInfoProperty", typing.Dict[str, typing.Any]]]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnContact.TargetsProperty.__init__)
...
class CfnContactChannel(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnContactChannel.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnContactChannel.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnContactChannel._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def channel_address(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContactChannel, "channel_address").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def channel_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContactChannel, "channel_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def channel_type(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContactChannel, "channel_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def contact_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContactChannel, "contact_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def defer_activation(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnContactChannel, "defer_activation").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnContactChannelProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnContactChannelProps.__init__)
...
class CfnContactProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnContactProps.__init__)
