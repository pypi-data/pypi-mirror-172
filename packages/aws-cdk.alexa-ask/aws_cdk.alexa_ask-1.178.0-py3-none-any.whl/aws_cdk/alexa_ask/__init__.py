...
class CfnSkill(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        authentication_configuration: typing.Union[typing.Union["CfnSkill.AuthenticationConfigurationProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable],
        skill_package: typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnSkill.SkillPackageProperty", typing.Dict[str, typing.Any]]],
    ...
    class SkillPackageProperty:
        def __init__(
            ...
            *,
            ...
            s3_key: builtins.str,
            overrides: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnSkill.OverridesProperty", typing.Dict[str, typing.Any]]]] = None,
