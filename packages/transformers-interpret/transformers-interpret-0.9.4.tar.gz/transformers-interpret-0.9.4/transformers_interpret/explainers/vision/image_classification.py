...
class ImageClassificationExplainer:
    ...
    def visualize(
        ...
        if use_original_image_pixels:
            ...
            np_image = np.transpose(self.inputs["pixel_values"].squeeze(), (1, 2, 0))
    ...
    def _calculate_attributions(self, inputs: torch.Tensor, class_name: Union[int, None], index: Union[int, None]) -> np.ndarray:
