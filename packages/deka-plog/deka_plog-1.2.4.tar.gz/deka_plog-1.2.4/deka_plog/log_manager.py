...
class LogManager(object):
    ...
    def exception_log(self, exception_log_switch: bool = True, log_level_int: int = None, is_add_stream_handler: bool = True,
        ...
        """
        self.log_config.exception_log_switch = exception_log_switch
        if len(exception_logger_list) == 0:
            _logger = self.get_builder().set_log_switch(log_switch) \
                          .set_log_level_int(log_level_int) \
                          .set_is_add_stream_handler(is_add_stream_handler) \
                          .set_log_write_to_file(log_write_to_file) \
                          .set_do_not_use_color_handler(do_not_use_color_handler) \
            ...
            sys.excepthook = self.callback_func
