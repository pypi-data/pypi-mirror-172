...
class BackupProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BackupProps.__init__)
...
class CfnDBCluster(
    ...
    def copy_tags_to_snapshot(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, aws_cdk.core.IResolvable]], jsii.get(self, "copyTagsToSnapshot"))
    ...
    def copy_tags_to_snapshot(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDBCluster, "copy_tags_to_snapshot").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def master_username(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDBCluster, "master_username").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def master_user_password(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDBCluster, "master_user_password").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnDBInstance(
    ...
    def enable_performance_insights(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, aws_cdk.core.IResolvable]], jsii.get(self, "enablePerformanceInsights"))
    ...
    def enable_performance_insights(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDBInstance, "enable_performance_insights").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DatabaseClusterProps:
    def __init__(
        ...
        *,
        ...
        backup: typing.Optional[typing.Union[BackupProps, typing.Dict[str, typing.Any]]] = None,
        cloud_watch_logs_retention: typing.Optional[aws_cdk.aws_logs.RetentionDays] = None,
        cloud_watch_logs_retention_role: typing.Optional[aws_cdk.aws_iam.IRole] = None,
    ...
    @builtins.property
    def cloud_watch_logs_retention_role(self) -> typing.Optional[aws_cdk.aws_iam.IRole]:
...
class ClusterParameterGroup(
    ...
    def from_parameter_group_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ClusterParameterGroup.from_parameter_group_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class DatabaseCluster(
    ...
    def from_database_cluster_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseCluster.from_database_cluster_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_rotation_multi_user(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseCluster.add_rotation_multi_user)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_rotation_single_user(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseCluster.add_rotation_single_user)
            check_type(argname="argument automatically_after", value=automatically_after, expected_type=type_hints["automatically_after"])
    ...
    def add_security_groups(
        ...
        *security_groups: aws_cdk.aws_ec2.ISecurityGroup,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseCluster.add_security_groups)
