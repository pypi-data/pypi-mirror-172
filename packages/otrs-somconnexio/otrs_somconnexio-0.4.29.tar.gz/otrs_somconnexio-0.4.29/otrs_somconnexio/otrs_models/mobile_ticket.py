# coding: utf-8
from otrs_somconnexio.otrs_models.configurations.mobile_ticket import (
    MobileTicketConfiguration, MobileTicketPausedConfiguration)
...
class MobileTicket(ProvisionTicket):
    def __init__(self, service_data, customer_data,
                 otrs_configuration=None):
        self.service_data = service_data
        self.customer_data = customer_data
        self.otrs_configuration = MobileTicketConfiguration(
            otrs_configuration)
...
class MobilePausedTicket(MobileTicket):
    def __init__(self, service_data, customer_data,
                 otrs_configuration=None):
        super().__init__(service_data, customer_data,
                         otrs_configuration)
        self.otrs_configuration = MobileTicketPausedConfiguration(
            otrs_configuration)
