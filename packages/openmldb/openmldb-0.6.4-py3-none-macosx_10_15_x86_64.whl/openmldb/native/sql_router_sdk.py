...
class SQLDeleteRow(object):
    ...
    def __init__(self, db, table_name, index, col_names, default_value, hole_column_map):
...
class SQLInsertRows(object):
    ...
    def __init__(self, table_info, schema, default_map, str_size, hole_idx_arr):
