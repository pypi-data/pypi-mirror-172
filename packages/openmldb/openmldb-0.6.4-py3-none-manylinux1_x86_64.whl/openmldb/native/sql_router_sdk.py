...
class StandaloneOptions(BasicRouterOptions):
    ...
    def __init__(self):
        _sql_router_sdk.StandaloneOptions_swiginit(self, _sql_router_sdk.new_StandaloneOptions())
...
def GenOutputSchema(sql: "std::string const &", schemas: "TableColumnDescPairVector") -> "std::shared_ptr< hybridse::sdk::Schema >":
    return _sql_router_sdk.GenOutputSchema(sql, schemas)

def ValidateSQLInBatch(sql: "std::string const &", schemas: "TableColumnDescPairVector") -> "std::vector< std::string,std::allocator< std::string > >":
    return _sql_router_sdk.ValidateSQLInBatch(sql, schemas)

def ValidateSQLInRequest(sql: "std::string const &", schemas: "TableColumnDescPairVector") -> "std::vector< std::string,std::allocator< std::string > >":
    return _sql_router_sdk.ValidateSQLInRequest(sql, schemas)
...
class ColumnIndicesSet(object):
    ...
    def __init__(self, schema: "std::shared_ptr< hybridse::sdk::Schema >"):
        _sql_router_sdk.ColumnIndicesSet_swiginit(self, _sql_router_sdk.new_ColumnIndicesSet(schema))
...
class SQLDeleteRow(object):
    ...
    def __init__(self, db: "std::string const &", table_name: "std::string const &", index: "std::string const &", col_names: "VectorString", default_value: "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &", hole_column_map: "std::map< int,std::string,std::less< int >,std::allocator< std::pair< int const,std::string > > > const"):
        _sql_router_sdk.SQLDeleteRow_swiginit(self, _sql_router_sdk.new_SQLDeleteRow(db, table_name, index, col_names, default_value, hole_column_map))
    ...
    def GetIndexName(self) -> "std::string const &":
        return _sql_router_sdk.SQLDeleteRow_GetIndexName(self)
...
class SQLInsertRows(object):
    ...
    def __init__(self, table_info: "std::shared_ptr< ::openmldb::nameserver::TableInfo >", schema: "std::shared_ptr< hybridse::sdk::Schema >", default_map: "openmldb::sdk::DefaultValueMap", str_size: "uint32_t", hole_idx_arr: "VectorUint32"):
        _sql_router_sdk.SQLInsertRows_swiginit(self, _sql_router_sdk.new_SQLInsertRows(table_info, schema, default_map, str_size, hole_idx_arr))
