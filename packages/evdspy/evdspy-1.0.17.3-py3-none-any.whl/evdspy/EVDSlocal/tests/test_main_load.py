...
#
# def test_check_if_this_is_pytest():
#     import sys
#     print(sys.argv)
#
#     assert evdspy.check_if_this_is_pytest() is True, f"Could not detect pytest is running if running {sys.argv}"
#

"""
    TODO 
    series.txt not found error check 
    create file test
    apikey not working error test
    proxy test
    graphs
    summary
