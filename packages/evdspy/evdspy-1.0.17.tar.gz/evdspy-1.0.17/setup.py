...
setup_kwargs = {
    'name': 'evdspy',
    'version': '1.0.17',
    'description': 'Get data from EVDS API and organize your local work environment with systematical approach. Using caching facility of this package make less request from the server.',
    ...
    'url': 'https://github.com/SermetPekin/evdspy',
    'packages': packages,
