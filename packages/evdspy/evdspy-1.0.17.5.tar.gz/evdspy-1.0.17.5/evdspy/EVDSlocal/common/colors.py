...
default_styles = {
    ...
    "failure2": Style(color="red", bgcolor="yellow", italic=True),
    "failure3": Style(color="red", bgcolor="yellow", italic=True),
    "failure4": Style(color="red", bgcolor="yellow", italic=True),
    "failure5": Style(color="red", bgcolor="yellow", italic=True),
