...
if not "1.12.1" in torch.__version__:
	raise sol.Exception("The NEC SX-Aurora TSUBASA can only be used with PyTorch v1.12.1 but you are using {}".format(torch.__version__))
