...
from xj_payment.apis import alipay, transaction_inquiry, wechat, pay
...
urlpatterns = [
    ...
    re_path(r'^wechat_pay/?$', pay.WechatPayDAL.create_order_info),  # 微信支付接口
    re_path(r'^scan_pay/?$', payment_wechat.PaymentWechat.payment_scan_pay),  # 微信扫码支付
    re_path(r'^wechat_callback/?$', payment_wechat.PaymentWechat.callback),  # 回调接口
