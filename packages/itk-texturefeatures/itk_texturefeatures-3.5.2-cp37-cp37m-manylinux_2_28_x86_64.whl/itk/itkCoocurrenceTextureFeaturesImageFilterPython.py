...
@helpers.accept_array_like_xarray_torch
def coocurrence_texture_features_image_filter(*args: itkt.ImageLike,  neighborhood_radius: Sequence[int]=..., mask_image: itkt.Image=..., offsets: Sequence[Sequence[int]]=..., offset: Sequence[int]=..., number_of_bins_per_axis: int=..., histogram_maximum: float=..., histogram_minimum: float=..., inside_pixel_value: int=..., normalize: bool=...,**kwargs)-> itkt.ImageSourceReturn:
