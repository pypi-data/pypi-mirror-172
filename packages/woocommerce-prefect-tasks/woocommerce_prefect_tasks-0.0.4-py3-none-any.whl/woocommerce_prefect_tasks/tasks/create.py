...
class Create(Task):
    ...
    @defaults_from_attrs("event", "aws_secret_name", "aws_secret_region")
    def run(self, aws_secret_name: str = None, aws_secret_region: str = None, event: dict = None) -> dict:
        ...
        try:
            ...
            resource = wc_api.api_client.post(endpoint=event.get('endpoint', None),
                                              data=event.get('data', None) or dict(),
