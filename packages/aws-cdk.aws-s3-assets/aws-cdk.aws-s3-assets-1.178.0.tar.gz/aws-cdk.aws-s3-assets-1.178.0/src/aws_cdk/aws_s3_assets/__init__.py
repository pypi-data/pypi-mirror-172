...
class Asset(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Asset.__init__)
    ...
    def add_resource_metadata(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Asset.add_resource_metadata)
    ...
    def grant_read(self, grantee: aws_cdk.aws_iam.IGrantable) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Asset.grant_read)
...
class AssetOptions(
    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AssetOptions.__init__)
