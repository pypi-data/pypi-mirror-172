...
from tcsoa.gen.Internal.Visualization._2008_06.StructureManagement import ExpandPSFromOccurrenceListResponse, CreateBOMsFromRecipesResponse, CreateVisSCsFromBOMsResponse, CreateBOMsFromRecipesInfo, ExpandPSFromOccurrenceListInfo, CreateVisSCsFromBOMsInfo, AreRecipesMergableResponse, ExpandPSFromOccurrenceListPref, AreRecipesMergableInfo
from tcsoa.gen.BusinessObjects import BusinessObject
from tcsoa.gen.Internal.Visualization._2008_06.DataManagement import CreateTwoDSnapshotResponse, GetLatestFileReadTicketsInfo, SessionModelUpdateResponse, MarkupInput, UpdateSesssionModel, UpdateSessionModelWithSessionInput, MarkupUpdateResponse, ServerInfo, VVITicketsResponse, MetaDataStampTicketsResponse, SessionInfo, MarkupResponse, SessionModelInput, UserAgentDataInfo, IdInfo, MarkupUpdateInput, GetLatestFileReadTicketsResponse, TwoDSnapshotInput, SaveSessionResponse, SessionModelResponse, UpdateTwoDSnapshotInput, UpdateTwoDSnapshotResponse
...
class StructureManagementService(TcService):
    ...
    def createBOMsFromRecipes(cls, info: List[CreateBOMsFromRecipesInfo]) -> CreateBOMsFromRecipesResponse:
        ...
        type StructureContext, Fnd0StructureContext or ConfigurationContext and if not, then no BOMWindow will be
        created. If the configuration object is of type ConfigurationContext then the topline object must also be
        supplied; the topline object is not used when the configuration object is of type StructureContext because it
        contains its own topline reference. The BOMWindow settings that will be configured include:
        - The topline object.
