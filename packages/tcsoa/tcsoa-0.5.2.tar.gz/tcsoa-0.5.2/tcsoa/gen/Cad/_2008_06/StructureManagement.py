...
from tcsoa.gen.BusinessObjects import Dataset, MEAppearancePathNode, PSBOMViewRevision, AbsOccurrence, BusinessObject, AssemblyArrangement, Form, AbsOccData, BOMLine, PSOccurrenceThread, VariantRule, ItemRevision, BOMWindow
from tcsoa.gen.Cad._2007_01.StructureManagement import RelationAndTypesFilter, RelOccInfo, AssemblyArrangementInfo, AttributesInfo, RevisionRuleConfigInfo, OccNote
