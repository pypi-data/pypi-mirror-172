...
from tcsoa.gen.Classification._2007_01.Classification import GetChildrenResponse, SearchByInstanceIdResponse, GetPartFamilyTemplatesResponse, GetKeyLOVsResponse, GetClassificationObjectsResponse, GetFileIdCriteria, ClassificationObject, SearchForClassesCriteria, GetClassDescriptionsResponse, FindClassificationObjectsResponse, GetParentsResponse, GetAttributesForClassesResponse, SearchClassAttributes, SearchResponse, FindClassifiedObjectsResponse, CreateClassificationObjectsResponse, UpdateClassificationObjectsResponse, SearchForClassesResponse, GetFileIdsResponse
