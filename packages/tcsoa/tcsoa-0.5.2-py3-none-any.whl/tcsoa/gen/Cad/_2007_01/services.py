...
from tcsoa.gen.BusinessObjects import BusinessObject, ItemRevision, Folder, BOMWindow
from tcsoa.gen.Cad._2007_01.StructureManagement import ExpandPSAllLevelsResponse, ExpandPSOneLevelPref, DeleteAssemblyArrangementsInfo, DeleteAssemblyArrangementsResponse, CreateOrUpdateAbsoluteStructureInfo, CreateOrUpdateAbsoluteStructurePref, GetVariantRulesResponse, ExpandPSAllLevelsPref, CreateOrUpdateAbsoluteStructureResponse, CreateBOMWindowsInfo, CreateOrUpdateRelativeStructurePref, DeleteRelativeStructurePref, CreateOrUpdateRelativeStructureResponse, GetRevisionRulesResponse, ExpandPSAllLevelsInfo, DeleteRelativeStructureInfo, CloseBOMWindowsResponse, CreateBOMWindowsResponse, ExpandPSOneLevelInfo, DeleteRelativeStructureResponse, CreateOrUpdateRelativeStructureInfo, ExpandPSOneLevelResponse
from tcsoa.gen.Cad._2007_01.DataManagement import ExpandGRMRelationsResponse, GetAllAttrMappingsResponse, ResolveAttrMappingsForDatasetResponse, CreateOrUpdateRelationsInfo, ResolveAttrMappingsForDatasetInfo, ExpandPrimaryObjectsResponse, ExpandFolderForCADPref, GetAttrMappingsForDatasetTypeResponse, GenerateAlternateIdsProperties, CreateOrUpdatePartsResponse, CreateOrUpdateRelationsResponse, GetAvailableTypesResponse, CreateOrUpdateRelationsPref, PartInfo, GenerateAlternateIdsResponse, ExpandGRMRelationsPref, ExpandFoldersForCADResponse, ExpandPrimaryObjectsPref, GetAttrMappingsForDatasetTypeCriteria
