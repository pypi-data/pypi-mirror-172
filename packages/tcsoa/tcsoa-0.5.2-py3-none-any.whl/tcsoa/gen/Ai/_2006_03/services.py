...
from tcsoa.gen.Ai._2006_03.Ai import ApplicationRef, Configuration, CommitFilesResponse, FileTicket, GetFileReadTicketsResponse, StateFilter, FileType, RequestDetail, CommitStructureFileResponse, CommitFileData, ObjectsExistResponse, ProjectCreationData, GetNextApprovedRequestResponse, ProjectInfo, StatusInfo, UpdateType, GetFileWriteTicketsResponse, ProjectFilter, CreatePublishRequestResponse, GetPropertiesOfObjectsResponse, GetStructureWriteTicketResponse, GenerateFullSyncRequestResponse, GetStructureReadTicketResponse, GenerateStructureResponse
