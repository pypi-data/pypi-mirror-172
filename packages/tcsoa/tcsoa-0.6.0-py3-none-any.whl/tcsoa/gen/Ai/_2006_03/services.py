...
from tcsoa.gen.BusinessObjects import RequestObject, AppInterface
from tcsoa.gen.Ai._2006_03.Ai import Configuration, GetFileWriteTicketsResponse, ApplicationRef, UpdateType, GetNextApprovedRequestResponse, GetPropertiesOfObjectsResponse, ProjectFilter, RequestDetail, GenerateStructureResponse, FileType, CommitStructureFileResponse, GetStructureReadTicketResponse, CreatePublishRequestResponse, GetStructureWriteTicketResponse, ProjectInfo, CommitFileData, StateFilter, CommitFilesResponse, ObjectsExistResponse, GetFileReadTicketsResponse, StatusInfo, FileTicket, ProjectCreationData, GenerateFullSyncRequestResponse
