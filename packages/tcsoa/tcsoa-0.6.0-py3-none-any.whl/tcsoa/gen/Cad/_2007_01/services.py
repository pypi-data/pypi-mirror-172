...
from tcsoa.gen.BusinessObjects import BOMWindow, BusinessObject, Folder, ItemRevision
from tcsoa.gen.Cad._2007_01.StructureManagement import CreateBOMWindowsInfo, CreateBOMWindowsResponse, DeleteAssemblyArrangementsInfo, DeleteRelativeStructurePref, ExpandPSAllLevelsResponse, ExpandPSOneLevelPref, CreateOrUpdateAbsoluteStructurePref, ExpandPSOneLevelInfo, DeleteRelativeStructureResponse, ExpandPSOneLevelResponse, CreateOrUpdateRelativeStructureInfo, CreateOrUpdateAbsoluteStructureInfo, DeleteRelativeStructureInfo, CreateOrUpdateRelativeStructureResponse, CreateOrUpdateAbsoluteStructureResponse, GetVariantRulesResponse, CreateOrUpdateRelativeStructurePref, GetRevisionRulesResponse, CloseBOMWindowsResponse, DeleteAssemblyArrangementsResponse, ExpandPSAllLevelsPref, ExpandPSAllLevelsInfo
from tcsoa.gen.Cad._2007_01.DataManagement import ResolveAttrMappingsForDatasetResponse, ExpandPrimaryObjectsResponse, GetAllAttrMappingsResponse, CreateOrUpdatePartsResponse, PartInfo, GetAttrMappingsForDatasetTypeCriteria, ExpandFoldersForCADResponse, CreateOrUpdateRelationsResponse, CreateOrUpdateRelationsPref, ExpandFolderForCADPref, ExpandPrimaryObjectsPref, CreateOrUpdateRelationsInfo, ResolveAttrMappingsForDatasetInfo, GetAttrMappingsForDatasetTypeResponse, ExpandGRMRelationsPref, GenerateAlternateIdsResponse, GenerateAlternateIdsProperties, GetAvailableTypesResponse, ExpandGRMRelationsResponse
