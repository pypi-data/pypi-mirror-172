...
from tcsoa.gen.Workflow._2008_06.Workflow import AttachmentInfo, ProcessTemplates, RemoveSignoffsInfo, InstanceInfo, ChangeStateInputInfo, CreateSignoffs, SoaEPMSupportingValues, SoaEPMAction, ChangeStateOutput, ContextData, Templates, AuditFile, GroupRoleRef, Tasks, Resources, AllOrAssigned, AssignmentLists, GetResourcePoolOutput
from tcsoa.gen.BusinessObjects import BusinessObject, WorkspaceObject, Signoff, EPMAssignmentList, EPMJob, EPMTask
