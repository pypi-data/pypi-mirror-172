...
from tcsoa.gen.BusinessObjects import AbsOccurrence, AssemblyArrangement, BusinessObject, ItemRevision, BOMLine, AbsOccData, PSOccurrenceThread, MEAppearancePathNode, Form, PSBOMViewRevision, BOMWindow, Dataset, VariantRule
from tcsoa.gen.Cad._2007_01.StructureManagement import OccNote, RelationAndTypesFilter, RevisionRuleConfigInfo, RelOccInfo, AttributesInfo, AssemblyArrangementInfo
