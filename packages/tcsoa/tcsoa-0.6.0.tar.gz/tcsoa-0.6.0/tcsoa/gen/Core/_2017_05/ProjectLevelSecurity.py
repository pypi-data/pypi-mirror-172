...
from tcsoa.gen.BusinessObjects import TC_Project, AssemblyArrangement, Folder, BusinessObject, ItemRevision, PSBOMView, CFMOverrideEntry, RevisionRule, ConfigurationContext, Item, VariantRule, User
