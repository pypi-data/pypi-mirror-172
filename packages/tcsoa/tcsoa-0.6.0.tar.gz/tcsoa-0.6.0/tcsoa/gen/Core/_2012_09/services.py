...
from tcsoa.gen.Core._2012_09.ProjectLevelSecurity import ProjectInformation, ProjectOpsResponse, CopyProjectsInfo, ModifyProjectsInfo, ProjectTeamsResponse, ProjectClientId
