...
from tcsoa.gen.Core._2008_06.DataManagement import CreateResponse, GetRevNRAttachResponse, Participants, CreateIn, InfoForNextId, DisplayableSubBOsResponse, CreateOrUpdateItemElementsResponse, GDELinkInfo, AddParticipantOutput, DatasetProperties2, CreateConnectionsResponse, GetNRPatternsWithCountersResponse, ConnectionProperties, CreateOrUpdateRelationsResponse, BOWithExclusionIn, ReviseResponse2, CreateOrUpdateRelationsInfo, GetNextIdsResponse, NRAttachInfo, SaveAsNewItemInfo, AddParticipantInfo, GetItemAndRelatedObjectsResponse, CreateOrUpdateGDELinksResponse, GetItemAndRelatedObjectsInfo, TypeAndItemRevInfo, ReviseInfo, SaveAsNewItemResponse2, ItemElementProperties
...
from tcsoa.gen.Core._2008_06.StructureManagement import RemoveInStructureAssociationsInfo, GetSecondariesOfInStructureAssociationInfo, GetPrimariesOfInStructureAssociationResponse, RemoveInStructureAssociationsResponse, InStructureAssociationInfo, GetSecondariesOfInStructureAssociationResponse, CreateInStructureAssociationResponse, GetPrimariesOfInStructureAssociationInfo
