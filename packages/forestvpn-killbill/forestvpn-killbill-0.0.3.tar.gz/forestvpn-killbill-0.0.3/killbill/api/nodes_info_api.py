...
class NodesInfoApi(object):
    ...
    def get_nodes_info(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_nodes_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_nodes_info_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_nodes_info_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def trigger_node_command(self, body, x_killbill_created_by, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.trigger_node_command(body, x_killbill_created_by, async_req=True)
        >>> result = thread.get()
    ...
    def trigger_node_command_with_http_info(self, body, x_killbill_created_by, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.trigger_node_command_with_http_info(body, x_killbill_created_by, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'x_killbill_created_by', 'x_killbill_reason', 'x_killbill_comment', 'local_node_only']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
