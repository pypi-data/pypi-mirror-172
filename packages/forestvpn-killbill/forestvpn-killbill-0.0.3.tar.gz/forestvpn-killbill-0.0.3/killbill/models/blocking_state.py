...
class BlockingState(object):
    ...
    def __init__(self, blocked_id=None, state_name=None, service=None, is_block_change=None, is_block_entitlement=None, is_block_billing=None, effective_date=None, type=None, audit_logs=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BlockingState, dict):
