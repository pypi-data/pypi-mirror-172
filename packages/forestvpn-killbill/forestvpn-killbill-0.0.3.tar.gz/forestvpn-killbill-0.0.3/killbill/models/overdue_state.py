...
class OverdueState(object):
    ...
    def __init__(self, name=None, external_message=None, is_disable_entitlement_and_changes_blocked=None, is_block_changes=None, is_clear_state=None, reevaluation_interval_days=None):  # noqa: E501
