...
class RenderNode(Object):
    ...
    def _set_render_information(self):
        ...
        self.render_information.border_bottom_left_radius = min(self.get_value(self.dom_node.styles.border_bottom_left_radius, 0) * BORDER_RADIUS_CORRECTION_FACTOR, self.render_information.width * BORDER_RADIUS_MAX_MULTIPLIER, self.render_information.height * BORDER_RADIUS_MAX_MULTIPLIER)
        self.render_information.border_bottom_right_radius = min(self.get_value(self.dom_node.styles.border_bottom_right_radius, 0) * BORDER_RADIUS_CORRECTION_FACTOR, self.render_information.width * BORDER_RADIUS_MAX_MULTIPLIER, self.render_information.height * BORDER_RADIUS_MAX_MULTIPLIER)
        self.render_information.border_top_left_radius = min(self.get_value(self.dom_node.styles.border_top_left_radius, 0) * BORDER_RADIUS_CORRECTION_FACTOR, self.render_information.width * BORDER_RADIUS_MAX_MULTIPLIER, self.render_information.height * BORDER_RADIUS_MAX_MULTIPLIER)
        self.render_information.border_top_right_radius = min(self.get_value(self.dom_node.styles.border_top_right_radius, 0) * BORDER_RADIUS_CORRECTION_FACTOR, self.render_information.width * BORDER_RADIUS_MAX_MULTIPLIER, self.render_information.height * BORDER_RADIUS_MAX_MULTIPLIER)
