...
class evaql_parserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by evaql_parser#renameTable.
    ...
    # Visit a parse tree produced by evaql_parser#dropUdf.
    ...
    # Visit a parse tree produced by evaql_parser#tableValuedFunction.
    def visitTableValuedFunction(self, ctx:evaql_parser.TableValuedFunctionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by evaql_parser#subqueryTableSourceItem.
    ...
    # Visit a parse tree produced by evaql_parser#lateralJoin.
    def visitLateralJoin(self, ctx:evaql_parser.LateralJoinContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by evaql_parser#aliasClause.
    ...
    # Visit a parse tree produced by evaql_parser#showStatement.
    ...
    # Visit a parse tree produced by evaql_parser#oldtableName.
    def visitOldtableName(self, ctx:evaql_parser.OldtableNameContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by evaql_parser#newtableName.
