...
if ('all' in section) or ('tech' in section):
    ...
    case1_t_agg = case1_t.groupby(['store-name', 'ecom-flag'], as_index=False)['promo-discount'].sum()
    ...
    case2_t_agg = case2_t.groupby(['store-name', 'ecom-flag'], as_index=False)['promo-discount'].sum()
    ...
    case3_t_agg = case3_t.groupby(['store-name', 'ecom-flag'], as_index=False)['promo-discount'].sum()
    ...
    case4_t_agg = case4_t.groupby(['store-name', 'ecom-flag'], as_index=False)['promo-discount'].sum()
...
if ('all' in section) or ('marketing' in section):
    ...
    case1_m_agg = case1_m.groupby(['store-name', 'ecom-flag'], as_index=False)['promo-discount'].sum()
    ...
    case2_m_agg = case2_m.groupby(['store-name', 'ecom-flag'], as_index=False)['promo-discount'].sum()
...
email.send_email_file(subject="Promo Leakage",
                      mail_body=f'None',
                      to_emails=email_to, file_uris=[], file_paths=file_paths)
