...
def _get_data_sources(args: FeatureViewArgs) -> List[specs.DataSourceSpec]:
    ...
    for ds_id in ds_ids:
        ds = _ALL_FCOS[ds_id]
        data_source_specs.append(specs.DataSourceSpec.from_args_proto(ds._args))
...
def get_transformations(args: FeatureViewArgs) -> List[specs.TransformationSpec]:
    ...
    for transformation_id in transformation_ids:
        ...
        transformation_specs.append(specs.TransformationSpec.from_args_proto(transformation._args_proto()))
