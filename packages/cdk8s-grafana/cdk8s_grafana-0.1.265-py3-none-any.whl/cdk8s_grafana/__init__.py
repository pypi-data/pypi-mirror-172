...
class Dashboard(
    ...
    def __init__(
        ...
        *,
        ...
        plugins: typing.Optional[typing.Sequence[typing.Union["GrafanaPlugin", typing.Dict[str, typing.Any]]]] = None,
    ...
    def add_plugins(self, *plugins: "GrafanaPlugin") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Dashboard.add_plugins)
...
class DataSource(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataSource.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class DataSourceProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataSourceProps.__init__)
...
class Grafana(
    ...
    def __init__(
        ...
        *,
        ...
        default_data_source: typing.Optional[typing.Union[DataSourceProps, typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Grafana.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = GrafanaProps(
    ...
    def add_dashboard(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Grafana.add_dashboard)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = DashboardProps(
            title=title,
            data_source_variables=data_source_variables,
    ...
    def add_data_source(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Grafana.add_data_source)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = DataSourceProps(
            access=access,
            name=name,
...
class GrafanaPlugin:
    def __init__(self, *, name: builtins.str, version: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GrafanaPlugin.__init__)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
...
class GrafanaProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GrafanaProps.__init__)
