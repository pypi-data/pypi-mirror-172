...
class CfnAnalyzer(
    ...
    def __init__(
        ...
        *,
        ...
        archive_rules: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[typing.Union["CfnAnalyzer.ArchiveRuleProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable]]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAnalyzer.__init__)
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAnalyzer.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAnalyzer._render_properties)
    ...
    def type(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAnalyzer, "type").fset)
    ...
    def analyzer_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAnalyzer, "analyzer_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def archive_rules(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAnalyzer, "archive_rules").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class ArchiveRuleProperty:
        def __init__(
            self,
            *,
            filter: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnAnalyzer.FilterProperty", typing.Dict[str, typing.Any]]]]],
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnAnalyzer.ArchiveRuleProperty.__init__)
    ...
    class FilterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnAnalyzer.FilterProperty.__init__)
...
class CfnAnalyzerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAnalyzerProps.__init__)
