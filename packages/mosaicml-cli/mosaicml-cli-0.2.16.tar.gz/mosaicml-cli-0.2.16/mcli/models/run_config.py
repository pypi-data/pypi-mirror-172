...
from mcli.utils.utils_string_functions import (camel_case_to_snake_case, ensure_rfc1123_compatibility,
                                               snake_case_to_camel_case, validate_image, validate_rfc1123_name)
...
class FinalRunConfig(DeserializableModel):
    ...
    def finalize_config(cls, run_config: RunConfig) -> FinalRunConfig:
        ...
        if run_config.optimization_level is None:
            ...
            # Internal runs (excluding hello worlds) are forced to use default optimization
            if conf.internal and run_config.image != 'bash':
