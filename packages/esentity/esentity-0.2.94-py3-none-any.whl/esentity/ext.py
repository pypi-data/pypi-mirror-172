...
class CasinosExtension(Extension):
    ...
    def _render(self, args, caller=None):
        ...
        default = [10, 'casinos_top', True, None] # cnt, template, has_geo, sort, [tags...]
        _ca = len(default)
        args = args[:_ca] + default[len(args):] + args[_ca:]
...
class RatingV2Extension(Extension):
    ...
    def _render(self, args, caller=None):
        ...
        default = ['casino', 10, ['software', 'provider_tags', 'currencies', 'deposits', 'games'], 1000, ['Fair', 'Anomymous', 'VPN']]
        _ca = len(default)
        args = args[:_ca] + default[len(args):] + args[_ca:]
