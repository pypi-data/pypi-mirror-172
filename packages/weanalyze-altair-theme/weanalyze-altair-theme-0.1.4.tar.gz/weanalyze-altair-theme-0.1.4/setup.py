...
setup(
    ...
    version=get_version(HERE, "weanalyze_altair_theme/__init__.py"),
    description="WeAnalyze's theme for Altair charts.",
    long_description=(HERE / "README.md").read_text(),
    long_description_content_type="text/markdown",
    author="weanalyze",
    url="https://github.com/weanalyze/weanalyze-altair-theme",
    ...
    project_urls={
        "Bug Reports": "https://github.com/weanalyze/weanalyze-altair-theme/issues",
        "Source": "https://github.com/weanalyze/weanalyze-altair-theme",
    },
)