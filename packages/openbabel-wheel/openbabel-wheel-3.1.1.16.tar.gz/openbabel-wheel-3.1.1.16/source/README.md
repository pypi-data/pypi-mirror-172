...
Note: This wheel package is unoffical and experimental. It's built through GitHub Actions. The source code is [here](https://github.com/njzjz/openbabel/tree/openbabel-3-1-1-pypi) based on the official release 3.1.1.
