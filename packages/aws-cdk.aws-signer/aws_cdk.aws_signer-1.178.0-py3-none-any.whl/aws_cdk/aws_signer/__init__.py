...
class CfnProfilePermission(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnProfilePermission.__init__)
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnProfilePermission.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnProfilePermission._render_properties)
    ...
    def action(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnProfilePermission, "action").fset)
    ...
    def principal(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnProfilePermission, "principal").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def profile_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnProfilePermission, "profile_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def statement_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnProfilePermission, "statement_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def profile_version(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnProfilePermission, "profile_version").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnProfilePermissionProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnProfilePermissionProps.__init__)
...
class CfnSigningProfile(
    ...
    def __init__(
        ...
        *,
        ...
        signature_validity_period: typing.Optional[typing.Union[typing.Union["CfnSigningProfile.SignatureValidityPeriodProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSigningProfile.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSigningProfile.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSigningProfile._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def platform_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnSigningProfile, "platform_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def signature_validity_period(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnSigningProfile, "signature_validity_period").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class SignatureValidityPeriodProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnSigningProfile.SignatureValidityPeriodProperty.__init__)
...
class CfnSigningProfileProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSigningProfileProps.__init__)
...
class SigningProfile(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SigningProfile.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_signing_profile_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SigningProfile.from_signing_profile_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class SigningProfileAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SigningProfileAttributes.__init__)
...
class SigningProfileProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SigningProfileProps.__init__)
