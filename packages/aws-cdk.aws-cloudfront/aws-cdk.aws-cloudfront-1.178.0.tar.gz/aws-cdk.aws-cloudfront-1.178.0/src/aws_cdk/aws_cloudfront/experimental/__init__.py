...
class EdgeFunction(
    ...
    def add_alias(
        ...
        *,
        additional_versions: typing.Optional[typing.Sequence[typing.Union[aws_cdk.aws_lambda.VersionWeight, typing.Dict[str, typing.Any]]]] = None,
        description: typing.Optional[builtins.str] = None,
    ...
    def add_function_url(
        self,
        *,
        auth_type: typing.Optional[aws_cdk.aws_lambda.FunctionUrlAuthType] = None,
        cors: typing.Optional[typing.Union[aws_cdk.aws_lambda.FunctionUrlCorsOptions, typing.Dict[str, typing.Any]]] = None,
    ) -> aws_cdk.aws_lambda.FunctionUrl:
        ...
        '''
        options = aws_cdk.aws_lambda.FunctionUrlOptions(auth_type=auth_type, cors=cors)

        return typing.cast(aws_cdk.aws_lambda.FunctionUrl, jsii.invoke(self, "addFunctionUrl", [options]))
    ...
    def add_permission(
        ...
        *,
        ...
        function_url_auth_type: typing.Optional[aws_cdk.aws_lambda.FunctionUrlAuthType] = None,
    ...
    def grant_invoke_url(
        ...
        if __debug__:
            ...
            check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
        return typing.cast(aws_cdk.aws_iam.Grant, jsii.invoke(self, "grantInvokeUrl", [identity]))
    ...
    def architecture(self) -> aws_cdk.aws_lambda.Architecture:
        ...
        return typing.cast(aws_cdk.aws_lambda.Architecture, jsii.get(self, "architecture"))
