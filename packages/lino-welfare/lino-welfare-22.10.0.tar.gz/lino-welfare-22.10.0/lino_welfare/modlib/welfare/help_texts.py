...
help_texts = {
    ...
    'lino_welfare.modlib.aids.Plugin.no_date_range_veto_until' : _("""Optionally specify the primary key (an integer) of the last granting for
...
not."""),
    ...
    'lino_welfare.modlib.households.RefundsByPerson' : _("""Shows the members of the primary household of this person together with an
amount which depends on whether that member is adult or not."""),
    'lino_welfare.modlib.households.RefundsByPerson.child_tariff' : _("""The amount to refund for children (household members less than
lino_xl.lib.households.Plugin.adult_age years old)."""),
    'lino_welfare.modlib.households.RefundsByPerson.adult_tariff' : _("""The amount to refund for children (household members who are
lino_xl.lib.households.Plugin.adult_age years or older)."""),
    ...
    'lino_welfare.modlib.households.RefundsByPerson.amount' : _("""The amount to pay. This is either child_tariff or
adult_tarif depending on the age of the household member."""),
    'lino_welfare.modlib.isip.ContractBase' : _("""Abstract base class for all integration contracts."""),
...
participant, plus possibly some other coach."""),
    'lino_welfare.modlib.isip.ContractBase.get_printable_demo_objects' : _("""All contracts of a demo project (not only one) are being printed.
Overrides
...
their duties."""),
    'lino_welfare.modlib.isip.ContractEvents' : _("""A list of observable events for filtering contracts
(ContractBaseTable.observed_event)."""),
    'lino_welfare.modlib.isip.ClientHasContract' : _("""Whether the client has at least one ISIP contact during the
observed date range."""),
    'lino_welfare.modlib.isip.ContractsByClient' : _("""To see this table you need either IntegrationAgent or
SocialCoordinator."""),
...
this type."""),
    'lino_welfare.modlib.isip.ContractTypeBase.overlap_group' : _("""The overlap group to use when checking whether two contracts are
...
responsible for issuing the following error messages:"""),
    ...
    'lino_welfare.modlib.jobs.JobProvider.is_social' : _("""Organisation bénéficiant de l’agrément « Initiative d’économie sociale »
