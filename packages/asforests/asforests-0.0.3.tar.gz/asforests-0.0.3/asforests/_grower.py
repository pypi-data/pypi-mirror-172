...
class ForestGrower:
    ...
    def __init__(self, info_supplier, d, step_size, w_min, epsilon, delta, extrapolation_multiplier, max_trees, random_state, stop_when_horizontal, logger):
    ...
    def step(self):
        ...
        for i in self.open_dims.copy():
            ...
            if not self.converged:
                ...
                #print(self.t, self.start_of_convergence_window[i], w, self.is_cauchy[i], np.max(history[-self.w_min:]) - np.min(history[self.start_of_convergence_window[i]:]))
