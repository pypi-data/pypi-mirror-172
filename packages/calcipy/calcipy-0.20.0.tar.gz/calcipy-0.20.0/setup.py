...
extras_require = \
{':python_version > "3.7"': ['numpy>=1.23.1'],
 'commitizen_legacy': ['cz_legacy>=0.1.2'],
 'dev': ['better-exceptions>=0.3.3',
         'commitizen>=2.28.0',
         ...
         'pyupgrade>=2.32.1'],
 'dev:sys_platform != "win32" or python_version < "3.9"': ['pdbpp>=0.10.3'],
