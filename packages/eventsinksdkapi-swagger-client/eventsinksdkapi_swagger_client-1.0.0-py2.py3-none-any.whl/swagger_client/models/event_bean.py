...
class EventBean(object):
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["ARGO_MINIO_FILE_COPY", "ARGO_REPORT_GENERATION", "ARGO_REPORT_PUBLISH", "ARGO_REPORT_RECON_CHECK", "BRANDED_REPORT_GENERATION", "BRANDED_REPORT_PUBLISH", "BT_AWS_S3_FILE_VALIDATION", "BT_BRANDED_AIRFLOW_DAG_FEEDFILE_COPY", "BT_BRANDED_AWS_S3_FILE_VALIDATION", "BT_SFTP_FILE_VALIDATION", "BT_UNBRANDED_AIRFLOW_DAG_FEEDFILE_COPY", "BT_UNBRANDED_AWS_S3_FILE_VALIDATION", "PP_EDP_JDF", "PP_HANDSHAKE_MODULE", "PP_SFTP_FILE_VALIDATION", "RDM_TABLE_LOAD", "UNBRANDED_RECON_CHECK", "UNBRANDED_REPORT_GENERATION", "UNBRANDED_REPORT_PUBLISH"]  # noqa: E501
