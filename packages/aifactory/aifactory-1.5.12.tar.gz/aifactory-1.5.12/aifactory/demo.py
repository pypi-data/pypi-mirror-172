...
api_url_test= "http://34.125.179.77:7887/demo"
...
def make_zip(key, main_name, func):
  ...
  for (path, dir, files) in os.walk("./"):
    for file in files:  
      ...
      if "train" not in path and "sample_data" not in path and "drive" not in path and "aif.zip" not in file and ".h5" not in ext and ".pth" not in ext:
