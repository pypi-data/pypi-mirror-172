...
class Semaphore(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Semaphore.__init__)
...
class SemaphoreProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SemaphoreProps.__init__)
    ...
    @builtins.property
    def next_state(self) -> aws_cdk.aws_stepfunctions.State:
        ...
        return typing.cast(aws_cdk.aws_stepfunctions.State, result)
