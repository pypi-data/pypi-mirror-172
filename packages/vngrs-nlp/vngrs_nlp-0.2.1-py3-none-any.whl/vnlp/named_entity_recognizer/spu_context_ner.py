...
class SPUContextNER:
    ...
    def __init__(self, evaluate):
        self.model = create_spucontext_ner_model(TOKEN_PIECE_MAX_LEN, SENTENCE_MAX_LEN, WORD_EMBEDDING_VOCAB_SIZE, LABEL_VOCAB_SIZE,
    ...
    def predict(self, sentence: str, displacy_format: bool = False) -> List[Tuple[int, str, int, str]]:
        ...
        preds = [self.tokenizer_label.sequences_to_texts([[int_pred]])[0] for int_pred in int_preds]
