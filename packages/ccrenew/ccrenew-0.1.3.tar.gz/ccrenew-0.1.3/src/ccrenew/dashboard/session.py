...
from ccrenew.dashboard.data_processing.CCR import (
    all_df_keys,
    file_project,
)
...
class DashboardSession(object):
    ...
    def __init__(self,
        ...
        self.raw_snow_df = utils.get_snow_df(dashboard_folder, data_source)
    ...
    def load_pickle(self, project_name, year=None):
        if not year:
    ...
    def draw_plots(self, project_name, plot_order=None, *args, **kwargs):
        ...
        Kwargs:
            mth (int): The month to show on the Power vs POA crossplot.
            open_folder (bool): Option to open the project's folder on the filesystem.

            <h3>Acceptable Options & Default Order:</h3>
