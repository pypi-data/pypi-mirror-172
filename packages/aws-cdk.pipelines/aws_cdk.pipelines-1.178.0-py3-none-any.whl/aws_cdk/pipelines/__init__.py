...
class CodeBuildOptions:
    def __init__(
        self,
        *,
        build_environment: typing.Optional[typing.Union[aws_cdk.aws_codebuild.BuildEnvironment, typing.Dict[str, typing.Any]]] = None,
...
class ShellScriptAction(
    ...
    def __init__(
        ...
        *,
        ...
        environment: typing.Optional[typing.Union[aws_cdk.aws_codebuild.BuildEnvironment, typing.Dict[str, typing.Any]]] = None,
        environment_variables: typing.Optional[typing.Mapping[builtins.str, typing.Union[aws_cdk.aws_codebuild.BuildEnvironmentVariable, typing.Dict[str, typing.Any]]]] = None,
