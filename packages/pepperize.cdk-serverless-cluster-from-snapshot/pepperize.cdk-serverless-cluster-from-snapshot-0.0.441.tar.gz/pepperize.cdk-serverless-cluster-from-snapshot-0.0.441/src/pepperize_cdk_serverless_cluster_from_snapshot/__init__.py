...
class ServerlessClusterFromSnapshot(
    ...
    def __init__(
        ...
        *,
        ...
        scaling: typing.Optional[typing.Union[aws_cdk.aws_rds.ServerlessScalingOptions, typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerlessClusterFromSnapshot.__init__)
    ...
    def add_rotation_multi_user(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerlessClusterFromSnapshot.add_rotation_multi_user)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def grant_data_api_access(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServerlessClusterFromSnapshot.grant_data_api_access)
    ...
    def _enable_data_api(self, value: typing.Optional[builtins.bool]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ServerlessClusterFromSnapshot, "_enable_data_api").fset)
...
class ServerlessClusterFromSnapshotProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ServerlessClusterFromSnapshotProps.__init__)
