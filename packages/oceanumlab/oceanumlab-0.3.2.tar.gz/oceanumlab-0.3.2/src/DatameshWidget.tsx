...
const datasourceCode = (
  ...
  if (
    ...
    datasourceStr += `=datamesh.query(${JSON.stringify(datasource).replace(
      /null/g,
      'None'
    )})`;
  } else {
...
class DatameshWorkspaceDisplay extends React.Component<IDatameshWorkspaceProps> {
  ...
  private insertDatameshConnect = async (
    ...
    if (widget instanceof NotebookPanel) {
      ...
      if (datameshTokenInject) {
        NotebookActions.setCellCollapse(notebookContent.widgets[0], true);
        //notebookContent.activeCellIndex = 0;
      }
