...
from .warblertypes import ColorType
...
def _normalize_text_alignment(alignment: Union[BorbAlignment, str]) -> BorbAlignment:
...
def _normalize_alignment(alignment: Union[BorbAlignment, str]) -> Tuple[BorbAlignment, BorbAlignment]:
...
def _normalize_vertical_alignment(alignment: Union[BorbAlignment, str]) -> BorbAlignment:
    # If alignment is already an enum object, just return it.
    if alignment in (
        BorbAlignment.TOP,
        BorbAlignment.MIDDLE,
...
def _normalize_horizontal_alignment(alignment: Union[BorbAlignment, str]) -> BorbAlignment:
    # If alignment is already an enum object, just return it.
    if alignment in (
        BorbAlignment.LEFT,
        BorbAlignment.CENTERED,
...
def _normalize_font(fontFile: Union[BorbTrueTypeFont, str, Path]) -> BorbTrueTypeFont:
