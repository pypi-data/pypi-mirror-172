from borb.pdf import Page as BorbPage
from borb.pdf import Paragraph as BorbParagraph
...
from borb.pdf import SingleColumnLayout as BorbSingleColumnLayout
from borb.pdf.page.page_size import PageSize as BorbPageSize

from .util import _normalize_text_alignment, _normalize_alignment, _normalize_color, _normalize_hyphenation, _normalize_font
from .warblertypes import NumberType, ColorType, OneNumForFourType, AligmentType, OneBoolForFourType
...
class Page(BorbPage):
    def __init__(self, width: NumberType = Decimal(612), height: NumberType = Decimal(792), size: str = ''):
        if size != '':
            width, height = pageSizeFromName(size)
    ...
    def add(self,
        ...
        text_alignment: AligmentType = BorbAlignment.LEFT,
        alignment: AligmentType = BorbAlignment.TOP,
        ...
        self.default_layout_obj.add(Paragraph(text, respect_newlines_in_text=respect_newlines_in_text, respect_spaces_in_text=respect_spaces_in_text, font=font, font_size=font_size, text_alignment=text_alignment, alignment=alignment, font_color=font_color, border=border, border_radius=border_radius, border_color=border_color, border_width=border_width, padding=padding, margin=margin, fixed_leading=fixed_leading, multiplied_leading=multiplied_leading, background_color=background_color, hyphenation=hyphenation))
