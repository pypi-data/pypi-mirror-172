...
class AwsManagedMicrosoftAd(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsManagedMicrosoftAd.__init__)
    ...
    def create_ad_group(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsManagedMicrosoftAd.create_ad_group)
    ...
    def create_service_account(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsManagedMicrosoftAd.create_service_account)
    ...
    def create_worker(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsManagedMicrosoftAd.create_worker)
...
class AwsManagedMicrosoftAdR53(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsManagedMicrosoftAdR53.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        jsii.create(self.__class__, self, [scope, id, props])
...
class _IAwsManagedMicrosoftAdParametersProxy:
    ...
    def configuration_store_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdParameters, "configuration_store_type").fset)
    ...
    def directory_id_pointer(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdParameters, "directory_id_pointer").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def namespace(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdParameters, "namespace").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def secret_pointer(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdParameters, "secret_pointer").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class _IAwsManagedMicrosoftAdPropsProxy:
    ...
    def vpc(self, value: aws_cdk.aws_ec2.IVpc) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdProps, "vpc").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def configuration_store(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdProps, "configuration_store").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def create_worker(self, value: typing.Optional[builtins.bool]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdProps, "create_worker").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def domain_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdProps, "domain_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def edition(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdProps, "edition").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def secret(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdProps, "secret").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def secret_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdProps, "secret_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def vpc_subnets(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IAwsManagedMicrosoftAdProps, "vpc_subnets").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
