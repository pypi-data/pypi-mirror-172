...
class FSxWindows(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FSxWindows.__init__)
    ...
    def create_folder(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FSxWindows.create_folder)
    ...
    def create_worker(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FSxWindows.create_worker)
...
class _IFSxWindowsParametersProxy:
    ...
    def dns_endpoint(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IFSxWindowsParameters, "dns_endpoint").fset)
    ...
    def namespace(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IFSxWindowsParameters, "namespace").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class _IFSxWindowsPropsProxy:
    ...
    def directory_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IFSxWindowsProps, "directory_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def vpc(self, value: aws_cdk.aws_ec2.IVpc) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IFSxWindowsProps, "vpc").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def file_system_in_private_subnet(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IFSxWindowsProps, "file_system_in_private_subnet").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def file_system_size(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IFSxWindowsProps, "file_system_size").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def multi_az(self, value: typing.Optional[builtins.bool]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IFSxWindowsProps, "multi_az").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ssm_parameters(self, value: typing.Optional[IFSxWindowsParameters]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IFSxWindowsProps, "ssm_parameters").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def throughput_mbps(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IFSxWindowsProps, "throughput_mbps").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
