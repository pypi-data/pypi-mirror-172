...
class DomainWindowsNode(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DomainWindowsNode.__init__)
    ...
    def open_rdp(self, ipaddress: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DomainWindowsNode.open_rdp)
    ...
    def run_ps_commands(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DomainWindowsNode.run_ps_commands)
    ...
    def run_p_swith_domain_admin(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DomainWindowsNode.run_p_swith_domain_admin)
            check_type(argname="argument ps_commands", value=ps_commands, expected_type=type_hints["ps_commands"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def run_shell_commands(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DomainWindowsNode.run_shell_commands)
...
class _IDomainWindowsNodePropsProxy:
    ...
    def vpc(self, value: aws_cdk.aws_ec2.IVpc) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainWindowsNodeProps, "vpc").fset)
    ...
    def ami_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainWindowsNodeProps, "ami_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def domain_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainWindowsNodeProps, "domain_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def iam_managed_policies_list(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainWindowsNodeProps, "iam_managed_policies_list").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def instance_type(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainWindowsNodeProps, "instance_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def password_object(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainWindowsNodeProps, "password_object").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def use_private_subnet(self, value: typing.Optional[builtins.bool]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainWindowsNodeProps, "use_private_subnet").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def user_data(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainWindowsNodeProps, "user_data").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def windows_machine(self, value: typing.Optional[builtins.bool]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainWindowsNodeProps, "windows_machine").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class _IRuntimeNodesProxy:
    ...
    def add_ad_dependency(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRuntimeNodes.add_ad_dependency)
    ...
    def add_eks_dependency(self, eks_cluster: aws_cdk.aws_eks.Cluster) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRuntimeNodes.add_eks_dependency)
    ...
    def add_local_cred_file(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRuntimeNodes.add_local_cred_file)
            check_type(argname="argument ad_parameters_store", value=ad_parameters_store, expected_type=type_hints["ad_parameters_store"])
    ...
    def add_storage_dependency(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRuntimeNodes.add_storage_dependency)
            check_type(argname="argument ad_parameters_store", value=ad_parameters_store, expected_type=type_hints["ad_parameters_store"])
    ...
    def add_user_data(self, *commands: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRuntimeNodes.add_user_data)
...
class _IWindowsEKSClusterParametersProxy:
    ...
    def cluster_name_pointer(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IWindowsEKSClusterParameters, "cluster_name_pointer").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def namespace(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IWindowsEKSClusterParameters, "namespace").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class _IWindowsEKSClusterPropsProxy:
    ...
    def vpc(self, value: aws_cdk.aws_ec2.IVpc) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IWindowsEKSClusterProps, "vpc").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "vpc", value)
    ...
    def eks_ssm_parameters(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IWindowsEKSClusterProps, "eks_ssm_parameters").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class _IWindowsEKSNodesPropsProxy:
    ...
    def vpc(self, value: aws_cdk.aws_ec2.IVpc) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IWindowsEKSNodesProps, "vpc").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "vpc", value)
    ...
    def instance_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IWindowsEKSNodesProps, "instance_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "instanceType", value)
    ...
    def namespace(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IWindowsEKSNodesProps, "namespace").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "namespace", value)
...
class WindowsEKSCluster(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WindowsEKSCluster.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        jsii.create(self.__class__, self, [scope, id, props])
...
class WindowsEKSNodes(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WindowsEKSNodes.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        jsii.create(self.__class__, self, [scope, id, props])
    ...
    def add_ad_dependency(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WindowsEKSNodes.add_ad_dependency)
            check_type(argname="argument ad_parameters_store", value=ad_parameters_store, expected_type=type_hints["ad_parameters_store"])
        return typing.cast(None, jsii.invoke(self, "addAdDependency", [ad_parameters_store]))
    ...
    def add_eks_dependency(self, eks_cluster: aws_cdk.aws_eks.Cluster) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WindowsEKSNodes.add_eks_dependency)
            check_type(argname="argument eks_cluster", value=eks_cluster, expected_type=type_hints["eks_cluster"])
        return typing.cast(None, jsii.invoke(self, "addEKSDependency", [eks_cluster]))
    ...
    def add_local_cred_file(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WindowsEKSNodes.add_local_cred_file)
            check_type(argname="argument ad_parameters_store", value=ad_parameters_store, expected_type=type_hints["ad_parameters_store"])
            check_type(argname="argument ad_group_name", value=ad_group_name, expected_type=type_hints["ad_group_name"])
            check_type(argname="argument account_name", value=account_name, expected_type=type_hints["account_name"])
        return typing.cast(None, jsii.invoke(self, "addLocalCredFile", [ad_parameters_store, ad_group_name, account_name]))
    ...
    def add_storage_dependency(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WindowsEKSNodes.add_storage_dependency)
            check_type(argname="argument ad_parameters_store", value=ad_parameters_store, expected_type=type_hints["ad_parameters_store"])
            check_type(argname="argument fsx_parameters_store", value=fsx_parameters_store, expected_type=type_hints["fsx_parameters_store"])
            check_type(argname="argument folder_name", value=folder_name, expected_type=type_hints["folder_name"])
        return typing.cast(None, jsii.invoke(self, "addStorageDependency", [ad_parameters_store, fsx_parameters_store, folder_name]))
    ...
    def add_user_data(self, *commands: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WindowsEKSNodes.add_user_data)
            check_type(argname="argument commands", value=commands, expected_type=typing.Tuple[type_hints["commands"], ...]) # pyright: ignore [reportGeneralTypeIssues]
        return typing.cast(None, jsii.invoke(self, "addUserData", [*commands]))
    ...
    def g_msa_web_hook_auto_install(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WindowsEKSNodes.g_msa_web_hook_auto_install)
            check_type(argname="argument eks_cluster", value=eks_cluster, expected_type=type_hints["eks_cluster"])
    ...
    def run_power_shell_ssm_document(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WindowsEKSNodes.run_power_shell_ssm_document)
