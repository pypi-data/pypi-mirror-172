from AGZ.Configs import maker , encryption , tools , welcome
import base64
import datetime
import io
import math
...
__copyright__ = "Copyright (C) 2022 Ali Ganji zadeh <Rub : @Aii_Gamer>"
...
class Bot:
	...
	def setGroupAdmin(self, chat_id, user_id):
		return self.maker.method('setGroupAdmin',{"group_guid": chat_id,"access_list":["PinMessages","DeleteGlobalAllMessages","BanMember","SetMemberAccess"],"action": "SetAdmin","member_guid": user_id})
