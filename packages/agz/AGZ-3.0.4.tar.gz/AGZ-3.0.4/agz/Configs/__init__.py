...
_url = "https://messengerg2c17.iranlms.ir/"
...
class welcome:
    def welcome_tx():
        print (f"AGZ library version {Fore.CYAN}3.0.2{Fore.WHITE}\nCopyright (c) {Fore.CYAN}2022 {Fore.WHITE}Ali Ganji zadeh <Rub: @Aii_Gamer>")