...
class SmarterSender:
    ...
    def __check_limit(self, usage_data, exp_slug) -> int:
        ...
        if not is_subscribed and trial_limit and usage_data[exp_slug] > trial_limit:
    ...
    def add_tag(self, is_event, id, new_tag, new_val):
        self.__db.add_tag(is_event=is_event, id=id, new_tag=new_tag, new_val=new_val, user_id=self.__user_id)
