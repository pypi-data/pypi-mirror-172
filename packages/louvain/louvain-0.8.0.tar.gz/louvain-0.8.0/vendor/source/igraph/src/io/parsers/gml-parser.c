...
#ifndef YY_IGRAPH_GML_YY_HOME_RUNNER_WORK_LOUVAIN_IGRAPH_LOUVAIN_IGRAPH_VENDOR_BUILD_IGRAPH_SRC_IO_PARSERS_GML_PARSER_H_INCLUDED
# define YY_IGRAPH_GML_YY_HOME_RUNNER_WORK_LOUVAIN_IGRAPH_LOUVAIN_IGRAPH_VENDOR_BUILD_IGRAPH_SRC_IO_PARSERS_GML_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_IGRAPH_GML_YY_HOME_RUNNER_WORK_LOUVAIN_IGRAPH_LOUVAIN_IGRAPH_VENDOR_BUILD_IGRAPH_SRC_IO_PARSERS_GML_PARSER_H_INCLUDED  */
...
{
       0,   127,   127,   129,   130,   131,   133,   135,   137,   141,
     144,   152
};
#endif
