...
#ifndef YY_IGRAPH_LGL_YY_HOME_RUNNER_WORK_LOUVAIN_IGRAPH_LOUVAIN_IGRAPH_VENDOR_BUILD_IGRAPH_SRC_IO_PARSERS_LGL_PARSER_H_INCLUDED
# define YY_IGRAPH_LGL_YY_HOME_RUNNER_WORK_LOUVAIN_IGRAPH_LOUVAIN_IGRAPH_VENDOR_BUILD_IGRAPH_SRC_IO_PARSERS_LGL_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_IGRAPH_LGL_YY_HOME_RUNNER_WORK_LOUVAIN_IGRAPH_LOUVAIN_IGRAPH_VENDOR_BUILD_IGRAPH_SRC_IO_PARSERS_LGL_PARSER_H_INCLUDED  */
...
{
       0,    92,    92,    93,    94,    97,    99,   101,   101,   103,
     108,   117,   127
};
#endif
...
{
  "\"end of file\"", "error", "$undefined", "\"alphanumeric\"",
  "\"end of line\"", "\"#\"", "ERROR", "$accept", "input", "vertex",
  "vertexdef", "edges", "edge", "edgeid", "weight", YY_NULLPTR
};
#endif
