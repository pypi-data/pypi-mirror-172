...
class HyperledgerFabricClient(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricClient.__init__)
    ...
    def vpc_endpoint(self) -> aws_cdk.aws_ec2.InterfaceVpcEndpoint:
        '''Managed Blockchain network VPC endpoint.'''
        return typing.cast(aws_cdk.aws_ec2.InterfaceVpcEndpoint, jsii.get(self, "vpcEndpoint"))
...
class HyperledgerFabricClientProps:
    def __init__(self, *, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricClientProps.__init__)
...
class HyperledgerFabricNetwork(
    ...
    def __init__(
        ...
        *,
        ...
        client: typing.Optional[typing.Union[HyperledgerFabricClientProps, typing.Dict[str, typing.Any]]] = None,
        ...
        nodes: typing.Optional[typing.Sequence[typing.Union["HyperledgerFabricNodeProps", typing.Dict[str, typing.Any]]]] = None,
        ...
        users: typing.Optional[typing.Sequence[typing.Union["HyperledgerFabricUserProps", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricNetwork.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def admin_password_secret(self) -> aws_cdk.aws_secretsmanager.Secret:
        '''Secret ARN for the Hyperledger Fabric admin password.'''
        return typing.cast(aws_cdk.aws_secretsmanager.Secret, jsii.get(self, "adminPasswordSecret"))

    @builtins.property
    @jsii.member(jsii_name="adminPrivateKeySecret")
    def admin_private_key_secret(self) -> aws_cdk.aws_secretsmanager.Secret:
        '''Secret for Hyperledger Fabric admin private key.'''
        return typing.cast(aws_cdk.aws_secretsmanager.Secret, jsii.get(self, "adminPrivateKeySecret"))

    @builtins.property
    @jsii.member(jsii_name="adminSignedCertSecret")
    def admin_signed_cert_secret(self) -> aws_cdk.aws_secretsmanager.Secret:
        '''Secret for Hyperledger Fabric admin signed certificate.'''
        return typing.cast(aws_cdk.aws_secretsmanager.Secret, jsii.get(self, "adminSignedCertSecret"))
...
class HyperledgerFabricNetworkProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricNetworkProps.__init__)
...
class HyperledgerFabricNode(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricNode.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def construct_nodes(
        cls,
        scope: HyperledgerFabricNetwork,
        node_props: typing.Optional[typing.Sequence[typing.Union["HyperledgerFabricNodeProps", typing.Dict[str, typing.Any]]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricNode.construct_nodes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def configure_logging(
        self,
        sdk_call_policy: aws_cdk.custom_resources.AwsCustomResourcePolicy,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricNode.configure_logging)
    ...
    def fetch_data(
        self,
        data_sdk_call_policy: aws_cdk.custom_resources.AwsCustomResourcePolicy,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricNode.fetch_data)
    ...
    def endpoint(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(HyperledgerFabricNode, "endpoint").fset)
    ...
    def event_endpoint(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(HyperledgerFabricNode, "event_endpoint").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "eventEndpoint", value)
...
class HyperledgerFabricNodeProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricNodeProps.__init__)
...
class HyperledgerFabricUser(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricUser.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def user_private_key_secret(self) -> aws_cdk.aws_secretsmanager.Secret:
        '''Secret for user private key.'''
        return typing.cast(aws_cdk.aws_secretsmanager.Secret, jsii.get(self, "userPrivateKeySecret"))

    @builtins.property
    @jsii.member(jsii_name="userSignedCertSecret")
    def user_signed_cert_secret(self) -> aws_cdk.aws_secretsmanager.Secret:
        '''Secret for user signed certificate.'''
        return typing.cast(aws_cdk.aws_secretsmanager.Secret, jsii.get(self, "userSignedCertSecret"))
...
class HyperledgerFabricUserProps:
    def __init__(self, *, affilitation: builtins.str, user_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HyperledgerFabricUserProps.__init__)
