...
_TENSORFLOW_CACHEKEY = _descriptor.Descriptor(
  name='CacheKey',
  full_name='tensorflow_federated.v0.TensorFlow.CacheKey',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='tensorflow_federated.v0.TensorFlow.CacheKey.id', index=0,
...
_TENSORFLOW = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='session_token_tensor_name', full_name='tensorflow_federated.v0.TensorFlow.session_token_tensor_name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='parameter', full_name='tensorflow_federated.v0.TensorFlow.parameter', index=3,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='result', full_name='tensorflow_federated.v0.TensorFlow.result', index=4,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cache_key', full_name='tensorflow_federated.v0.TensorFlow.cache_key', index=5,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_TENSORFLOW_BINDING, _TENSORFLOW_STRUCTBINDING, _TENSORFLOW_TENSORBINDING, _TENSORFLOW_SEQUENCEBINDING, _TENSORFLOW_CACHEKEY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_TENSORFLOW_CACHEKEY.containing_type = _TENSORFLOW
...
_TENSORFLOW.fields_by_name['cache_key'].message_type = _TENSORFLOW_CACHEKEY
