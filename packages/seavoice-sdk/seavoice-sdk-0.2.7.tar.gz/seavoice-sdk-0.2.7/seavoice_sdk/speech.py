...
class Recognizer():
    ...
    class RecognizerWebSocket(WebSocketClient):
        ...
        def __init__(self, url, headers, recognizer):
        ...
        def received_message(self, message: ws4py.messaging.TextMessage) -> None:
            ...
            svc_logger.info(f"RECEIVED MESSSGE {message}")
            try:
                ...
                svc_logger.error(f"Exception in receive_message: {str(message)}, e: {e}")
    ...
    def __init__(self, speech_config: SpeechConfig, audio_config: Optional[audio.AudioConfig] = None, monitor_session: bool = False, itn: bool = True, punctuation: bool = True):
    ...
    def send_thread(self):
        ...
        if self.monitor_session:
            data = {
                ...
                "current_time": self.seconds_received
            }
...
class SpeechRecognizer(Recognizer):
    ...
    def __init__(self, speech_config: SpeechConfig, audio_config: Optional[audio.AudioConfig] = None, monitor_session: bool = False, itn: bool = True, punctuation: bool = True):
        ...
        super().__init__(speech_config=speech_config, audio_config=audio_config, monitor_session=monitor_session, itn=itn, punctuation=punctuation)
