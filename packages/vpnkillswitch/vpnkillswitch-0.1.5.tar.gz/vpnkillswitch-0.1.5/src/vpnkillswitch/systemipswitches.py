...
create_filter_rule 'iptables -A RB_I_RELATED_AND_ESTABLISHED -p udp --sport 53 -m conntrack --ctstate RELATED,ESTABLISHED -j ACCEPT'
create_filter_rule 'iptables -A RB_I_RELATED_AND_ESTABLISHED -i lo -p udp --dport 53 -m conntrack --ctstate RELATED,ESTABLISHED -j ACCEPT'
...
create_filter_rule 'iptables -A RB_O_RELATED_AND_ESTABLISHED -p udp --dport 53 -m conntrack --ctstate NEW,RELATED,ESTABLISHED -j ACCEPT'
create_filter_rule 'iptables -A RB_O_RELATED_AND_ESTABLISHED -o lo -p udp --sport 53 -m conntrack --ctstate ESTABLISHED -j ACCEPT'
