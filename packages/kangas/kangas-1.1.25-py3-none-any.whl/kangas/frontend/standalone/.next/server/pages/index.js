...
const localConfig = {
    ...
    apiProxyUrl: `${external_process_.env.KANGAS_PROTOCOL || "http"}://${external_process_.env.KANGAS_HOST}:${external_process_.env.KANGAS_BACKEND_PORT}/datagrid/`,
