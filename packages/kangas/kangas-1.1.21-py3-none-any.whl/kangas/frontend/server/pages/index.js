...
var dynamic = __webpack_require__("(sc_server)/./node_modules/next/dynamic.js");
...
const localConfig = {
    apiUrl: `http://${external_process_.env.KANGAS_HOST}:${external_process_.env.KANGAS_BACKEND_PORT}/datagrid/`,
    apiProxyUrl: `http://${external_process_.env.KANGAS_HOST}:${external_process_.env.KANGAS_BACKEND_PORT}/datagrid/`,
    defaultDecimalPrecision: 5,
    locale: "en-US"
};
if (external_process_.env.KANGAS_BACKEND_PROXY) {
    if (external_process_.env.KANGAS_BACKEND_PROXY.endsWith("/")) localConfig.apiProxyUrl = `${external_process_.env.KANGAS_BACKEND_PROXY}datagrid/`;
    else localConfig.apiProxyUrl = `${external_process_.env.KANGAS_BACKEND_PROXY}/datagrid/`;
}
...
/* harmony default export */ const GroupBy_client = ({ $$typeof: MODULE_REFERENCE, filepath: "/home/dblank/comet/kangas/frontend/components/SettingsBar/GroupBy.client.js", name: "default" });
...
/* harmony default export */ const MatrixSelect_client = ({ $$typeof: MatrixSelect_client_MODULE_REFERENCE, filepath: "/home/dblank/comet/kangas/frontend/components/SettingsBar/MatrixSelect.client.js", name: "default" });
...
/* harmony default export */ const SortBy_client = ({ $$typeof: SortBy_client_MODULE_REFERENCE, filepath: "/home/dblank/comet/kangas/frontend/components/SettingsBar/SortBy.client.js", name: "default" });
...
/* harmony default export */ const FilterExpr_client = ({ $$typeof: FilterExpr_client_MODULE_REFERENCE, filepath: "/home/dblank/comet/kangas/frontend/components/SettingsBar/FilterExpr.client.js", name: "default" });
...
/* harmony default export */ const CustomizeColumns_client = ({ $$typeof: CustomizeColumns_client_MODULE_REFERENCE, filepath: "/home/dblank/comet/kangas/frontend/components/SettingsBar/CustomizeColumns.client.js", name: "default" });
...
const SortButton = ()=>/*#__PURE__*/ _jsxs("div", {
...
const GroupButton = ()=>/*#__PURE__*/ _jsxs("div", {
        className: "button-outline",
        children: [
            /*#__PURE__*/ _jsx("img", {
...
const SelectButton = ()=>/*#__PURE__*/ _jsxs("div", {
        className: "button-outline",
        children: [
            /*#__PURE__*/ _jsx("img", {
...
var next_image = __webpack_require__("(sc_server)/./node_modules/next/image.js");
...
const ImageCell = ({ value , dgid  })=>{
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx(external_react_.Suspense, {
            ...
            children: /*#__PURE__*/ jsx_runtime_.jsx(next_image/* default */.Z, {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(external_react_.Suspense, {
            ...
            children: [
                ...
                /*#__PURE__*/ jsx_runtime_.jsx(next_image/* default */.Z, {
...
const Root = ({ query , matrices , expiration  })=>{
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(page_client, {
            children: [
                ...
                /*#__PURE__*/ jsx_runtime_.jsx(external_react_.Suspense, {
                    ...
                    children: /*#__PURE__*/ jsx_runtime_.jsx(ClientContext_client, {
                        ...
                        apiProxyUrl: config_0.apiProxyUrl,
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
...
var __webpack_exports__ = __webpack_require__.X(0, [546], () => (__webpack_exec__("(sc_server)/./pages/index.server.js")));
