"""Kedro Language Server command line interface."""
...
def get_version() -> str:
    ...
    try:
        ...
        try:
            ...
            sys.exit(1)
    return version("kedro-lsp")


def cli() -> None:
    """Kedro language server cli entrypoint."""
    parser = argparse.ArgumentParser(
        prog="kedro-lsp",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        description="Kedro Language Server: an LSP wrapper for Kedro.",
        epilog="""\
Examples:
