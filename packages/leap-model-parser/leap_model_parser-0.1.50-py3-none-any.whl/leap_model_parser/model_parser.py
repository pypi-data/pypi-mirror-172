...
class ModelParser:
    def __init__(self, should_transform_inputs_and_outputs=False,
                 custom_layers: Optional[Dict[str, Type[tf.keras.layers.Layer]]] = None, dataset_version: Optional[Dict] = None, dataset_name: Optional[str] = None):
    ...
    def get_keras_model_and_model_graph(
        ...
        try:
            ...
            model_generator = KerasJsonModelImport(self.custom_layers, self.dataset_version, self.dataset_name)
