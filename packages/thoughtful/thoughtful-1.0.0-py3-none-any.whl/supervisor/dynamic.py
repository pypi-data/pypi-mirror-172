...
```
from supervisor.dynamic import ...
```
"""
import warnings

# These are the imports to make "from supervisor.dynamic import ..." backwards
# compatible
from supervisor.default_instances import *

warnings.simplefilter("once", DeprecationWarning)
warnings.warn(
    "Using `from supervisor.dynamic import ...` is deprecated and will be "
    "removed in the future. You should use `from supervisor import ...` instead.",
    DeprecationWarning,
)
