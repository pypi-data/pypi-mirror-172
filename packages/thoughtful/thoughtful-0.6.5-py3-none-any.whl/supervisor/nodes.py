...
class Node(ABC):
    def __init__(
        ...
        deprecate_non_dynamic(stacklevel=3)
        self.uuid = uuid
...
@dataclass
class BranchNode(Node, DeprecatedBecauseNonDynamic):
...
@dataclass
class ConditionalNode(Node, DeprecatedBecauseNonDynamic):
...
@dataclass
class SequentialNode(Node, DeprecatedBecauseNonDynamic):
...
class NodeBuilder(DeprecatedBecauseNonDynamic):
    """
