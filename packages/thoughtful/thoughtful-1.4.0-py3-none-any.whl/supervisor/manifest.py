...
class StepStatus(str, Enum):
    ...
    WARNING: The step finished, but requires attention
...
class RecordStatusColumns(YamlModel):
    ...
    Attributes:
        succeeded (Optional[str]): The name of the column that contains
            the succeeded records.
        failed (Optional[str]): The name of the column that contains
            the failed records.
        warning (Optional[str]): The name of the column that contains
            the warning records.
    """
...
class Step(YamlModel):
    ...
    A step to execute in a manifest workflow.
        ...
        columns (RecordStatusColumns, optional): The columns to display in the
            UI for record statuses. If none, it will use manifest defaults.
    """
...
class Manifest(YamlModel):
    ...
    Attributes:
        ...
        columns (RecordStatusColumns, optional): The columns to display in the
            UI for record statuses. If none, it will use defaults.
