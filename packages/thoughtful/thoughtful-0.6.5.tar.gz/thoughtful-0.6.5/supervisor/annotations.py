...
@dataclass
class RunResult(DeprecatedBecauseNonDynamic):
    """
...
@dataclass
class Annotation(DeprecatedBecauseNonDynamic):
    """
...
class Annotatable(DeprecatedBecauseNonDynamic, metaclass=AnnotatableMeta):
    """
