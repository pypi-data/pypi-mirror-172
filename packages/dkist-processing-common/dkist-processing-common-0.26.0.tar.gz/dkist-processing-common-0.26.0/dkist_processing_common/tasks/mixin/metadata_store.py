...
input_dataset_part_document_type_hint = Union[list, dict, str, int, float, None]
...
class MetadataStoreMixin:
    ...
    ) -> Union[InputDatasetPartResponse, List[InputDatasetPartResponse], None]:
    ...
    def _metadata_store_input_dataset_observe_frames_part(
        self,
    ) -> Optional[InputDatasetPartResponse]:
    ...
    @property
    def metadata_store_input_dataset_observe_frames_part_id(self) -> Optional[int]:
    ...
    @property
    def metadata_store_input_dataset_calibration_frames_part_id(self) -> Optional[int]:
    ...
    @property
    def metadata_store_input_dataset_parameters_part_id(self) -> Optional[int]:
