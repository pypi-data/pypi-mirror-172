...
from owl_builder.buildr.svc import AddGraphNodes
from owl_builder.buildr.svc import GenerateOwlModel
from owl_builder.buildr.svc import OpenAsGraph
...
class OwlBuilderAPI(BaseObject):
    ...
    def __init__(self):
        ...
        Created:
            21-Jul-20922
            craigtrim@gmail.com
            *   https://github.com/craigtrim/buildolw/issues/7
        """
