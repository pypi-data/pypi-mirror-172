...
from owl_builder.autosyns.dmo import OpenAIEventExecutor
from owl_builder.autosyns.dmo import OpenAIOutputExtractor
...
class GenerateInflectionCall(BaseObject):
    ...
    def __init__(self):
        ...
        Created:
            20-Jul-2022
            craigtrim@gmail.com
            *   https://github.com/craigtrim/buildolw/issues/5
        """
