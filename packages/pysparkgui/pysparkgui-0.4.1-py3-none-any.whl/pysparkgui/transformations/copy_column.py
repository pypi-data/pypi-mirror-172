...
from pysparkgui.helper import Transformation, DF_OLD, string_to_code, PysparkguiError
...
class CopyColumn(Transformation):
    ...
    def get_options(self):
        return list(self.df_manager.get_latest_df().columns)
    ...
    def is_valid_transformation(self):
        if self.new_column_name_input.value == "":
            raise PysparkguiError("New column name cannot be blank")
