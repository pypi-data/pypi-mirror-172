...
from pysparkgui.helper import Transformation, DF_OLD, string_to_code

from pysparkgui.transformations.base_components import (
    ValueSelector,
    SingleColumnSelector,
)
from pysparkgui.transformations.filter_transformer import ConditionSection
...
class SetValuesTransformation(Transformation):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add_else_checkbox.add_class("pysparkgui-checkbox")
