...
from pysparkgui.widgets import Button, Singleselect, CloseButton, Text

from pysparkgui.helper import DF_OLD, string_to_code, safe_cast, notification, PysparkguiError
...
class SelectorGroupMixin:
    ...
    def init_selector_group(self, add_button_text="add", add_first_selector=True):
        ...
        self.selector_group.add_class("pysparkgui-overflow-visible")
