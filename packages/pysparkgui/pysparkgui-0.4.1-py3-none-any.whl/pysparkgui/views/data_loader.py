...
from pysparkgui._path import DBFS_BASE_PATH
from pysparkgui.helper import notification, VSpace, safe_cast
...
class CSVLoader(widgets.HBox):
    ...
    def __init__(self, csv_options_embeddable, on_open_file):
        ...
        ).add_class("pysparkgui-file-chooser")
...
class ExcelOptions(widgets.VBox):
    ...
    def __init__(self, path, on_open_file, **kwargs):
        ...
        self.user_notification = notification(
            ...
            If you need more flexibility, please reach out to us via <a href="mailto:pysparkgui-feedback+read_excel@databricks.com?subject=pysparkgui - Read Excel feature">email</a>.
            """
            ),
            type="warning",
        )
...
class ExcelLoader(widgets.HBox):
    ...
    def __init__(self, excel_options_embeddable, on_open_file):
        ...
        ).add_class("pysparkgui-loader-options-section")
