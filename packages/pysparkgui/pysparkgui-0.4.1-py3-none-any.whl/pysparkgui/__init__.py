...
from pysparkgui.datasets.get_datasets import (
    titanic_csv,
    sales_csv,
    get_titanic_df,
...
from pysparkgui.setup import test_setup
from pysparkgui.setup.import_ import enable, disable, _enable_rich_pandas_df
from pysparkgui.helper import activate_license, set_license
from pysparkgui.config import set_option, get_option, reset_options

# Attention: when adding a function here, make sure it is decorated
from pysparkgui.edaviz.__modules__ import (
    plot,
    glimpse,
    columns,
    bivariate_plot,
...
def fix_trailets_bug():
    ...
    def extended_inspect_isfunction(object):
        from pysparkgui._types import CyFunctionType
...
# from pysparkgui.setup.ipython_display import extend_pandas_ipython_display
# extend_pandas_ipython_display()
# del extend_pandas_ipython_display

from pysparkgui.setup.ipython_display import extend_spark_ipython_display
extend_spark_ipython_display()
del extend_spark_ipython_display
...
import pysparkgui.loaders as _loader_plugins


# ATTENTION: this needs to be the last logic within init
from pysparkgui.setup.module_view import setup_module_view

# __name__ enables whitelabeling of the library name. Usually its value is "pysparkgui"
...
try:
    ...
    # this fixes a conversion issue for toPandas()
    # we might only want to use this before and after toPandas() calls
    # in Databricks, this is per default set to True
