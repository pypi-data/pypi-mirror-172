...
def Failure_Dag(**context):
    ...
    control_dim["last_execution"].loc[control_dim["dag"]==dag] = exec_date
    ...
    dicc = {"dag":dag,"date_execution":exec_date,"duration":duration,"status":state,"date_log":end_date,"url_log":f'"{log_url}"'}
