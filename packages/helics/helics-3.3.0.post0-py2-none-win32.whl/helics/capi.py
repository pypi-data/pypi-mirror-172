...
def helicsCreateCallbackFederate(fed_name     , fi                     = None)                          :
    """
...
def helicsCreateCallbackFederateFromConfig(config_file     )                          :
    """
...
def helicsFederateProtect(fed_name     ):
    """
...
def helicsFederateUnProtect(fed_name     ):
    """
...
def helicsFederateIsProtected(fed_name     )        :
    """
...
def helicsFederateProcessCommunications(fed                , period            ):
    """
...
def helicsFederateSetStateChangeCallback(fed                , state_changer, user_data):
    """
...
def helicsEndpointSendBytesAt(endpoint                , data       , time            ):
    """
...
def helicsEndpointSendMessageZeroCopy(endpoint                , message               ):
    """
...
def helicsMessageClear(message               ):
    """
...
def helicsCoreRegisterTranslator(core            , type                       , name     )                    :
    """
...
def helicsInputGetPublicationDataType(ipt             )       :
    """
...
def helicsFederateSetTimeUpdateCallback(fed                , time_update, user_data):
    """
    Set the callback for the time request
...
def helicsFederateInitializingEntryCallback(fed                , initializing_entry, user_data):
    """
...
def helicsFederateExecutingEntryCallback(fed                , executing_entry, user_data):
    """
...
def helicsFederateCosimulationTerminationCallback(fed                , cosim_termination, user_data):
    """
...
def helicsFederateErrorHandlerCallback(fed                , error_handler, user_data):
    """
...
def helicsCallbackFederateNextTimeCallback(fed                , time_update, user_data):
    """
...
def helicsCallbackFederateNextTimeIterativeCallback(fed                , time_update, user_data):
    """
...
def helicsCallbackFederateInitializeCallback(fed                , initialize, user_data):
    """
...
def helicsFilterSetCustomCallback(filter              , callback, user_data):
...
def helicsDataBufferIsValid(data                  )        :
    f = loadSym("helicsDataBufferIsValid")
    return f(data) == 1


def helicsDataBufferConvertToType(data                  , new_data_type     ):
    f = loadSym("helicsDataBufferConvertToType")
    return f(data, new_data_type) == 1


def helicsDataBufferClone(data                  )                    :
...
def helicsDataBufferStringSize(data                  )       :
    f = loadSym("helicsDataBufferStringSize")
    return f(data)


def helicsDataBufferToTime(data                  )              :
    f = loadSym("helicsDataBufferToTime")
    return f(data)


def helicsDataBufferVectorSize(data                  )       :
    f = loadSym("helicsDataBufferVectorSize")
    return f(data)


def helicsDataBufferToVector(data                  )               :
...
def helicsIntegerToBytes(value     , data                  ):
    """
...
def helicsRawStringToBytes(string       , data                  ):
    """
...
def helicsBooleanToBytes(value      , data                  ):
    """
...
def helicsComplexObjectToBytes(value         , data                  ):
    """
    Convert a complex to serialized bytes
    """
...
def helicsComplexVectorToBytes(value               , data                  ):
    """
    Convert a complex to serialized bytes
    """
...
def helicsNamedPointToBytes(string     , value       , data                  ):
    """
...
def helicsDataBufferToInteger(data                  )       :
    f = loadSym("helicsDataBufferToInteger")
    return f(data)


def helicsDataBufferToChar(data                  )       :
    f = loadSym("helicsDataBufferToChar")
    return f(data)


def helicsDataBufferToString(data                  )       :
...
def helicsDataBufferToRawString(data                  )       :
...
def helicsDataBufferToBoolean(data                  )        :
    f = loadSym("helicsDataBufferToBoolean")
    return f(data)


def helicsDataBufferToComplex(data                  )           :
...
def helicsDataBufferToComplexObject(data                  )           :
    raise NotImplementedError("`helicsDataBufferToComplexObject` is not implemented.")


def helicsDataBufferToComplexVector(data                  )                 :
...
def helicsDataBufferToNamedPoint(data                  )                     :
