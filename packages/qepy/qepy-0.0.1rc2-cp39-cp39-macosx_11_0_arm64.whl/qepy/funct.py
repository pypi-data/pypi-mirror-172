...
Defined at funct.fpp lines 13-1349
...
def enforce_input_dft(dft_, nomsg=None):
    ...
    Defined at funct.fpp lines 838-861
...
def enforce_dft_exxrpa():
    ...
    Defined at funct.fpp lines 866-884
...
def init_dft_exxrpa():
    ...
    Defined at funct.fpp lines 889-903
...
def start_exx():
    ...
    Defined at funct.fpp lines 908-911
...
def stop_exx():
    ...
    Defined at funct.fpp lines 914-917
...
def dft_force_hybrid(request=None):
    ...
    Defined at funct.fpp lines 920-929
...
def exx_is_active():
    ...
    Defined at funct.fpp lines 932-934
...
def set_exx_fraction(exxf_):
    ...
    Defined at funct.fpp lines 937-941
...
def set_screening_parameter(scrparm_):
    ...
    Defined at funct.fpp lines 944-949
...
def get_screening_parameter():
    ...
    Defined at funct.fpp lines 952-955
...
def set_gau_parameter(gauparm_):
    ...
    Defined at funct.fpp lines 958-963
...
def get_gau_parameter():
    ...
    Defined at funct.fpp lines 966-969
...
def get_iexch():
    ...
    Defined at funct.fpp lines 972-975
...
def get_icorr():
    ...
    Defined at funct.fpp lines 978-981
...
def get_igcx():
    ...
    Defined at funct.fpp lines 984-987
...
def get_igcc():
    ...
    Defined at funct.fpp lines 990-993
...
def get_meta():
    ...
    Defined at funct.fpp lines 996-999
...
def get_metac():
    ...
    Defined at funct.fpp lines 1002-1005
...
def get_inlc():
    ...
    Defined at funct.fpp lines 1008-1011
...
def get_nonlocc_name():
    ...
    Defined at funct.fpp lines 1014-1017
...
def dft_is_nonlocc():
    ...
    Defined at funct.fpp lines 1020-1023
...
def get_exx_fraction():
    ...
    Defined at funct.fpp lines 1026-1030
...
def get_dft_name():
    ...
    Defined at funct.fpp lines 1033-1036
...
def dft_is_gradient():
    ...
    Defined at funct.fpp lines 1039-1042
...
def dft_is_meta():
    ...
    Defined at funct.fpp lines 1045-1048
...
def dft_is_hybrid():
    ...
    Defined at funct.fpp lines 1051-1054
...
def igcc_is_lyp():
    ...
    Defined at funct.fpp lines 1057-1060
...
def dft_has_finite_size_correction():
    ...
    Defined at funct.fpp lines 1063-1066
...
def set_finite_size_volume(volume):
    ...
    Defined at funct.fpp lines 1069-1078
...
def get_finite_size_cell_volume():
    ...
    Defined at funct.fpp lines 1082-1087
...
def set_dft_from_indices(iexch_, icorr_, igcx_, igcc_, imeta_, inlc_):
    ...
    Defined at funct.fpp lines 1094-1131
...
def get_dft_short():
    ...
    Defined at funct.fpp lines 1136-1257
...
def get_dft_long():
    ...
    Defined at funct.fpp lines 1262-1277
...
def write_dft_name():
    ...
    Defined at funct.fpp lines 1282-1288
...
def nlc(rho_valence, rho_core, nspin, enl, vnl, v):
    ...
    Defined at funct.fpp lines 1297-1343
