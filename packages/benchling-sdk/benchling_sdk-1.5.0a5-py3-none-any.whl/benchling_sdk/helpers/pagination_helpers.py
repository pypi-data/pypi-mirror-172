...
from benchling_api_client.v2.alpha.extensions import NotPresentError as NotPresentErrorAlpha
from benchling_api_client.v2.beta.extensions import NotPresentError as NotPresentErrorBeta
from benchling_api_client.v2.extensions import NotPresentError
from benchling_api_client.v2.stable.extensions import NotPresentError as NotPresentErrorStable
...
Model = TypeVar("Model")
NextToken = str
_NotPresentErrors = (NotPresentError, NotPresentErrorAlpha, NotPresentErrorBeta, NotPresentErrorStable)
...
def _default_token_extractor(body: ResultsBody) -> NextToken:
    ...
    """
    try:
        # When accessing nextToken it can raise NotPresentError if nextToken is not included in ?returning param
        return body.next_token  # type: ignore
    # PageIterator is used across all API versions so except all stabilities
    except _NotPresentErrors:
        return ""
