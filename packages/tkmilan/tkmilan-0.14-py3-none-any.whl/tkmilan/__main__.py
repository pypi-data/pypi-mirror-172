...
from . import Button, Checkbox, Entry, Label, LabelStateful, Listbox, Combobox, ComboboxMap, EntryMultiline, Tree, ListboxControl, Spinbox, Radio
from . import var, spec, fn
from .model import CP, BindingGlobal, Timeout, TimeoutIdle, FileType, FileTypes, Justification
...
class NB_Center_RadioFrames_Inner(FrameRadio):
    # wstate_single = 'inner'  # TODO: This errors out, but it should be supported
...
class RW(RootWindow):
    ...
    def setup_widgets(self):
        ...
        self.nb_center = NB_Center(self, styleID='TabCenter')
