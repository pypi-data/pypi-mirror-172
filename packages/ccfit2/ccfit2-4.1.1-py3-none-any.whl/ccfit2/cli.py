...
def ac_mode_func(args):
    ...
    if args.verbose:
        ...
        for experiments in all_experiments_sep:
            ...
            for experiment in experiments:
                ...
                print('{} Frequencies: {}\n'.format(len(experiment.ac_freq), experiment.ac_freq))
    ...
    for experiments, dc_field in zip(all_experiments_sep, unique_dc_fields):
        ...
        models = ac.Model.from_experiments(experiments, verbose=True)
    ...
    for models, experiments, dc_field in zip(all_models_sep, all_experiments_sep, unique_dc_fields): # noqa
        ...
        if np.abs(dc_field) < args.zf_cutoff:
            dc_field = 0.
...
def read_args(arg_list=None):
    ...
    ac_parser.add_argument(
        ...
        type=float,
        default=5,
        help='DC Field with smaller absolute valuesthan this will be considered to be zero, default 5 Oe' # noqa
    )
    ac_parser.add_argument(
        '--select_T',
        action='store_true',
