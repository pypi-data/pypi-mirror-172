...
class AddToPrincipalPolicyResult:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AddToPrincipalPolicyResult.__init__)
...
class AddToResourcePolicyResult:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AddToResourcePolicyResult.__init__)
            check_type(argname="argument statement_added", value=statement_added, expected_type=type_hints["statement_added"])
            check_type(argname="argument policy_dependable", value=policy_dependable, expected_type=type_hints["policy_dependable"])
        self._values: typing.Dict[str, typing.Any] = {
            "statement_added": statement_added,
...
class CfnAccessKey(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAccessKey.__init__)
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAccessKey.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAccessKey._render_properties)
    ...
    def user_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAccessKey, "user_name").fset)
    ...
    def serial(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAccessKey, "serial").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def status(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAccessKey, "status").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnAccessKeyProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAccessKeyProps.__init__)
...
class CfnGroup(
    ...
    def __init__(
        ...
        *,
        ...
        policies: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnGroup.PolicyProperty", typing.Dict[str, typing.Any]]]]]] = None,
    ) -> None:
    ...
    def group_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGroup, "group_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def managed_policy_arns(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGroup, "managed_policy_arns").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def path(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGroup, "path").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def policies(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnGroup, "policies").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class PolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnGroup.PolicyProperty.__init__)
...
class CfnInstanceProfile(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInstanceProfile.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInstanceProfile.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInstanceProfile._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def roles(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInstanceProfile, "roles").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def instance_profile_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInstanceProfile, "instance_profile_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def path(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnInstanceProfile, "path").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "path", value)
...
class CfnInstanceProfileProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnInstanceProfileProps.__init__)
...
class CfnManagedPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnManagedPolicy.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnManagedPolicy.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnManagedPolicy._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def policy_document(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnManagedPolicy, "policy_document").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def description(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnManagedPolicy, "description").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def groups(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnManagedPolicy, "groups").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def managed_policy_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnManagedPolicy, "managed_policy_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def path(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnManagedPolicy, "path").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "path", value)
    ...
    def roles(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnManagedPolicy, "roles").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "roles", value)
    ...
    def users(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnManagedPolicy, "users").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnManagedPolicyProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnManagedPolicyProps.__init__)
            check_type(argname="argument policy_document", value=policy_document, expected_type=type_hints["policy_document"])
...
class CfnOIDCProvider(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnOIDCProvider.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnOIDCProvider.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnOIDCProvider._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def thumbprint_list(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnOIDCProvider, "thumbprint_list").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def client_id_list(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnOIDCProvider, "client_id_list").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def url(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnOIDCProvider, "url").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnOIDCProviderProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnOIDCProviderProps.__init__)
...
class CfnPolicy(
    ...
    def groups(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPolicy, "groups").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "groups", value)
    ...
    def roles(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPolicy, "roles").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "roles", value)
    ...
    def users(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPolicy, "users").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "users", value)
...
class CfnRole(
    ...
    def __init__(
        ...
        *,
        ...
        policies: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnRole.PolicyProperty", typing.Dict[str, typing.Any]]]]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRole.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = CfnRoleProps(
            assume_role_policy_document=assume_role_policy_document,
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRole.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRole._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def assume_role_policy_document(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRole, "assume_role_policy_document").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def description(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRole, "description").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "description", value)
    ...
    def managed_policy_arns(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRole, "managed_policy_arns").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "managedPolicyArns", value)
    ...
    def max_session_duration(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRole, "max_session_duration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def path(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRole, "path").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "path", value)
    ...
    def permissions_boundary(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRole, "permissions_boundary").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def policies(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRole, "policies").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "policies", value)
    ...
    def role_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnRole, "role_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class PolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnRole.PolicyProperty.__init__)
                check_type(argname="argument policy_document", value=policy_document, expected_type=type_hints["policy_document"])
                check_type(argname="argument policy_name", value=policy_name, expected_type=type_hints["policy_name"])
            self._values: typing.Dict[str, typing.Any] = {
                "policy_document": policy_document,
...
class CfnRoleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnRoleProps.__init__)
...
class CfnSAMLProvider(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSAMLProvider.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSAMLProvider.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSAMLProvider._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def saml_metadata_document(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnSAMLProvider, "saml_metadata_document").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnSAMLProvider, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnSAMLProviderProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnSAMLProviderProps.__init__)
...
class CfnServerCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnServerCertificate.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnServerCertificate.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnServerCertificate._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def certificate_body(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnServerCertificate, "certificate_body").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def certificate_chain(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnServerCertificate, "certificate_chain").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def path(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnServerCertificate, "path").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "path", value)
    ...
    def private_key(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnServerCertificate, "private_key").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def server_certificate_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnServerCertificate, "server_certificate_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnServerCertificateProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnServerCertificateProps.__init__)
...
class CfnServiceLinkedRole(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnServiceLinkedRole.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnServiceLinkedRole.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnServiceLinkedRole._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def aws_service_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnServiceLinkedRole, "aws_service_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def custom_suffix(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnServiceLinkedRole, "custom_suffix").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def description(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnServiceLinkedRole, "description").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "description", value)
...
class CfnServiceLinkedRoleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnServiceLinkedRoleProps.__init__)
...
class CfnUser(
    ...
    def __init__(
        ...
        *,
        groups: typing.Optional[typing.Sequence[builtins.str]] = None,
        login_profile: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnUser.LoginProfileProperty", typing.Dict[str, typing.Any]]]] = None,
        managed_policy_arns: typing.Optional[typing.Sequence[builtins.str]] = None,
        path: typing.Optional[builtins.str] = None,
        permissions_boundary: typing.Optional[builtins.str] = None,
        policies: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnUser.PolicyProperty", typing.Dict[str, typing.Any]]]]]] = None,
        tags: typing.Optional[typing.Sequence[typing.Union[aws_cdk.core.CfnTag, typing.Dict[str, typing.Any]]]] = None,
    ...
    def groups(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnUser, "groups").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "groups", value)
    ...
    def login_profile(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnUser, "login_profile").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def managed_policy_arns(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnUser, "managed_policy_arns").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "managedPolicyArns", value)
    ...
    def path(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnUser, "path").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "path", value)
    ...
    def permissions_boundary(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnUser, "permissions_boundary").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "permissionsBoundary", value)
    ...
    def policies(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnUser, "policies").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "policies", value)
    ...
    class LoginProfileProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnUser.LoginProfileProperty.__init__)
    ...
    class PolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnUser.PolicyProperty.__init__)
                check_type(argname="argument policy_document", value=policy_document, expected_type=type_hints["policy_document"])
                check_type(argname="argument policy_name", value=policy_name, expected_type=type_hints["policy_name"])
            self._values: typing.Dict[str, typing.Any] = {
                "policy_document": policy_document,
...
class CfnUserToGroupAddition(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnUserToGroupAddition.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnUserToGroupAddition.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnUserToGroupAddition._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def group_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnUserToGroupAddition, "group_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "groupName", value)
    ...
    def users(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnUserToGroupAddition, "users").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "users", value)
...
class CfnUserToGroupAdditionProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnUserToGroupAdditionProps.__init__)
            check_type(argname="argument group_name", value=group_name, expected_type=type_hints["group_name"])
            check_type(argname="argument users", value=users, expected_type=type_hints["users"])
        self._values: typing.Dict[str, typing.Any] = {
            "group_name": group_name,
...
class CfnVirtualMFADevice(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnVirtualMFADevice.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnVirtualMFADevice.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnVirtualMFADevice._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def users(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnVirtualMFADevice, "users").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "users", value)
    ...
    def path(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnVirtualMFADevice, "path").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "path", value)
    ...
    def virtual_mfa_device_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnVirtualMFADevice, "virtual_mfa_device_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnVirtualMFADeviceProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnVirtualMFADeviceProps.__init__)
            check_type(argname="argument users", value=users, expected_type=type_hints["users"])
            check_type(argname="argument path", value=path, expected_type=type_hints["path"])
            check_type(argname="argument tags", value=tags, expected_type=type_hints["tags"])
...
class CommonGrantOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CommonGrantOptions.__init__)
...
class ComparablePrincipal(
    ...
    def dedupe_string_for(cls, x: "IPrincipal") -> typing.Optional[builtins.str]:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ComparablePrincipal.dedupe_string_for)
    ...
    def is_comparable_principal(cls, x: "IPrincipal") -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ComparablePrincipal.is_comparable_principal)
            check_type(argname="argument x", value=x, expected_type=type_hints["x"])
...
class CompositeDependable(
    ...
    def __init__(self, *dependables: aws_cdk.core.IDependable) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CompositeDependable.__init__)
...
class FromRoleArnOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FromRoleArnOptions.__init__)
...
class Grant(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.Grant"):
    ...
    def drop(cls, grantee: "IGrantable", _intent: builtins.str) -> "Grant":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Grant.drop)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
    ...
    def apply_before(self, *constructs: aws_cdk.core.IConstruct) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Grant.apply_before)
...
class GrantOnPrincipalAndResourceOptions(CommonGrantOptions):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GrantOnPrincipalAndResourceOptions.__init__)
            check_type(argname="argument actions", value=actions, expected_type=type_hints["actions"])
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
            check_type(argname="argument resource_arns", value=resource_arns, expected_type=type_hints["resource_arns"])
...
class GrantOnPrincipalOptions(CommonGrantOptions):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GrantOnPrincipalOptions.__init__)
            check_type(argname="argument actions", value=actions, expected_type=type_hints["actions"])
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
            check_type(argname="argument resource_arns", value=resource_arns, expected_type=type_hints["resource_arns"])
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class GrantWithResourceOptions(CommonGrantOptions):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GrantWithResourceOptions.__init__)
            check_type(argname="argument actions", value=actions, expected_type=type_hints["actions"])
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
            check_type(argname="argument resource_arns", value=resource_arns, expected_type=type_hints["resource_arns"])
            check_type(argname="argument resource", value=resource, expected_type=type_hints["resource"])
...
class _IPrincipalProxy(
    ...
    def add_to_policy(self, statement: "PolicyStatement") -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IPrincipal.add_to_policy)
    ...
    def add_to_principal_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IPrincipal.add_to_principal_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
...
class _IResourceWithPolicyProxy(
    ...
    def add_to_resource_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IResourceWithPolicy.add_to_resource_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
...
class ManagedPolicy(
    ...
    def from_aws_managed_policy_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManagedPolicy.from_aws_managed_policy_name)
            check_type(argname="argument managed_policy_name", value=managed_policy_name, expected_type=type_hints["managed_policy_name"])
    ...
    def from_managed_policy_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManagedPolicy.from_managed_policy_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_managed_policy_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManagedPolicy.from_managed_policy_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument managed_policy_name", value=managed_policy_name, expected_type=type_hints["managed_policy_name"])
    ...
    def add_statements(self, *statement: "PolicyStatement") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManagedPolicy.add_statements)
    ...
    def attach_to_group(self, group: "IGroup") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManagedPolicy.attach_to_group)
    ...
    def attach_to_role(self, role: "IRole") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManagedPolicy.attach_to_role)
    ...
    def attach_to_user(self, user: "IUser") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ManagedPolicy.attach_to_user)
            check_type(argname="argument user", value=user, expected_type=type_hints["user"])
...
class OpenIdConnectProvider(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OpenIdConnectProvider.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_open_id_connect_provider_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OpenIdConnectProvider.from_open_id_connect_provider_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class OpenIdConnectProviderProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OpenIdConnectProviderProps.__init__)
            check_type(argname="argument url", value=url, expected_type=type_hints["url"])
...
class PermissionsBoundary(
    ...
    def of(cls, scope: constructs.IConstruct) -> "PermissionsBoundary":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PermissionsBoundary.of)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def apply(self, boundary_policy: IManagedPolicy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PermissionsBoundary.apply)
...
class Policy(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Policy.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = PolicyProps(
            document=document,
    ...
    def from_policy_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Policy.from_policy_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument policy_name", value=policy_name, expected_type=type_hints["policy_name"])
    ...
    def add_statements(self, *statement: "PolicyStatement") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Policy.add_statements)
            check_type(argname="argument statement", value=statement, expected_type=typing.Tuple[type_hints["statement"], ...]) # pyright: ignore [reportGeneralTypeIssues]
        return typing.cast(None, jsii.invoke(self, "addStatements", [*statement]))
    ...
    def attach_to_group(self, group: "IGroup") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Policy.attach_to_group)
            check_type(argname="argument group", value=group, expected_type=type_hints["group"])
        return typing.cast(None, jsii.invoke(self, "attachToGroup", [group]))
    ...
    def attach_to_role(self, role: "IRole") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Policy.attach_to_role)
            check_type(argname="argument role", value=role, expected_type=type_hints["role"])
        return typing.cast(None, jsii.invoke(self, "attachToRole", [role]))
    ...
    def attach_to_user(self, user: "IUser") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Policy.attach_to_user)
            check_type(argname="argument user", value=user, expected_type=type_hints["user"])
        return typing.cast(None, jsii.invoke(self, "attachToUser", [user]))
...
class PolicyDocument(
    ...
    def from_json(cls, obj: typing.Any) -> "PolicyDocument":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyDocument.from_json)
    ...
    def add_statements(self, *statement: "PolicyStatement") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyDocument.add_statements)
            check_type(argname="argument statement", value=statement, expected_type=typing.Tuple[type_hints["statement"], ...]) # pyright: ignore [reportGeneralTypeIssues]
        return typing.cast(None, jsii.invoke(self, "addStatements", [*statement]))
    ...
    def resolve(self, context: aws_cdk.core.IResolveContext) -> typing.Any:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyDocument.resolve)
...
class PolicyDocumentProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyDocumentProps.__init__)
...
class PolicyProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyProps.__init__)
            check_type(argname="argument document", value=document, expected_type=type_hints["document"])
...
class PolicyStatement(
    ...
    def from_json(cls, obj: typing.Any) -> "PolicyStatement":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.from_json)
            check_type(argname="argument obj", value=obj, expected_type=type_hints["obj"])
    ...
    def add_account_condition(self, account_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_account_condition)
    ...
    def add_actions(self, *actions: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_actions)
    ...
    def add_arn_principal(self, arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_arn_principal)
    ...
    def add_aws_account_principal(self, account_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_aws_account_principal)
            check_type(argname="argument account_id", value=account_id, expected_type=type_hints["account_id"])
    ...
    def add_canonical_user_principal(self, canonical_user_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_canonical_user_principal)
    ...
    def add_condition(self, key: builtins.str, value: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_condition)
    ...
    def add_conditions(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_conditions)
    ...
    def add_federated_principal(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_federated_principal)
    ...
    def add_not_actions(self, *not_actions: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_not_actions)
    ...
    def add_not_principals(self, *not_principals: IPrincipal) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_not_principals)
    ...
    def add_not_resources(self, *arns: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_not_resources)
    ...
    def add_principals(self, *principals: IPrincipal) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_principals)
    ...
    def add_resources(self, *arns: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_resources)
            check_type(argname="argument arns", value=arns, expected_type=typing.Tuple[type_hints["arns"], ...]) # pyright: ignore [reportGeneralTypeIssues]
    ...
    def add_service_principal(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatement.add_service_principal)
    ...
    def effect(self, value: Effect) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PolicyStatement, "effect").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def sid(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(PolicyStatement, "sid").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class PolicyStatementProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PolicyStatementProps.__init__)
            check_type(argname="argument actions", value=actions, expected_type=type_hints["actions"])
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
...
class PrincipalPolicyFragment(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalPolicyFragment.__init__)
...
class SamlMetadataDocument(
    ...
    def from_file(cls, path: builtins.str) -> "SamlMetadataDocument":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SamlMetadataDocument.from_file)
            check_type(argname="argument path", value=path, expected_type=type_hints["path"])
    ...
    def from_xml(cls, xml: builtins.str) -> "SamlMetadataDocument":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SamlMetadataDocument.from_xml)
...
class SamlProvider(
    ...
    def from_saml_provider_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SamlProvider.from_saml_provider_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class ServicePrincipalOpts:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServicePrincipalOpts.__init__)
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
...
class UnknownPrincipal(
    ...
    def add_to_policy(self, statement: PolicyStatement) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UnknownPrincipal.add_to_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(builtins.bool, jsii.invoke(self, "addToPolicy", [statement]))
    ...
    def add_to_principal_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UnknownPrincipal.add_to_principal_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(AddToPrincipalPolicyResult, jsii.invoke(self, "addToPrincipalPolicy", [statement]))
...
class UnknownPrincipalProps:
    def __init__(self, *, resource: constructs.IConstruct) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UnknownPrincipalProps.__init__)
            check_type(argname="argument resource", value=resource, expected_type=type_hints["resource"])
        self._values: typing.Dict[str, typing.Any] = {
            "resource": resource,
        }
...
class WithoutPolicyUpdatesOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WithoutPolicyUpdatesOptions.__init__)
            check_type(argname="argument add_grants_to_resources", value=add_grants_to_resources, expected_type=type_hints["add_grants_to_resources"])
        self._values: typing.Dict[str, typing.Any] = {}
        if add_grants_to_resources is not None:
            self._values["add_grants_to_resources"] = add_grants_to_resources
...
class _IAssumeRolePrincipalProxy(
    ...
    def add_to_assume_role_policy(self, document: PolicyDocument) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IAssumeRolePrincipal.add_to_assume_role_policy)
            check_type(argname="argument document", value=document, expected_type=type_hints["document"])
...
class _IIdentityProxy(
    ...
    def add_managed_policy(self, policy: IManagedPolicy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IIdentity.add_managed_policy)
    ...
    def attach_inline_policy(self, policy: Policy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IIdentity.attach_inline_policy)
            check_type(argname="argument policy", value=policy, expected_type=type_hints["policy"])
...
class _IRoleProxy(
    ...
    def grant(self, grantee: IPrincipal, *actions: builtins.str) -> Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRole.grant)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
            check_type(argname="argument actions", value=actions, expected_type=typing.Tuple[type_hints["actions"], ...]) # pyright: ignore [reportGeneralTypeIssues]
    ...
    def grant_assume_role(self, grantee: IPrincipal) -> Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRole.grant_assume_role)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
    ...
    def grant_pass_role(self, grantee: IPrincipal) -> Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRole.grant_pass_role)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
...
class _IUserProxy(
    ...
    def add_to_group(self, group: "IGroup") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IUser.add_to_group)
            check_type(argname="argument group", value=group, expected_type=type_hints["group"])
...
class LazyRole(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LazyRole.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = LazyRoleProps(
            assumed_by=assumed_by,
    ...
    def add_managed_policy(self, policy: IManagedPolicy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LazyRole.add_managed_policy)
            check_type(argname="argument policy", value=policy, expected_type=type_hints["policy"])
        return typing.cast(None, jsii.invoke(self, "addManagedPolicy", [policy]))
    ...
    def add_to_policy(self, statement: PolicyStatement) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LazyRole.add_to_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(builtins.bool, jsii.invoke(self, "addToPolicy", [statement]))
    ...
    def add_to_principal_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LazyRole.add_to_principal_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(AddToPrincipalPolicyResult, jsii.invoke(self, "addToPrincipalPolicy", [statement]))
    ...
    def attach_inline_policy(self, policy: Policy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LazyRole.attach_inline_policy)
            check_type(argname="argument policy", value=policy, expected_type=type_hints["policy"])
        return typing.cast(None, jsii.invoke(self, "attachInlinePolicy", [policy]))
    ...
    def grant(self, identity: IPrincipal, *actions: builtins.str) -> Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LazyRole.grant)
    ...
    def grant_assume_role(self, identity: IPrincipal) -> Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LazyRole.grant_assume_role)
            check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
    ...
    def grant_pass_role(self, identity: IPrincipal) -> Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LazyRole.grant_pass_role)
            check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
...
class LazyRoleProps(RoleProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LazyRoleProps.__init__)
            check_type(argname="argument assumed_by", value=assumed_by, expected_type=type_hints["assumed_by"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
            check_type(argname="argument external_id", value=external_id, expected_type=type_hints["external_id"])
            check_type(argname="argument external_ids", value=external_ids, expected_type=type_hints["external_ids"])
...
class PrincipalBase(
    ...
    def add_to_assume_role_policy(self, document: PolicyDocument) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalBase.add_to_assume_role_policy)
            check_type(argname="argument document", value=document, expected_type=type_hints["document"])
        return typing.cast(None, jsii.invoke(self, "addToAssumeRolePolicy", [document]))
    ...
    def add_to_policy(self, statement: PolicyStatement) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalBase.add_to_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(builtins.bool, jsii.invoke(self, "addToPolicy", [statement]))
    ...
    def add_to_principal_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalBase.add_to_principal_policy)
    ...
    def with_conditions(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalBase.with_conditions)
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
...
class PrincipalWithConditions(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalWithConditions.__init__)
    ...
    def add_condition(self, key: builtins.str, value: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalWithConditions.add_condition)
            check_type(argname="argument key", value=key, expected_type=type_hints["key"])
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        return typing.cast(None, jsii.invoke(self, "addCondition", [key, value]))
    ...
    def add_conditions(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalWithConditions.add_conditions)
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
        return typing.cast(None, jsii.invoke(self, "addConditions", [conditions]))
    ...
    def add_to_policy(self, statement: PolicyStatement) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalWithConditions.add_to_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(builtins.bool, jsii.invoke(self, "addToPolicy", [statement]))
    ...
    def add_to_principal_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalWithConditions.add_to_principal_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(AddToPrincipalPolicyResult, jsii.invoke(self, "addToPrincipalPolicy", [statement]))
    ...
    def _append_dedupe(self, append: builtins.str) -> typing.Optional[builtins.str]:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrincipalWithConditions._append_dedupe)
...
class Role(
    ...
    def from_role_arn(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Role.from_role_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_managed_policy(self, policy: IManagedPolicy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Role.add_managed_policy)
            check_type(argname="argument policy", value=policy, expected_type=type_hints["policy"])
        return typing.cast(None, jsii.invoke(self, "addManagedPolicy", [policy]))
    ...
    def add_to_policy(self, statement: PolicyStatement) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Role.add_to_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(builtins.bool, jsii.invoke(self, "addToPolicy", [statement]))
    ...
    def add_to_principal_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Role.add_to_principal_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(AddToPrincipalPolicyResult, jsii.invoke(self, "addToPrincipalPolicy", [statement]))
    ...
    def attach_inline_policy(self, policy: Policy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Role.attach_inline_policy)
            check_type(argname="argument policy", value=policy, expected_type=type_hints["policy"])
        return typing.cast(None, jsii.invoke(self, "attachInlinePolicy", [policy]))
    ...
    def grant(self, grantee: IPrincipal, *actions: builtins.str) -> Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Role.grant)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
            check_type(argname="argument actions", value=actions, expected_type=typing.Tuple[type_hints["actions"], ...]) # pyright: ignore [reportGeneralTypeIssues]
        return typing.cast(Grant, jsii.invoke(self, "grant", [grantee, *actions]))
    ...
    def grant_assume_role(self, identity: IPrincipal) -> Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Role.grant_assume_role)
            check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
        return typing.cast(Grant, jsii.invoke(self, "grantAssumeRole", [identity]))
    ...
    def grant_pass_role(self, identity: IPrincipal) -> Grant:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Role.grant_pass_role)
            check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
        return typing.cast(Grant, jsii.invoke(self, "grantPassRole", [identity]))
...
class ServicePrincipal(
    ...
    def service_principal_name(cls, service: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ServicePrincipal.service_principal_name)
            check_type(argname="argument service", value=service, expected_type=type_hints["service"])
...
class SessionTagsPrincipal(
    ...
    def __init__(self, principal: IPrincipal) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SessionTagsPrincipal.__init__)
            check_type(argname="argument principal", value=principal, expected_type=type_hints["principal"])
    ...
    def add_to_assume_role_policy(self, doc: PolicyDocument) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SessionTagsPrincipal.add_to_assume_role_policy)
    ...
    def add_to_policy(self, statement: PolicyStatement) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SessionTagsPrincipal.add_to_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(builtins.bool, jsii.invoke(self, "addToPolicy", [statement]))
    ...
    def add_to_principal_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SessionTagsPrincipal.add_to_principal_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(AddToPrincipalPolicyResult, jsii.invoke(self, "addToPrincipalPolicy", [statement]))
    ...
    def _append_dedupe(self, append: builtins.str) -> typing.Optional[builtins.str]:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SessionTagsPrincipal._append_dedupe)
            check_type(argname="argument append", value=append, expected_type=type_hints["append"])
        return typing.cast(typing.Optional[builtins.str], jsii.invoke(self, "appendDedupe", [append]))
...
class User(
    ...
    def from_user_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(User.from_user_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument user_arn", value=user_arn, expected_type=type_hints["user_arn"])
    ...
    def from_user_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(User.from_user_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument user_name", value=user_name, expected_type=type_hints["user_name"])
    ...
    def add_managed_policy(self, policy: IManagedPolicy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(User.add_managed_policy)
            check_type(argname="argument policy", value=policy, expected_type=type_hints["policy"])
        return typing.cast(None, jsii.invoke(self, "addManagedPolicy", [policy]))
    ...
    def add_to_group(self, group: "IGroup") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(User.add_to_group)
            check_type(argname="argument group", value=group, expected_type=type_hints["group"])
        return typing.cast(None, jsii.invoke(self, "addToGroup", [group]))
    ...
    def add_to_policy(self, statement: PolicyStatement) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(User.add_to_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(builtins.bool, jsii.invoke(self, "addToPolicy", [statement]))
    ...
    def add_to_principal_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(User.add_to_principal_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(AddToPrincipalPolicyResult, jsii.invoke(self, "addToPrincipalPolicy", [statement]))
    ...
    def attach_inline_policy(self, policy: Policy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(User.attach_inline_policy)
            check_type(argname="argument policy", value=policy, expected_type=type_hints["policy"])
        return typing.cast(None, jsii.invoke(self, "attachInlinePolicy", [policy]))
...
class ArnPrincipal(
    ...
    def __init__(self, arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ArnPrincipal.__init__)
            check_type(argname="argument arn", value=arn, expected_type=type_hints["arn"])
    ...
    def in_organization(self, organization_id: builtins.str) -> PrincipalBase:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ArnPrincipal.in_organization)
...
class CanonicalUserPrincipal(
    ...
    def __init__(self, canonical_user_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CanonicalUserPrincipal.__init__)
            check_type(argname="argument canonical_user_id", value=canonical_user_id, expected_type=type_hints["canonical_user_id"])
...
class CompositePrincipal(
    ...
    def __init__(self, *principals: IPrincipal) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CompositePrincipal.__init__)
            check_type(argname="argument principals", value=principals, expected_type=typing.Tuple[type_hints["principals"], ...]) # pyright: ignore [reportGeneralTypeIssues]
    ...
    def add_principals(self, *principals: IPrincipal) -> "CompositePrincipal":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CompositePrincipal.add_principals)
            check_type(argname="argument principals", value=principals, expected_type=typing.Tuple[type_hints["principals"], ...]) # pyright: ignore [reportGeneralTypeIssues]
    ...
    def add_to_assume_role_policy(self, doc: PolicyDocument) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CompositePrincipal.add_to_assume_role_policy)
            check_type(argname="argument doc", value=doc, expected_type=type_hints["doc"])
        return typing.cast(None, jsii.invoke(self, "addToAssumeRolePolicy", [doc]))
...
class FederatedPrincipal(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FederatedPrincipal.__init__)
            check_type(argname="argument federated", value=federated, expected_type=type_hints["federated"])
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
...
class OrganizationPrincipal(
    ...
    def __init__(self, organization_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OrganizationPrincipal.__init__)
            check_type(argname="argument organization_id", value=organization_id, expected_type=type_hints["organization_id"])
...
class SamlPrincipal(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SamlPrincipal.__init__)
...
class WebIdentityPrincipal(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WebIdentityPrincipal.__init__)
...
class AccountPrincipal(
    ...
    def __init__(self, account_id: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountPrincipal.__init__)
            check_type(argname="argument account_id", value=account_id, expected_type=type_hints["account_id"])
...
class Group(
    ...
    def from_group_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Group.from_group_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_group_name(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Group.from_group_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument group_name", value=group_name, expected_type=type_hints["group_name"])
    ...
    def add_managed_policy(self, policy: IManagedPolicy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Group.add_managed_policy)
            check_type(argname="argument policy", value=policy, expected_type=type_hints["policy"])
        return typing.cast(None, jsii.invoke(self, "addManagedPolicy", [policy]))
    ...
    def add_to_policy(self, statement: PolicyStatement) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Group.add_to_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(builtins.bool, jsii.invoke(self, "addToPolicy", [statement]))
    ...
    def add_to_principal_policy(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Group.add_to_principal_policy)
            check_type(argname="argument statement", value=statement, expected_type=type_hints["statement"])
        return typing.cast(AddToPrincipalPolicyResult, jsii.invoke(self, "addToPrincipalPolicy", [statement]))
    ...
    def add_user(self, user: IUser) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Group.add_user)
            check_type(argname="argument user", value=user, expected_type=type_hints["user"])
    ...
    def attach_inline_policy(self, policy: Policy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Group.attach_inline_policy)
            check_type(argname="argument policy", value=policy, expected_type=type_hints["policy"])
        return typing.cast(None, jsii.invoke(self, "attachInlinePolicy", [policy]))
...
class OpenIdConnectPrincipal(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(OpenIdConnectPrincipal.__init__)
...
class SamlConsolePrincipal(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SamlConsolePrincipal.__init__)
            check_type(argname="argument saml_provider", value=saml_provider, expected_type=type_hints["saml_provider"])
            check_type(argname="argument conditions", value=conditions, expected_type=type_hints["conditions"])
        jsii.create(self.__class__, self, [saml_provider, conditions])
