...
class CfnLedger(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnLedger.__init__)
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnLedger.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnLedger._render_properties)
    ...
    def permissions_mode(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnLedger, "permissions_mode").fset)
    ...
    def deletion_protection(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnLedger, "deletion_protection").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def kms_key(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnLedger, "kms_key").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnLedger, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnLedgerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnLedgerProps.__init__)
...
class CfnStream(
    ...
    def __init__(
        ...
        *,
        ...
        kinesis_configuration: typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnStream.KinesisConfigurationProperty", typing.Dict[str, typing.Any]]],
    ...
    def inclusive_start_time(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnStream, "inclusive_start_time").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def kinesis_configuration(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnStream, "kinesis_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ledger_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnStream, "ledger_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def role_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnStream, "role_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def stream_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnStream, "stream_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def exclusive_end_time(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnStream, "exclusive_end_time").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class KinesisConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnStream.KinesisConfigurationProperty.__init__)
