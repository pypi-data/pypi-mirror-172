...
class CfnResourceShare(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnResourceShare.__init__)
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnResourceShare.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnResourceShare._render_properties)
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnResourceShare, "name").fset)
    ...
    def allow_external_principals(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnResourceShare, "allow_external_principals").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def permission_arns(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnResourceShare, "permission_arns").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def principals(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnResourceShare, "principals").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def resource_arns(self, value: typing.Optional[typing.List[builtins.str]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnResourceShare, "resource_arns").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnResourceShareProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnResourceShareProps.__init__)
