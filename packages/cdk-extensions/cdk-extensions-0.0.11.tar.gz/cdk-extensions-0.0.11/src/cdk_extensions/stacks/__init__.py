...
from ..s3 import (
    AlbLogsBucket as _AlbLogsBucket_bda1021e,
    CloudfrontLogsBucket as _CloudfrontLogsBucket_bd8f0723,
    CloudtrailBucket as _CloudtrailBucket_921d46d2,
    FlowLogsBucket as _FlowLogsBucket_9136d50e,
    S3AccessLogsBucket as _S3AccessLogsBucket_69ee666c,
    SesLogsBucket as _SesLogsBucket_c0465f81,
    WafLogsBucket as _WafLogsBucket_f0045aa3,
)
...
class AwsLoggingStack(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        alb_logs_bucket: typing.Optional[_AlbLogsBucket_bda1021e] = None,
        cloudfront_logs_bucket: typing.Optional[_CloudfrontLogsBucket_bd8f0723] = None,
        cloudtrail_logs_bucket: typing.Optional[_CloudtrailBucket_921d46d2] = None,
        database_name: typing.Optional[builtins.str] = None,
        flow_logs_bucket: typing.Optional[_FlowLogsBucket_9136d50e] = None,
        flow_logs_format: typing.Optional[_FlowLogFormat_b7c2ba34] = None,
        friendly_query_names: typing.Optional[builtins.bool] = None,
        ses_logs_bucket: typing.Optional[_SesLogsBucket_c0465f81] = None,
        standardize_names: typing.Optional[builtins.bool] = None,
        waf_logs_bucket: typing.Optional[_WafLogsBucket_f0045aa3] = None,
        ...
        :param scope: -
        :param id: -
        :param alb_logs_bucket: 
        :param cloudfront_logs_bucket: 
        :param cloudtrail_logs_bucket: 
        :param database_name: 
        :param flow_logs_bucket: 
        :param flow_logs_format: 
        :param friendly_query_names: 
        :param ses_logs_bucket: 
        :param standardize_names: 
        :param waf_logs_bucket: 
    ...
    def alb_logs_bucket(self) -> _AlbLogsBucket_bda1021e:
        return typing.cast(_AlbLogsBucket_bda1021e, jsii.get(self, "albLogsBucket"))

    @builtins.property
    @jsii.member(jsii_name="cloudfrontLogsBucket")
    def cloudfront_logs_bucket(self) -> _CloudfrontLogsBucket_bd8f0723:
        return typing.cast(_CloudfrontLogsBucket_bd8f0723, jsii.get(self, "cloudfrontLogsBucket"))

    @builtins.property
    @jsii.member(jsii_name="cloudtrailLogsBucket")
    def cloudtrail_logs_bucket(self) -> _CloudtrailBucket_921d46d2:
        return typing.cast(_CloudtrailBucket_921d46d2, jsii.get(self, "cloudtrailLogsBucket"))
    ...
    def flow_logs_bucket(self) -> _FlowLogsBucket_9136d50e:
        return typing.cast(_FlowLogsBucket_9136d50e, jsii.get(self, "flowLogsBucket"))
    ...
    def s3_access_logs_bucket(self) -> _S3AccessLogsBucket_69ee666c:
        return typing.cast(_S3AccessLogsBucket_69ee666c, jsii.get(self, "s3AccessLogsBucket"))

    @builtins.property
    @jsii.member(jsii_name="sesLogsBucket")
    def ses_logs_bucket(self) -> _SesLogsBucket_c0465f81:
        return typing.cast(_SesLogsBucket_c0465f81, jsii.get(self, "sesLogsBucket"))
    ...
    def waf_logs_bucket(self) -> _WafLogsBucket_f0045aa3:
        return typing.cast(_WafLogsBucket_f0045aa3, jsii.get(self, "wafLogsBucket"))
...
class AwsLoggingStackProps(aws_cdk.StackProps):
    ...
    @builtins.property
    def alb_logs_bucket(self) -> typing.Optional[_AlbLogsBucket_bda1021e]:
        result = self._values.get("alb_logs_bucket")
        return typing.cast(typing.Optional[_AlbLogsBucket_bda1021e], result)

    @builtins.property
    def cloudfront_logs_bucket(self) -> typing.Optional[_CloudfrontLogsBucket_bd8f0723]:
        result = self._values.get("cloudfront_logs_bucket")
        return typing.cast(typing.Optional[_CloudfrontLogsBucket_bd8f0723], result)

    @builtins.property
    def cloudtrail_logs_bucket(self) -> typing.Optional[_CloudtrailBucket_921d46d2]:
        result = self._values.get("cloudtrail_logs_bucket")
        return typing.cast(typing.Optional[_CloudtrailBucket_921d46d2], result)
    ...
    @builtins.property
    def flow_logs_bucket(self) -> typing.Optional[_FlowLogsBucket_9136d50e]:
        result = self._values.get("flow_logs_bucket")
        return typing.cast(typing.Optional[_FlowLogsBucket_9136d50e], result)
    ...
    @builtins.property
    def ses_logs_bucket(self) -> typing.Optional[_SesLogsBucket_c0465f81]:
        result = self._values.get("ses_logs_bucket")
        return typing.cast(typing.Optional[_SesLogsBucket_c0465f81], result)
    ...
    @builtins.property
    def waf_logs_bucket(self) -> typing.Optional[_WafLogsBucket_f0045aa3]:
        result = self._values.get("waf_logs_bucket")
        return typing.cast(typing.Optional[_WafLogsBucket_f0045aa3], result)
