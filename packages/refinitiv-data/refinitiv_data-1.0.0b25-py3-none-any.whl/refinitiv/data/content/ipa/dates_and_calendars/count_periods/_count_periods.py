...
class Definition(
    ContentUsageLoggerMixin[BaseResponse[CountedPeriod]],
    DataProviderLayer[BaseResponse[CountedPeriod]],
):
    """
    ...
    ----------
        ...
        date_count_basis: DayCountBasis or str, optional
...
class Definitions(
    ContentUsageLoggerMixin[BaseResponse[CountedPeriods]],
    DataProviderLayer[BaseResponse[CountedPeriods]],
):
    """
