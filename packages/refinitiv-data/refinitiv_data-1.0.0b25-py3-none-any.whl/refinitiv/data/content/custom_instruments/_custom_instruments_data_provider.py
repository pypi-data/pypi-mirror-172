...
custom_insts_type_arg_parser = EnumArgsParser(
...
custom_insts_events_query_params = [
    ValueParamItem(
        "start", function=custom_insts_datetime_adapter.get_str, is_true=is_date_true
    ),
    ValueParamItem(
        "end", function=custom_insts_datetime_adapter.get_str, is_true=is_date_true
    ),
...
custom_insts_body_params = [
    ...
    ValueParamItem("type_", "type", custom_insts_type_arg_parser.parse),
    ParamItem("symbol", function=provide_session(convert_to_symbol)),
    ParamItem("currency"),
