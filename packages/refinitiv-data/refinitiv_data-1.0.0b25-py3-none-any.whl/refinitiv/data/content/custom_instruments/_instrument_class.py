...
class Instrument(abc.ABC):
    ...
    def save(self):
        ...
        Examples:
        --------
        >>> from refinitiv.data.content.custom_instruments.manage import create_formula, Holiday
        ...
        response = provider.get_data(self._session, method=RequestMethod.PUT)
...
def create_instr_factory(data, session):
    ...
    enum_type = custom_insts_type_arg_parser.get_enum(_type)
