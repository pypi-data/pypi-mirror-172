...
class Definition(
    ContentUsageLoggerMixin[BaseResponse[AddedPeriod]],
    DataProviderLayer[BaseResponse[AddedPeriod]],
):
    """
...
class Definitions(
    ContentUsageLoggerMixin[BaseResponse[AddedPeriods]],
    DataProviderLayer[BaseResponse[AddedPeriods]],
):
    """
