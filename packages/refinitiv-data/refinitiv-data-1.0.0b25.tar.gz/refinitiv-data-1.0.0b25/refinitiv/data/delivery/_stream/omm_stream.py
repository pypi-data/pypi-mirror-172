...
from ...content._content_type import ContentType  # noqa
...
class OMMStream(StreamOpenWithUpdatesMixin):
    ...
    def contribute(
        self, fields_values: dict, post_user_info: Optional[dict] = None
    ) -> "ContribResponse":
        """
        ...
        """
        return self._stream.contribute(fields_values, post_user_info=post_user_info)
    ...
    async def contribute_async(
        ...
        return await self._stream.contribute_async(
            fields_values, post_user_info=post_user_info
        )
