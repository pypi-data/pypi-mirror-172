...
from typing import (TypeVar, Literal, Any, Generic, Optional)
...
def _expr10(gen0: TypeInfo) -> TypeInfo:
...
Comparer_1_reflection = _expr10

def Comparer_1__ctor(__unit: Literal[None]=None) -> Comparer_1[Any]:
    return Comparer_1(__unit)


def Comparer_1_get_Default(__unit: Literal[None]=None) -> IComparer_1[Any]:
    class ObjectExpr11(IComparer_1[_T_]):
...
EqualityComparer_1_reflection = _expr12

def EqualityComparer_1__ctor(__unit: Literal[None]=None) -> EqualityComparer_1[Any]:
    return EqualityComparer_1(__unit)


def EqualityComparer_1_get_Default(__unit: Literal[None]=None) -> IEqualityComparer_1[Any]:
    class ObjectExpr13(IEqualityComparer_1[Any]):
...
class Stack_1(Generic[_T]):
    ...
    def GetEnumerator(self, __unit: Literal[None]=None) -> IEnumerator[_T]:
        _: Stack_1[_T] = self
        def _arrow17(__unit: Literal[None]=None) -> IEnumerable_1[_T]:
            index: int = (_.count - 1) or 0
            def _arrow14(__unit: Literal[None]=None) -> bool:
                return index >= 0

            def _arrow16(__unit: Literal[None]=None) -> IEnumerable_1[_T]:
                def _arrow15(__unit: Literal[None]=None) -> IEnumerable_1[_T]:
                    nonlocal index
                    index = (index - 1) or 0
                    return empty()

                return append(singleton(_.contents[index]), delay(_arrow15))

            return enumerate_while(_arrow14, delay(_arrow16))

        return get_enumerator(delay(_arrow17))
...
def Stack_1__ctor(__unit: Literal[None]=None) -> Stack_1[Any]:
...
def Stack_1__Ensure_Z524259A4(_: Stack_1[Any], new_size: int) -> None:
    ...
    if new_size > old_size:
        ...
        def _arrow20(x: int, y: int, _: Stack_1[_T]=_, new_size: int=new_size) -> int:
            return compare_primitives(x, y)

        def _arrow21(x: int, y: int, _: Stack_1[_T]=_, new_size: int=new_size) -> int:
            return compare_primitives(x, y)

        _.contents = fill([0] * max(_arrow20, new_size, old_size * 2), 0, max(_arrow21, new_size, old_size * 2), None)
...
def Stack_1__ToArray(_: Stack_1[_T]) -> Array[_T]:
    def _arrow22(i: int, _: Stack_1[_T]=_) -> _T:
        return _.contents[(_.count - 1) - i]

    return initialize(_.count, _arrow22, None)


def _expr23(gen0: TypeInfo) -> TypeInfo:
...
def Queue_1__ctor(__unit: Literal[None]=None) -> Queue_1[Any]:
...
def Queue_1__toSeq(this: Queue_1[_T]) -> IEnumerable_1[_T]:
    def _arrow27(__unit: Literal[None]=None, this: Queue_1[_T]=this) -> IEnumerable_1[_T]:
        i: int = 0
        def _arrow24(__unit: Literal[None]=None) -> bool:
            return i < this.count

        def _arrow26(__unit: Literal[None]=None) -> IEnumerable_1[_T]:
            def _arrow25(__unit: Literal[None]=None) -> IEnumerable_1[_T]:
                nonlocal i
                i = (i + 1) or 0
                return empty()

            return append(singleton(this.contents[Queue_1__toIndex_Z524259A4(this, i)]), delay(_arrow25))

        return enumerate_while(_arrow24, delay(_arrow26))

    return delay(_arrow27)
