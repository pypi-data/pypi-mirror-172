...
def _expr40(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
FSharpResult_2_reflection = _expr40
...
def _expr41(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
FSharpChoice_2_reflection = _expr41

def _expr42(gen0: TypeInfo, gen1: TypeInfo, gen2: TypeInfo) -> TypeInfo:
...
FSharpChoice_3_reflection = _expr42

def _expr43(gen0: TypeInfo, gen1: TypeInfo, gen2: TypeInfo, gen3: TypeInfo) -> TypeInfo:
...
FSharpChoice_4_reflection = _expr43

def _expr44(gen0: TypeInfo, gen1: TypeInfo, gen2: TypeInfo, gen3: TypeInfo, gen4: TypeInfo) -> TypeInfo:
...
FSharpChoice_5_reflection = _expr44

def _expr45(gen0: TypeInfo, gen1: TypeInfo, gen2: TypeInfo, gen3: TypeInfo, gen4: TypeInfo, gen5: TypeInfo) -> TypeInfo:
...
FSharpChoice_6_reflection = _expr45

def _expr46(gen0: TypeInfo, gen1: TypeInfo, gen2: TypeInfo, gen3: TypeInfo, gen4: TypeInfo, gen5: TypeInfo, gen6: TypeInfo) -> TypeInfo:
...
FSharpChoice_7_reflection = _expr46
