...
from typing import (TypeVar, Any, Generic, Optional, Literal, Tuple, Callable)
...
MapTreeLeaf_2_reflection = _expr253
...
MapTreeNode_2_reflection = _expr254
...
def MapTreeModule_empty(__unit: Literal[None]=None) -> Optional[MapTreeLeaf_2[_KEY, _VALUE]]:
    return None
...
def MapTreeModule_rebalance(t1: Optional[MapTreeLeaf_2[_KEY, _VALUE]], k: _KEY, v: _VALUE, t2: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Optional[MapTreeLeaf_2[_KEY, _VALUE]]:
    ...
    if t2h > (t1h + 2):
        ...
        if isinstance(match_value, MapTreeNode_2):
            def _arrow255(__unit: Literal[None]=None, t1: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=t1, k: _KEY=k, v: _VALUE=v, t2: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=t2) -> int:
        ...
        if isinstance(match_value_2, MapTreeNode_2):
            def _arrow256(__unit: Literal[None]=None, t1: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=t1, k: _KEY=k, v: _VALUE=v, t2: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=t2) -> int:
...
def MapTreeModule_foldSectionOpt(comparer: IComparer_1[_KEY], lo: _KEY, hi: _KEY, f: Any, m: Optional[MapTreeLeaf_2[_KEY, _VALUE]], x: _A) -> _A:
    def fold_from_to(f_1_mut: Any, m_1_mut: Optional[MapTreeLeaf_2[_KEY, _VALUE]], x_1_mut: _A, comparer: IComparer_1[_KEY]=comparer, lo: _KEY=lo, hi: _KEY=hi, f: Any=f, m: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=m, x: _A=x) -> _A:
        while True:
...
def MapTreeModule_copyToArray(m: Optional[MapTreeLeaf_2[__A, __B]], arr: Array[Any], i: int) -> None:
    j: int = i or 0
    def _arrow257(x: __A, y: __B, m: Optional[MapTreeLeaf_2[__A, __B]]=m, arr: Array[Any]=arr, i: int=i) -> None:
        nonlocal j
        arr[j] = (x, y)
        j = (j + 1) or 0

    MapTreeModule_iter(_arrow257, m)
...
def MapTreeModule_ofList(comparer: IComparer_1[__A], l: FSharpList[Tuple[__A, __B]]) -> Optional[MapTreeLeaf_2[__A, __B]]:
    def _arrow258(acc: Optional[MapTreeLeaf_2[__A, __B]], tupled_arg: Tuple[__A, __B], comparer: IComparer_1[__A]=comparer, l: FSharpList[Tuple[__A, __B]]=l) -> Optional[MapTreeLeaf_2[__A, __B]]:
        return MapTreeModule_add(comparer, tupled_arg[0], tupled_arg[1], acc)

    return fold_1(_arrow258, MapTreeModule_empty(), l)
...
MapTreeModule_MapIterator_2_reflection = _expr259
...
def MapTreeModule_notStarted(__unit: Literal[None]=None) -> Any:
    raise Exception("enumeration not started")


def MapTreeModule_alreadyFinished(__unit: Literal[None]=None) -> Any:
...
def MapTreeModule_mkIEnumerator(m: Optional[MapTreeLeaf_2[_A, _B]]=None) -> IEnumerator[Any]:
    ...
    class ObjectExpr260(IEnumerator[Any]):
        def System_Collections_Generic_IEnumerator_1_get_Current(self, __unit: Literal[None]=None, m: Optional[MapTreeLeaf_2[_A, _B]]=m) -> Any:
            return MapTreeModule_current(i)

        def System_Collections_IEnumerator_get_Current(self, __unit: Literal[None]=None, m: Optional[MapTreeLeaf_2[_A, _B]]=m) -> Any:
            return MapTreeModule_current(i)

        def System_Collections_IEnumerator_MoveNext(self, __unit: Literal[None]=None, m: Optional[MapTreeLeaf_2[_A, _B]]=m) -> bool:
            return MapTreeModule_moveNext(i)

        def System_Collections_IEnumerator_Reset(self, __unit: Literal[None]=None, m: Optional[MapTreeLeaf_2[_A, _B]]=m) -> None:
            nonlocal i
            i = MapTreeModule_mkIterator(m)

        def Dispose(self, __unit: Literal[None]=None, m: Optional[MapTreeLeaf_2[_A, _B]]=m) -> None:
            pass

    return ObjectExpr260()


def MapTreeModule_toSeq(s: Optional[MapTreeLeaf_2[__A, __B]]=None) -> IEnumerable_1[Any]:
    def generator(en_1: IEnumerator[Any], s: Optional[MapTreeLeaf_2[__A, __B]]=s) -> Optional[Tuple[Any, IEnumerator[Any]]]:
...
def _expr263(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
class FSharpMap(Generic[_KEY, _VALUE]):
        ...
        if isinstance(that, FSharpMap):
            with get_enumerator(this) as e1:
                with get_enumerator(that) as e2:
                    def loop(__unit: Literal[None]=None) -> bool:
    ...
    def __str__(self, __unit: Literal[None]=None) -> str:
        this: FSharpMap[_KEY, _VALUE] = self
        def _arrow261(kv: Any) -> str:
            return format("({0}, {1})", kv[0], kv[1])

        return ("map [" + join("; ", map_1(_arrow261, this))) + "]"
    ...
    def GetEnumerator(self, __unit: Literal[None]=None) -> IEnumerator[Any]:
    ...
    def entries(self, __unit: Literal[None]=None) -> IEnumerable_1[Tuple[_KEY, _VALUE]]:
        m: FSharpMap[_KEY, _VALUE] = self
    ...
    def keys(self, __unit: Literal[None]=None) -> IEnumerable_1[_KEY]:
        m: FSharpMap[_KEY, _VALUE] = self
    ...
    def values(self, __unit: Literal[None]=None) -> IEnumerable_1[_VALUE]:
        m: FSharpMap[_KEY, _VALUE] = self
...
def find_key(predicate: Callable[[__A, __B], bool], table: FSharpMap[__A, __B]) -> __A:
    def chooser(kvp: Any, predicate: Callable[[__A, __B], bool]=predicate, table: FSharpMap[__A, __B]=table) -> Optional[__A]:
        k: __A = kvp[0]
