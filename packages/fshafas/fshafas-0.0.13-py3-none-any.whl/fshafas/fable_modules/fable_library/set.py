...
from typing import (TypeVar, Any, Optional, Generic, Literal, Tuple, Callable)
...
SetTreeLeaf_1_reflection = _expr235
...
def _expr236(gen0: TypeInfo) -> TypeInfo:
...
SetTreeNode_1_reflection = _expr236
...
def SetTreeModule_empty(__unit: Literal[None]=None) -> Optional[SetTreeLeaf_1[_T]]:
    return None
...
def SetTreeModule_rebalance(t1: Optional[SetTreeLeaf_1[_T]], v: _T, t2: Optional[SetTreeLeaf_1[_T]]=None) -> Optional[SetTreeLeaf_1[_T]]:
    ...
    if t2h > (t1h + 2):
        ...
        if isinstance(match_value, SetTreeNode_1):
            def _arrow237(__unit: Literal[None]=None, t1: Optional[SetTreeLeaf_1[_T]]=t1, v: _T=v, t2: Optional[SetTreeLeaf_1[_T]]=t2) -> int:
        ...
        if isinstance(match_value_2, SetTreeNode_1):
            def _arrow238(__unit: Literal[None]=None, t1: Optional[SetTreeLeaf_1[_T]]=t1, v: _T=v, t2: Optional[SetTreeLeaf_1[_T]]=t2) -> int:
...
def SetTreeModule_subset(comparer: IComparer_1[__A], a: Optional[SetTreeLeaf_1[__A]]=None, b: Optional[SetTreeLeaf_1[__A]]=None) -> bool:
    def _arrow239(x: Optional[__A]=None, comparer: IComparer_1[__A]=comparer, a: Optional[SetTreeLeaf_1[__A]]=a, b: Optional[SetTreeLeaf_1[__A]]=b) -> bool:
        return SetTreeModule_mem(comparer, x, b)

    return SetTreeModule_forall(_arrow239, a)
...
def SetTreeModule_properSubset(comparer: IComparer_1[__A], a: Optional[SetTreeLeaf_1[__A]]=None, b: Optional[SetTreeLeaf_1[__A]]=None) -> bool:
    def _arrow240(x: Optional[__A]=None, comparer: IComparer_1[__A]=comparer, a: Optional[SetTreeLeaf_1[__A]]=a, b: Optional[SetTreeLeaf_1[__A]]=b) -> bool:
        return SetTreeModule_mem(comparer, x, b)

    if SetTreeModule_forall(_arrow240, a):
        def _arrow241(x_1: Optional[__A]=None, comparer: IComparer_1[__A]=comparer, a: Optional[SetTreeLeaf_1[__A]]=a, b: Optional[SetTreeLeaf_1[__A]]=b) -> bool:
            return not SetTreeModule_mem(comparer, x_1, a)

        return SetTreeModule_exists(_arrow241, b)
...
def _expr242(gen0: TypeInfo) -> TypeInfo:
...
SetTreeModule_SetIterator_1_reflection = _expr242
...
def SetTreeModule_notStarted(__unit: Literal[None]=None) -> Any:
    raise Exception("Enumeration not started")


def SetTreeModule_alreadyFinished(__unit: Literal[None]=None) -> Any:
...
def SetTreeModule_mkIEnumerator(s: Optional[SetTreeLeaf_1[_A]]=None) -> IEnumerator[_A]:
    ...
    class ObjectExpr243(IEnumerator[_A_]):
        def System_Collections_Generic_IEnumerator_1_get_Current(self, __unit: Literal[None]=None, s: Optional[SetTreeLeaf_1[_A]]=s) -> _A_:
            return SetTreeModule_current(i)

        def System_Collections_IEnumerator_get_Current(self, __unit: Literal[None]=None, s: Optional[SetTreeLeaf_1[_A]]=s) -> Any:
            return SetTreeModule_current(i)

        def System_Collections_IEnumerator_MoveNext(self, __unit: Literal[None]=None, s: Optional[SetTreeLeaf_1[_A]]=s) -> bool:
            return SetTreeModule_moveNext(i)

        def System_Collections_IEnumerator_Reset(self, __unit: Literal[None]=None, s: Optional[SetTreeLeaf_1[_A]]=s) -> None:
            nonlocal i
            i = SetTreeModule_mkIterator(s)

        def Dispose(self, __unit: Literal[None]=None, s: Optional[SetTreeLeaf_1[_A]]=s) -> None:
            pass

    return ObjectExpr243()
...
def SetTreeModule_copyToArray(s: Optional[SetTreeLeaf_1[__A]], arr: Array[__A], i: int) -> None:
    j: int = i or 0
    def _arrow244(x: Optional[__A]=None, s: Optional[SetTreeLeaf_1[__A]]=s, arr: Array[__A]=arr, i: int=i) -> None:
        nonlocal j
        arr[j] = x
        j = (j + 1) or 0

    SetTreeModule_iter(_arrow244, s)
...
def SetTreeModule_ofArray(comparer: IComparer_1[__A], l: Array[__A]) -> Optional[SetTreeLeaf_1[__A]]:
    def _arrow245(acc: Optional[SetTreeLeaf_1[__A]], k: __A, comparer: IComparer_1[__A]=comparer, l: Array[__A]=l) -> Optional[SetTreeLeaf_1[__A]]:
        return SetTreeModule_add(comparer, k, acc)

    return fold_1(_arrow245, SetTreeModule_empty(), l)


def SetTreeModule_ofList(comparer: IComparer_1[__A], l: FSharpList[__A]) -> Optional[SetTreeLeaf_1[__A]]:
    def _arrow246(acc: Optional[SetTreeLeaf_1[__A]], k: __A, comparer: IComparer_1[__A]=comparer, l: FSharpList[__A]=l) -> Optional[SetTreeLeaf_1[__A]]:
        return SetTreeModule_add(comparer, k, acc)

    return fold_2(_arrow246, SetTreeModule_empty(), l)
...
def _expr248(gen0: TypeInfo) -> TypeInfo:
...
class FSharpSet(Generic[_T]):
    ...
    def __str__(self, __unit: Literal[None]=None) -> str:
        this: FSharpSet[_T] = self
        def _arrow247(x: Optional[_T]=None) -> str:
            copy_of_struct: _T = x
            return to_string(copy_of_struct)

        return ("set [" + join("; ", map_1(_arrow247, this))) + "]"

    @property
    def Symbol_toStringTag(self, __unit: Literal[None]=None) -> str:
        return "FSharpSet"
    ...
    def System_Collections_Generic_ICollection_1_Clear(self, __unit: Literal[None]=None) -> None:
        raise Exception("ReadOnlyCollection")
    ...
    def System_Collections_Generic_ICollection_1_get_IsReadOnly(self, __unit: Literal[None]=None) -> bool:
        return True

    def __len__(self, __unit: Literal[None]=None) -> int:
        s: FSharpSet[_T] = self
    ...
    @property
    def size(self, __unit: Literal[None]=None) -> int:
        s: FSharpSet[_T] = self
        return FSharpSet__get_Count(s)
    ...
    def clear(self, __unit: Literal[None]=None) -> None:
        raise Exception("Set cannot be mutated")
    ...
    def keys(self, __unit: Literal[None]=None) -> IEnumerable_1[_T]:
        s: FSharpSet[_T] = self
    ...
    def values(self, __unit: Literal[None]=None) -> IEnumerable_1[_T]:
        s: FSharpSet[_T] = self
        def mapping(x: Optional[_T]=None) -> Optional[_T]:
            return x
    ...
    def entries(self, __unit: Literal[None]=None) -> IEnumerable_1[Tuple[_T, _T]]:
        s: FSharpSet[_T] = self
...
def FSharpSet__Fold(s: FSharpSet[_T], f: Callable[[_T, __A], __A], z: __A) -> __A:
    f_1: Any = f
    def _arrow249(x: __A, z_1: _T, s: FSharpSet[_T]=s, f: Callable[[_T, __A], __A]=f, z: __A=z) -> __A:
        return f_1(z_1, x)

    return SetTreeModule_fold(_arrow249, z, FSharpSet__get_Tree(s))
...
def FSharpSet__Map(s: FSharpSet[_T], f: Callable[[_T], _U], comparer: IComparer_1[_U]) -> FSharpSet[_U]:
    def _arrow250(acc: Optional[SetTreeLeaf_1[_U]], k: _T, s: FSharpSet[_T]=s, f: Callable[[_T], _U]=f, comparer: IComparer_1[_U]=comparer) -> Optional[SetTreeLeaf_1[_U]]:
        return SetTreeModule_add(comparer, f(k), acc)

    return FSharpSet__ctor(comparer, SetTreeModule_fold(_arrow250, SetTreeModule_empty(), FSharpSet__get_Tree(s)))
...
def FSharpSet_IntersectionMany(sets: IEnumerable_1[FSharpSet[_T]]) -> FSharpSet[_T]:
    def _arrow251(s1: FSharpSet[_T], s2: FSharpSet[_T], sets: IEnumerable_1[FSharpSet[_T]]=sets) -> FSharpSet[_T]:
        return FSharpSet_Intersection(s1, s2)

    return reduce(_arrow251, sets)
...
def union_many(sets: IEnumerable_1[FSharpSet[_T]], comparer: IComparer_1[_T]) -> FSharpSet[_T]:
    def _arrow252(s1: FSharpSet[_T], s2: FSharpSet[_T], sets: IEnumerable_1[FSharpSet[_T]]=sets, comparer: IComparer_1[_T]=comparer) -> FSharpSet[_T]:
        return FSharpSet_op_Addition(s1, s2)

    return fold_3(_arrow252, FSharpSet_Empty(comparer), sets)
...
def to_seq(set_1: FSharpSet[_T]) -> IEnumerable_1[_T]:
    def mapping(x: Optional[_T]=None, set_1: FSharpSet[_T]=set_1) -> Optional[_T]:
        return x
...
def union_with(s1: Set_1[_T], s2: IEnumerable_1[_T]) -> Set_1[_T]:
    def folder(acc: Set_1[_T], x: _T, s1: Set_1[_T]=s1, s2: IEnumerable_1[_T]=s2) -> Set_1[_T]:
        return acc.add(x)
...
def intersect_with(s1: Set_1[_T], s2: IEnumerable_1[_T]) -> None:
    ...
    def action(x: Optional[_T]=None, s1: Set_1[_T]=s1, s2: IEnumerable_1[_T]=s2) -> None:
        if not (x in s2_1):
            ignore(s1.delete(x))
...
def is_subset_of(s1: Set_1[_T], s2: IEnumerable_1[_T]) -> bool:
    s2_1: Set_1[_T] = new_mutable_set_with(s1, s2)
    def predicate(arg: Optional[_T]=None, s1: Set_1[_T]=s1, s2: IEnumerable_1[_T]=s2) -> bool:
        return arg in s2_1
...
def is_proper_superset_of(s1: Set_1[_T], s2: IEnumerable_1[_T]) -> bool:
    ...
    def predicate(arg_1: Optional[_T]=None, s1: Set_1[_T]=s1, s2: IEnumerable_1[_T]=s2) -> bool:
        return not (arg_1 in s1)

    if exists_1(predicate, s2_1):
        def predicate_1(arg_2: Optional[_T]=None, s1: Set_1[_T]=s1, s2: IEnumerable_1[_T]=s2) -> bool:
            return arg_2 in s1
