...
from typing import (Literal, Any, TypeVar, Callable, Optional, Tuple)
...
def different_lengths(__unit: Literal[None]=None) -> Any:
...
def truncate(count: int, array: Array[_T]) -> Array[_T]:
    def _arrow47(x: int, y: int, count: int=count, array: Array[_T]=array) -> int:
        return compare_primitives(x, y)

    count_1: int = max_1(_arrow47, 0, count) or 0
...
def index_of(array: Array[_T], item_1: _T, start: Optional[int], count: Optional[int], eq: IEqualityComparer_1[Any]) -> int:
    ...
    def mapping(c: int, array: Array[_T]=array, item_1: _T=item_1, start: Optional[int]=start, count: Optional[int]=count, eq: IEqualityComparer_1[Any]=eq) -> int:
        return start_1 + c

    end_0027: int = default_arg(map_1(mapping, count), len(array)) or 0
    def loop(i_mut: int, array: Array[_T]=array, item_1: _T=item_1, start: Optional[int]=start, count: Optional[int]=count, eq: IEqualityComparer_1[Any]=eq) -> int:
        while True:
            (i,) = (i_mut,)
            if i >= end_0027:
                return -1
...
def insert_range_in_place(index: int, range: IEnumerable_1[_T], array: Array[_T]) -> None:
    ...
    with get_enumerator(range) as enumerator:
        while enumerator.System_Collections_IEnumerator_MoveNext():
            ...
            def _arrow48(__unit: Literal[None]=None, index: int=index, range: IEnumerable_1[_T]=range, array: Array[_T]=array) -> Array[_T]:
                index_1: int = i or 0
...
def choose(chooser: Callable[[_T], Optional[_U]], array: Array[_T], cons: Cons_1[_U]) -> Array[_U]:
    ...
    if equals_1(cons, None):
        ...
        def _arrow49(x: Optional[_U]=None, chooser: Callable[[_T], Optional[_U]]=chooser, array: Array[_T]=array, cons: Cons_1[_U]=cons) -> Optional[_U]:
            return x

        return map(_arrow49, res, cons)



def fold_indexed(folder: Callable[[int, _STATE, _T], _STATE], state: _STATE, array: Array[_T]) -> _STATE:
    def _arrow50(delegate_arg: _STATE, delegate_arg_1: _T, delegate_arg_2: int, folder: Callable[[int, _STATE, _T], _STATE]=folder, state: _STATE=state, array: Array[_T]=array) -> _STATE:
        return folder(delegate_arg_2, delegate_arg, delegate_arg_1)

    return array.reduce((_arrow50, state))


def fold(folder: Callable[[_STATE, _T], _STATE], state: _STATE, array: Array[_T]) -> _STATE:
    def _arrow51(acc: _STATE, x: _T, folder: Callable[[_STATE, _T], _STATE]=folder, state: _STATE=state, array: Array[_T]=array) -> _STATE:
        return folder(acc, x)

    return functools.reduce(_arrow51, array, state)
...
def permute(f: Callable[[int], int], array: Array[_T]) -> Array[_T]:
    ...
    def _arrow52(i: int, x: _T, f: Callable[[int], int]=f, array: Array[_T]=array) -> None:
        j: int = f(i) or 0
...
def sort_in_place_by(projection: Callable[[_A], _B], xs: Array[_A], comparer: IComparer_1[_B]) -> None:
    def _arrow53(x: _A, y: _A, projection: Callable[[_A], _B]=projection, xs: Array[_A]=xs, comparer: IComparer_1[_B]=comparer) -> int:
...
def sort_in_place(xs: Array[_T], comparer: IComparer_1[_T]) -> None:
    def _arrow54(x: _T, y: _T, xs: Array[_T]=xs, comparer: IComparer_1[_T]=comparer) -> int:
...
def sort(xs: Array[_T], comparer: IComparer_1[_T]) -> Array[_T]:
    xs_1: Array[_T] = xs[:]
    def comparer_1(x: _T, y: _T, xs: Array[_T]=xs, comparer: IComparer_1[_T]=comparer) -> int:
        return comparer.Compare(x, y)
...
def sort_by(projection: Callable[[_A], _B], xs: Array[_A], comparer: IComparer_1[_B]) -> Array[_A]:
    xs_1: Array[_A] = xs[:]
    def comparer_1(x: _A, y: _A, projection: Callable[[_A], _B]=projection, xs: Array[_A]=xs, comparer: IComparer_1[_B]=comparer) -> int:
        return comparer.Compare(projection(x), projection(y))
...
def unzip(array: Array[Tuple[__A, __B]]) -> Tuple[Array[__A], Array[__B]]:
    ...
    def _arrow55(i: int, tupled_arg: Tuple[__A, __B], array: Array[Tuple[__A, __B]]=array) -> None:
        res1[i] = tupled_arg[0]
        res2[i] = tupled_arg[1]

    iterate_indexed(_arrow55, array)
    return (res1, res2)
...
def unzip3(array: Array[Tuple[__A, __B, __C]]) -> Tuple[Array[__A], Array[__B], Array[__C]]:
    ...
    def _arrow56(i: int, tupled_arg: Tuple[__A, __B, __C], array: Array[Tuple[__A, __B, __C]]=array) -> None:
        res1[i] = tupled_arg[0]
        res2[i] = tupled_arg[1]
        res3[i] = tupled_arg[2]

    iterate_indexed(_arrow56, array)
...
def fold_back_indexed(folder: Callable[[int, _T, _STATE], _STATE], array: Array[_T], state: _STATE) -> _STATE:
    def _arrow57(delegate_arg: _STATE, delegate_arg_1: _T, delegate_arg_2: int, folder: Callable[[int, _T, _STATE], _STATE]=folder, array: Array[_T]=array, state: _STATE=state) -> _STATE:
        return folder(delegate_arg_2, delegate_arg_1, delegate_arg)

    return array.reduceRight((_arrow57, state))


def fold_back(folder: Callable[[_T, _STATE], _STATE], array: Array[_T], state: _STATE) -> _STATE:
    def _arrow58(acc: _STATE, x: _T, folder: Callable[[_T, _STATE], _STATE]=folder, array: Array[_T]=array, state: _STATE=state) -> _STATE:
        return folder(x, acc)

    return functools.reduce(_arrow58, array[::-1], state)
...
def fold2(folder: Callable[[_STATE, _T1, _T2], _STATE], state: _STATE, array1: Array[_T1], array2: Array[_T2]) -> _STATE:
    def _arrow59(_arg: int, acc: _STATE, x: _T1, y: _T2, folder: Callable[[_STATE, _T1, _T2], _STATE]=folder, state: _STATE=state, array1: Array[_T1]=array1, array2: Array[_T2]=array2) -> _STATE:
        return folder(acc, x, y)

    return fold_indexed2(_arrow59, state, array1, array2)
...
def fold_back2(f: Callable[[_T1, _T2, _STATE], _STATE], array1: Array[_T1], array2: Array[_T2], state: _STATE) -> _STATE:
    def _arrow60(_arg: int, x: _T1, y: _T2, acc: _STATE, f: Callable[[_T1, _T2, _STATE], _STATE]=f, array1: Array[_T1]=array1, array2: Array[_T2]=array2, state: _STATE=state) -> _STATE:
        return f(x, y, acc)

    return fold_back_indexed2(_arrow60, array1, array2, state)
...
def for_all2(predicate: Callable[[__A, __B], bool], array1: Array[__A], array2: Array[__B]) -> bool:
    def _arrow61(acc: bool, x: __A, y: __B, predicate: Callable[[__A, __B], bool]=predicate, array1: Array[__A]=array1, array2: Array[__B]=array2) -> bool:
        return predicate(x, y) if acc else False

    return fold2(_arrow61, True, array1, array2)
...
def max_by(projection: Callable[[_A], _B], xs: Array[_A], comparer: IComparer_1[_B]) -> _A:
    def _arrow62(x: _A, y: _A, projection: Callable[[_A], _B]=projection, xs: Array[_A]=xs, comparer: IComparer_1[_B]=comparer) -> _A:
...
def max(xs: Array[_A], comparer: IComparer_1[_A]) -> _A:
    def _arrow63(x: _A, y: _A, xs: Array[_A]=xs, comparer: IComparer_1[_A]=comparer) -> _A:
...
def min_by(projection: Callable[[_A], _B], xs: Array[_A], comparer: IComparer_1[_B]) -> _A:
    def _arrow64(x: _A, y: _A, projection: Callable[[_A], _B]=projection, xs: Array[_A]=xs, comparer: IComparer_1[_B]=comparer) -> _A:
...
def min(xs: Array[_A], comparer: IComparer_1[_A]) -> _A:
    def _arrow65(x: _A, y: _A, xs: Array[_A]=xs, comparer: IComparer_1[_A]=comparer) -> _A:
...
def windowed(window_size: int, source: Array[_T]) -> Array[Array[_T]]:
    ...
    res: Array[Array[_T]]
    def _arrow66(x: int, y: int, window_size: int=window_size, source: Array[_T]=source) -> int:
        return compare_primitives(x, y)

    len_1: int = max_1(_arrow66, 0, (len(source) - window_size) + 1) or 0
    res = [None]*len_1
...
def split_into(chunks: int, array: Array[_T]) -> Array[Array[_T]]:
    ...
    if len(array) == 0:
        ...
        result: Array[Array[_T]] = []
        def _arrow67(x: int, y: int, chunks: int=chunks, array: Array[_T]=array) -> int:
            return compare_primitives(x, y)

        chunks_1: int = min_1(_arrow67, chunks, len(array)) or 0
        ...
        for i in range(0, (chunks_1 - 1) + 1, 1):
            ...
            def _arrow68(x_1: int, y_1: int, chunks: int=chunks, array: Array[_T]=array) -> int:
                return compare_primitives(x_1, y_1)

            start: int = ((i * min_chunk_size) + min_1(_arrow68, chunks_with_extra_item, i)) or 0
            slice: Array[_T] = array[start:start+chunk_size]
            ignore(result.append(slice))
        return result
...
def transpose(arrays: IEnumerable_1[Array[_T]], cons: Cons_1[_T]) -> Array[Array[_T]]:
    ...
    if len_1 == 0:
        ...
        def predicate(a: Array[_T], arrays: IEnumerable_1[Array[_T]]=arrays, cons: Cons_1[_T]=cons) -> bool:
