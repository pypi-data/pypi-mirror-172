...
def HashSet__TryFindIndex_2B595(this: HashSet[_T], k: _T) -> Tuple[bool, int, int]:
    ...
    def _arrow29(__unit: Literal[None]=None, this: HashSet[_T]=this, k: _T=k) -> Array[_T]:
        return out_arg

    def _arrow30(v: Array[_T], this: HashSet[_T]=this, k: _T=k) -> None:
        nonlocal out_arg
        out_arg = v

    match_value = (try_get_value(this.hash_map, h, FSharpRef(_arrow29, _arrow30)), out_arg)
    if match_value[0]:
        def _arrow31(v_1: Optional[_T]=None, this: HashSet[_T]=this, k: _T=k) -> bool:
            return this.comparer.Equals(k, v_1)

        return (True, h, find_index(_arrow31, match_value[1]))
