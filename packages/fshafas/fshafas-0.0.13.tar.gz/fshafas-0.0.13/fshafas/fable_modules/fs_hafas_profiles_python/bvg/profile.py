...
Profile__set__endpoint_Z721C83C5(profile, "https://bvg-apps-ext.hafas.de/bin/mgate.exe")
...
Profile__set__lines_6FCE9E49(profile, True)

Profile__set__remarks_6FCE9E49(profile, True)
