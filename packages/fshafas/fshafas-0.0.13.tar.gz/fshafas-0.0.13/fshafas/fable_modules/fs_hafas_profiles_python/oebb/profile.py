...
Profile__set__locale_Z721C83C5(profile, "de-AT")

Profile__set__timezone_Z721C83C5(profile, "Europe/Vienna")

Profile__set__endpoint_Z721C83C5(profile, "https://fahrplan.oebb.at/bin/mgate.exe")
