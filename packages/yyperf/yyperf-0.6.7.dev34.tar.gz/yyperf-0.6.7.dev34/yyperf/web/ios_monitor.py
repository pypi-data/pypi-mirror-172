...
class app_monitor(threading.Thread):
    ...
    def run(self) -> None:
        ...
        if pid==-1:
            ...
            return None
        thd_list = []
        target_list = [self.recive_exit,self.get_system,self.get_traffic,self.get_gpu,self.get_fps]
...
if __name__ == "__main__":
    ...
    parser.add_argument('-bundle_id', type=str, default="com.yy.enterprise.yyvoice", help='bundle_id')
    parser.add_argument('-udid', type=str, default="00008110-0010699A3C79801E", help='device udid')
