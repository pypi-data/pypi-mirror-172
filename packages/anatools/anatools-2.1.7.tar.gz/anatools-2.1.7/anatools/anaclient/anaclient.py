...
class client:
    ...
    def __init__(self, workspaceId=None, environment='prod', email=None, password=None, local=False, interactive=True, verbose=None):
        ...
        if len(self.organizations) == 0: print("No organizations available. Contact admin@rendered.ai for support or fill out a form at https://rendered.ai/#contact."); return
        self.get_workspaces()
        if len(self.workspaces) == 0: 
            self.workspace = None
            print("No workspaces available. Contact admin@rendered.ai for support or fill out a form at https://rendered.ai/#contact."); 
            return
        self.get_channels()
        self.get_volumes()
        if workspaceId:     
            ...
            if self.organization is None:
                print("The workspaceId provided is invalid. If you believe this is a mistake, contact admin@rendered.ai for support or fill out a form at https://rendered.ai/#contact.")
