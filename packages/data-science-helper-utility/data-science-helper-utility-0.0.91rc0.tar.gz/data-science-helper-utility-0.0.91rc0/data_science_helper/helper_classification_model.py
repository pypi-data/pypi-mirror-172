...
def kpis_cross_validation(list_path=[], n_splits=5,url_out=None,postfix=""):
    ...
    result_kpis = [
                   {"Metric":"Precisión","Splits":n_splits,"Data":"Test","Promedio":mean_valid_precision,"SD":std_valid_precision,"Min":min_valid_precision,"Max":max_valid_precision},
                   {"Metric":"Precisión","Splits":n_splits,"Data":"Train","Promedio":mean_train_precision,"SD":std_train_precision,"Min":min_train_precision,"Max":max_train_precision},
                   
                   {"Metric":"Sensibilidad","Splits":n_splits,"Data":"Test","Promedio":mean_valid_recall,"SD":std_valid_recall,"Min":min_valid_recall,"Max":max_valid_recall},
                   {"Metric":"Sensibilidad","Splits":n_splits,"Data":"Train","Promedio":mean_train_recall,"SD":std_train_recall,"Min":min_train_recall,"Max":max_train_recall},
    
                   {"Metric":"Especificidad","Splits":n_splits,"Data":"Test","Promedio":mean_valid_specificity,"SD":std_valid_specificity,"Min":min_valid_specificity,"Max":max_valid_specificity},               
                   {"Metric":"Especificidad","Splits":n_splits,"Data":"Train","Promedio":mean_train_specificity,"SD":std_train_specificity,"Min":min_train_specificity,"Max":max_train_specificity},               
                                       
                   {"Metric":"F1","Splits":n_splits,"Data":"Test","Promedio":mean_valid_f1,"SD":std_valid_f1,"Min":min_valid_f1,"Max":max_valid_f1},
                   {"Metric":"F1","Splits":n_splits,"Data":"Train","Promedio":mean_train_f1,"SD":std_train_f1,"Min":min_train_f1,"Max":max_train_f1},
    
                   {"Metric":"PR AUC","Splits":n_splits,"Data":"Test","Promedio":mean_valid_average_precision,"SD":std_valid_average_precision,"Min":min_valid_average_precision,"Max":max_valid_average_precision},
                   {"Metric":"PR AUC","Splits":n_splits,"Data":"Train","Promedio":mean_train_average_precision,"SD":std_train_average_precision,"Min":min_train_average_precision,"Max":max_train_average_precision},
    
                   {"Metric":"ROC AUC","Splits":n_splits,"Data":"Test","Promedio":mean_valid_roc_auc,"SD":std_valid_roc_auc,"Min":min_valid_roc_auc,"Max":max_valid_roc_auc},
                   {"Metric":"ROC AUC","Splits":n_splits,"Data":"Train","Promedio":mean_train_roc_auc,"SD":std_train_roc_auc,"Min":min_train_roc_auc,"Max":max_train_roc_auc},               
                  
                   {"Metric":"Filtración ","Splits":n_splits,"Data":"Test","Promedio":mean_valid_filtracion,"SD":std_valid_filtracion,"Min":min_valid_filtracion,"Max":max_valid_filtracion},
                   {"Metric":"Filtración ","Splits":n_splits,"Data":"Train","Promedio":mean_train_filtracion,"SD":std_train_filtracion,"Min":min_train_filtracion,"Max":max_train_filtracion},               
                 
                   {"Metric":"Subcobertura  ","Splits":n_splits,"Data":"Test","Promedio":mean_valid_subcobertura,"SD":std_valid_subcobertura,"Min":min_valid_subcobertura,"Max":max_valid_subcobertura},
                   {"Metric":"Subcobertura ","Splits":n_splits,"Data":"Train","Promedio":mean_train_subcobertura,"SD":std_train_subcobertura,"Min":min_train_subcobertura,"Max":max_train_subcobertura},               
