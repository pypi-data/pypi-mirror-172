...
from ...kalmonak_extension import Amavis
...
class Command(BaseCommand):
    ...
    def _build_message(self, rcpt, total, reqs):
        ...
        content = render_to_string(
            "kalabash_amavis/notifications/pending_requests.html",
            context
        )
        msg = mail.EmailMessage(
            _("[kalabash] Pending release requests"),
            content,
            self.sender,
            [rcpt]
        )
