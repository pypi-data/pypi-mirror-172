...
from kalabash_amavis.lib import cleanup_email_address, make_query_args


class MakeQueryArgsTests(KalmonakTestCase):

    """Tests for kalabash_amavis.lib.make_query_args()."""
...
class FixUTF8EncodingTests(SimpleTestCase):
    ...
    """Tests for kalabash_amavis.lib.cleanup_email_address()."""
