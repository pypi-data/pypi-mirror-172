...
def create_default_provider(apps, schema_editor):
    ...
    EmailProvider = apps.get_model("kalabash_imap_migration", "EmailProvider")
    Migration = apps.get_model("kalabash_imap_migration", "Migration")
    LocalConfig = apps.get_model("core", "LocalConfig")
    lc = LocalConfig.objects.first()
    if not lc:
        return
    params = lc._parameters.get("kalabash_imap_migration")
    if params is None:
        return
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('kalabash_imap_migration', '0002_password'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kalabash_imap_migration.EmailProvider')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='migration',
            name='provider',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='kalabash_imap_migration.EmailProvider'),
        ),
