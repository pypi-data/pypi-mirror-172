...
# class ViewsTestCase(DataMixin, KalmonakTestCase):
#     """Views test cases."""
...
class AuthenticationTestCase(DataMixin, KalmonakTestCase):
...
class ManagementCommandTestCase(DataMixin, KalmonakTestCase):
...
class ViewSetTestCase(DataMixin, KalmonakAPITestCase):
...
class ChecksTestCase(KalmonakTestCase):
