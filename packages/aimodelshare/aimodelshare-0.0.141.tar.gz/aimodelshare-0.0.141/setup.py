...
setuptools.setup(
    ...
    install_requires=["boto3==1.21.20", "botocore==1.24.20","scikit-learn==0.24.2","onnx>=1.9.0","onnxconverter-common>=1.7.0", "regex",
    "keras2onnx>=1.7.0","tensorflow>=2.5.0","tf2onnx","skl2onnx>=1.8.0","onnxruntime>=1.7.0","torch>=1.8.1","pydot==1.3.0","importlib-resources==5.10.0",
