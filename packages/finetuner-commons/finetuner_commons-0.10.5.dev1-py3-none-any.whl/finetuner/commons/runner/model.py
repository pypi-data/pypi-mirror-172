...
from ..data import collate, preprocess
from ..models import builders
from ..models.export import to_onnx_format, to_torch_format
from ..models.utils import convert_backbone_to_embedding_model
from .stubs.model import ModelStubType
...
class RunnerModel:
    ...
    def __init__(
        ...
        self._builder = getattr(builders, self._stub.builder)(
            self._stub.descriptor, self._stub.options
        )
