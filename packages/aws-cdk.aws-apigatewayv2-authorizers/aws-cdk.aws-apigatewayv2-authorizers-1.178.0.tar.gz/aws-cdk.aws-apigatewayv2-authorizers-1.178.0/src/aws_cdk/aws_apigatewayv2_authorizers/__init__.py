...
class HttpIamAuthorizer(
    ...
    def bind(
        ...
        *,
        ...
        :stability: experimental
        '''
        _options = aws_cdk.aws_apigatewayv2.HttpRouteAuthorizerBindOptions(
            route=route, scope=scope
        )

        return typing.cast(aws_cdk.aws_apigatewayv2.HttpRouteAuthorizerConfig, jsii.invoke(self, "bind", [_options]))
...
class HttpJwtAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HttpJwtAuthorizer.__init__)
...
class HttpJwtAuthorizerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HttpJwtAuthorizerProps.__init__)
...
class HttpLambdaAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HttpLambdaAuthorizer.__init__)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class HttpLambdaAuthorizerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HttpLambdaAuthorizerProps.__init__)
            check_type(argname="argument authorizer_name", value=authorizer_name, expected_type=type_hints["authorizer_name"])
            check_type(argname="argument identity_source", value=identity_source, expected_type=type_hints["identity_source"])
...
class HttpUserPoolAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HttpUserPoolAuthorizer.__init__)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class HttpUserPoolAuthorizerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HttpUserPoolAuthorizerProps.__init__)
            check_type(argname="argument authorizer_name", value=authorizer_name, expected_type=type_hints["authorizer_name"])
            check_type(argname="argument identity_source", value=identity_source, expected_type=type_hints["identity_source"])
...
@jsii.implements(aws_cdk.aws_apigatewayv2.IWebSocketRouteAuthorizer)
class WebSocketLambdaAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WebSocketLambdaAuthorizer.__init__)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument handler", value=handler, expected_type=type_hints["handler"])
    ...
    def bind(
        ...
        *,
        ...
        :stability: experimental
        '''
        options = aws_cdk.aws_apigatewayv2.WebSocketRouteAuthorizerBindOptions(
            route=route, scope=scope
        )

        return typing.cast(aws_cdk.aws_apigatewayv2.WebSocketRouteAuthorizerConfig, jsii.invoke(self, "bind", [options]))
...
class WebSocketLambdaAuthorizerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WebSocketLambdaAuthorizerProps.__init__)
            check_type(argname="argument authorizer_name", value=authorizer_name, expected_type=type_hints["authorizer_name"])
            check_type(argname="argument identity_source", value=identity_source, expected_type=type_hints["identity_source"])
        self._values: typing.Dict[str, typing.Any] = {}
        if authorizer_name is not None:
