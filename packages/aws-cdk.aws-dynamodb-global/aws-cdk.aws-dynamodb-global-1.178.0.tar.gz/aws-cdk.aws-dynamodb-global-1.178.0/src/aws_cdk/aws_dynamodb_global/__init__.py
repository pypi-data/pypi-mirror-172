...
class GlobalTable(
    ...
    def __init__(
        ...
        *,
        ...
        table_class: typing.Optional[aws_cdk.aws_dynamodb.TableClass] = None,
        ...
        partition_key: typing.Union[aws_cdk.aws_dynamodb.Attribute, typing.Dict[str, typing.Any]],
        sort_key: typing.Optional[typing.Union[aws_cdk.aws_dynamodb.Attribute, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GlobalTable.__init__)
...
class GlobalTableProps(aws_cdk.core.StackProps, aws_cdk.aws_dynamodb.TableOptions):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GlobalTableProps.__init__)
    ...
    @builtins.property
    def table_class(self) -> typing.Optional[aws_cdk.aws_dynamodb.TableClass]:
        '''Specify the table class.

        :default: STANDARD
        '''
        result = self._values.get("table_class")
        return typing.cast(typing.Optional[aws_cdk.aws_dynamodb.TableClass], result)
