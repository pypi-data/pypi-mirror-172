from tunas2dsdl import DetectionParse, Generation, SemanticSegmentationParse
import os
import click
...
@click.option("-t", "--task", "task", type=click.Choice(["detection", "classification", "segmentation"]), required=True,
