...
class EquipmentWarningService:
    ...
    def add(params):
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=["id", "equip", "equip_record", "summary", "work_level", "warn_type", "is_manual_report", "created_time", "report_time", "extend_json", ]
        )
        try:
            instance = EquipmentWarn.objects.create(**params)
