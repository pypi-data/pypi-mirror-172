...
def create_background(target_size_px, image_bg_color, padding, path = str):
    ...
    image = image.resize((target_size_px, target_size_px), resample=Image.Resampling.LANCZOS)
    image.save(path)

if __name__ == "__main__":
    #for i in range(10):
    create_background(256, (0,0,0), 12, f"teste_image_0.png" )
