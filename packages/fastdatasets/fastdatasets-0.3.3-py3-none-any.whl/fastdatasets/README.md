...
### 2. Simple Writer Demo
```python
import pickle
import data_serialize
from fastdatasets import RecordLoader,FeatureWriter,StringWriter,PickleWriter,DataType,gfile
