...
class CfnDevice(
    ...
    def device_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDevice, "device_id").fset)
    ...
    def enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnDevice, "enabled").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnPlacement(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPlacement.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPlacement.inspect)
            check_type(argname="argument inspector", value=inspector, expected_type=type_hints["inspector"])
        return typing.cast(None, jsii.invoke(self, "inspect", [inspector]))
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPlacement._render_properties)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def associated_devices(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPlacement, "associated_devices").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def attributes(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPlacement, "attributes").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def project_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPlacement, "project_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def placement_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnPlacement, "placement_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnPlacementProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnPlacementProps.__init__)
...
class CfnProject(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        placement_template: typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnProject.PlacementTemplateProperty", typing.Dict[str, typing.Any]]],
    ...
    def placement_template(
        self,
    ) -> typing.Union[aws_cdk.core.IResolvable, "CfnProject.PlacementTemplateProperty"]:
        ...
        '''
        return typing.cast(typing.Union[aws_cdk.core.IResolvable, "CfnProject.PlacementTemplateProperty"], jsii.get(self, "placementTemplate"))

    @placement_template.setter
    def placement_template(
        self,
        value: typing.Union[aws_cdk.core.IResolvable, "CfnProject.PlacementTemplateProperty"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnProject, "placement_template").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class DeviceTemplateProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnProject.DeviceTemplateProperty.__init__)
    ...
    class PlacementTemplateProperty:
        def __init__(
            ...
            *,
            ...
            device_templates: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Mapping[builtins.str, typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnProject.DeviceTemplateProperty", typing.Dict[str, typing.Any]]]]]] = None,
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnProject.PlacementTemplateProperty.__init__)
...
class CfnProjectProps:
    ...
    def placement_template(
        ...
        return typing.cast(typing.Union[aws_cdk.core.IResolvable, CfnProject.PlacementTemplateProperty], result)
