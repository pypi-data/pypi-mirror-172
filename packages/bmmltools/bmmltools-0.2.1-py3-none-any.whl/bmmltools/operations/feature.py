...
class PatchTransform3D:
    ...
    def apply(self,patch_shape,transform_name = None,random_patches=False,n_random_patches=4000):
        """
    ...
    def _random_patches_transform(self,name):
        ...
        with h5py.File(self.trace.hdf5_trace_path,'a') as file:
            ...
            #
            group_db = file.create_group(name=hdf5_inner_path + self.output_dataset[0])
            db = group_db.create_dataset('{}_tmp'.format(name),
...
class PatchDiscreteFourierTransform3D:
    ...
    def apply(self,patch_shape,representation = 'module_phase',random_patches=False,n_random_patches=4000,
