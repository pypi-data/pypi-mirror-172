...
class CertificateValidation(
    ...
    def from_dns(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CertificateValidation.from_dns)
    ...
    def from_dns_multi_zone(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CertificateValidation.from_dns_multi_zone)
    ...
    def from_email(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CertificateValidation.from_email)
            check_type(argname="argument validation_domains", value=validation_domains, expected_type=type_hints["validation_domains"])
...
class CertificationValidationProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CertificationValidationProps.__init__)
            check_type(argname="argument hosted_zone", value=hosted_zone, expected_type=type_hints["hosted_zone"])
            check_type(argname="argument hosted_zones", value=hosted_zones, expected_type=type_hints["hosted_zones"])
...
class CfnAccount(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        expiry_events_configuration: typing.Union[typing.Union["CfnAccount.ExpiryEventsConfigurationProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable],
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAccount.__init__)
    ...
    def inspect(self, inspector: aws_cdk.core.TreeInspector) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAccount.inspect)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAccount._render_properties)
    ...
    def expiry_events_configuration(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnAccount, "expiry_events_configuration").fset)
    ...
    class ExpiryEventsConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnAccount.ExpiryEventsConfigurationProperty.__init__)
...
class CfnAccountProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnAccountProps.__init__)
...
class CfnCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        domain_validation_options: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnCertificate.DomainValidationOptionProperty", typing.Dict[str, typing.Any]]]]]] = None,
        subject_alternative_names: typing.Optional[typing.Sequence[builtins.str]] = None,
    ...
    def certificate_transparency_logging_preference(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnCertificate, "certificate_transparency_logging_preference").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def domain_validation_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnCertificate, "domain_validation_options").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def validation_method(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnCertificate, "validation_method").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class DomainValidationOptionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnCertificate.DomainValidationOptionProperty.__init__)
                check_type(argname="argument domain_name", value=domain_name, expected_type=type_hints["domain_name"])
...
class DnsValidatedCertificateProps(CertificateProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DnsValidatedCertificateProps.__init__)
            check_type(argname="argument domain_name", value=domain_name, expected_type=type_hints["domain_name"])
            check_type(argname="argument subject_alternative_names", value=subject_alternative_names, expected_type=type_hints["subject_alternative_names"])
            check_type(argname="argument validation", value=validation, expected_type=type_hints["validation"])
            check_type(argname="argument validation_domains", value=validation_domains, expected_type=type_hints["validation_domains"])
...
class PrivateCertificate(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        certificate_authority: aws_cdk.aws_acmpca.ICertificateAuthority,
        domain_name: builtins.str,
        subject_alternative_names: typing.Optional[typing.Sequence[builtins.str]] = None,
    ) -> None:
        '''
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrivateCertificate.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_certificate_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrivateCertificate.from_certificate_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class PrivateCertificateProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrivateCertificateProps.__init__)
    ...
    @builtins.property
    def certificate_authority(self) -> aws_cdk.aws_acmpca.ICertificateAuthority:
        ...
        return typing.cast(aws_cdk.aws_acmpca.ICertificateAuthority, result)
...
class Certificate(
    ...
    def from_certificate_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Certificate.from_certificate_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument certificate_arn", value=certificate_arn, expected_type=type_hints["certificate_arn"])
        return typing.cast(ICertificate, jsii.sinvoke(cls, "fromCertificateArn", [scope, id, certificate_arn]))
...
class DnsValidatedCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DnsValidatedCertificate.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
