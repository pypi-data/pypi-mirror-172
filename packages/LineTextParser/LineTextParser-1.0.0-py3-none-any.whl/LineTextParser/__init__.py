...
class load:
    ...
    class speech:
        def __init__(self,date=None,line=None,y=None,M=None,d=None,day=None,h=None,m=None,user=None,seq=None):
            if date:
                self.day=date[11:] 
        ...
        def __repr__(self):
            #return f"{self.y}.{self.M}.{self.d} {self.h}:{self.m} {self.user} {self.seq}"
            return rep.repr("speech",self,"y,M,d,day,h,m,user,seq")
