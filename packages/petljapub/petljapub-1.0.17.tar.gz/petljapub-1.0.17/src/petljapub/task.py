...
class Task:
    ...
    def test_on_example_testcases(self, sol, lang, force_recompile=False, reporter=None):
        ...
        return self.test_on_given_testcases(sol, lang, self.example_testcases(), force_recompile=force_recompile, reporter=reporter, warn_status=False, warn_not_OK=True)
    ...
    def test_on_given_testcases(self, sol, lang, testcases, timeout=None, force_recompile=False, reporter=None, warn_status=True, warn_not_OK=False):
        if not force_recompile and reporter and not reporter.should_test(sol, lang):
            return None
