...
class App(Generic[GenericDependencyContainer]):
    ...
    def __init__(self, name: str, dependency_container: GenericDependencyContainer,
                 dispatcher: IDispatcher = None, with_addons=False):
        self.name = name
        self.container = dependency_container
        self.sanic = Sanic(name, loads=orjson.loads, dumps=orjson.dumps, error_handler=ExtendedErrorHandler())
