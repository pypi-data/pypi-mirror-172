...
class AmazonMachineImage(
    ...
    def from_ssm_parameter(cls, path: builtins.str) -> aws_cdk.aws_ec2.IMachineImage:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AmazonMachineImage.from_ssm_parameter)
...
class _ILaunchtemplateProxy:
    ...
    def bind(self, spotfleet: "SpotFleet") -> "SpotFleetLaunchTemplateConfig":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ILaunchtemplate.bind)
...
class LaunchTemplate(metaclass=jsii.JSIIMeta, jsii_type="cdk-spot-one.LaunchTemplate"):
    ...
    def bind(self, spotfleet: "SpotFleet") -> "SpotFleetLaunchTemplateConfig":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LaunchTemplate.bind)
            check_type(argname="argument spotfleet", value=spotfleet, expected_type=type_hints["spotfleet"])
        return typing.cast("SpotFleetLaunchTemplateConfig", jsii.invoke(self, "bind", [spotfleet]))
...
class LaunchTemplateProps:
    def __init__(
        self,
        *,
        block_device_mappings: typing.Optional[typing.Sequence[typing.Union[aws_cdk.aws_ec2.CfnLaunchTemplate.BlockDeviceMappingProperty, typing.Dict[str, typing.Any]]]] = None,
        ...
        instance_market_options: typing.Optional[typing.Union[aws_cdk.aws_ec2.CfnLaunchTemplate.InstanceMarketOptionsProperty, typing.Dict[str, typing.Any]]] = None,
...
class LaunchTemplateResource(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LaunchTemplateResource.__init__)
...
class SpotFleetLaunchTemplateConfig:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SpotFleetLaunchTemplateConfig.__init__)
...
class SpotOne(
    ...
    def __init__(
        ...
        *,
        ...
        vpc_subnet: typing.Optional[typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SpotOne.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = SpotOneProps(
    ...
    def _create_instance_profile(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SpotOne._create_instance_profile)
    ...
    def _instance_profile(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SpotOne, "_instance_profile").fset)
    ...
    def _instance_role(self, value: typing.Optional[aws_cdk.aws_iam.IRole]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SpotOne, "_instance_role").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SpotOneProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SpotOneProps.__init__)
...
class VpcProvider(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(VpcProvider.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    @builtins.classmethod
    def get_or_create(cls, scope: constructs.Construct) -> aws_cdk.aws_ec2.IVpc:
        '''
        :param scope: -
        '''
        if __debug__:
            type_hints = typing.get_type_hints(VpcProvider.get_or_create)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(vpc_subnet, dict):
            vpc_subnet = aws_cdk.aws_ec2.SubnetSelection(**vpc_subnet)
        if __debug__:
            type_hints = typing.get_type_hints(BaseSpotFleetProps.__init__)
            check_type(argname="argument additional_user_data", value=additional_user_data, expected_type=type_hints["additional_user_data"])
            check_type(argname="argument assign_eip", value=assign_eip, expected_type=type_hints["assign_eip"])
            check_type(argname="argument custom_ami_id", value=custom_ami_id, expected_type=type_hints["custom_ami_id"])
            check_type(argname="argument default_instance_type", value=default_instance_type, expected_type=type_hints["default_instance_type"])
...
class SpotFleet(SpotOne, metaclass=jsii.JSIIMeta, jsii_type="cdk-spot-one.SpotFleet"):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SpotFleet.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def expire_after(self, duration: aws_cdk.Duration) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SpotFleet.expire_after)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(vpc_subnet, dict):
            vpc_subnet = aws_cdk.aws_ec2.SubnetSelection(**vpc_subnet)
        if __debug__:
            type_hints = typing.get_type_hints(SpotFleetProps.__init__)
            check_type(argname="argument additional_user_data", value=additional_user_data, expected_type=type_hints["additional_user_data"])
            check_type(argname="argument assign_eip", value=assign_eip, expected_type=type_hints["assign_eip"])
            check_type(argname="argument custom_ami_id", value=custom_ami_id, expected_type=type_hints["custom_ami_id"])
            check_type(argname="argument default_instance_type", value=default_instance_type, expected_type=type_hints["default_instance_type"])
...
class SpotInstance(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SpotInstance.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(vpc_subnet, dict):
            vpc_subnet = aws_cdk.aws_ec2.SubnetSelection(**vpc_subnet)
        if __debug__:
            type_hints = typing.get_type_hints(SpotInstanceProps.__init__)
            check_type(argname="argument additional_user_data", value=additional_user_data, expected_type=type_hints["additional_user_data"])
            check_type(argname="argument assign_eip", value=assign_eip, expected_type=type_hints["assign_eip"])
            check_type(argname="argument custom_ami_id", value=custom_ami_id, expected_type=type_hints["custom_ami_id"])
            check_type(argname="argument default_instance_type", value=default_instance_type, expected_type=type_hints["default_instance_type"])
