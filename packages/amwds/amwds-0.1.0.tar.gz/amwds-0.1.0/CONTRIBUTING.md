...
Welcome to `amwds` contributor's guide.
...
If you experience bugs or general issues with `amwds`, please have a look
...
You can help improve `amwds` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`amwds` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `amwds`'s files. While this mechanism can
...
```
conda create -n amwds python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/amwds.git
   cd amwds
   ```
...
5. Install [pre-commit]:
   ...
   `amwds` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/amwds
[issue tracker]: https://github.com/<USERNAME>/amwds/issues
