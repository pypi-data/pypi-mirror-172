...
Tools:
Might need to convert code to Rust or C++ to improve speed, python is
...
class blacklight(environment):
    def __init_(self, numpopulations, individualsperpopulation, numberofparentsmating, numberofgenerations, environmentgoal):
        super().__init__(numpopulations, individualsperpopulation, numberofparentsmating, numberofgenerations, environmentgoal)


    def fit(self, dataset):
        self.environmentgoal = dataset
        self.runenvironment()
