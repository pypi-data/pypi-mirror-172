...
class LambdaInvokeAction(
    ...
    def __init__(self, func: aws_cdk.aws_lambda.IFunction) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaInvokeAction.__init__)
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LambdaInvokeAction.bind)
...
class SetVariableAction(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SetVariableAction.__init__)
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SetVariableAction.bind)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
