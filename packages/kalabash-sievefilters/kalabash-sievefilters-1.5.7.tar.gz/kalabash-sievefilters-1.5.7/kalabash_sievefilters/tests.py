...
class SieveFiltersTestCase(KalmonakTestCase):
    """Check sieve filters."""
    ...
    def test_index(self):
        """Test index view."""
        response = self.client.get(reverse("kalabash_sievefilters:index"))
    ...
    def test_move_filter_up(self):
        ...
        url = reverse("kalabash_sievefilters:filter_move_up",
    ...
    def test_move_filter_down(self):
        ...
        url = reverse("kalabash_sievefilters:filter_move_down",
                      args=["main_script", "test1"])
        response = self.ajax_get(url)
        pos1 = response["content"].find(
            "/sfilters/main_script/editfilter/test2/")
    ...
    def test_new_filter(self):
        ...
        url = reverse("kalabash_sievefilters:filter_add", args=["main_script"])
    ...
    def test_edit_filter(self):
        ...
        url = reverse(
            "kalabash_sievefilters:filter_change",
            args=["main_script", "test1"])
        response = self.client.get(url)
    ...
    def test_remove_filter(self):
        ...
        url = reverse(
            "kalabash_sievefilters:filter_delete",
    ...
    def test_download_filters_set(self):
        ...
        url = reverse("kalabash_sievefilters:fs_download", args=["main_script"])
        response = self.client.get(url)
    ...
    def test_activate_filters_set(self):
        ...
        url = reverse(
            "kalabash_sievefilters:fs_activate", args=["second_script"])
        response = self.ajax_get(url)
    ...
    def test_savefs(self):
        """Test savefs view."""
        url = reverse("kalabash_sievefilters:fs_save", args=["new_script"])
