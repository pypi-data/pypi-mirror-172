...
from kognic.io.resources.input.cameras import Cameras
from kognic.io.resources.input.cameras_sequence import CamerasSequence
from kognic.io.resources.input.input import InputResource
from kognic.io.resources.input.lidars import Lidars
from kognic.io.resources.input.lidars_and_cameras import LidarsAndCameras
from kognic.io.resources.input.lidars_and_cameras_sequence import LidarsAndCamerasSequence
from kognic.io.resources.input.lidars_sequence import LidarsSequence
from kognic.io.resources.input.pre_annotation import PreAnnotationResource
...
class KognicIOClient:
    ...
    def __init__(
        ...
        *,
        ...
        """
        :param auth: auth credentials, see https://pypi.org/project/kognic-auth
