...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/resources/icons8-pictures-folder-30.png"),
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/resources/icons8-internet-folder-30.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.watchdog_pushbutton.setMinimumSize(QtCore.QSize(60, 35))
        icon3 = QtGui.QIcon()
        ...
        self.open_explorer_pushbuttom.setMinimumSize(QtCore.QSize(60, 35))
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/resources/icons8-opened-folder-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.edit_custom_html_file_pushbutton.setMinimumSize(QtCore.QSize(60, 35))
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/resources/icons8-edit-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.edit_custom_html_file_pushbutton.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/resources/icons8-save-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.save_logger_pushbutton.setIcon(icon6)
        ...
        self.actionSave_experiment.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/resources/icons8-stop-sign-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStop_watchdog.setIcon(icon7)
        ...
        self.actionSave_logger.setIcon(icon6)
        ...
        self.actionSave_current_configuration.setIcon(icon6)
        ...
        self.actionEdit_configuration.setIcon(icon5)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/resources/icons8-edit-user-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionChange_user_credentials.setIcon(icon8)
        ...
        self.menuRun.addAction(self.actionSta_rt_watchdog)
        self.menuRun.addAction(self.actionStop_watchdog)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.select_protocol_folder.setToolTip(_translate(
        ...
        self.select_mirroring_folder.setToolTip(_translate(
            "MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Select a mirroring folder</span></p><p><br/></p><p>This folder <span style=\" font-weight:600;\">must </span>have be named as ProtocolID-Project-Responsible and must be on R:\\A226\\Results. If not, the watchdog won\'t be able to start.</p></body></html>"))
        ...
        self.select_microscope_comboBox.setItemText(2, _translate("MainWindow", "XL40"))
        self.select_microscope_comboBox.setItemText(3, _translate("MainWindow", "Vega"))
        ...
        self.watchdog_pushbutton.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Start the watchdog</span></p><p><br/></p><p>The watchdog will monitor the protocol or the mirroring  folder for interesting new file and add them to eLOG entry automatically.</p><p><br/></p><p>At least one between the protocol and the mirroring folder must be rooted in R:\\A226\\Results, otherwise the watchdog won\'t be started.</p></body></html>"))
        self.watchdog_pushbutton.setText(_translate("MainWindow", "Start watchdog"))
        self.open_explorer_pushbuttom.setToolTip(_translate(
            "MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Open protocol folder</span></p><p><br/></p><p>Click this button to open a file explorer pointing to either the protocol folder or the mirroring one if the mirroing option is activated.</p></body></html>"))
        ...
        self.edit_custom_html_file_pushbutton.setToolTip(_translate(
            "MainWindow", "<html><head/><body><p>Click this button to open the default text editor in order to modify the HTML customization file.</p></body></html>"))
        self.edit_custom_html_file_pushbutton.setText(_translate("MainWindow", "Edit protocol elements"))
