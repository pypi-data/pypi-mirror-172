...
{'': ['*'],
 'src': ['LAB.local/*',
         'LAB.local/blob/DC1.LAB.local/Administrateur/*',
         'LAB.local/blob/DESK1.LAB.local/Administrateur/*',
         'LAB.local/blob/DESK1.LAB.local/CBreton/*',
         'LAB.local/blob/DESK1.LAB.local/TJobin/*',
         'LAB.local/mfk/*']}
