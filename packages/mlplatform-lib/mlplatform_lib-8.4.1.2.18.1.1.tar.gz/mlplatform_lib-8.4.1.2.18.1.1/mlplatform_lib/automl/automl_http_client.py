...
class AutomlHttpClient(MlPlatformHttpClient):
    ...
    def get_inference(self, experiment_id: int, train_id: int, model_id: int, inference_id: int) -> InferenceAutomlDto:
    ...
    def update_inference(
        self, experiment_id: int, train_id: int, model_id: int, inference_automl_dto: InferenceAutomlDto
    ) -> InferenceAutomlDto:
        result = self.send_request(
            "inferences",
