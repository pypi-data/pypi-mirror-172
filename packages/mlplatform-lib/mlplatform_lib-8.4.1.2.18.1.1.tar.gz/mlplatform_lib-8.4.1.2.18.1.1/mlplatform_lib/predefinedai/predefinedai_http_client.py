...
class PredefinedAIHttpClient(MlPlatformHttpClient):
    ...
    def get_inference(self, experiment_id: int, train_id: int, model_id: int, inference_id: int) -> InferencePredefinedaiDto:
    ...
    def update_inference(
        self, experiment_id: int, train_id: int, model_id: int, inference_predefinedai_dto: InferencePredefinedaiDto
