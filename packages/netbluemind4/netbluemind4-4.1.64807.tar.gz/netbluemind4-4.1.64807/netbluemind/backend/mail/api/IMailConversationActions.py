...
IMailConversationActions_VERSION = "4.1.64807"

class IMailConversationActions(BaseEndpoint):
    def __init__(self, apiKey, url ,conversationContainer ,replicatedMailboxUid ):
        self.url = url
        self.apiKey = apiKey
        self.base = url +'/mail_conversation/{conversationContainer}/{replicatedMailboxUid}'
    ...
    def importItems (self, folderDestinationId , mailboxItems ):
        ...
        response = requests.put( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IMailConversationActions_VERSION}, data = __encoded__);
    ...
    def move (self, targetMailboxUid , conversationUids ):
        ...
        response = requests.post( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IMailConversationActions_VERSION}, data = __encoded__);
