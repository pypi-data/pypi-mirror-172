...
INoteIndexMgmt_VERSION = "4.1.64807"
...
class INoteIndexMgmt(BaseEndpoint):
    ...
    def reindex (self, containerUid ):
        ...
        response = requests.post( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : INoteIndexMgmt_VERSION}, data = __encoded__);
