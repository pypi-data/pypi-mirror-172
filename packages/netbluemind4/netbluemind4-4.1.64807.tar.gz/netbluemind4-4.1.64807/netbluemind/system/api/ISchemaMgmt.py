...
class ISchemaMgmt(BaseEndpoint):
    ...
    def verify (self):
        ...
        response = requests.put( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : ISchemaMgmt_VERSION}, data = __encoded__);
