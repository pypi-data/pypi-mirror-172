    ...
    def __init__(self, api_client=None):
        ...
        def __get_wellbore_by_source(
            ...
            **kwargs
            ...
            >>> thread = api.get_wellbore_by_source(source_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_wellbore_by_source = Endpoint(
            settings={
                ...
                'endpoint_path': '/api/production/wellbore/{sourceId}',
                'operation_id': 'get_wellbore_by_source',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_wellbore_by_source
        )

        def __get_wellbores_by_well(
            self,
            source_well_id,
            **kwargs
        ):
            ...
            >>> thread = api.get_wellbores_by_well(source_well_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_wellbores_by_well = Endpoint(
            settings={
                'response_type': ([Wellbore],),
                'auth': [
                    'bearerAuth'
                ...
                'operation_id': 'get_wellbores_by_well',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_wellbores_by_well
        )
