    ...
    def __init__(self, api_client=None):
        ...
        def __get_casing_by_source_id(
            ...
            **kwargs
            ...
            >>> thread = api.get_casing_by_source_id(source_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_casing_by_source_id = Endpoint(
            settings={
                ...
                'endpoint_path': '/api/production/casing/{sourceId}',
                'operation_id': 'get_casing_by_source_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_casing_by_source_id
        )

        def __get_casing_for_well(
            self,
            source_well_id,
            **kwargs
        ):
            ...
            >>> thread = api.get_casing_for_well(source_well_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_casing_for_well = Endpoint(
            settings={
                'response_type': ([Casing],),
                'auth': [
                    'bearerAuth'
                ...
                'operation_id': 'get_casing_for_well',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_casing_for_well
        )
