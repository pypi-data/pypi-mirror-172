    ...
    def __init__(self, api_client=None):
        ...
        def __delete_tubing(
            ...
            **kwargs
            ...
            >>> thread = api.delete_tubing(source_id, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_tubing = Endpoint(
            settings={
                ...
                'endpoint_path': '/api/production/tubing/{sourceId}',
        ...
        def __get_tubing_by_source_id(
            ...
            **kwargs
            ...
            >>> thread = api.get_tubing_by_source_id(source_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_tubing_by_source_id = Endpoint(
            settings={
                ...
                'endpoint_path': '/api/production/tubing/{sourceId}',
                'operation_id': 'get_tubing_by_source_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_tubing_by_source_id
        )

        def __get_tubing_for_well(
            self,
            source_well_id,
            **kwargs
        ):
            ...
            >>> thread = api.get_tubing_for_well(source_well_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_tubing_for_well = Endpoint(
            settings={
                'response_type': ([Tubing],),
                'auth': [
                    'bearerAuth'
                ...
                'operation_id': 'get_tubing_for_well',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_tubing_for_well
        )
