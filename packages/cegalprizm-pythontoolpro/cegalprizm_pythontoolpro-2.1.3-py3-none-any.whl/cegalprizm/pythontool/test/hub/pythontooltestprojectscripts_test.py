...
class PythonToolTestProjectScriptsTest(PetreltestUnitCase):
    _project: str = fr'{os.environ["home"]}/Documents\PetrelUnitTestFramework\1\PythonToolTestProject\PythonToolTestProject.pet'
    ...
    def test_WelllogdiscreteAsDataframe(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogdiscreteSamplesCount(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogdiscreteSetEmpty(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogdiscreteWell(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogdiscreteSamplesValues(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogdiscreteSamplesValues2017(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteChunkError(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteChunkSetDf(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteLayer(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridCoordsextent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridGridvertices(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridIndicesValueError(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridIsundefFalse(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridPositionValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridRetrievestats(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridVerticesunchecked(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridVerticesuncheckedValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridVerticesValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyChunkSetDf(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyChunkSetDfReadonly(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyChunkError(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyColumns(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyColumnsvalueerrorIrange(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyColumnsvalueerrorJrange(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyColumnvalueerrorI(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyColumnvalueerrorJ(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyHassameparent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyHassameparentFalse(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyHassameparentValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyIsundefvalueFalse(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyIsundefvalueTrue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyLayer(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyLayers(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyLayersvalueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyLayervalueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyObjectextent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyParentcollection(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyParentgrid(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyPetrelname(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyReadonly(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertySetundefvalue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertySliceclone(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertySlicedisconnectedTrue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyUnitsymbol(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyUpdaterawvalues(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyUpscaledcellsComplete(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteArithmeticforbidden(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteColumns(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteColumnsvalueerrorIrange(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteColumnsvalueerrorJrange(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteColumnvalueerrorI(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteColumnvalueerrorJ(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteDiscretecode(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteHassameparent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteHassameparentFalse(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteHassameparentValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteIsundef(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteIsundefvalueFalse(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteIsundefvalueTrue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteLayers(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteLayersvalueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteLayervalueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteParentcollection(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteParentgrid(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscretePetrelname(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteReadonly(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteRetrievestats(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteSetundefvalue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteUnitsymbol(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteUpdaterawvalues(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Horizoninterpretation(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_HorizoninterpretationClone(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\Blueback.PythonTool.PythonApi.PetrelTest\Resources\ValidatedScripts\txt\horizoninterpretation_clone_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_WelllogAsDataframe(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogSamplesAt(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogSamplesSetValues(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogSamplesSetValuesEmpty(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogSamplesSetWritable(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogSamplesCount(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogSamplesTransferInBulk(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogSamplesValues(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogSamplesValues2017(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogNavigation(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogSetvalues(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellLogsDataframeColumnsOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellLogsDataframeSizeOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellLogsDataframeValuesOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
        ...
        try:
            ...
            import numpy as np
            for colName, colVals in sorted_logs.iteritems():
                value = colVals[18795]
    ...
    def test_PetrelbridgeDiscretegridpropertiesOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PetrelbridgeGridkeyvalueOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PetrelbridgeGridPathOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PetrelbridgeGridpropertyKeyvalueOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PetrelbridgeGridpropertyPathOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PetrelbridgeGridOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PetrelconnectionMakeConnection(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
        ...
        try:
            ...
            with make_connection() as p:
                    ...
                    print(df_clone_after_set_values.head())
            
                    GR_clone.set_values(MD_to_reset,np.array(df["Value"]))
                    print(GR_clone.as_dataframe().head())
    ...
    def test_PetrelconnectionAProjectIsActiveOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PetrelconnectionGetpetrelobjectsbyguidsPythontooltestproject(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
            ...
            for data_type in data_types:
                for item in data_type:
                    ...
                    if (p_obj == None):
                        ...
                        print(obj.droid == p_obj.droid and obj.path == p_obj.path, obj)
    ...
    def test_PetrelconnectionOpenDeprecation(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PetrelconnectionGetprojectstorageunits(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PetrelobjectDroid(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PetrelobjectTemplate(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetAddPointNoAttributes(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetAddPointWithAttributes(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetComplete(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetCompleteReadonly(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetAsDataframe(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetAsDataframeSpatialRange(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetAsDataframeMaxPoints(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetAsDataframeNoproperties(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetSetValues(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetAttributesInfo(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetSetValuesCreate(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetpropertyComplete(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetRetrievestats(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetPetrelname(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetReadonly(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PolylinesetComplete(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PolylinesetGetpoints(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PolylinesetCompleteReadonly(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Propertycollection(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dChunkSetOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dColumns(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dColumnsvalueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dCoordsextent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dHassameparent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dHassameparentValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dIndices(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dIndicesvalueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dPetrelname(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dPosition(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dPositionvalueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dReadonly(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dRetrievestats(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dAnnotation(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dAnnotationIndices(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dAnnotationIndicesValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dAnnotationvalueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dSetValue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dChunkError(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dColumns(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dColumnvalueerrorI(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dColumnvalueerrorJ(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dCoordsextent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dHassameparent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dHassameparentValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dIndices(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dIndicesvalueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dObjectextent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dPetrelname(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dPosition(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dPositionvalueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dReadonly(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dSliceclone(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dUpdaterawvalue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dRetrievestats(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceHassameparent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceHassameparentValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceIsundefFalse(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceIsundefTrue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceObjectextent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceParentsurface(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceParentsurfaceCoordsextent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceParentsurfaceRetrievestats(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceParentsurfaceextent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceParentsurfaceindices(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceParentsurfaceindicesValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceParentsurfaceposition(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceParentsurfacepositionValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfacePetrelname(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceRetrievestats(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceSetundefvalue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceUnitsymbol(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceUpdaterawvalues(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceParentsurfaceSurfaceattributes(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributePosition(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributePosition1(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Surfacecollection(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteIsundefFalse(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteChunk(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteDiscretecodes(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteDiscretecodeschange(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteHassameparent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteHassameparentValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteIsundefTrue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteParentsurface(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteParentsurfaceextent(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteParentsurfaceindices(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteParentsurfaceindicesValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteParentsurfaceposition(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteParentsurfacepositionValueerror(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscretePetrelname(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteReadonly(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteRetrievestats(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteSetundefvalue(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteUnitsymbol(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteUpdaterawvalues(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributeChunk(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertydiscreteCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WelllogdiscreteCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributeCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributeCloneNocopyOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic3dCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Seismic2dCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GlobalwelllogSmoketest(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GlobalwelllogLog(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GlobalwelllogBasic(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GlobalwelllogCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GlobalwelllogdiscreteCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GlobalwelllogdiscreteLog(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GlobalwelllogdiscreteLogs(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GlobalwelllogdiscreteWithKey(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PointsetCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_PolylinesetCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Horizoninterpretation3dCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Horizonproperty3dCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellsurveySetSurveyAsDefinitive(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellsurveyCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellsurveyRetrievehistory(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellsurveySetter(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellsurveySetterExplicit(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellsurveylateralBasic(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellsurveylateralCloneOop(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellsurveylateralDroid(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellsurveylateralSetter(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributeChunkSetDf(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_SurfaceattributediscreteChunkSetDf(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Horizoninterpretation3dChunkSetDf(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Horizonproperty3dChunkSetDf(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_Positionconverters(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
        ...
        pointset.readonly = False
        try:
            import cegalprizm.pythontool.experimental as ex
            ex.set_experimental_ok(True)
            import numpy as np
    ...
    def test_GridpropertyChunkSize(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_GridpropertyChunkSize1(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
    ...
    def test_WellLogExceptions(self):
        output = io.StringIO()
        sys_out = sys.stdout
        sys.stdout = output
        petrellink = PetrelConnection(petrel_ctx = self._ptx, allow_experimental=True)
