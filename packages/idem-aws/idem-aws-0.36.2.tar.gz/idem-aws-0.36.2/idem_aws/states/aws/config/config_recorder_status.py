...
async def present(
    ...
    resource_translated = await hub.tool.aws.config.conversion_utils.convert_raw_config_recorder_status_to_present(
    ...
    if recording != before["recording"]:
        ...
        result["comment"] = hub.tool.aws.comment_utils.already_present_comment(
            resource_type="aws.config.config_recorder_status", name=name
        )
    return result
...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    ...
    for resource in ret["ret"]["ConfigurationRecorders"]:
        ...
        translated_resource = await hub.tool.aws.config.conversion_utils.convert_raw_config_recorder_status_to_present(
            ctx,
