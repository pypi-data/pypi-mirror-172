...
resource = await hub.tool.boto3.resource.create(ctx, "ec2", "Subnet", name)
...
async def search(
    ...
    """
    Use an un-managed subnet as a data-source. Supply one of the inputs as the filter. This function has been deprecated.
    Please use exec.run with aws.ec2.subnet.get instead.
