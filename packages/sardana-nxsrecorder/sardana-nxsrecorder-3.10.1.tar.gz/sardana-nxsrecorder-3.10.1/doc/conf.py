# -*- coding: utf-8 -*-
#
# sardananxsrecorder documentation build configuration file, created by
...
htmlhelp_basename = 'sardananxsrecorderdoc'
...
latex_documents = [
  ('index', 'sardananxsrecorder.tex', u'sardananxsrecorder Documentation',
   u'Author', 'manual'),
]
...
man_pages = [
    ('index', 'sardananxsrecorder', u'sardananxsrecorder Documentation',
     [u'Author'], 1)
]
...
texinfo_documents = [
  ('index', 'sardananxsrecorder', u'sardananxsrecorder Documentation',
   u'Author', 'sardananxsrecorder', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'sardananxsrecorder'
epub_author = u'Author'
epub_publisher = u'Author'
epub_copyright = u'2016, Author'

# The basename for the epub file. It defaults to the project name.
# epub_basename = u'sardananxsrecorder'
