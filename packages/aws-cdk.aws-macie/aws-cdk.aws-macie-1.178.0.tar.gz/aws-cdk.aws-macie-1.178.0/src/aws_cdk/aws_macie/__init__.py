...
class CfnAllowList(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        criteria: typing.Union[typing.Union["CfnAllowList.CriteriaProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable],
        name: builtins.str,
    ...
    def criteria(
        self,
    ) -> typing.Union["CfnAllowList.CriteriaProperty", aws_cdk.core.IResolvable]:
        ...
        '''
        return typing.cast(typing.Union["CfnAllowList.CriteriaProperty", aws_cdk.core.IResolvable], jsii.get(self, "criteria"))

    @criteria.setter
    def criteria(
        self,
        value: typing.Union["CfnAllowList.CriteriaProperty", aws_cdk.core.IResolvable],
    ) -> None:
        if __debug__:
    ...
    class CriteriaProperty:
        def __init__(
            ...
            *,
            ...
            s3_words_list: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnAllowList.S3WordsListProperty", typing.Dict[str, typing.Any]]]] = None,
        ) -> None:
            '''
        ...
        def s3_words_list(
            self,
        ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAllowList.S3WordsListProperty"]]:
            ...
            return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAllowList.S3WordsListProperty"]], result)
...
class CfnAllowListProps:
    ...
    def criteria(
        ...
        return typing.cast(typing.Union[CfnAllowList.CriteriaProperty, aws_cdk.core.IResolvable], result)
...
class CfnFindingsFilter(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        finding_criteria: typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnFindingsFilter.FindingCriteriaProperty", typing.Dict[str, typing.Any]]],
        name: builtins.str,
    ...
    def finding_criteria(
        self,
    ) -> typing.Union[aws_cdk.core.IResolvable, "CfnFindingsFilter.FindingCriteriaProperty"]:
        ...
        '''
        return typing.cast(typing.Union[aws_cdk.core.IResolvable, "CfnFindingsFilter.FindingCriteriaProperty"], jsii.get(self, "findingCriteria"))

    @finding_criteria.setter
    def finding_criteria(
        self,
        value: typing.Union[aws_cdk.core.IResolvable, "CfnFindingsFilter.FindingCriteriaProperty"],
    ) -> None:
        if __debug__:
...
class CfnFindingsFilterProps:
    ...
    def finding_criteria(
        ...
        return typing.cast(typing.Union[aws_cdk.core.IResolvable, CfnFindingsFilter.FindingCriteriaProperty], result)
