...
class TTable(object):
    ...
    def __init__(self, db_name=None, tbl_name=None, load_status=None, access_level=None, columns=None, clustering_columns=None, table_stats=None, table_type=None, hdfs_table=None, hbase_table=None, metastore_table=None, data_source_table=None, kudu_table=None, storage_metadata_load_time_ns=None, iceberg_table=None,):
        self.db_name = db_name
        self.tbl_name = tbl_name
    ...
    def write(self, oprot):
        ...
        if self.clustering_columns is not None:
            ...
            for iter203 in self.clustering_columns:
                iter203.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.iceberg_table is not None:
            oprot.writeFieldBegin('iceberg_table', TType.STRUCT, 16)
...
class TPrincipal(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i208 in range(_size204):
                        ...
                        self.grant_groups.append(_elem209)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.grant_groups is not None:
            ...
            for iter210 in self.grant_groups:
...
TColumn.thrift_spec = (
    ...
    (18, TType.BOOL, 'is_iceberg_column', None, None, ),  # 18
    (19, TType.I32, 'iceberg_field_id', None, None, ),  # 19
    (20, TType.I32, 'iceberg_field_map_key_id', None, None, ),  # 20
    (21, TType.I32, 'iceberg_field_map_value_id', None, None, ),  # 21
)
...
TTable.thrift_spec = (
    ...
    (16, TType.STRUCT, 'iceberg_table', [TIcebergTable, None], None, ),  # 16
)
