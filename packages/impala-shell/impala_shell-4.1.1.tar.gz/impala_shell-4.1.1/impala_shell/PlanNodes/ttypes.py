...
class THdfsFileSplit(object):
    ...
    def __init__(self, relative_path=None, offset=None, length=None, partition_id=None, file_length=None, file_compression=None, mtime=None, partition_path_hash=None,):
