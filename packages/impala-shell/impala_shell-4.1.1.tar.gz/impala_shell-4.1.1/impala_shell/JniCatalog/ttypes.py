...
class TComputeStatsParams(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i259 in range(_size255):
                        _elem260 = CatalogObjects.ttypes.TPartitionStats()
                        _elem260.read(iprot)
                        self.existing_part_stats.append(_elem260)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i265 in range(_size261):
                        ...
                        for _i271 in range(_size267):
                            ...
                            _elem266.append(_elem272)
                        iprot.readListEnd()
                        self.expected_partitions.append(_elem266)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.existing_part_stats is not None:
            ...
            for iter273 in self.existing_part_stats:
                iter273.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.expected_partitions is not None:
            ...
            for iter274 in self.expected_partitions:
                oprot.writeListBegin(TType.STRING, len(iter274))
                for iter275 in iter274:
...
class TGrantRevokeRoleParams(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i280 in range(_size276):
                        ...
                        self.role_names.append(_elem281)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i286 in range(_size282):
                        ...
                        self.group_names.append(_elem287)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.role_names is not None:
            ...
            for iter288 in self.role_names:
        ...
        if self.group_names is not None:
            ...
            for iter289 in self.group_names:
...
class TGrantRevokePrivParams(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i294 in range(_size290):
                        _elem295 = CatalogObjects.ttypes.TPrivilege()
                        _elem295.read(iprot)
                        self.privileges.append(_elem295)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.privileges is not None:
            ...
            for iter296 in self.privileges:
                iter296.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i301 in range(_size297):
                        ...
                        _elem302.read(iprot)
                        self.arg_types.append(_elem302)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
...
class TGetCatalogUsageResponse(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i308 in range(_size304):
                        _elem309 = TTableUsageMetrics()
                        _elem309.read(iprot)
                        self.large_tables.append(_elem309)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i314 in range(_size310):
                        _elem315 = TTableUsageMetrics()
                        _elem315.read(iprot)
                        self.frequently_accessed_tables.append(_elem315)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i320 in range(_size316):
                        _elem321 = TTableUsageMetrics()
                        _elem321.read(iprot)
                        self.high_file_count_tables.append(_elem321)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i326 in range(_size322):
                        _elem327 = TTableUsageMetrics()
                        _elem327.read(iprot)
                        self.long_metadata_loading_tables.append(_elem327)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.large_tables is not None:
            ...
            for iter328 in self.large_tables:
                iter328.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.frequently_accessed_tables is not None:
            ...
            for iter329 in self.frequently_accessed_tables:
                iter329.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.high_file_count_tables is not None:
            ...
            for iter330 in self.high_file_count_tables:
                iter330.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.long_metadata_loading_tables is not None:
            ...
            for iter331 in self.long_metadata_loading_tables:
                iter331.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetOperationUsageResponse(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i336 in range(_size332):
                        _elem337 = TOperationUsageCounter()
                        _elem337.read(iprot)
                        self.catalog_op_counters.append(_elem337)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.catalog_op_counters is not None:
            ...
            for iter338 in self.catalog_op_counters:
                iter338.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TCatalogdHmsCacheMetrics(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i343 in range(_size339):
                        _elem344 = TCatalogHmsCacheApiMetrics()
                        _elem344.read(iprot)
                        self.api_metrics.append(_elem344)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.api_metrics is not None:
            ...
            for iter345 in self.api_metrics:
                iter345.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.cache_hit_ratio is not None:
