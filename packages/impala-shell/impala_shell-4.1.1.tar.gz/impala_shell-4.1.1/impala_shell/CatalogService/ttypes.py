...
class TIcebergOperationParam(object):
    ...
    def __init__(self, spec_id=None, iceberg_data_files_fb=None, is_overwrite=False,):
...
class TPartialTableInfo(object):
    ...
    def __init__(self, hms_table=None, partitions=None, column_stats=None, storage_metadata_load_time_ns=None, network_addresses=None, sql_constraints=None, valid_write_ids=None, is_marked_cached=None, partition_prefixes=None, iceberg_table=None,):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i118 in range(_size114):
                        _elem119 = Types.ttypes.TNetworkAddress()
                        _elem119.read(iprot)
                        self.network_addresses.append(_elem119)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i124 in range(_size120):
                        ...
                        self.partition_prefixes.append(_elem125)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
    ...
    def write(self, oprot):
        ...
        if self.partitions is not None:
            ...
            for iter126 in self.partitions:
                iter126.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_stats is not None:
            ...
            for iter127 in self.column_stats:
                iter127.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.network_addresses is not None:
            ...
            for iter128 in self.network_addresses:
                iter128.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.valid_write_ids is not None:
            ...
            oprot.writeFieldEnd()
        if self.is_marked_cached is not None:
            oprot.writeFieldBegin('is_marked_cached', TType.BOOL, 10)
            oprot.writeBool(self.is_marked_cached)
            oprot.writeFieldEnd()
        if self.partition_prefixes is not None:
            oprot.writeFieldBegin('partition_prefixes', TType.LIST, 11)
            oprot.writeListBegin(TType.STRING, len(self.partition_prefixes))
            for iter129 in self.partition_prefixes:
                oprot.writeString(iter129)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.iceberg_table is not None:
            oprot.writeFieldBegin('iceberg_table', TType.STRUCT, 12)
...
class TBriefTableMeta(object):
    ...
    def __init__(self, name=None, msType=None, comment=None,):
        self.name = name
        self.msType = msType
...
class TPartialDbInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i134 in range(_size130):
                        _elem135 = TBriefTableMeta()
                        _elem135.read(iprot)
                        self.brief_meta_of_tables.append(_elem135)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i140 in range(_size136):
                        ...
                        self.function_names.append(_elem141)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.brief_meta_of_tables is not None:
            ...
            for iter142 in self.brief_meta_of_tables:
                iter142.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.function_names is not None:
            ...
            for iter143 in self.function_names:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i148 in range(_size144):
                        _elem149 = Types.ttypes.TFunction()
                        _elem149.read(iprot)
                        self.functions.append(_elem149)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TGetPartitionStatsResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i155 in range(_size151):
                        ...
                        self.partition_stats[_key156] = _val157
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partition_stats is not None:
            ...
            for kiter158, viter159 in self.partition_stats.items():
...
class TPrioritizeLoadRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i164 in range(_size160):
                        ...
                        _elem165.read(iprot)
                        self.object_descs.append(_elem165)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.object_descs is not None:
            ...
            for iter166 in self.object_descs:
                iter166.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i171 in range(_size167):
                        _elem172 = TTableUsage()
                        _elem172.read(iprot)
                        self.usages.append(_elem172)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
TPartialTableInfo.thrift_spec = (
    ...
    (9, TType.STRUCT, 'valid_write_ids', [CatalogObjects.ttypes.TValidWriteIdList, None], None, ),  # 9
    (10, TType.BOOL, 'is_marked_cached', None, None, ),  # 10
    (11, TType.LIST, 'partition_prefixes', (TType.STRING, None, False), None, ),  # 11
    (12, TType.STRUCT, 'iceberg_table', [CatalogObjects.ttypes.TIcebergTable, None], None, ),  # 12
)
