...
class TFinalizeParams(object):
    ...
    def __init__(self, is_overwrite=None, hdfs_base_dir=None, table_name=None, table_db=None, staging_dir=None, table_id=None, transaction_id=None, write_id=None, spec_id=None,):
