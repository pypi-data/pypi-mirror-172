...
class FlowMoney(object):
    ...
    def flow_moeny(cls, flowmoney_data, name, width='1600px', height = '600px'):
        ...
        bar_plot = cls.flowmoney_bar(flowmoney_data[['flow_money']], trade_date_list, name)
        line_plot = cls.flowmoney_line(flowmoney_data[['ma5']], trade_date_list)
    ...
    def flowmoney_line(cls, flowmoney_data, trade_date_list):
        ...
        line_plot.add_yaxis('5日净流入资金均值', result_format,linestyle_opts=opts.LineStyleOpts(width=3, opacity=0.5),
                           is_smooth=True,
