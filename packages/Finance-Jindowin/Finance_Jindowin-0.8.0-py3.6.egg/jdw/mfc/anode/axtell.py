...
class Axtell(BaseEngine):
    ...
    def sell_yesterday(self,vt_symbol, price,volume, order_type = OrderType.LIMIT):
        return self.send_order(vt_symbol, price, volume, Direction.LONG, Offset.CLOSEYESTERDAY, order_type)

    def cover_yesterday(self,vt_symbol, price,volume, order_type = OrderType.LIMIT):
        return self.send_order(vt_symbol, price, volume, Direction.SHORT, Offset.CLOSEYESTERDAY, order_type)

    def sell_today(self,vt_symbol, price,volume, order_type = OrderType.LIMIT):
        return self.send_order(vt_symbol, price, volume, Direction.SHORT, Offset.CLOSETODAY, order_type)

    def cover_today(self,vt_symbol, price,volume, order_type = OrderType.LIMIT):
        return self.send_order(vt_symbol, price, volume, Direction.LONG, Offset.CLOSETODAY, order_type)
