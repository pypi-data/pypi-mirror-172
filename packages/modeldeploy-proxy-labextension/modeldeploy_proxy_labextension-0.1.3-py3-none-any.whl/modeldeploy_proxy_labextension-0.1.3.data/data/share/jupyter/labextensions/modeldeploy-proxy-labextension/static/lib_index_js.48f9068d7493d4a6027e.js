...
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @material-ui/core */ "webpack/sharing/consume/default/@material-ui/core/@material-ui/core");
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_Select__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../components/Select */ "./lib/components/Select.js");
/* harmony import */ var _lib_TagsUtils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../lib/TagsUtils */ "./lib/lib/TagsUtils.js");
/* harmony import */ var _CellMetadataEditorDialog__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./CellMetadataEditorDialog */ "./lib/widgets/CellMetadataEditorDialog.js");
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../settings */ "./lib/settings.js");
/* harmony import */ var _states__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../states */ "./lib/states.js");
    ...
    constructor(props) {
        ...
        this.updateCurrentCellTag = (value) => {
            if (value !== this.state.transformerTag) {
                ...
                (0,_states__WEBPACK_IMPORTED_MODULE_3__.issueTransformerStatesChange)(this.props.cellId, this.transformerStates);
        ...
        this.saveCellTagInNotebookFile = () => {
            ...
            if (value == CELL_TYPE_PREPROCESSOR || value == CELL_TYPE_POSTPROCESSOR || value == CELL_TYPE_REQUIREMENTS) {
                isDuplicated = _lib_TagsUtils__WEBPACK_IMPORTED_MODULE_4__["default"].isTransformerTagExistedInOtherCells(this.props.notebookPanel, this.props.notebookPanel.content.activeCellIndex, value);
            }
            if (isDuplicated) {
                ...
                if (RESERVED_CELL_NAMES.includes(value)) {
                    ...
                    _lib_TagsUtils__WEBPACK_IMPORTED_MODULE_4__["default"].setCellTransformerTag(this.props.notebookPanel, this.props.notebookPanel.content.activeCellIndex, cellMetadata).then(newValue => {
                        this.hideSelector();
                    });
                }
                else if (CELL_TYPE_NA === value) {
                    _lib_TagsUtils__WEBPACK_IMPORTED_MODULE_4__["default"].resetCellTransformerTag(this.props.notebookPanel, this.props.notebookPanel.content.activeCellIndex).then(newValue => {
                        this.hideSelector();
                    });
                }
            }
        ...
        this.transformerStates = (0,_states__WEBPACK_IMPORTED_MODULE_3__.fetchTransformerStattes)();
        this.updateLocalTransformerStates(props.transformerTag, true);
        (0,_states__WEBPACK_IMPORTED_MODULE_3__.addStatesChangeListener)(this.onStatesChangeCallback);
        (0,_states__WEBPACK_IMPORTED_MODULE_3__.issueTransformerStatesChange)(this.props.cellId, this.transformerStates);
        const defaultState = {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'transformer-metadata-editor-wrapper' + ((this.state.isTransformerEnabled && this.state.isSelectorVisible) ? '' : ' hidden') },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: 'transformer-cell-metadata-editor', style: { borderLeft: `2px solid ${cellColor}` } },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_Select__WEBPACK_IMPORTED_MODULE_5__.Select, { updateValue: this.updateCurrentCellTag, values: this.state.typeSelectOptions, value: cellType, label: 'Cell type', index: 0, variant: "outlined", style: { width: 'auto', minWidth: '14em' } }),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__.IconButton, { "aria-label": "remove", onClick: () => this.removeCellTagInNotebookFile() },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_icons_Close__WEBPACK_IMPORTED_MODULE_6__["default"], { fontSize: "small" })),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__.IconButton, { "aria-label": "apply", onClick: () => this.saveCellTagInNotebookFile() },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_icons_Check__WEBPACK_IMPORTED_MODULE_7__["default"], { fontSize: "small" })),
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_CellMetadataEditorDialog__WEBPACK_IMPORTED_MODULE_8__.CellMetadataEditorDialog, { open: this.state.cellMetadataEditorDialog, toggleDialog: this.toggleTagsEditorDialog, title: this.state.dialogTitle, dialogContent: this.state.dialogContent })));
    }
}
        ...
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__.DialogContent, { dividers: true, style: { paddingTop: 0 } },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__.Grid, { container: true, direction: "column", justify: "center", alignItems: "center" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__.Grid, { container: true, direction: "row", justify: "space-between", alignItems: "center", style: { marginTop: '15px' } },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, props.dialogContent)))),
...
//# sourceMappingURL=lib_index_js.48f9068d7493d4a6027e.js.map