...
@LastEditTime: 2022-10-19 14:55:28
...
class OperateBaseModel():
    ...
    def add_operation_log(self, operation_type, title, operation_desc, model_name, handler_name, old_detail, update_detail, app_id, act_id, operate_user_id, operate_user_name, operate_role_id, request_dict, ip , request_code):
        """
        :description: 创建操作日志
