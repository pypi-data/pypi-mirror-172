...
@LastEditTime: 2022-10-14 15:56:22
...
class FrameBaseHandler(BaseApiHandler):
                ...
                if user_nick:
                    ...
                    if store_user_nick:
                        ...
                        if app_info_dict:
                            ...
                            if main_user_open_id !="" and app_info_dict.get("main_user_open_id","") == "":
    ...
    def create_operation_log(self, operation_type=1, model_name="", handler_name="", old_detail=None, update_detail=None, operate_user_id="", operate_user_name="", operate_role_id="", title="", operation_desc=""):
        ...
        """
        plat_type = config.get_value("plat_type", 1)  # 平台类型 1淘宝2微信3抖音
        if plat_type == 1 and not operate_user_id:
        ...
        operate_base_model.add_operation_log(operation_type, title, operation_desc, model_name, handler_name, old_detail, update_detail, self.get_app_id(), self.get_act_id(), operate_user_id, operate_user_name, operate_role_id, {"request_params": self.request_params, "request": self.request}, self.get_remote_ip())
