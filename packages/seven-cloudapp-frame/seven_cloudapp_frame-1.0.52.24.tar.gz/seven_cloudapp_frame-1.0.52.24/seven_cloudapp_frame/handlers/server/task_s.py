...
@LastEditTime: 2022-10-17 15:01:05
        ...
        for item in task_list:
            ...
            if "id" in item.keys():
                ...
                if task_info:
                    ...
                    self.create_operation_log(operation_type=OperationType.update.value, model_name=task_info.__str__(), old_detail=old_task_info.__dict__, update_detail=task_info.__dict__, title=task_name)
                    ref_params = {}
                ...
                self.create_operation_log(operation_type=OperationType.add.value, model_name=task_info.__str__(), old_detail=None, update_detail=task_info.__dict__, title=task_name)
                ref_params = {}
                self.business_process_executed(task_info, ref_params)
