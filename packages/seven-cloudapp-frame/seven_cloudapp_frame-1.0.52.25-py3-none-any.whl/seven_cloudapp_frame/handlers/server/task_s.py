...
@LastEditTime: 2022-10-20 16:59:54
...
class SaveTaskInfoHandler(ClientBaseHandler):
    ...
    def post_async(self):
        ...
        title = invoke_result_data.data["title"] if invoke_result_data.data.__contains__("title") else ""
        ...
        for item in task_list:
            ...
            title = title if title else task_name
            if "id" in item.keys():
