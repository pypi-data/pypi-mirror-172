...
class TasksStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CountTasks = channel.unary_unary(
                '/armonik.api.grpc.v1.tasks.Tasks/CountTasks',
                request_serializer=tasks__common__pb2.CountTasksRequest.SerializeToString,
                response_deserializer=tasks__common__pb2.CountTasksResponse.FromString,
                )
...
class TasksServicer(object):
    ...
    def CountTasks(self, request, context):
        """*
        Count tasks using filters and a specific field.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_TasksServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CountTasks': grpc.unary_unary_rpc_method_handler(
                    servicer.CountTasks,
                    request_deserializer=tasks__common__pb2.CountTasksRequest.FromString,
                    response_serializer=tasks__common__pb2.CountTasksResponse.SerializeToString,
            ),
...
class Tasks(object):
    ...
    def CountTasks(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/armonik.api.grpc.v1.tasks.Tasks/CountTasks',
            tasks__common__pb2.CountTasksRequest.SerializeToString,
            tasks__common__pb2.CountTasksResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
