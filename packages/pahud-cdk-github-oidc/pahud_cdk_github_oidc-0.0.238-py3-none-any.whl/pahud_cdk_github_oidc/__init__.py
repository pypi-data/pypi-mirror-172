...
class ProviderBase(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProviderBase.__init__)
    ...
    def create_role(
        self,
        id: builtins.str,
        repo: typing.Sequence[typing.Union["RepositoryConfig", typing.Dict[str, typing.Any]]],
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProviderBase.create_role)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class Provider(
    ...
    def from_account(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Provider.from_account)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
