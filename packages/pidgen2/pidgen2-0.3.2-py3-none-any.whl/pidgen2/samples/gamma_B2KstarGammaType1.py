...
from ..datasets import photon_run1_datasets_kstargamma_partreco_type1 as ds_run1
from ..datasets import photon_run2_datasets_kstargamma_partreco_type1 as ds_run2
...
common_params = {
    ...
    "data_ranges" : [ (3.48, 4.4), (1.0, 4.0) ],           # Ranges of each variable after transformation
...
sample_run1 = {
  year : { 
    ...
    "expressions" : [ 
      "gamma_PT", 
      "-log(gamma_PT/sqrt(gamma_P**2-gamma_PT**2))", 
      "wt_sig"
    ], 
    "branches" : [ 
      "gamma_PT", 
