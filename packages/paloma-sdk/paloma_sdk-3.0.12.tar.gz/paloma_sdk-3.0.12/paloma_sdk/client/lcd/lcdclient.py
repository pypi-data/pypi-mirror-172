...
from paloma_sdk.core import Coins, Dec, Numeric
from paloma_sdk.exceptions import LCDResponseError
from paloma_sdk.key.key import Key
from paloma_sdk.util.json import dict_to_data
from paloma_sdk.util.url import urljoin
...
class LCDClient(AsyncLCDClient):
    """An object representing a connection to a node running the Paloma LCD server."""
    ...
    auth: AuthAPI
    """:class:`AuthAPI<paloma_sdk.client.lcd.api.auth.AuthAPI>`."""
    ...
    gov: GovAPI
    """:class:`GovAPI<paloma_sdk.client.lcd.api.gov.GovAPI>`."""

    feegrant: FeeGrantAPI
    """:class:`FeeGrant<paloma_sdk.client.lcd.api.feegrant.FeeGrantAPI>`."""
    ...
    staking: StakingAPI
    """:class:`StakingAPI<paloma_sdk.client.lcd.api.staking.StakingAPI>`."""

    tendermint: TendermintAPI
    """:class:`TendermintAPI<paloma_sdk.client.lcd.api.tendermint.TendermintAPI>`."""

    wasm: WasmAPI
    """:class:`WasmAPI<paloma_sdk.client.lcd.api.wasm.WasmAPI>`."""

    tx: TxAPI
    """:class:`TxAPI<paloma_sdk.client.lcd.api.tx.TxAPI>`."""

    ibc: IbcAPI
    """:class:`IbcAPI<paloma_sdk.client.lcd.api.ibc.IbcAPI>`."""

    ibc_transfer: IbcTransferAPI
    """:class:`IbcTransferAPI<paloma_sdk.client.lcd.api.ibc_transfer.IbcTransferAPI>`."""
