...
if TYPE_CHECKING:
    from newchain_web3 import Web3 as _Web3  # noqa: F401
...
def Web3() -> Type["_Web3"]:
    from newchain_web3 import Web3 as Web3Main
...
def init_web3(
    ...
    from newchain_web3 import Web3 as Web3Main
    from newchain_web3.eth import Eth as EthMain
...
def init_async_web3(
    ...
    from newchain_web3 import Web3 as Web3Main
    from newchain_web3.eth import AsyncEth as AsyncEthMain
...
async def _async_ens_stalecheck_middleware(
    ...
    from newchain_web3.middleware import async_make_stalecheck_middleware
