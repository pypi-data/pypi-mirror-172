...
from ..enum.kpi_filter_type import KpiFilterType


@dataclass(frozen=True)
class KpiFilterInput(DataClassJsonMixin):
    filterType: KpiFilterType = _field(metadata=enum_field_metadata(KpiFilterType))
