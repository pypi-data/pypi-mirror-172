...
from ..enum.vendor_filter_type import VendorFilterType


@dataclass(frozen=True)
class VendorFilterInput(DataClassJsonMixin):
    filterType: VendorFilterType = _field(metadata=enum_field_metadata(VendorFilterType))
