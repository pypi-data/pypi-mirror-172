...
from ..enum.formula_filter_type import FormulaFilterType


@dataclass(frozen=True)
class FormulaFilterInput(DataClassJsonMixin):
    filterType: FormulaFilterType = _field(metadata=enum_field_metadata(FormulaFilterType))
