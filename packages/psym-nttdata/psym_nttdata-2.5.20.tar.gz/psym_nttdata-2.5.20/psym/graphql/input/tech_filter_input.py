...
from ..enum.tech_filter_type import TechFilterType


@dataclass(frozen=True)
class TechFilterInput(DataClassJsonMixin):
    filterType: TechFilterType = _field(metadata=enum_field_metadata(TechFilterType))
