...
def animate(sol, fig=None, ax=None, title="", savepath=None, fig_size=(6, 6), variable=0, **kwargs):
    """
    ...
    def anime2d(i):
        ax.set_title(title + f" Timesteps: {i}")
    ...
    anima = animation.FuncAnimation(fig, anime, frames=len(sol[variable, :]), repeat=False, **kwargs)
