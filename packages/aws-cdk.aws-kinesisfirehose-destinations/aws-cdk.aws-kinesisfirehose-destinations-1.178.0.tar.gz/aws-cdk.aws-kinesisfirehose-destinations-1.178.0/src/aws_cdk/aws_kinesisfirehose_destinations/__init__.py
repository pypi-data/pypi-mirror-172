...
class CommonDestinationProps:
    def __init__(
        ...
        *,
        ...
        s3_backup: typing.Optional[typing.Union["DestinationS3BackupProps", typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        ...
        if __debug__:
            type_hints = typing.get_type_hints(CommonDestinationProps.__init__)
...
class CommonDestinationS3Props:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CommonDestinationS3Props.__init__)
...
class Compression(
    ...
    def of(cls, value: builtins.str) -> "Compression":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Compression.of)
...
class DestinationS3BackupProps(CommonDestinationS3Props):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DestinationS3BackupProps.__init__)
            check_type(argname="argument buffering_interval", value=buffering_interval, expected_type=type_hints["buffering_interval"])
            check_type(argname="argument buffering_size", value=buffering_size, expected_type=type_hints["buffering_size"])
            check_type(argname="argument compression", value=compression, expected_type=type_hints["compression"])
            check_type(argname="argument data_output_prefix", value=data_output_prefix, expected_type=type_hints["data_output_prefix"])
...
class S3Bucket(
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(S3Bucket.bind)
