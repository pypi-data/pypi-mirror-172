...
class CheapVpc(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CheapVpc.__init__)
...
class CreateTags(
    ...
    def __init__(
        ...
        *,
        ...
        tags: typing.Sequence[typing.Union["Tag", typing.Dict[str, typing.Any]]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CreateTags.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class CreateTagsProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CreateTagsProps.__init__)
