...
class _IDomainPropsProxy:
    ...
    def hosted_zone_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainProps, "hosted_zone_id").fset)
    ...
    def record_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainProps, "record_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def zone_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainProps, "zone_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def acm(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainProps, "acm").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ttl(self, value: typing.Optional[aws_cdk.core.Duration]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IDomainProps, "ttl").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class _ISuperDomainPropsProxy(
    ...
    def loadbalancer(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ISuperDomainProps, "loadbalancer").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class _ISuperEC2BasePropsProxy:
    ...
    def ami_os_type(self, value: typing.Optional[AmiOSType]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ISuperEC2BaseProps, "ami_os_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def instance_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ISuperEC2BaseProps, "instance_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def vpc(self, value: typing.Optional[aws_cdk.aws_ec2.IVpc]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ISuperEC2BaseProps, "vpc").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SuperDomain(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SuperDomain.__init__)
...
class SuperEC2Base(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SuperEC2Base.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        jsii.create(self.__class__, self, [scope, id, props])
...
class _IJenkinsEC2PropsProxy(
    ...
    def domain(self, value: typing.Optional[IDomainProps]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IJenkinsEC2Props, "domain").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def loadbalancer(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IJenkinsEC2Props, "loadbalancer").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "loadbalancer", value)
    ...
    def loadbalancer_type(self, value: typing.Optional[ELBtype]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(IJenkinsEC2Props, "loadbalancer_type").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class JenkinsEC2(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JenkinsEC2.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        jsii.create(self.__class__, self, [scope, id, props])
