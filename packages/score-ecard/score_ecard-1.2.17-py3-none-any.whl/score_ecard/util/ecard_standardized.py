...
class ECardStandardized(object):
    ...
    def load(self, model_name:str):
        ...
        self.func_clf = lambda x: model.get('func_clf', self.func_empty2)(self.clf,x)
    ...
    def save(self, model_name, model='all'):
        assert model in ['all','pure'],'all for backup, pure for online'
        if model =='pure':
            model_raw = None
        else:
        ...
        model = {
            ...
            'features_ext': self.card_ext,
            'score_bins': self.score_bins,
            'preprocessing_befor': self.preprocessing_befor,
            'preprocessing_after': self.preprocessing_after,
