...
if __name__ == "__main__":
    ...
    parser.add_argument("-w", "--workspace", default=4, type=int, help="The max memory workspace size to allow in Gb, "
                                                                       "default: 1")
    ...
    parser.add_argument("--end2end", default=False, type=bool,
