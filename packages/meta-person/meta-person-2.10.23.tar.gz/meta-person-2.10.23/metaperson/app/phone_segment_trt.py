import cv2
from ..model_zoo import PhoneSegment


class PhoneSegmentTrt:
    def __init__(self,
        ...
        self.model = PhoneSegment(engine_path=trt_file, imgsz=input_shape)

    def predict(self, image):
        dets = self.model.segment(image, conf=self.conf, iou=self.iou, end2end=self.end2end)
