...
class itkBModeImageFilterCASCID2CASCID2CASCcomplexID2(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCID2CASCID2):
...
def itkBModeImageFilterCASCID2CASCID2ICD2_New():
    return itkBModeImageFilterCASCID2CASCID2ICD2.New()

class itkBModeImageFilterCASCID2CASCID2ICD2(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCID2CASCID2):
    r"""Proxy of C++ itkBModeImageFilterCASCID2CASCID2ICD2 class."""
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCID2CASCID2ICD2___New_orig__)
    Clone = _swig_new_instance_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCID2CASCID2ICD2_Clone)
    SetDirection = _swig_new_instance_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCID2CASCID2ICD2_SetDirection)
    GetDirection = _swig_new_instance_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCID2CASCID2ICD2_GetDirection)
    SetFrequencyFilter = _swig_new_instance_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCID2CASCID2ICD2_SetFrequencyFilter)
    __swig_destroy__ = _itkBModeImageFilterPython.delete_itkBModeImageFilterCASCID2CASCID2ICD2
    cast = _swig_new_static_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCID2CASCID2ICD2_cast)

    def New(*args, **kargs):
        """New() -> itkBModeImageFilterCASCID2CASCID2ICD2

        Create a new object of the class itkBModeImageFilterCASCID2CASCID2ICD2 and set the input and the parameters if some
        named or non-named arguments are passed to that method.
        ...
        Ex:
          ...
          itkBModeImageFilterCASCID2CASCID2ICD2.New(reader, threshold=10)

        is (most of the time) equivalent to:

          obj = itkBModeImageFilterCASCID2CASCID2ICD2.New()
          obj.SetInput(0, reader.GetOutput())
          obj.SetThreshold(10)
        """
        obj = itkBModeImageFilterCASCID2CASCID2ICD2.__New_orig__()
        from itk.support import template_class
        template_class.New(obj, *args, **kargs)
        return obj
    New = staticmethod(New)
...
# Register itkBModeImageFilterCASCID2CASCID2ICD2 in _itkBModeImageFilterPython:
_itkBModeImageFilterPython.itkBModeImageFilterCASCID2CASCID2ICD2_swigregister(itkBModeImageFilterCASCID2CASCID2ICD2)
itkBModeImageFilterCASCID2CASCID2ICD2___New_orig__ = _itkBModeImageFilterPython.itkBModeImageFilterCASCID2CASCID2ICD2___New_orig__
itkBModeImageFilterCASCID2CASCID2ICD2_cast = _itkBModeImageFilterPython.itkBModeImageFilterCASCID2CASCID2ICD2_cast


def itkBModeImageFilterCASCIF2CASCIF2CASCcomplexIF2_New():
    return itkBModeImageFilterCASCIF2CASCIF2CASCcomplexIF2.New()

class itkBModeImageFilterCASCIF2CASCIF2CASCcomplexIF2(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIF2CASCIF2):
...
def itkBModeImageFilterCASCIF2CASCIF2ICF2_New():
    return itkBModeImageFilterCASCIF2CASCIF2ICF2.New()

class itkBModeImageFilterCASCIF2CASCIF2ICF2(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIF2CASCIF2):
    r"""Proxy of C++ itkBModeImageFilterCASCIF2CASCIF2ICF2 class."""
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCIF2CASCIF2ICF2___New_orig__)
    Clone = _swig_new_instance_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCIF2CASCIF2ICF2_Clone)
    SetDirection = _swig_new_instance_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCIF2CASCIF2ICF2_SetDirection)
    GetDirection = _swig_new_instance_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCIF2CASCIF2ICF2_GetDirection)
    SetFrequencyFilter = _swig_new_instance_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCIF2CASCIF2ICF2_SetFrequencyFilter)
    __swig_destroy__ = _itkBModeImageFilterPython.delete_itkBModeImageFilterCASCIF2CASCIF2ICF2
    cast = _swig_new_static_method(_itkBModeImageFilterPython.itkBModeImageFilterCASCIF2CASCIF2ICF2_cast)

    def New(*args, **kargs):
        """New() -> itkBModeImageFilterCASCIF2CASCIF2ICF2

        Create a new object of the class itkBModeImageFilterCASCIF2CASCIF2ICF2 and set the input and the parameters if some
        named or non-named arguments are passed to that method.
        ...
        Ex:
          ...
          itkBModeImageFilterCASCIF2CASCIF2ICF2.New(reader, threshold=10)

        is (most of the time) equivalent to:

          obj = itkBModeImageFilterCASCIF2CASCIF2ICF2.New()
          obj.SetInput(0, reader.GetOutput())
          obj.SetThreshold(10)
        """
        obj = itkBModeImageFilterCASCIF2CASCIF2ICF2.__New_orig__()
        from itk.support import template_class
        template_class.New(obj, *args, **kargs)
        return obj
    New = staticmethod(New)
...
# Register itkBModeImageFilterCASCIF2CASCIF2ICF2 in _itkBModeImageFilterPython:
_itkBModeImageFilterPython.itkBModeImageFilterCASCIF2CASCIF2ICF2_swigregister(itkBModeImageFilterCASCIF2CASCIF2ICF2)
itkBModeImageFilterCASCIF2CASCIF2ICF2___New_orig__ = _itkBModeImageFilterPython.itkBModeImageFilterCASCIF2CASCIF2ICF2___New_orig__
itkBModeImageFilterCASCIF2CASCIF2ICF2_cast = _itkBModeImageFilterPython.itkBModeImageFilterCASCIF2CASCIF2ICF2_cast
