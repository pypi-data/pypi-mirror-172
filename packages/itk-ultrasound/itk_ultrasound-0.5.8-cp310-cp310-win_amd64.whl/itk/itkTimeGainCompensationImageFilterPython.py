...
class itkTimeGainCompensationImageFilterCASCID2(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCID2CASCID2):
...
class itkTimeGainCompensationImageFilterCASCID3(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCID3CASCID3):
...
class itkTimeGainCompensationImageFilterCASCID4(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCID4CASCID4):
...
class itkTimeGainCompensationImageFilterCASCIF2(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIF2CASCIF2):
...
class itkTimeGainCompensationImageFilterCASCIF3(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIF3CASCIF3):
...
class itkTimeGainCompensationImageFilterCASCIF4(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIF4CASCIF4):
...
class itkTimeGainCompensationImageFilterCASCISS2(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCISS2CASCISS2):
...
class itkTimeGainCompensationImageFilterCASCISS3(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCISS3CASCISS3):
...
class itkTimeGainCompensationImageFilterCASCISS4(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCISS4CASCISS4):
...
class itkTimeGainCompensationImageFilterCASCIUC2(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIUC2CASCIUC2):
...
class itkTimeGainCompensationImageFilterCASCIUC3(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIUC3CASCIUC3):
...
class itkTimeGainCompensationImageFilterCASCIUC4(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIUC4CASCIUC4):
...
class itkTimeGainCompensationImageFilterCASCIUS2(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIUS2CASCIUS2):
...
class itkTimeGainCompensationImageFilterCASCIUS3(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIUS3CASCIUS3):
...
class itkTimeGainCompensationImageFilterCASCIUS4(itk.itkCurvilinearArraySpecialCoordinatesImageFiltersPython.itkImageToImageFilterCASCIUS4CASCIUS4):
...
def time_gain_compensation_image_filter(*args: itkt.ImageLike,  gain=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for TimeGainCompensationImageFilter"""
    import itk

    kwarg_typehints = { 'gain':gain }
...
def time_gain_compensation_image_filter_init_docstring():
    ...
    time_gain_compensation_image_filter.process_object = filter_class
