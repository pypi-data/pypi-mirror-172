"""
<plugin key="AirtonAC" name="Airton AC" author="gab@les-cactus.co" version="0.1.2" wikilink="https://github.com/gpajot/airton-ac#domoticz-plugin" externallink="https://github.com/gpajot/airton-ac">
    <description>
