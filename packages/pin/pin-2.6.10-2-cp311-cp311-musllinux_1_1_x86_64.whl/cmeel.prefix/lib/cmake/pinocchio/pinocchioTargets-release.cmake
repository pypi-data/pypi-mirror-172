...
set_target_properties(pinocchio::pinocchio PROPERTIES
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/libpinocchio.so.2.6.10"
  IMPORTED_SONAME_RELEASE "libpinocchio.so.2.6.10"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio "${PACKAGE_PREFIX_DIR}/lib/libpinocchio.so.2.6.10" )
...
set_target_properties(pinocchio::pinocchio_pywrap PROPERTIES
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.11/site-packages/pinocchio/pinocchio_pywrap.cpython-311-x86_64-linux-musl.so.2.6.10"
  IMPORTED_SONAME_RELEASE "pinocchio_pywrap.cpython-311-x86_64-linux-musl.so.2.6.10"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_pywrap )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_pywrap "${PACKAGE_PREFIX_DIR}/lib/python3.11/site-packages/pinocchio/pinocchio_pywrap.cpython-311-x86_64-linux-musl.so.2.6.10" )
