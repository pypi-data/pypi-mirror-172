...
struct mjtPluginTypeBit {
  static constexpr char name[] = "mjtPluginTypeBit";
  using type = ::mjtPluginTypeBit;
  static constexpr auto values = std::array{
    std::make_pair("mjPLUGIN_ACTUATOR", ::mjtPluginTypeBit::mjPLUGIN_ACTUATOR),
    std::make_pair("mjPLUGIN_SENSOR", ::mjtPluginTypeBit::mjPLUGIN_SENSOR),
    std::make_pair("mjPLUGIN_PASSIVE", ::mjtPluginTypeBit::mjPLUGIN_PASSIVE)};
};
