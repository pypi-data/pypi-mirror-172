...
class MonitorInstances(BaseInstances):
    ...
    def __create_monitor_from_training_stats(self, data_mart_id, training_stats_info, params, background_mode):
        ...
        if 'explainability_configuration' in training_stats_info:
            ...
            global_explanation = get(training_stats_info, "explainability_configuration.parameters.global_explanation.enabled")
    ...
    def __validate_fairness_params(self, params):  
        ...
        supported_metrics = [metric_name.value for metric_name in FairnessMetrics]
        ...
        if len(un_supported_metrics) > 0:             
            raise Exception("Metric ids {} are invalid. Please use the FairnessMetrics enum class for the correct metric ids".format(un_supported_metrics))            
