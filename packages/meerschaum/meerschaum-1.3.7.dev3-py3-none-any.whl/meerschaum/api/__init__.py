...
typing_extensions = attempt_import('typing_extensions', lazy=False, check_update=CHECK_UPDATE)
pydantic_dataclasses = attempt_import('pydantic.dataclasses', lazy=False, check_update=CHECK_UPDATE)
