        ...
        if message._type=="text":
           return message.text
            ...
            if message.interactive["type"] == "button_reply":
                ...
                print("There is no message text defined for this interactive type: {}".format(message.interactive["type"]))
                return ""
        else:
            print("There is no message text defined for this message type: {}".format(message._type))
...
class WhatsAppValue:
    def __init__(self, metadata, contacts=[], errors=[], messaging_product="whatsapp", messages=[], statuses=[]):
        ...
        self.messages = [WhatsAppMessage(**message) for message in messages_list]
...
class WhatsAppStatus:
    def __init__(self, id, recipient_id, status, timestamp, conversation=None, pricing=None) -> None:
        if conversation:
