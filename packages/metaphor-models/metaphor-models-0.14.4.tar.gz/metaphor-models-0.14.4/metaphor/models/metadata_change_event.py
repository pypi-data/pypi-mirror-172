...
class Dashboard:
    ...
    def from_dict(obj: Any) -> 'Dashboard':
        ...
        return Dashboard(created_at, id, asset_contacts, asset_followers, asset_governed_tags, dashboard_created_at, dashboard_info, deleted_at, display_name, entity_type, dashboard_id, last_ingested_at, last_modified_at, logical_id, source_info, upstream)
...
class DatasetStatistics:
    ...
    def from_dict(obj: Any) -> 'DatasetStatistics':
        ...
        return DatasetStatistics(created_at, aspect_type, dataset_statistics_created_at, data_size, entity_id, field_statistics, id, last_updated, record_count)
...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, asset_contacts, asset_followers, asset_governed_tags, dataset_created_at, custom_metadata, deleted_at, display_name, documentation, entity_type, field_associations, field_statistics, dataset_id, last_ingested_at, last_modified_at, logical_id, ownership_assignment, query_history, schema, soda_data_quality, source_info, statistics, structure, tag_assignment, upstream, usage, usage_history)
...
class ChangeRequestKnowledgeCard:
    ...
    def from_dict(obj: Any) -> 'ChangeRequestKnowledgeCard':
        ...
        request_type = from_union([RequestType, from_none], obj.get("requestType"))
        title = from_union([from_str, from_none], obj.get("title"))
        return ChangeRequestKnowledgeCard(message, recipient_id, request_type, title)

    def to_dict(self) -> dict:
        result: dict = {}
        result["message"] = from_union([from_str, from_none], self.message)
        result["recipientId"] = from_union([from_str, from_none], self.recipient_id)
        result["requestType"] = from_union([lambda x: to_enum(RequestType, x), from_none], self.request_type)
        result["title"] = from_union([from_str, from_none], self.title)
        return result
...
class KnowledgeCardDetail:
    ...
    def from_dict(obj: Any) -> 'KnowledgeCardDetail':
        ...
        return KnowledgeCardDetail(asset_description, change_request, column_description, data_document, deprecation, incident, type, usage)
...
class KnowledgeCardInfo:
    ...
    def from_dict(obj: Any) -> 'KnowledgeCardInfo':
        ...
        return KnowledgeCardInfo(created_at, non_anchoring_ids_backing_store, anchor_entity_id, archived, aspect_type, created, knowledge_card_info_created_at, detail, entity_id, hashtags, id, is_draft, last_modified, published, related_entity_ids)
...
class KnowledgeCard:
    ...
    def from_dict(obj: Any) -> 'KnowledgeCard':
        ...
        return KnowledgeCard(created_at, id, asset_contacts, asset_followers, asset_governed_tags, knowledge_card_created_at, deleted_at, display_name, entity_type, knowledge_card_id, knowledge_card_info, knowledge_card_validation, last_ingested_at, last_modified_at, logical_id)
...
class MetricInfo:
    ...
    def from_dict(obj: Any) -> 'MetricInfo':
        ...
        id = from_union([from_str, from_none], obj.get("id"))
        related_entity_ids = from_union([lambda x: from_list(from_str, x), from_none], obj.get("relatedEntityIds"))
        return MetricInfo(created_at, aspect_type, metric_info_created_at, entity_id, id, related_entity_ids)
...
class Metric:
    ...
    def from_dict(obj: Any) -> 'Metric':
        ...
        return Metric(created_at, id, asset_contacts, asset_followers, asset_governed_tags, metric_created_at, dbt_metric, deleted_at, display_name, entity_type, metric_id, last_ingested_at, last_modified_at, logical_id, metric_info)
...
class PersonOrganization:
    ...
    def from_dict(obj: Any) -> 'PersonOrganization':
        ...
        name = from_union([from_str, from_none], obj.get("name"))
        title = from_union([from_str, from_none], obj.get("title"))
        return PersonOrganization(created_at, aspect_type, person_organization_created_at, department, division, employee_number, entity_id, groups, id, manager, name, title)
...
class QueriedDataset:
    ...
    def from_dict(obj: Any) -> 'QueriedDataset':
        ...
        schema = from_union([from_str, from_none], obj.get("schema"))
        table = from_union([from_str, from_none], obj.get("table"))
        return QueriedDataset(columns, database, schema, table)
...
class QueryLog:
    ...
    def from_dict(obj: Any) -> 'QueryLog':
        ...
        return QueryLog(id, account, bytes_read, bytes_written, duration, email, metadata, platform, query_id, rows_read, rows_written, sources, sql, sql_hash, start_time, targets, type, user_id)
