...
def project(project_name, path=None):
  ...
  os.environ['exclusion_variables'] = str([])
  os.environ['inclusion_variables'] = str([])
...
def node(node_name = "", filename = "", lineno = "", node_description="", path=None):
  ...
  print("PREV " +os.environ['prev_node'])
