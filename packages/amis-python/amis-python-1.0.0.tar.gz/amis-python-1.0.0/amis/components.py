...
class Badge(AmisNode):
    ...
    """99  # 设置封顶的数字值"""
    position: str = None
    """"top-right"  # 角标位置， 可以是top-right/top-left/bottom-right/bottom-left"""
    offset: int = None
...
class CollapseGroup(AmisNode):
    ...
    """collapse-group"""
    activeKey: Union[str, int] = None
    """初始化激活面板的key"""
    accordion: bool = None
    """手风琴模式"""
    expandIcon: SchemaNode = None
    """自定义切换图标"""
    expandIconPosition: Literal["left", "right"] = None
...
class Divider(AmisNode):
    ...
    className: str = None
    """外层 Dom 的类名"""
    lineStyle: Literal["dashed", "solid"] = None
...
class Grid(AmisNode):
    ...
    class Column(AmisNode):
        ...
        """"auto"   # 宽度占比： 1 - 12"""
        valign: str = None
        """'top'|'middle'|'bottom'|'between = None # 当前列内容的垂直对齐"""
        body: SchemaNode = None
...
class Grid2D(AmisNode):
    ...
    class Grid(AmisNode):
        ...
        """格子所在行的高度，可以设置 auto"""
        align: Literal['left', 'right', 'center', 'auto'] = None
        """格子内容水平布局"""
        valign: Literal['top', 'middle', 'bottom', 'auto'] = None
        """格子内容垂直布局"""
        body: SchemaNode = None
...
class Pagination(AmisNode):
    """分页"""
    type: str = "pagination"
    mode: Literal["normal", "simple"] = None
...
class Panel(AmisNode):
    ...
    """指定为 Panel 渲染器"""
    className: str = None
    """"panel-default"  # 外层 Dom 的类名"""
    headerClassName: str = None
    """"panel-heading"  # header 区域的类名"""
    footerClassName: str = None
    """"panel-footer bg-light lter wrapper"  # footer 区域的类名"""
    actionsClassName: str = None
    """"panel-footer"  # actions 区域的类名"""
    bodyClassName: str = None
    """"panel-body"  # body 区域的类名"""
    title: SchemaNode = None
    """标题"""
...
class Tabs(AmisNode):
    ...
    class Item(AmisNode):
        ...
        """每次退出都会销毁当前 tab 栏内容"""
        className: str = None
        """"bg-white b-l b-r b-b wrapper-md"  # Tab 区域样式"""
        iconPosition: str = None
        """"left"  # Tab 的图标位置 left / right"""
        closable: bool = None
    ...
    editable: bool = None
    """收否可编辑标签名"""
    sidePosition: Literal['left', 'right'] = None
    """sidebar 模式下，标签栏位置"""
    collapseOnExceed: int = None
    """当 tabs 超出多少个时开始折叠"""
    collapseBtnLabel: str = None
    """用来设置折叠按钮的文字"""
...
class Action(AmisNode):
    ...
    """primary:bool=None"""
    onClick: str = None
    """自定义点击事件 通过字符串形式的 onClick 来定义点击事件，这个字符串会转成 JavaScript 函数"""
...
class Breadcrumb(AmisNode):
    ...
    """最大展示长度"""
    tooltipPosition: Literal['left', 'right', 'top', 'bottom'] = None
    """浮窗提示位置"""
    source: str = None
    """动态数据"""
...
class DropDownButton(AmisNode):
    ...
    """点击按钮后自动关闭下拉菜单"""
    trigger: Literal['hover', 'click'] = None
    """	触发方式"""
    hideCaret: bool = None
    """隐藏下拉图标"""
...
class AnchorNav(AmisNode):
    ...
    class Link(AmisNode):
        ...
        """区域 内容区"""
        className: str = None
        """"bg-white b-l b-r b-b wrapper-md"  # 区域成员 样式"""
    ...
    """links 内容"""
    direction: str = None
    """"vertical"  # 可以配置导航水平展示还是垂直展示。对应的配置项分别是：vertical、horizontal"""
    active: str = None
    """需要定位的区域"""
...
class TooltipWrapper(AmisNode):
    ...
    placement: Literal["top", "right", "bottom", "left"] = None
    """文字提示浮层出现位置"""
    tooltipTheme: Literal["dark", "light"] = None
    """主题样式， 默认为 light"""
...
class InputCity(FormItem):
    ...
    """False  # 是否出搜索框"""
    extractValue: bool = None
    """True#是否抽取值，如果设置成 false 值格式会变成对象，包含 code、province、city和district文字信息。"""
...
class InputColor(FormItem):
    ...
    format: str = None
    """"hex"  # 请选择 hex、hls、rgb或者rgba。"""
    presetColors: List[str] = None
    """"选择器预设颜色值"  # 选择器底部的默认颜色，数组内为空则不显示默认颜色"""
    allowCustomColor: bool = None
    """True  # 为false时只能选择颜色，使用 presetColors 设定颜色选择范围"""
    clearable: bool = None
    """"label"  # 是否显示清除按钮"""
    resetValue: str = None
    """""  # 清除后，表单项值调整成该值"""
...
class Combo(FormItem):
    ...
    delimiter: str = None
    """"False"  # 当扁平化开启并且 joinValues 为 true 时，用什么分隔符。"""
    addable: bool = False
    """是否可新增"""
    addButtonText: str = None
    """"新增"  # 新增按钮文字"""
    ...
    """"确认要删除？"  # 当配置 deleteApi 才生效！删除时用来做用户确认"""
    draggable: bool = False
    """是否可以拖动排序, 需要注意的是当启用拖动排序的时候，会多一个$id 字段"""
    draggableTip: str = None
    """"可通过拖动每行中的【交换】按钮进行顺序调整"  # 可拖拽的提示文字"""
    subFormMode: str = None
    """"normal"  # 可选normal、horizontal、inline"""
    placeholder: str = None
    """"``"  # 没有成员时显示。"""
...
class Editor(FormItem):
    ...
    size: Literal['md', 'lg', 'xl', 'xxl'] = None
...
class InputFile(FormItem):
    ...
    """上传文件接口"""
    accept: str = None
    """"text/plain"  # 默认只支持纯文本，要支持其他类型，请配置此属性为文件后缀.xxx"""
    asBase64: bool = None
    """False  # 将文件以base64的形式，赋值给当前组件"""
    asBlob: bool = None
    """False  # 将文件以二进制的形式，赋值给当前组件"""
    maxSize: int = None
    ...
    fileField: str = None
    """"file"  # 如果你不想自己存储，则可以忽略此属性。"""
    nameField: str = None
    """"name"  # 接口返回哪个字段用来标识文件名"""
    valueField: str = None
    """"value"  # 文件的值用那个字段来标识。"""
    urlField: str = None
    """"url"  # 文件下载地址的字段名。"""
...
class Group(InputGroup):
    ...
    direction: str = None
    """"horizontal"  # 可以配置水平展示还是垂直展示。对应的配置项分别是：vertical、horizontal"""
...
class InputImage(FormItem):
    ...
    """上传文件接口"""
    accept: str = None
    """".jpeg,.jpg,.png,.gif"  # 支持的图片类型格式，请配置此属性为图片后缀，例如.jpg,.png"""
    maxSize: int = None
    """默认没有限制，当设置后，文件大小大于此值将不允许上传。单位为B"""
    maxLength: int = None
    """默认没有限制，当设置后，一次只允许上传指定数量文件。"""
    ...
    """1  # 裁剪文件格式的质量，用于 jpeg/webp，取值在 0 和 1 之间"""
    limit: Limit = None
    """限制图片大小，超出不让上传。"""
    frameImage: str = None
    """默认占位图地址"""
...
class MatrixCheckboxes(FormItem):
    ...
    multiple: bool = None
    """是否多选"""
    singleSelectMode: Literal['cell', 'row', 'column'] = None
...
class Static(FormItem):
    """静态展示/标签"""
    type: str = 'static'
    """支持通过配置type为static-xxx的形式，展示其他 非表单项 组件 static-json|static-datetime"""
...
class Select(FormItem):
    ...
    """移动端浮层类名"""
    selectMode: Literal['group', 'table', 'tree', 'chained', 'associated'] = None
    ...
    leftMode: Literal['list', 'tree'] = None
...
class InputMonth(FormItem):
    ...
    """默认值"""
    format: str = None
    """"X"  # 月份选择器值格式，更多格式类型请参考 moment"""
    inputFormat: str = None
    """"YYYY-MM"  # 月份选择器显示格式，即时间戳格式，更多格式类型请参考 moment"""
    placeholder: str = None
    """"请选择月份"  # 占位文本"""
    clearable: bool = None
    """True  # 是否可清除"""
...
class InputTime(FormItem):
    ...
    """默认值"""
    timeFormat: str = None
    """"HH:mm"  # 时间选择器值格式，更多格式类型请参考 moment"""
    format: str = None
    """"X"  # 时间选择器值格式，更多格式类型请参考 moment"""
    inputFormat: str = None
    """"HH:mm"  # 时间选择器显示格式，即时间戳格式，更多格式类型请参考 moment"""
    placeholder: str = None
    """"请选择时间"  # 占位文本"""
    clearable: bool = None
    """True  # 是否可清除"""
    timeConstraints: dict = None
    """True  # 请参考： react-datetime"""
...
class InputDatetime(FormItem):
    ...
    """默认值"""
    format: str = None
    """"X"  # 日期时间选择器值格式，更多格式类型请参考 文档"""
    inputFormat: str = None
    """"YYYY-MM-DD HH:mm:ss"  # 日期时间选择器显示格式，即时间戳格式，更多格式类型请参考 文档"""
    placeholder: str = None
    """"请选择日期以及时间"  # 占位文本"""
    shortcuts: str = None
    """日期时间快捷键"""
...
class InputDate(FormItem):
    ...
    """默认值"""
    format: str = None
    """"X"  # 日期选择器值格式，更多格式类型请参考 文档"""
    inputFormat: str = None
    """"YYYY-DD-MM"  # 日期选择器显示格式，即时间戳格式，更多格式类型请参考 文档"""
    placeholder: str = None
    """"请选择日期"  # 占位文本"""
    shortcuts: str = None
    """日期快捷键"""
    ...
    """False  # 点选日期后，是否马上关闭选择框"""
    schedules: Union[list, str] = None
    """日历中展示日程，可设置静态数据或从上下文中取数据，className参考背景色"""
...
class InputRating(FormItem):
    ...
    textPosition: Literal['right', 'left'] = None
    """文字的位置"""
    char: str = None
    """自定义字符"""
    className: str = None
...
class InputRange(FormItem):
    ...
    """是否显示滑块标签"""
    tooltipPlacement: Literal["auto", "bottom", "left", "right"] = None
...
class InputDatetimeRange(InputTimeRange):
    ...
    """"yesterday,7daysago,prevweek,thismonth,prevmonth,prevquarter" 日期范围快捷键，"""
...
class InputYearRange(InputDateRange):
    """年份范围"""
...
class InputFormula(FormItem):
    ...
    variables: dict = None
    """可用变量"""
    variableMode: Literal['tabs', 'list', 'tree'] = None
...
class InputTree(FormItem):
    ...
    """配置删除选项接口"""
    searchable: bool = None
    """False  # 是否可检索，仅在 type 为 tree-select 的时候生效"""
    hideRoot: bool = None
    """True  # 如果想要显示个顶级节点，请设置为 false"""
    rootLabel: bool = None
    """"顶级"  # 当 hideRoot 不为 false 时有用，用来设置顶级节点的文字。"""
    showIcon: bool = None
    """True  # 是否显示图标"""
    showRadio: bool = None
    """False  # 是否显示单选按钮，multiple 为 false 是有效。"""
    initiallyOpen: bool = None
    """True  # 设置是否默认展开所有层级。"""
    unfoldedLevel: int = None
    """0  # 设置默认展开的级数，只有initiallyOpen不是true时生效。"""
    cascade: bool = None
    """False  # 当选中父节点时不自动选择子节点。"""
    withChildren: bool = None
    """False  # 选中父节点时，值里面将包含子节点的值，否则只会保留父节点的值。"""
    onlyChildren: bool = None
    """False  # 多选时，选中父节点时，是否只将其子节点加入到值中。"""
...
class Image(AmisNode):
    ...
    """放大预览的描述"""
    thumbMode: str = None
    """"contain"  # 预览图模式，可选：'w-full','h-full','contain','cover'"""
    thumbRatio: str = None
    """"1:1"  # 预览图比例，可选：'1:1','4:3','16:9'"""
    imageMode: str = None
    """"thumb"  # 图片展示模式，可选：'thumb','original' 即：缩略图模式 或者 原图模式"""
...
class Carousel(AmisNode):
    ...
    """"['dots','arrows']"  # 显示左右箭头、底部圆点索引"""
    controlsTheme: str = None
    """"light"  # 左右箭头、底部圆点索引颜色，默认light，另有dark模式"""
    animation: str = None
    """"fade"  # 切换动画效果，默认fade，另有slide模式"""
    thumbMode: str = None
    """"cover"|"contain"  # 图片默认缩放模式"""
...
class CRUD(AmisNode):
    ...
    """True  # 在开启 loadDataOnce 时，filter 时是否去重新请求 api"""
    source: str = None
    ...
    """True  # 设置过滤器默认是否可见。"""
    initFetch: bool = None
    """True  # 是否初始化的时候拉取数据, 只针对有 filter 的情况, 没有 filter 初始都会拉取数据"""
    interval: int = None
    """刷新时间(最低 1000)"""
    silentPolling: bool = None
    """配置刷新时是否隐藏加载动画"""
    ...
    """False  # 是否将过滤条件的参数同步到地址栏, !!!开启后可能改变数据类型,无法通过fastpi数据校验"""
    draggable: bool = None
    """是否可通过拖拽排序"""
    ...
    """"perPage"  # 设置分页一页显示的多少条数据的字段名。注意：最好与 defaultParams 一起使用，请看下面例子。"""
    perPageAvailable: List[int] = None
    """[5, 10, 20, 50, 100]  # 设置一页显示多少条数据下拉框可选条数。"""
    orderField: str = None
    ...
    """['bulkActions','pagination']  # 顶部工具栏配置"""
    footerToolbar: list = None
    """['statistics','pagination']  # 底部工具栏配置"""
...
class Table(AmisNode):
    ...
    """"auto"  # 展示列显示开关, 自动即：列数量大于或等于 5 个时自动开启"""
    placeholder: str = None
    """"暂无数据"  # 当没数据的时候的文字提示"""
    className: str = None
    """"panel-default"  # 外层 CSS 类名"""
    tableClassName: str = None
    """"table-db table-striped"  # 表格 CSS 类名"""
    headerClassName: str = None
    """"Action.md-table-header"  # 顶部外层 CSS 类名"""
    footerClassName: str = None
    """"Action.md-table-footer"  # 底部外层 CSS 类名"""
    toolbarClassName: str = None
    """"Action.md-table-toolbar"  # 工具栏 CSS 类名"""
    ...
    """列太多时，内容没办法全部显示完，可以让部分信息在底部显示，可以让用户展开查看详情。"""
...
class Card(AmisNode):
    ...
    class Header(AmisNode):
        ...
        highlight: Union[bool, Template] = None
...
class Json(AmisNode):
    ...
    """1  # 默认展开的层级"""
    jsonTheme: str = None
    """"twilight"  # 主题，可选twilight和eighties"""
    mutable: bool = None
    """False  # 是否可修改"""
...
class Mapping(AmisNode):
    """映射"""
    type: str = "mapping"
    """如果在 Table、Card 和 List 中，为"mapping"；在 Form 中用作静态展示，为"static-mapping"""
    className: str = None
    """外层 CSS 类名"""
    placeholder: str = None
    """占位文本"""
...
class Progress(AmisNode):
    """进度条"""
    type: str = "progress"
    """如果在 Form 中用作静态展示，为"static-progress" """
    mode: Literal['line', 'circle', 'dashboard'] = None
    """进度条的类型"""
    className: str = None
    """外层 CSS 类名"""
    value: int = None
    ...
    animated: bool = None
    """	type 为 line，可支持动画"""
    map: Union[str, List[Union[str, dict]]] = None
    """进度颜色映射"""
    ...
    gapDegree: int = None
    """仪表盘缺角角度，可取值 0 ~ 295"""
    gapPosition: Literal['top', 'bottom', 'left', 'right'] = None
    """仪表盘进度条缺口位置"""
...
class Steps(AmisNode):
    ...
    className: str = None
    """自定义类名"""
    mode: Literal['horizontal', 'vertical'] = None
    """指定步骤条方向。目前支持水平（horizontal）和竖直（vertical）两种方向"""
    labelPlacement: Literal['horizontal', 'vertical'] = None
...
class Property(AmisNode):
    ...
    """3  # 每行几列"""
    mode: str = None
    """'table'  # 显示模式，目前只有 'table' 和 'simple'"""
    separator: str = None
...
class Tag(AmisNode):
    """标签"""
    type: str = 'tag'
    displayMode: Literal['normal', 'rounded', 'status'] = None
    """展现模式"""
    color: str = None
...
class Video(AmisNode):
    ...
    """视频地址"""
    isLive: bool = None
    """False  # 是否为直播，视频为直播时需要添加上，支持flv和hls格式"""
    videoType: str = None
    """指定直播视频格式"""
    poster: str = None
    """视频封面地址"""
...
class Alert(AmisNode):
    ...
    """外层 Dom 的类名"""
    level: str = None
    """"info"  # 级别，可以是：info、success、warning 或者 danger"""
    body: SchemaNode = None
    """显示内容"""
...
class Drawer(AmisNode):
    ...
    """'left'  # 位置"""
    bodyClassName: str = None
    """"modal-body"  # Drawer body 区域的样式类名"""
    closeOnEsc: bool = None
    """False  # 是否支持按 Esc 关闭 Drawer"""
    closeOnOutside: bool = None
    """False  # 点击内容区外是否关闭 Drawer"""
    overlay: bool = None
    """True  # 是否显示蒙层"""
    resizable: bool = None
    """False  # 是否可通过拖拽改变 Drawer 大小"""
    actions: List[Action] = None
...
class Tasks(AmisNode):
    ...
    interval: int = None
    """3000  # 当有任务进行中，会每隔一段时间再次检测，而时间间隔就是通过此项配置，默认 3s。"""
    ...
    """"重试"  # 重试操作按钮文字"""
    btnClassName: str = None
    """"btn-sm btn-default"  # 配置容器按钮 className"""
    retryBtnClassName: str = None
    """"btn-sm btn-danger"  # 配置容器重试按钮 className"""
    ...
    """"["未开始", "就绪", "进行中", "出错", "已完成", "出错"]" # 状态显示对应的文字显示配置"""
...
class Wizard(AmisNode):
    ...
    """指定为 Wizard 组件"""
    mode: str = None
    """"horizontal"  # 展示模式，选择：horizontal 或者 vertical"""
    api: API = None
    """最后一步保存的接口。"""
    initApi: API = None
    """初始化数据接口"""
    ...
    """"btn-sm btn-default"  # 按钮 CSS 类名"""
    reload: str = None
    """操作完后刷新目标对象。请填写目标组件设置的 name 值，如果填写为 window 则让当前页面整体刷新。"""
    redirect: Template = None
    """"3000"  # 操作完后跳转。"""
    target: str = None
    """"False"  # 可以把数据提交给别的组件而不是自己保存。请填写目标组件设置的 name 值，"""

    """如果填写为 window 则把数据同步到地址栏上，同时依赖这些数据的组件会自动重新刷新。"""
    steps: List[Step] = None
    """数组，配置步骤信息"""
    startStep: int = None
    """"1"  # 起始默认值，从第几步开始。可支持模版，但是只有在组件创建时渲染模版并设置当前步数，在之后组件被刷新时，"""
