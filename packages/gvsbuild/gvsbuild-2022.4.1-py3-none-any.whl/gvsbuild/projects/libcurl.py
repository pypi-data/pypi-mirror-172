...
class Libcurl(Tarball, CmakeProject):
    def __init__(self):
        Project.__init__(
            self,
            "libcurl",
            archive_url="https://github.com/curl/curl/releases/download/curl-7_85_0/curl-7.85.0.tar.xz",
            hash="88b54a6d4b9a48cb4d873c7056dcba997ddd5b7be5a2d537a4acb55c20b04be6",
            dependencies=[
                "perl",
                "cmake",
                "ninja",
