...
{'': ['*'],
 'gvsbuild': ['patches/*',
              ...
              'patches/cairo/*',
              'patches/cairo/build/*',
              'patches/cairo/pc-files/*',
              'patches/cairo/util/cairo-gobject/*',
              'patches/check-libs/*',
...
extras_require = \
{'outdated': ['lastversion>=2.4.2,<3.0.0', 'packaging>=21.3,<22.0']}

entry_points = \
{'console_scripts': ['gvsbuild = gvsbuild.main:build']}
