...
class SwaggerUi(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SwaggerUi.__init__)
...
class SwaggerUiProps:
    def __init__(self, *, resource: aws_cdk.aws_apigateway.IResource) -> None:
        '''
        :param resource: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SwaggerUiProps.__init__)
    ...
    @builtins.property
    def resource(self) -> aws_cdk.aws_apigateway.IResource:
