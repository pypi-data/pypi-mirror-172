...
class MonthDetail(object):
    ...
    def __init__(self, activity=None, age_of_money=None, budgeted=None, deleted=None, income=None, month=None, note=None, to_be_budgeted=None, categories=None):  # noqa: E501
