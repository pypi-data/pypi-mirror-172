...
import json
from typing import Any, cast, Dict, List, Optional, Set, Tuple, Type, TYPE_CHECKING, TypeVar, Union
import warnings
...
class Project(APIObject, BrowserMixin):
    ...
    def set_options(self, options: Optional[AdvancedOptions] = None, **kwargs) -> None:
...
OR individual keyword arguments. You cannot pass both."
    ...
    def _reconcile_options(
        ...
        **kwargs,
        ...
        options_warn_non_persistable: Set = set()
    ...
    @deprecated(
        ...
        will_remove_version="3.1",
        message="The method 'set_advanced_options' is deprecated. Please use the method 'set_options' instead.",
    )
    def set_advanced_options(self, advanced_options: AdvancedOptions = None, **kwargs) -> None:
        """Update the advanced options of this project.
        ...
        Either accepts an AdvancedOptions object to replace all advanced options or indiviudal keyword
