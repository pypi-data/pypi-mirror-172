...
class TypeScriptProject(
    ...
    def __init__(
        ...
        *,
        ...
        projenrc_ts_options: typing.Optional[typing.Union[ProjenrcOptions, typing.Dict[str, typing.Any]]] = None,
...
class TypeScriptProjectOptions(_NodeProjectOptions_d12f6f3b):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(TypeScriptProjectOptions.__init__)
...
class TypedocDocgen(
    ...
    def __init__(self, project: TypeScriptProject) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TypedocDocgen.__init__)
            check_type(argname="argument project", value=project, expected_type=type_hints["project"])
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(tsconfig_dev, dict):
            tsconfig_dev = _TypescriptConfigOptions_8c5492cd(**tsconfig_dev)
        if __debug__:
            type_hints = typing.get_type_hints(TypeScriptLibraryProjectOptions.__init__)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument commit_generated", value=commit_generated, expected_type=type_hints["commit_generated"])
            check_type(argname="argument logging", value=logging, expected_type=type_hints["logging"])
            check_type(argname="argument outdir", value=outdir, expected_type=type_hints["outdir"])
