...
class ConstructLibraryCdktf(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param cdktf_version: (experimental) Minimum target version this library is tested against. Default: "^0.8.3"
...
class ConstructLibraryCdktfOptions(_ConstructLibraryOptions_dcd2adc0):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ConstructLibraryCdktfOptions.__init__)
