...
from picsellia.exceptions import BadConfigurationScan, FileNotFoundException
...
class Project(Dao):
    ...
    @beartype
    def update(
        self, name: str = None, description: str = None, private: bool = None
    ) -> None:
    ...
    def create_scan(
        ...
        max_run: int = 1,
        requirements: Union[List[dict], str] = None,
    ...
    def create_scan_from_config(
        ...
        config: dict,
        image: str = None,
        path_script_file: str = None,
        files: List[str] = None,
        base_model: ModelVersion = None,
        base_dataset: DatasetVersion = None,
    ) -> Scan:
