...
setup(
    name="image_processing-test-package",
    version="0.0.2",
    author="Adriano Romero",
    author_email="adriano.romerofco@gmail.com",
    ...
    url="https://github.com/ogihromero/image-processing-package",
