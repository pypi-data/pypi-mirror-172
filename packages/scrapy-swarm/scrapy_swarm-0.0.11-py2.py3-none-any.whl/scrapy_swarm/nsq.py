...
from scrapy_swarm.utils import TextColor
...
class NsqHelper:
    ...
    @classmethod
    def register(cls, redis_key, spider):
        cls.mutex.acquire()
        spiders_map[redis_key] = spider
        cls.mutex.release()
