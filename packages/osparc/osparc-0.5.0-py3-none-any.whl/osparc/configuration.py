...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of osparc.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the osparc.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = osparc.Configuration(
        signing_info = osparc.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("osparc")
