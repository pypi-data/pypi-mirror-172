...
class UsersGroup(object):
    ...
    """
    openapi_types = {"gid": "str", "label": "str", "description": "str"}

    attribute_map = {"gid": "gid", "label": "label", "description": "description"}

    def __init__(
        self, gid=None, label=None, description=None, local_vars_configuration=None
    ):  # noqa: E501
