...
echo "python3 accuracy.py --dataset_guess=files/names/names_inter/intermales.csv --dataset_test=files/names/names_tests/fifa.csv --measure=accuracy --api=damegender > files/logs/accuracy-inter-males-$(date "+%Y-%m-%d").txt"

python3 accuracy.py --dataset_guess=files/names/names_inter/intermales.csv --dataset_test=files/names/names_tests/fifa.csv --dataset_guess_row_name=3 --dataset_guess_row_gender=185 --dataset_guess_delimiter=; --measure=accuracy --api=damegender > files/logs/accuracy-inter-males-$(date "+%Y-%m-%d").txt
