...
class Fastapi(Driver):
    def __init__(self, service_name: str, service_version: str, on_startup: Sequence[Callable], connection_details: ConnectionDetails = None,
                 verbosity: int = 0):
    ...
    def sentry(self):
        # This function is likely no longer needed now that Sentry supports FastAPI directly
        pass
        # self.instance.add_middleware(SentryAsgiMiddleware)
