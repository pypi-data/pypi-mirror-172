            ...
            if export == True:
                ...
                for t in target:
                    ...
                    if location_check == True:
                        ...
                        color_print_green("  ├  Users within 3000m: ", str(d_4000))
                        color_print_green("  ├  Users within 3000m: ", str(d_5000))
                        color_print_green("  ├  Users within 3000m: ", str(d_6000))
                        color_print_green("  ├  Users within 3000m: ", str(d_7000))
                        color_print_green("  ├  Users within 3000m: ", str(d_8000))
                        color_print_green("  ├  Users within 3000m: ", str(d_9000))
                        color_print_green("  ├  Users within 3000m: ", str(d_10000))
