                    ...
                    if location_check == True:
                        ...
                        for user in result.updates[0].peers:
                            try:
                                ...
                                locations_list.append([ID, distance, longitude, latitude, filetime])
                        ...
                        for account, distance, longitude, latitude, filetime in user_df.itertuples(index=False):
                            account = int(account)
