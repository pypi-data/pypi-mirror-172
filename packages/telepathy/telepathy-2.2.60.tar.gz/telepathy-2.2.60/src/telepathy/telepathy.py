            ...
            if export == True:
                ...
                for t in target:
                    ...
                    if location_check == True:
                        ...
                        color_print_green("  ├  Users within 1,000m: ", str(d_1000))
                        color_print_green("  ├  Users within 2,000m: ", str(d_2000))
                        color_print_green("  ├  Users within 3,000m: ", str(d_3000))
                        color_print_green("  ├  Users within 4,000m: ", str(d_4000))
                        color_print_green("  ├  Users within 5,000m: ", str(d_5000))
                        color_print_green("  ├  Users within 6,000m: ", str(d_6000))
                        color_print_green("  ├  Users within 7,000m: ", str(d_7000))
                        color_print_green("  ├  Users within 8,000m: ", str(d_8000))
                        color_print_green("  ├  Users within 9,000m: ", str(d_9000))
                        color_print_green("  ├  Users within 10,000m: ", str(d_10000))
