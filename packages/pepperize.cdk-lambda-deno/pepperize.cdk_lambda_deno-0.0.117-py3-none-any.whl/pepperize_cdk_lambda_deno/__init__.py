...
class DenoFunction(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DenoFunction.__init__)
...
class DenoFunctionProps(aws_cdk.aws_lambda.FunctionOptions):
    def __init__(
        self,
        *,
        max_event_age: typing.Optional[aws_cdk.Duration] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DenoFunctionProps.__init__)
...
class DenoLayer(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DenoLayer.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def get_or_create(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DenoLayer.get_or_create)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        options = DenoLayerOptions(version=version)
...
class DenoLayerOptions:
    def __init__(self, *, version: typing.Optional["DenoVersion"] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DenoLayerOptions.__init__)
            check_type(argname="argument version", value=version, expected_type=type_hints["version"])
        self._values: typing.Dict[str, typing.Any] = {}
        if version is not None:
            self._values["version"] = version
...
class DenoVersion(
    ...
    def of(cls, version: builtins.str) -> "DenoVersion":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DenoVersion.of)
            check_type(argname="argument version", value=version, expected_type=type_hints["version"])
