...
class AccountViewSetTestCase(KalmonakAPITestCase):
...
class IdentityViewSetTestCase(KalmonakAPITestCase):
...
class AliasViewSetTestCase(KalmonakAPITestCase):
...
class UserAccountViewSetTestCase(KalmonakAPITestCase):
...
class AlarmViewSetTestCase(KalmonakAPITestCase):
