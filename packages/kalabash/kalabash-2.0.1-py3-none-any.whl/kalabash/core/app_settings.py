...
from kalabash.core.password_hashers import get_dovecot_schemes
from kalabash.core.password_hashers.base import PasswordHasher
...
class GeneralParametersForm(param_forms.AdminParametersForm):
    ...
    enable_api_communication = YesNoField(
        ...
        initial=True,
        help_text=ugettext_lazy(
            "Enable communication with Kalabash public API")
    )
