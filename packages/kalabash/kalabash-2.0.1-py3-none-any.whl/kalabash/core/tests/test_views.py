...
class LoginTestCase(KalmonakTestCase):
...
class DashboardTestCase(KalmonakTestCase):
    """Dashboard tests."""
...
class SettingsTestCase(KalmonakTestCase):
    """Settings tests."""
...
class PreferencesTestCase(KalmonakTestCase):
