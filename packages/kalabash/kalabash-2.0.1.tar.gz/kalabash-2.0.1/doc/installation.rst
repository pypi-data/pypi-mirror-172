...
.. note:: **👀 Heads up for kalabash versions 1.15 and later**
   
   Python 2 support has been dropped with kalabash version 1.15. 
   If you still have Python 2 installed on your system either uninstall it 
   or force kalabash user to run with Python 3.

Recommended way
===============

If you start from scratch and want to deploy a complete mail server,
you will love the `kalabash installer
<https://github.com/amonak/kalinstall>`_! It is the easiest
and the quickest way to setup a fully functional server (kalabash,
...
.. warning::
   ...
   another Linux or a UNIX system, you will have to install Kalabash
...
.. sourcecode:: bash        
  ...
  > git clone https://github.com/amonak/kalinstall
  > cd kalinstall
