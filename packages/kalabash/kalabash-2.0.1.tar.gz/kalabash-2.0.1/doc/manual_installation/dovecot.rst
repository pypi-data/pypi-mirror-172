...
And add the following line inside::
  ...
  * * * * * python <kalabash_site>/manage.py handle_mailbox_operations
...
A working copy of this trigger is available on `Github <https://raw.githubusercontent.com/amonak/kalinstall/master/kalinstall/scripts/files/dovecot/install_kalabash_postgres_trigger.sql>`_.
