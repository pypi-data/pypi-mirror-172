...
from kalabash.lib.tests import NO_LDAP, KalmonakTestCase
...
class AccountTestCase(KalmonakTestCase):
    ...
    def test_crud(self):
        values = {
            ...
            "password2": "Toto1234", "role": "StandardUsers", "quota_act": True,
    ...
    def test_random_password(self):
        ...
        values = {
            "username": "tester@test.com",
            "first_name": "Tester", "last_name": "Toto",
            "random_password": True, "role": "StandardUsers",
            "quota_act": True, "is_active": True, "email": "tester@test.com",
            "stepid": "step2"
        }
        self.ajax_post(reverse("admin:account_add"), values)
    ...
    def test_sender_address(self):
        ...
        values = {
            ...
            "last_name": "Toto", "role": "StandardUsers",
    ...
    def test_conflicts(self):
        ...
        values = {
            ...
            "role": "StandardUsers", "quota_act": True,
            "is_active": True, "email": "user@test.com",
            "stepid": "step2"
        }
...
class LDAPAccountTestCase(test_ldap.LDAPTestCaseMixin, KalmonakTestCase):
...
class PermissionsTestCase(KalmonakTestCase):
    ...
    def test_domainadmin_master_user(self):
        ...
        values = {
            ...
            "password2": "Toto1234", "role": "StandardUsers", "is_active": True,
