...
class KalmonakTestCase(ParametersMixin, TestCase):
    """All test cases must inherit from this one."""

    @classmethod
    def setUpTestData(cls):  # noqa
        """Create a default user."""
        super(KalmonakTestCase, cls).setUpTestData()
...
class KalmonakAPITestCase(ParametersMixin, APITestCase):
    """All test cases must inherit from this one."""

    @classmethod
    def setUpTestData(cls):  # noqa
        """Create a default user."""
        super(KalmonakAPITestCase, cls).setUpTestData()
        management.call_command("load_initial_data")
    ...
    def setUp(self):
        """Setup."""
        super(KalmonakAPITestCase, self).setUp()
