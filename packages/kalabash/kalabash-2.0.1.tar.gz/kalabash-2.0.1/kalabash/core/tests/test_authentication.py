...
from kalabash.core.password_hashers import (
    get_password_hasher, get_dovecot_schemes
)
from kalabash.lib.tests import NO_SMTP, KalmonakTestCase
...
class PasswordResetTestCase(KalmonakTestCase):
...
class SMTPAuthenticationTestCase(KalmonakTestCase):
