...
from kalabash.lib.api_client import KalmonakAPIClient
...
class DeployCommand(Command):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._parser.add_argument("name", type=str,
                                  help="The name of your Kalabash instance")
    ...
    def _get_extension_list(self):
        ...
        official_exts = KalmonakAPIClient(url).list_extensions()
    ...
    def handle(self, parsed_args):
        ...
        if parsed_args.domain:
            ...
            allowed_host = input(
                "What will be the hostname used to access Kalabash? ")
            if not allowed_host:
