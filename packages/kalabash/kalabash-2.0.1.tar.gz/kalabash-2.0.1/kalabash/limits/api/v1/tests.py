...
class APIAdminLimitsTestCase(lib_tests.KalmonakAPITestCase):
...
class APIDomainLimitsTestCase(lib_tests.KalmonakAPITestCase):
    """Check that limits are used also by the API."""
...
class ResourcesAPITestCase(lib_tests.KalmonakAPITestCase):
    """Check resources API."""
