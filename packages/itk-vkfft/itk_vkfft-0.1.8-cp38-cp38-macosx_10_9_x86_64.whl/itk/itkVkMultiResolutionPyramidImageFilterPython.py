...
def vk_multi_resolution_pyramid_image_filter(*args: itkt.ImageLike,  metric_threshold: Union[float, Sequence[int]]=..., number_of_levels: int=..., schedule=..., starting_shrink_factors: int=..., maximum_error: float=..., use_shrink_image_filter: bool=...,**kwargs)-> itkt.ImageSourceReturn:
