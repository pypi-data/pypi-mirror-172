...
class itkVkInverse1DFFTImageFilterICD2(itk.itkInverse1DFFTImageFilterPython.itkInverse1DFFTImageFilterICD2):
    ...
    SetUseVkGlobalConfiguration = _swig_new_instance_method(_itkVkInverse1DFFTImageFilterPython.itkVkInverse1DFFTImageFilterICD2_SetUseVkGlobalConfiguration)
    GetUseVkGlobalConfiguration = _swig_new_instance_method(_itkVkInverse1DFFTImageFilterPython.itkVkInverse1DFFTImageFilterICD2_GetUseVkGlobalConfiguration)
...
class itkVkInverse1DFFTImageFilterICD3(itk.itkInverse1DFFTImageFilterPython.itkInverse1DFFTImageFilterICD3):
    ...
    SetUseVkGlobalConfiguration = _swig_new_instance_method(_itkVkInverse1DFFTImageFilterPython.itkVkInverse1DFFTImageFilterICD3_SetUseVkGlobalConfiguration)
    GetUseVkGlobalConfiguration = _swig_new_instance_method(_itkVkInverse1DFFTImageFilterPython.itkVkInverse1DFFTImageFilterICD3_GetUseVkGlobalConfiguration)
...
class itkVkInverse1DFFTImageFilterICF2(itk.itkInverse1DFFTImageFilterPython.itkInverse1DFFTImageFilterICF2):
    ...
    SetUseVkGlobalConfiguration = _swig_new_instance_method(_itkVkInverse1DFFTImageFilterPython.itkVkInverse1DFFTImageFilterICF2_SetUseVkGlobalConfiguration)
    GetUseVkGlobalConfiguration = _swig_new_instance_method(_itkVkInverse1DFFTImageFilterPython.itkVkInverse1DFFTImageFilterICF2_GetUseVkGlobalConfiguration)
...
class itkVkInverse1DFFTImageFilterICF3(itk.itkInverse1DFFTImageFilterPython.itkInverse1DFFTImageFilterICF3):
    ...
    SetUseVkGlobalConfiguration = _swig_new_instance_method(_itkVkInverse1DFFTImageFilterPython.itkVkInverse1DFFTImageFilterICF3_SetUseVkGlobalConfiguration)
    GetUseVkGlobalConfiguration = _swig_new_instance_method(_itkVkInverse1DFFTImageFilterPython.itkVkInverse1DFFTImageFilterICF3_GetUseVkGlobalConfiguration)
...
def vk_inverse1_dfft_image_filter(*args: itkt.ImageLike,  use_vk_global_configuration: bool=..., device_id: int=..., direction: int=...,**kwargs)-> itkt.ImageSourceReturn:
