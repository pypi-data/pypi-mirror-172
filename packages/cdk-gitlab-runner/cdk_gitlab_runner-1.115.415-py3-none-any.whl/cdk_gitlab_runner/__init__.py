...
class DockerVolumes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DockerVolumes.__init__)
...
class GitlabContainerRunner(
    ...
    def __init__(
        ...
        *,
        ...
        docker_volumes: typing.Optional[typing.Sequence[typing.Union[DockerVolumes, typing.Dict[str, typing.Any]]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitlabContainerRunner.__init__)
    ...
    def create_user_data(
        self,
        props: typing.Union["GitlabContainerRunnerProps", typing.Dict[str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitlabContainerRunner.create_user_data)
    ...
    def expire_after(self, duration: aws_cdk.core.Duration) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GitlabContainerRunner.expire_after)
...
class GitlabContainerRunnerProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GitlabContainerRunnerProps.__init__)
