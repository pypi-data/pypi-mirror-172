## Code taken from https://github.com/Zabamund/wellpathpy was modified.
...
def min_curve_method(md, inc, azi, md_units='ft', norm_opt=0,surface_northing=0,surface_easting=0, rte=0, crs=None):
    """
