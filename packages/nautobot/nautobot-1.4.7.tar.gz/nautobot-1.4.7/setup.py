...
{'': ['*'],
 'nautobot': ['docs/*',
              ...
              'docs/apps/*',
              'docs/assets/*',
              'docs/assets/app-icons/*',
              'docs/assets/overrides/partials/*',
              'docs/configuration/*',
              ...
              'project-static/css/*',
              'project-static/docs/*',
              'project-static/docs/additional-features/*',
              'project-static/docs/administration/*',
              'project-static/docs/apps/*',
              'project-static/docs/assets/*',
              'project-static/docs/assets/app-icons/*',
              'project-static/docs/assets/images/*',
              'project-static/docs/assets/javascripts/*',
              'project-static/docs/assets/javascripts/lunr/*',
              'project-static/docs/assets/javascripts/lunr/min/*',
              'project-static/docs/assets/javascripts/workers/*',
              'project-static/docs/assets/overrides/partials/*',
              'project-static/docs/assets/stylesheets/*',
              'project-static/docs/configuration/*',
              'project-static/docs/configuration/authentication/*',
              'project-static/docs/core-functionality/*',
              'project-static/docs/development/*',
              'project-static/docs/docker/*',
              'project-static/docs/img/*',
              'project-static/docs/installation/*',
              'project-static/docs/media/*',
              'project-static/docs/media/development/*',
              'project-static/docs/media/installation/*',
              'project-static/docs/media/models/*',
              'project-static/docs/media/plugins/*',
              'project-static/docs/models/circuits/*',
              'project-static/docs/models/dcim/*',
              'project-static/docs/models/extras/*',
              'project-static/docs/models/ipam/*',
              'project-static/docs/models/tenancy/*',
              'project-static/docs/models/users/*',
              'project-static/docs/models/virtualization/*',
              'project-static/docs/plugins/*',
              'project-static/docs/release-notes/*',
              'project-static/docs/rest-api/*',
              'project-static/docs/search/*',
              'project-static/docs/user-guides/*',
              'project-static/docs/user-guides/getting-started/*',
              'project-static/docs/user-guides/images/getting-started-nautobot-ui/*',
              'project-static/docs/user-guides/images/git-as-data-source/*',
              'project-static/docs/user-guides/images/graphql/*',
...
['Django>=3.2.15,<3.3.0',
 ...
 'drf-spectacular[sidecar]>=0.24.0,<0.25.0',
