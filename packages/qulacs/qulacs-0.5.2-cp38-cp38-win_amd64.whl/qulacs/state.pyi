...
@overload
def permutate_qubit(state: qulacs_core.QuantumState, order: List[int]) -> qulacs_core.QuantumState: ...
@overload
def permutate_qubit(state: qulacs_core.DensityMatrix, order: List[int]) -> qulacs_core.DensityMatrix: ...
@overload
