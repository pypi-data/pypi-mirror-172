...
APP_NAME = (
    "psu_calendar Demo Application"  # Displayed in some generic UI scenarios
)
...
SECRET_KEY = "django-insecure-j7!q997d+(6a%yyq9q%$1cny=&cn1gb!&95*phqokdch*tb7a3"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "libraries": {
                "psu_calendar_taglib": "psu_calendar.templatetags.psu_calendar_taglib",
            },
        },
    },
]
...
if is_aws:
    ...
    SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-j7!q997d+(6a%yyq9q%$1cny=&cn1gb!&95*phqokdch*tb7a3")
