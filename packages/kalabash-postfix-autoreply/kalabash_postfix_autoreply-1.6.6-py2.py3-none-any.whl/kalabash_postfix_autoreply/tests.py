...
class EventsTestCase(KalmonakTestCase):
...
class FormTestCase(KalmonakTestCase):
...
class RepairTestCase(KalmonakTestCase):
    ...
    def test_management_command(self):
        ...
        management.call_command("kalmonak", "repair", "--quiet")
        self.assertFalse(
            admin_models.AliasRecipient.objects.filter(
...
class ManagementCommandTestCase(KalmonakTestCase):
...
class ARMessageViewSetTestCase(KalmonakAPITestCase):
    """API test case."""
