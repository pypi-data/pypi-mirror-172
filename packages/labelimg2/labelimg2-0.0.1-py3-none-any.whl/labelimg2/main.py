import codecs, os, platform, random, string, sys
...
from mixins.window import WindowMixin
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=os.path.join(os.path.dirname(__file__), "data", "predefined_classes.txt"), default_save_dir=None):
        super().__init__()
    ...
    def initMixins(self):
        ...
        self.load_predefined_classes(self.default_prefdef_class_file)
        ...
        self.diffc_button.setStyleSheet('padding: 10px;')
        ...
        list_layout.addItem(spacerItem)
        ...
        self.statusBar().setStyleSheet(f"background-image : url(images:status.jpg); background-position: center; color: orange;")
        self.statusBar().show()
...
def main():
    ...
    # QDir.addSearchPath('images', os.path.join(rootdir, 'themes/images'))
    QDir.addSearchPath('images', rootdir)
    app = QApplication([])
    # set_theme(app)
