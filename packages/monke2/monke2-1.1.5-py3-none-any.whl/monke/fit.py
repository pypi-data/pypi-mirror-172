...
class linear_fit():
   ...
   # Style des Diagramms
    ...
    def plot(self,title='title',xlabel='x_Achse',ylabel='y_achse',err=True,legend=False, infos = False, save = False,name='name.png'):
        ...
        ax.plot(self.x_val, self.__f(self.x_val),color=self.colors[1],label='Geraden-Fit')
        ...
        yerr=self.y_err, xerr=self.x_err,label='Messwerte',capsize=self.errbar[1], elinewidth=self.errbar[2], markeredgewidth=self.errbar[3])
