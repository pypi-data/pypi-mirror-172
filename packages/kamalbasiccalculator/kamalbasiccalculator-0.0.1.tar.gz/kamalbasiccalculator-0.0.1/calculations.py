...
class Calculator:
   ...
   def reset_memory(self):
        """
        This function will resets the memory back to zero
        """
        self.memory =0
   ...
   def add( self,num1, num2=None):
        """
        This function will performs the sum of two numbers
        Parameters:
   ...
   def multiply(self,num1,num2=None):
         """
       This function will performs the multipliction of two numbers
        Parameters:
            num1 : The num1 to multiply from
            num2 : The num2 is to be multiplied and if left empty it takes last memory
        Returns:
            Total subtraction: The mutliplication of the provided numbers
        """
   ...
   def division(self,num1,num2=None):
        ...
        """
         This function will performs the division of two numbers
        Parameters:
