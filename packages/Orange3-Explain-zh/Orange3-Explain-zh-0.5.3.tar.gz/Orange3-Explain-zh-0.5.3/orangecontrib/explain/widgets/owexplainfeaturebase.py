...
class OWExplainFeatureBase(OWWidget, ConcurrentWidgetMixin, openclass=True):
    ...
    class Outputs:
        selected_data = Output("选中的数据(Selected Data)", Table, replaces=["Selected Data"])
