...
class OWPermutationImportance(OWExplainFeatureBase):
    name = "特征重要性(Feature Importance)"
    description = "使用随机排列特征重要性技术检查模型."
    keywords = ["explain", "model", "permutation", "feature", "importance", "tezhengzhongyaoxing", "zhongyaoxing"]
    ...
    def update_scene(self):
        ...
        if self.results is not None:
            ...
            txt = "上升" if score in ("MSE", "RMSE", "MAE") else "下降"
            x_label = f"按照{score}{txt} "
