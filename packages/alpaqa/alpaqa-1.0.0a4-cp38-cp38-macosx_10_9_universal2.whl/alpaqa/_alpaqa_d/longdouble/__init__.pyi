...
class ALMSolver():
    ...
    """
    def __call__(self, problem: ProblemBase, x: typing.Optional[numpy.ndarray] = None, y: typing.Optional[numpy.ndarray] = None) -> typing.Tuple[numpy.ndarray, numpy.ndarray, dict]: 
        """
        Solve.
...
class LBFGS():
    ...
    class Params():
        ...
        def min_div_fac(self, arg0: float) -> None:
            pass
        @property
        def stepsize(self) -> _alpaqa_d.LBFGSStepsize:
            """
            :type: _alpaqa_d.LBFGSStepsize
            """
        @stepsize.setter
        def stepsize(self, arg0: _alpaqa_d.LBFGSStepsize) -> None:
            pass
        pass
    class Sign():
        """
        ...
        def value(self) -> int:
            ...
            :type: int
            """
        Negative: _alpaqa_d.longdouble.LBFGS.Sign # value = <Sign.Negative: 1>
        Positive: _alpaqa_d.longdouble.LBFGS.Sign # value = <Sign.Positive: 0>
...
class PANOCParams():
    ...
    def quadratic_upperbound_tolerance_factor(self, arg0: float) -> None:
        pass
    @property
    def stop_crit(self) -> _alpaqa_d.PANOCStopCrit:
        """
        :type: _alpaqa_d.PANOCStopCrit
        """
    @stop_crit.setter
    def stop_crit(self, arg0: _alpaqa_d.PANOCStopCrit) -> None:
        pass
    @property
...
class PANOCSolver():
    ...
    def __call__(self, problem: ProblemBase, Σ: numpy.ndarray, ε: float, x: typing.Optional[numpy.ndarray] = None, y: typing.Optional[numpy.ndarray] = None) -> typing.Tuple[numpy.ndarray, numpy.ndarray, numpy.ndarray, dict]: 
        ...
        """
    @typing.overload
    def __call__(self, problem: ProblemBase, ε: float, x: typing.Optional[numpy.ndarray] = None) -> typing.Tuple[numpy.ndarray, dict]: ...
    @typing.overload
...
class CountedProblem(ProblemBase):
    ...
    def evaluations(self) -> _alpaqa_d.EvalCounter:
        ...
        """
    @evaluations.setter
    def evaluations(self, arg0: _alpaqa_d.EvalCounter) -> None:
        pass
    pass
