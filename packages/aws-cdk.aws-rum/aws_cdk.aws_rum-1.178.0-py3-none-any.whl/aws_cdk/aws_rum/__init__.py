...
class CfnAppMonitor(
    ...
    def __init__(
        ...
        *,
        domain: builtins.str,
        name: builtins.str,
        app_monitor_configuration: typing.Optional[typing.Union[typing.Union["CfnAppMonitor.AppMonitorConfigurationProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable]] = None,
