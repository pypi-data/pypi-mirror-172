...
class TreeEnsembles(BinaryMapping):
  ...
  """
  def __init__(self, forest, ML_solver_information):
    self.forest = forest
    ...
    assert all(tree.force_features_equal_to_binaries == self.force_features_equal_to_binaries for tree in forest), "All trees in the forest have to have the same force_features_equal_to_binaries value."
