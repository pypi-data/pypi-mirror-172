...
class MLSolver():
    ...
    def load_data_limited(self, datasetname, possibles_indexes, n):
      ...
      self.feature_name = data.columns.values.tolist() 
    ...
    def load_data(self, dataframe, datasetname):
      ...
      Tools.verbose("Dataset name:", self.datasetname)
    ...
    def load_get_files(self, models_directory):
      assert models_directory is not None and os.path.exists(models_directory), "The path of models_directory do not exist: " + str(models_directory)
    ...
    def save(self, models, save_directory, generic=False):
      ...
      for i, trees in enumerate(models):
        ...
        data = {"training_index": ML_solver_information.training_index.tolist(), 
                ...
                "solver_name": ML_solver_information.solver_name if not generic else "Generic", 
    ...
    """
    def get_instances(self, model=None, indexes=Indexes.All, *, dataset=None, n=None, correct=None, predictions=None, save_directory=None, instances_id=None):
          ...
          if instances_id is None:
            ...
            for filename in os.listdir(indexes): 
              ...
              if os.path.isfile(file) and file.endswith("." + str(instances_id) + ".instances"):
                  ...
                  found = True
                  break
            assert found, "No ." + str(instances_id) + ".instances" + " files in the directory: " + indexes + " Please put directly the good file in the option or use the instances_id parameter !"
