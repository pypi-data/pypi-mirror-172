...
class AbductiveModelV2():
  ...
  def get_leaves(self, BTs, implicant, current_removed, is_removed):
    ...
    trees = BTs.forest
    for tree in trees:
      leaves_current_tree = leaves_current_tree.append(tree.root) if tree.is_leaf() else BTs.get_leaves(tree, tree.root, implicant, is_removed, current_removed, False)
