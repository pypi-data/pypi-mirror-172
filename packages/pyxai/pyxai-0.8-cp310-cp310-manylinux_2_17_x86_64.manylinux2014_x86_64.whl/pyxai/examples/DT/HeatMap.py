...
assert explainer.is_sufficient_reason(sufficient_reasons[-1]), "This is have to be a sufficient reason !"

minimal = explainer.minimal_sufficient_reason()
print("minimal:", minimal)
assert explainer.is_sufficient_reason(minimal), "This is have to be a sufficient reason !"
