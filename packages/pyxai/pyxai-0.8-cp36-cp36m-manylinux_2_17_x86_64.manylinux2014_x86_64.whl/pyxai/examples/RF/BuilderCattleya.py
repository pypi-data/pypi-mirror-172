...
# @misc{https://doi.org/10.48550/arxiv.2108.05276,
#   doi = {10.48550/ARXIV.2108.05276},
#   url = {https://arxiv.org/abs/2108.05276},
...
#         r = explainer.sufficient_reason()
#         print(r)
#         print(explainer.is_implicant(r))
#         if(explainer.is_implicant(r) is False) : exit(1)
#         print("-----")
...
for i in range(2):
  for j in range(2):
    for k in range(2):
      for l in range(2):
        explainer.set_instance((i,j,k,l))
        print(i,j,k,l)
        assert(explainer.is_sufficient_reason(explainer.sufficient_reason()))
