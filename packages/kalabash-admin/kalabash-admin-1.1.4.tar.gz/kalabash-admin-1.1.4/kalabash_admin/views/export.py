...
@login_required
@user_passes_test(
    lambda u: u.has_perm("core.add_user") or u.has_perm("kalabash_admin.add_alias")
)
def export_identities(request):
    ctx = {
        ...
        "formid": "exportform",
        "action": reverse("kalabash_admin:identity_export"),
    }
...
def export_domains(request):
    ctx = {
        ...
        "action_classes": "submit",
        "formid": "exportform",
        "action": reverse("kalabash_admin:domain_export"),
    }
