    ...
    if form.is_valid():
        ...
        if error is None:
            try:
                ...
                return render(request, "kalabash_admin/import_done.html", {
                    "status": "ok", "msg": msg
                })
...
""" % ''.join([unicode(hlp) for hlp in
    ...
    ctx = dict(
        ...
        action=reverse("kalabash_admin:domain_import"),
        formid="importform",
    ...
    return render(request, "kalabash_admin/importform.html", ctx)
...
""")
    ctx = dict(
        ...
        action_label=_("Import"),
        action_classes="submit",
        action=reverse("kalabash_admin:identity_import"),
        formid="importform",
        enctype="multipart/form-data",
        target="import_target",
