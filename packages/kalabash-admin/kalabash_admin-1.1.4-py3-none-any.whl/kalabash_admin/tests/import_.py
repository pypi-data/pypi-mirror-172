...
class ImportTestCase(KalmonakTestCase):
...
""", name="domains.csv")
        self.clt.post(
            reverse("kalabash_admin:domain_import"), {
                "sourcefile": f
            }
        )
...
""", name="identities.csv")
        self.clt.post(
            reverse("kalabash_admin:identity_import"),
        ...
        self.assertEqual(u1.group, "StandardUsers")
...
""", name="identities.csv")
    ...
    def test_import_quota_too_big(self):
        ...
        self.clt.login(username="admin@test.com", password="toto")
        f = ContentFile(b"""
account; user1@test.com; toto; User; One; True; StandardUsers; user1@test.com; 20
""", name="identities.csv")
        resp = self.clt.post(
            reverse("kalabash_admin:identity_import"),
            {"sourcefile": f, "crypt_password": True}
