...
class DomainTestCase(KalmonakTestCase):
    ...
    def test_create(self):
        ...
        self.ajax_post(reverse("kalabash_admin:domain_add"), values)
    ...
    def test_create_using_default_quota(self):
        parameters.save_admin('DEFAULT_DOMAIN_QUOTA', 50, app='kalabash_admin')
        values = {
    ...
    def test_domain_flat_list(self):
        ...
        response = self.clt.get(reverse("kalabash_admin:domain_flat_list"))
