...
class AliasTestCase(KalmonakTestCase):
    ...
    def test_alias_with_duplicated_recipient(self):
        ...
        self.ajax_post(
            reverse("kalabash_admin:dlist_add"), values
        )
    ...
    def test_dlist(self):
        ...
        self.ajax_post(
            reverse("kalabash_admin:alias_change", args=[dlist.id]),
            values
        )
        ...
        self.ajax_post(
            "{}?selection={}".format(
                reverse("kalabash_admin:alias_delete"), dlist.id),
            {}
        )
        self.assertRaises(
    ...
    def test_forward(self):
        ...
        self.ajax_post(
            reverse("kalabash_admin:forward_add"), values
        )
        ...
        self.ajax_post(
            reverse("kalabash_admin:alias_change",
                    args=[fwd.id]),
            values
        )
        self.assertEqual(fwd.recipients_count, 1)
    ...
    def test_forward_and_local_copies(self):
        ...
        self.ajax_post(
            reverse("kalabash_admin:alias_change", args=[fwd.id]),
            values
        )
