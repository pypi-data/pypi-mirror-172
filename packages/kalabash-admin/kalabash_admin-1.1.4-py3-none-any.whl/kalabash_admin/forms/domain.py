...
from kalabash.lib.exceptions import KalabashException, Conflict
...
class DomainFormOptions(forms.Form):
    ...
    def save(self, *args, **kwargs):
        ...
        mb.set_quota(
            override_rules=user.has_perm("kalabash_admin.change_domain"))
...
class DomainForm(TabForms):
    ...
    template_name = "kalabash_admin/editdomainform.html"

    def __init__(self, request, *args, **kwargs):
        self.user = request.user
        self.forms = []
        self.domain = None
        if self.user.has_perm("kalabash_admin.change_domain"):
            self.forms.append({
                "id": "general",
                "title": _("General"),
                "formtpl": "kalabash_admin/domain_general_form.html",
    ...
    def extra_context(self, context):
        ...
        context.update({
            ...
            "action": reverse(
                "kalabash_admin:domain_change", args=[self.domain.pk]),
            "formid": "domform",
            "domain": self.domain,
            "domadmins": domadmins
        })
...
class DomainWizard(WizardForm):
    ...
    def __init__(self, request):
        ...
        self.add_step(
            WizardStep(
                ...
                "kalabash_admin/domain_general_form.html"
            )
        )
        ...
        self.add_step(
            WizardStep(
                ...
                "kalabash_admin/domain_options_form.html",
                [self.request.user]
            )
        )
    ...
    def extra_context(self, context):
        context.update({
            "title": _("New domain"),
            "action": reverse("kalabash_admin:domain_add"),
            "formid": "domform"
        })
