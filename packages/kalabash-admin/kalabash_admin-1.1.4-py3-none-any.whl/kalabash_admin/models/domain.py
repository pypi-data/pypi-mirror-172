...
from kalabash.core.models import User, ObjectAccess
...
class Domain(AdminObject):
    ...
    def add_admin(self, account):
        ...
        for mb in self.mailbox_set.all():
            if mb.user.has_perm("kalabash_admin.add_domain"):
                continue
    ...
    def remove_admin(self, account):
        ...
        """
        from kalabash.lib.permissions import \
