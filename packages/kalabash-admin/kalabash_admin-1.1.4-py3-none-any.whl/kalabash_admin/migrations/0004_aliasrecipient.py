...
def fill_recipients(apps, schema_editor):
    ...
    Alias = apps.get_model("kalabash_admin", "Alias")
    AliasRecipient = apps.get_model("kalabash_admin", "AliasRecipient")
    to_create = []
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.ForeignKey(to='kalabash_admin.Alias')),
                ('r_alias', models.ForeignKey(related_name='alias_recipient_aliases', blank=True, to='kalabash_admin.Alias', null=True)),
                ('r_mailbox', models.ForeignKey(blank=True, to='kalabash_admin.Mailbox', null=True)),
            ],
            options={
        ...
        migrations.AlterField(
            model_name='alias',
            name='domain',
            field=models.ForeignKey(to='kalabash_admin.Domain', null=True),
