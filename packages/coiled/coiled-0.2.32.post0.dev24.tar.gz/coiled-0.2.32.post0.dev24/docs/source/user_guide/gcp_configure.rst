...
Coiled uses the service account that you created in the :ref:`previous step <create-service-account>` to create clusters the necessary infrastructure, and therefore requires a number of permissions including including network-related resources, firewall-related resources, and access to Cloud Storage.
