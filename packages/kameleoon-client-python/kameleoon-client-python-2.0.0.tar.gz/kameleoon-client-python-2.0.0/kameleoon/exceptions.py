...
class NotTargeted(KameleoonException):
    ...
    def __init__(self, visitor_code=None, campaign_key_id=None) -> None:
        self.message = "Visitor " + str(visitor_code) + \
                       " is not targeted for " + str(campaign_key_id)
        super().__init__(self.message)


class NotActivated(KameleoonException):
    ...
    def __init__(self, visitor_code=None, campaign_key_id=None) -> None:
        self.message = "Visitor " + str(visitor_code) + \
                       " is not activated for " + str(campaign_key_id)
        super().__init__(self.message)
