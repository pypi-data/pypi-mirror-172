...
class Client:
    ...
    def get_entitlements(
        self, entitlement_id: str = None, params: dict = None, **kwargs
    ) -> list:
        """
    ...
    def get_releases(
        self, entitlement_id: str, release_id: str = None, params: dict = None, **kwargs
    ) -> list:
        """
    ...
    def get_artifacts(
        self, entitlement_id: str, release_id: str, artifact_id: str = None, **kwargs
    ) -> list:
        """
