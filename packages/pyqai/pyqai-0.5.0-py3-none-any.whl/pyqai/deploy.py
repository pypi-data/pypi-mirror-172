...
#region Input Santizing
    ...
    if(check_string(version_name)==False):
        ...
        return(False)
    if(memoryLimit>16.0):
        printError("Error. We currently do not support models larger than 16 GB in our alpha test. Please try again with a smaller model")
        return(False)
#endregion
...
#region Dockerfile and requirements file handling
    printInfo("Building requirements.txt and dockerfile...")
...
def main():
    ...
    parser.add_argument("--number_pods", help="The number of pods of your deployment if you are providing your own", required=False, default=1)
    parser.add_argument("--keep_alive", help="How many hours the model should remain active without any usage. Anything greater than 8 hours may incur additional cost. You will experience a cold start once this time period expires. Defaults to 8", required=False, default=8, type=int)
