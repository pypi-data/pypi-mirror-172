...
class Box:
    ...
    def EmptyBox(self, *args, **kwargs) -> Any: ...
    def Intersects(self, arg0: Box) -> bool: ...
    def MaxBox(self, *args, **kwargs) -> Any: ...
    def Within(self, arg0: Box) -> bool: ...

class CopcConfig:
    def __init__(self, *args, **kwargs) -> None: ...
    @property
    def copc_extents(self) -> Any: ...
    @property
    def copc_info(self) -> Any: ...
    @property
...
class FileReader:
    ...
    @property
    def copc_config(self) -> Any: ...
    @property
    def path(self) -> str: ...

class FileWriter:
    def __init__(self, file_path: str, config, point_format_id: Optional[int] = ..., scale: Optional[Vector3] = ..., offset: Optional[Vector3] = ..., wkt: Optional[str] = ..., extra_bytes_vlr: Optional[EbVlr] = ..., has_extended_stats: Optional[bool] = ...) -> None: ...
    @overload
...
class Vector3:
    ...
    @overload
    def __init__(self, list: List[float]) -> None: ...
    def DefaultOffset(self, *args, **kwargs) -> Any: ...
    def DefaultScale(self, *args, **kwargs) -> Any: ...
    @overload
...
class VoxelKey:
    ...
    def GetResolutionAtDepth(self, *args, **kwargs) -> Any: ...
    def Intersects(self, arg0, arg1) -> bool: ...
    def InvalidKey(self, *args, **kwargs) -> Any: ...
    def IsValid(self) -> bool: ...
    def Resolution(self, las_header, copc_header) -> float: ...
    def RootKey(self, *args, **kwargs) -> Any: ...
...
@overload
def CompressBytes(in: VectorChar, point_format_id: int, eb_byte_size: int) -> VectorChar: ...
@overload
