...
class LaunchTemplateOptions:
    def __init__(
        ...
        *,
        ...
        spot_options: typing.Optional[typing.Union["SpotOptions", typing.Dict[str, typing.Any]]] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(LaunchTemplateOptions.__init__)
...
class Provider(
    ...
    def create_auto_scaling_group(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Provider.create_auto_scaling_group)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def create_fleet(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Provider.create_fleet)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def create_instance(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Provider.create_instance)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def create_instance_profile(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Provider.create_instance_profile)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def create_launch_template(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Provider.create_launch_template)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def get_or_create_vpc(self, scope: constructs.Construct) -> aws_cdk.aws_ec2.IVpc:
        '''
        :param scope: -
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Provider.get_or_create_vpc)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class SpotOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SpotOptions.__init__)
...
class SpotFleetOptions(AutoScalingGroupOptions):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SpotFleetOptions.__init__)
            check_type(argname="argument instance_profile", value=instance_profile, expected_type=type_hints["instance_profile"])
            check_type(argname="argument instance_type", value=instance_type, expected_type=type_hints["instance_type"])
            check_type(argname="argument machine_image", value=machine_image, expected_type=type_hints["machine_image"])
            check_type(argname="argument spot_options", value=spot_options, expected_type=type_hints["spot_options"])
