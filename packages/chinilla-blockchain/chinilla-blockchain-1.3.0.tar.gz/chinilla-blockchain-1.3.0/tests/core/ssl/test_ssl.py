...
from chinilla.protocols.shared_protocol import protocol_version, capabilities
...
async def establish_connection(server: ChinillaServer, self_hostname: str, ssl_context) -> None:
