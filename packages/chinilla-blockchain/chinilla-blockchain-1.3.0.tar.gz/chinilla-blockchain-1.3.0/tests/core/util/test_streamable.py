...
from chinilla.protocols.wallet_protocol import RespondRemovals
...
from chinilla.types.blockchain_format.sized_bytes import bytes4, bytes32
...
from chinilla.util.streamable import (
    DefinitionError,
    Streamable,
    is_type_List,
