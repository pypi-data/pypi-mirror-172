...
class TestOfferLifecycle:
    ...
    async def test_complex_offer(self, setup_sim):
        ...
        try:
            ...
            new_offer = Offer.aggregate([chinilla_offer, red_offer, red_offer_2])
            ...
            # Create yet another offer of BLUE for HCX and RED
            ...
            assert new_offer.summary() == (
                ...
                {"hcx": 900, str_to_tail_hash("red").hex(): 350},
