...
"""
run_block: Convert an encoded FullBlock from the Chinilla blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../chinilla/types/full_block.py) in json format
...
$ca_root is the directory containing your current Chinilla config files
$hash is the header_hash of the [BlockRecord](../chinilla/consensus/block_record.py)
