...
from chinilla.util.cached_bls import LOCAL_CACHE
...
from chinilla.full_node.mempool_check_conditions import mempool_check_time_locks
...
class MempoolManager:
    ...
    def __init__(
        ...
        *,
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 HCX per block, or about 0.00005 HCX for two
        # spends.
