...
from chinilla.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
from chinilla.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
...
def _create_shutdown_file() -> IO:
    return tempfile.NamedTemporaryFile(prefix="chinilla_full_node_weight_proof_handler_executor_shutdown_trigger")
