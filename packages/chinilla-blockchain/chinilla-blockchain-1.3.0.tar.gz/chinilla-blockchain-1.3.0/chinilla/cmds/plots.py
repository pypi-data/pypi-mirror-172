...
def show_plots(root_path: Path):
    from chinilla.plotting.util import get_plot_directories
...
def check_cmd(
    ...
    from chinilla.plotting.check_plots import check_plots
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from chinilla.plotting.util import remove_plot_directory
