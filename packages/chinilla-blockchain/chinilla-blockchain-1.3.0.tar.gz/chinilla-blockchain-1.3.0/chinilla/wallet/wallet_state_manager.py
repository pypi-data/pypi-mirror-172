...
from chinilla.data_layer.dl_wallet_store import DataLayerStore
...
from chinilla.protocols.wallet_protocol import CoinState, PuzzleSolutionResponse, RespondPuzzleSolution
...
from chinilla.wallet.cat_wallet.cat_utils import construct_cat_puzzle, match_cat_puzzle
...
from chinilla.wallet.nft_wallet.nft_puzzles import get_metadata_and_phs, get_new_owner_did
...
from chinilla.wallet.puzzles.cat_loader import CAT_MOD, CAT_MOD_HASH
...
from chinilla.wallet.util.wallet_sync_utils import last_change_height_cs
...
from chinilla.wallet.wallet_nft_store import WalletNftStore
...
class WalletStateManager:
    ...
    async def filter_spam(self, new_coin_state: List[CoinState]) -> List[CoinState]:
        hcx_spam_amount = self.config.get("hcx_spam_amount", 1000000)
        ...
        small_unspent_count = await self.coin_store.count_small_unspent(hcx_spam_amount)
        ...
        for cs in new_coin_state:
            ...
            if (
                ...
                and cs.coin.amount < hcx_spam_amount
