...
from chinilla.wallet.cat_wallet.cat_info import CATInfo, LegacyCATInfo
...
class CATWallet:
    ...
    async def coin_added(self, coin: Coin, height: uint32, peer: WSChinillaConnection):
    ...
    async def generate_unsigned_spendbundle(
        ...
        # Figure out if we need to absorb/melt some HCX as part of this
