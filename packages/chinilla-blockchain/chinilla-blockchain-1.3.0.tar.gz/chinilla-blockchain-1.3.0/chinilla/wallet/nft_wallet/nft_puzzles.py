...
from chinilla.wallet.nft_wallet.nft_info import NFTCoinInfo, NFTInfo
from chinilla.wallet.nft_wallet.uncurry_nft import UncurriedNFT
from chinilla.wallet.puzzles.load_clvm import load_clvm
from chinilla.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import solution_for_conditions
...
def metadata_to_program(metadata: Dict[bytes, Any]) -> Program:
    """
    Convert the metadata dict to a Chinillalisp program
    :param metadata: User defined metadata
    :return: Chinillalisp program
    """
    kv_list = []
...
def program_to_metadata(program: Program) -> Dict[bytes, Any]:
    ...
    :param program: Chinillalisp program contains the metadata
