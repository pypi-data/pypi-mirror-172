...
from chinilla.plot_sync.exceptions import (
...
from chinilla.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
class Receiver:
    _connection: WSChinillaConnection
    _current_sync: Sync
    _last_sync: Sync
    ...
    def connection(self) -> WSChinillaConnection:
